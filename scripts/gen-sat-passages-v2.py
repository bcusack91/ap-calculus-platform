#!/usr/bin/env python3
"""Expand SAT passage bank from 14 to 60 passages.
Uses JSON for data to avoid Python quoting issues.
Writes to src/data/sat-passages.ts."""
import json, os, textwrap

BASE = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
OUT = os.path.join(BASE, 'src', 'data', 'sat-passages.ts')

# Store all passages as JSON-safe dicts (double-quote escaping handled by json module)
PASSAGES = json.loads(r'''
[
  {
  ...
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "Mrs. Okafor tells Daniel he plays the notes but not the music and asks him to think of someone he misses, showing emotional connection transforms technical playing into true musical expression.", "skill": "central-ideas"
    }]
  },
  {
  ...
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Fatima\u2019s advanced vocabulary, praised as precociousness, actually reflects the adult responsibilities she carries.", "skill": "central-ideas"
    }]
  },
  {
  ...
  },
  {
    ...
    "questions": [{
      ...
      "correct": 0, "explanation": "The handshake metaphor describes Nadia\u2019s belief that a first page establishes a relationship of trust and intrigue between author and reader.", "skill": "vocabulary-context"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The snow carries David\u2019s childhood description of messages and arrives like a letter he could not quite read, symbolizing an ongoing emotional connection to his deceased brother.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The roulette number was unrelated to African countries in the UN, yet it systematically shifted participants\u2019 estimates.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "The Pirah\u00e3 struggled with exact but not approximate quantities, suggesting language influences thought without fully determining it.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Darley and Latan\u00e9 attributed the effect to diffusion of responsibility: each person assumes someone else will act.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Students praised for ability were more likely to give up, viewing the setback as proof of limited ability.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The key insight is that competence provides the metacognitive skills needed to evaluate performance.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "The 2018 study found correlations disappeared after controlling for family background, suggesting socioeconomic environment drove the differences.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The passage identifies the mechanism as anxiety-induced cognitive load that consumes working memory resources.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "Confirming information activates reward circuits while disconfirming evidence triggers threat responses, indicating neurological reinforcement.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The passage notes uncertainty about whether social media causes loneliness or lonely people gravitate to social media.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "Ostrom demonstrated that communities develop self-governing institutions to manage shared resources sustainably.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The meta-analysis found IAT scores only weakly predicted discriminatory behavior and can vary significantly across sessions.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Critics argue addiction involves compulsive behavior driven by altered brain chemistry, undermining the assumption of rational choice.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The passage rules out genetic change and identifies environmental factors: improved nutrition, education, smaller family sizes, and technology exposure.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Prospect theory states people are risk-seeking when facing losses, so they tend to hold on or gamble to try to get back to their reference point.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The decline in crime coincided with economic growth, demographic shifts, and the decline of the crack epidemic, making it difficult to isolate the policing effect.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Mother trees preferentially send carbon and defense signals to their seedlings and increase transfers when dying \u2014 evidence of cooperative behavior.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The passage identifies the concern about editing germline cells, which would pass modifications to future generations.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Acidification threatens organisms that build shells or skeletons from calcium carbonate because higher acidity makes it dissolve more readily.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Transplanting gut bacteria from obese to lean mice caused weight gain on identical diets, demonstrating a causal mechanism.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "MOND fails to explain observations at the galaxy cluster scale, limiting its viability as a complete alternative.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Effects appearing in the next generation demonstrate that environmental experiences can create heritable epigenetic changes.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Hippocampal enlargement correlated with years of experience, supporting environmental cognitive demands reshaping brain structure.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Horizontal gene transfer enables bacteria to share genetic material through plasmids, spreading resistance genes between species.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Despite compelling evidence, Wegener could not explain the mechanism for continental movement, making the theory unacceptable until seafloor spreading provided the answer.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Blue light triggers photosensitive ganglion cells to signal the SCN to suppress melatonin production, delaying sleep onset.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "The passage states mRNA degrades within days and never enters the cell nucleus, so it cannot alter DNA.", "skill": "evidence"
    }]
  },
  {
  ...
  },
  {
    ...
    "questions": [{
      ...
      "correct": 2, "explanation": "Entanglement does not violate relativity because measurement outcomes appear random and meaningful data extraction requires classical communication.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Bleaching occurs when corals expel their zooxanthellae in a stress response triggered by elevated temperatures.", "skill": "central-ideas"
    }]
  },
  {
  ...
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The prohibition confirmed literacy\u2019s power: if reading made one unfit for slavery, then it was a tool of liberation, threatening the institution.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Madison argues that a large republic\u2019s diversity of interests makes it less probable that a majority will have a common motive to invade others\u2019 rights.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The industry mounted an aggressive campaign to discredit both the book and its author, relying on ad hominem attacks rather than scientific refutation.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Using the same language forced readers to confront the gap between American ideals and American practice.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Lincoln states labor is prior to and independent of capital and deserves much the higher consideration.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Truth uses her personal experience of physical labor and hardship to expose how arguments about women\u2019s nature served to protect privilege.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "By framing the crisis as fear and inaction, Roosevelt positioned confidence and decisive action as the solution, making the New Deal seem necessary.", "skill": "inference"
    }]
  },
  {
    "id": "hist-08", "title": "MLK Letter from Birmingham", "genre": "historical",
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The white moderate\u2019s preference for order to justice and for gradual change indefinitely deferred justice.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Since European nations subsidized their own industries, American manufacturers needed government support to compete on an uneven playing field.", "skill": "evidence"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Thoreau argues the majority rules not because they are most likely to be in the right but because they are physically the strongest.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "options": ["his genuine inability to understand her argument", "that even revolutionary leaders who championed liberty could dismiss its application to women", "his plan to include women in the new Constitution", "that Abigail lacked political knowledge"],
      "correct": 1, "explanation": "Adams dismissed women\u2019s inclusion despite championing liberty from British rule, revealing that revolutionary principles were selectively applied.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Du Bois argued that without political rights, economic advancement would remain fragile and dependent on white goodwill.", "skill": "central-ideas"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The doctrine shifted from a defensive position into a justification for US intervention, the opposite of its original anti-intervention purpose.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "Not collecting the fine prevented Anthony from appealing to the Supreme Court, denying her the opportunity to establish precedent.", "skill": "inference"
    }]
  },
  {
    ...
    "questions": [{
      ...
      "correct": 1, "explanation": "The warning coming from a career military leader gave it credibility, as he could not be accused of anti-military bias.", "skill": "inference"
    }]
  }
]
''')
...
def write_passage(p, f):
    """Write a single passage entry to the TypeScript file."""
    # Escape backticks and ${} in text for template literals
    text = p['text'].replace('\\', '\\\\').replace('`', '\\`').replace('${', '\\${')
    f.write('  {\n')
    f.write(f"    id: '{p['id']}',\n")
    f.write(f"    title: '{p['title']}',\n")
    f.write(f"    genre: '{p['genre']}',\n")
    f.write(f'    text: `{text}`,\n')
    f.write('    questions: [\n')
    for qi, q in enumerate(p['questions']):
        qtext = q['question'].replace("'", "\\'")
        expl = q['explanation'].replace("'", "\\'")
        opts = ',\n'.join(f"          '{o}'" for o in (opt.replace("'", "\\'") for opt in q['options']))
        f.write('      {\n')
        f.write(f"        question: '{qtext}',\n")
        f.write(f'        options: [\n{opts}\n        ],\n')
        f.write(f"        correctAnswer: {q['correct']},\n")
        f.write(f"        explanation: '{expl}',\n")
        f.write(f"        skill: '{q['skill']}'\n")
        f.write('      }')
        if qi < len(p['questions']) - 1:
            f.write(',')
        f.write('\n')
    f.write('    ]\n')
    f.write('  }')
...
""")
    ...
    print(f'Written {len(PASSAGES)} passages to {OUT}')
