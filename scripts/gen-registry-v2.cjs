...
const calcabTopics = [
  ...
  { slug: 'exponential-models-calcab', base: 'calcabExpModels', titles: ['Exponential Growth','Exponential Decay','Newton Cooling Law','Population Models','Continuously Compounded Interest','Problem-Solving Workshop','Review & Applications'] },
