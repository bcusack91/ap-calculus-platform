...
async function main() {
  console.log('Fixing real-world applications formatting...')
...
**Example:** Comparing 325 and 867 on a number line:
...
✅ The symbol "eats" the bigger number!`
  ...
  console.log('✅ Fixed dollar signs and formatting in real-world applications!')
