...
const T: Record<AccentColor, {
  ...
  indigo:  { pageBg: 'from-indigo-50 via-white to-accent-subtle dark:from-gray-900 dark:via-gray-950 dark:to-gray-900', gradBtn: 'from-indigo-600 to-accent', borderBtn: 'border-indigo-400 dark:border-indigo-600', borderBtnText: 'text-indigo-700 dark:text-indigo-400', borderBtnHover: 'hover:bg-indigo-50 dark:hover:bg-indigo-900/20', link: 'text-indigo-600 dark:text-indigo-400', chartGrad: ['#6366F1', '#A855F7'] },
  purple:  { pageBg: 'from-accent-subtle via-white to-fuchsia-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900', gradBtn: 'from-accent to-fuchsia-600', borderBtn: 'border-accent-muted dark:border-accent', borderBtnText: 'text-accent-hover dark:text-accent-muted', borderBtnHover: 'hover:bg-accent-subtle dark:hover:bg-accent-light/20', link: 'text-accent dark:text-accent-muted', chartGrad: ['#A855F7', '#D946EF'] },
  gray:    { pageBg: 'from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900', gradBtn: 'from-gray-600 to-gray-600', borderBtn: 'border-gray-400 dark:border-gray-600', borderBtnText: 'text-gray-700 dark:text-gray-400', borderBtnHover: 'hover:bg-gray-50 dark:hover:bg-gray-900/20', link: 'text-gray-600 dark:text-gray-400', chartGrad: ['#6B7280', '#64748B'] },
