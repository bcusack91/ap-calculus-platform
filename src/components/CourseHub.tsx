...
const UNIT_TITLE_COLORS: Record<HubUnitColor, string> = {
  ...
  purple: 'text-accent-hover dark:text-accent-muted',
...
const ACCENTS: Record<HubAccent, AccentClasses> = {
  ...
  purple: {
    pageBg: 'bg-gradient-to-br from-accent-subtle via-white to-violet-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900',
    badgeBg: 'bg-accent-light dark:bg-accent-light/40',
    badgeText: 'text-accent-hover dark:text-accent-muted',
    titleGradient: 'bg-gradient-to-r from-accent to-violet-600 bg-clip-text text-transparent',
    ctaGradient: 'bg-gradient-to-r from-accent to-violet-600',
    ctaSecondaryBorder: 'border-accent-muted dark:border-accent',
    ctaSecondaryText: 'text-accent-hover dark:text-accent-muted',
    ctaSecondaryHover: 'hover:bg-accent-subtle dark:hover:bg-accent-light/20',
    cardHover: 'group-hover:text-accent dark:group-hover:text-accent-muted',
  },
  violet: {
    pageBg: 'bg-gradient-to-br from-violet-50 via-white to-accent-subtle dark:from-gray-900 dark:via-gray-950 dark:to-gray-900',
    badgeBg: 'bg-violet-100 dark:bg-violet-900/40',
    badgeText: 'text-violet-700 dark:text-violet-300',
    titleGradient: 'bg-gradient-to-r from-violet-600 to-accent bg-clip-text text-transparent',
    ctaGradient: 'bg-gradient-to-r from-violet-600 to-accent',
