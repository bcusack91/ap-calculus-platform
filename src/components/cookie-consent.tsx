      ...
      <div className="bg-white border-t shadow-2xl">
        <div className="container py-4 sm:py-6">
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <button
              onClick={closeBanner}
              className="absolute top-3 right-3 sm:relative sm:top-0 sm:right-0 p-1 text-gray-400 hover:text-gray-600 transition-colors"
          ...
          <details className="mt-4 pt-4 border-t border-gray-100">
            ...
            <div className="mt-3 space-y-3 text-xs text-gray-600">
              <div>
                <span className="font-semibold text-gray-900">Essential Cookies:</span> Required for basic site functionality 
                (navigation, security, preferences). These cannot be disabled.
              </div>
              <div>
                <span className="font-semibold text-gray-900">Analytics Cookies:</span> Help us understand how you use the site 
                so we can improve your learning experience (Google Analytics, Vercel Analytics).
              </div>
              <div>
                <span className="font-semibold text-gray-900">Advertising Cookies:</span> Enable us to show relevant ads that support 
