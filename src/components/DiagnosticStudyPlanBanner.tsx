...
const diagnosticConfig: Record<string, { apiPath: string; icon: string; label: string; borderColor: string; bgGradient: string; accentColor: string; pillHigh: string; pillMed: string; diagnosticHref: string }> = {
  ...
  'ap-calculus-ab': { apiPath: '/api/calcab-diagnostic/history', icon: '∫', label: 'AP Calculus AB', borderColor: 'border-accent-muted dark:border-accent', bgGradient: 'from-accent-subtle via-violet-50 to-accent-subtle dark:from-accent-light/30 dark:via-violet-900/20 dark:to-accent-light/30', accentColor: 'text-accent dark:text-accent-muted', pillHigh: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400', pillMed: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400', diagnosticHref: '/calcab-diagnostic' },
  'ap-calculus-bc': { apiPath: '/api/calcbc-diagnostic/history', icon: '∬', label: 'AP Calculus BC', borderColor: 'border-violet-400 dark:border-violet-600', bgGradient: 'from-violet-50 via-accent-subtle to-violet-50 dark:from-violet-900/30 dark:via-accent-light/20 dark:to-violet-900/30', accentColor: 'text-violet-600 dark:text-violet-400', pillHigh: 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-400', pillMed: 'bg-amber-100 text-amber-700 dark:bg-amber-900/30 dark:text-amber-400', diagnosticHref: '/calcbc-diagnostic' },
