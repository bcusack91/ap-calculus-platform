...
export function DiagnosticPlanPaywall() {
  return (
    <div className="mb-8 rounded-2xl border-2 border-purple-300 bg-gradient-to-br from-purple-50 to-blue-50 p-6 text-center dark:border-purple-700 dark:from-purple-900/20 dark:to-blue-900/20">
