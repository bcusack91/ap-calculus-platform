...
interface APChemReferenceModalProps {
  open: boolean
  onClose: () => void
}

/* ── Compact Periodic Table Data (Z, Symbol, Mass) ── */
...
/* ── Equation / Constants Data ── */
const EQUATION_SECTIONS: { title: string; items: string[] }[] = [
  {
...
export default function APChemReferenceModal({ open, onClose }: APChemReferenceModalProps) {
  ...
  return (
    ...
    >
      <div className="p-5">
        ...
        {/* Content */}
        {tab === 'periodic' ? <PeriodicTableView /> : <EquationsView />}
      </div>
    </FocusTrapDialog>
  )
}
