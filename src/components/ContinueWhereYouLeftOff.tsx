...
export default function ContinueWhereYouLeftOff() {
  ...
  return (
    <div className="mb-6 relative overflow-hidden rounded-xl border border-accent-light dark:border-accent-light bg-gradient-to-r from-accent-subtle to-blue-50 dark:from-accent-light/30 dark:to-blue-900/30 p-5">
      <button
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        <div className="flex-shrink-0 w-12 h-12 rounded-full bg-accent-light dark:bg-accent-light flex items-center justify-center text-2xl">
          📚
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-medium text-accent dark:text-accent-muted">Continue where you left off</p>
        ...
        <Link
          ...
          className="px-5 py-2.5 text-sm font-semibold rounded-lg bg-accent text-white hover:bg-accent-hover transition-colors whitespace-nowrap"
        >
          Resume →
        </Link>
      </div>
