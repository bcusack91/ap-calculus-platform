...
function APEnglishLangDailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-english-lang-daily-question')
      .then(r => r.json())
      .then(data => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">AP English Language — Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh question every day covering all AP English Language units!</p>
        ...
        {loading ? (
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-indigo-500 to-blue-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s AP English Language Question</span>
              </div>
              <div className="p-6">
                ...
                {!revealed ? (
                  <button onClick={() => setRevealed(true)} disabled={selected === null} className="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 py-2.5 font-semibold text-white shadow transition hover:shadow-lg disabled:opacity-40">Check Answer</button>
                ) : (
        ...
        <div className="mx-auto mt-10 max-w-md text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link href="/ap-english-lang-diagnostic" className="rounded-lg bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 transition hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400">Diagnostic Test</Link>
            <Link href="/courses/ap-english-language" className="rounded-lg bg-indigo-100 px-4 py-2 text-sm font-medium text-indigo-700 transition hover:bg-indigo-200 dark:bg-indigo-900/30 dark:text-indigo-400">All Topics</Link>
          </div>
        </div>
      </div>
    </div>
...
export default function APEnglishLangDailyQuestionPage() {
  return (
    <>
      <APEnglishLangDailyQuestionPageInner />
