...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering Coulomb\'s law, Gauss\'s law, electric potential, capacitors, DC circuits, magnetic fields, EM induction, and Maxwell\'s equations — with calculus-based practice problems.',
  ...
  },
  {
    ...
    description: 'Complete AP Physics C: E&M exam simulation: 40 MCQ (80 min) + 4 FRQ (100 min) with timed sections and self-graded rubrics.',
...
export default function APPhysicsCEMHub() {
  return (
    ...
    />
      ...
      <CourseToolGrid courseSlug="ap-physics-c-em" />
    </div>
  )
}
