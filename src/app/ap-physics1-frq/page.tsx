...
function APPhysics1FRQPageInner() {
  const { status } = useSession()
  const router = useRouter()

  const [mode, setMode] = useState<Mode>('menu')
  const [filter, setFilter] = useState<Filter>('all')
  const [frqs, setFrqs] = useState<Physics1FRQ[]>([])
  // FRQ pool from content store (DB) w/ static fallback (#10). Practice uses DB; timed exam stays static.
  const [allFrqs, setAllFrqs] = useState<Physics1FRQ[]>(() => getPhysics1FRQs())
  ...
  useRecordFrqAttempt('ap-physics-1', mode, totalEarned, totalPossible, frqs.length)
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with AP Physics 1 free-response questions. Each question includes a scoring
              rubric and sample response — the FRQ section is 50% of your AP exam score.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">AP Physics 1 FRQ Format</h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Quantitative & qualitative reasoning</li>
                  <li>• Paragraph-length argument with physics principles</li>
                  <li>• Translating between representations (graphs, equations, diagrams)</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-orange-500 to-amber-500 text-white text-xl">
                  📄
                </div>
                <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part experimental design and quantitative/qualitative analysis covering
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Paragraph arguments, calculations, and translations between representations for SHM,
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-orange-300 dark:border-orange-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Physics 1 Section II under exam conditions with a countdown timer.
              </p>
            </button>
          </div>

          <div className="bg-orange-50 dark:bg-orange-900/20 rounded-2xl p-6 border border-orange-200 dark:border-orange-700">
            <h3 className="font-bold text-orange-800 dark:text-orange-300 mb-3">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-orange-700 dark:text-orange-400">
              ...
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-0.5">✓</span>
                State which physics principle applies (Newton&apos;s 2nd law, conservation of energy, etc.)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-0.5">✓</span>
                Show all algebra — symbolic answers before plugging in numbers
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-0.5">✓</span>
                For paragraph arguments, use cause-and-effect reasoning with physics principles
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-0.5">✓</span>
                Label all vectors with direction and magnitude
              </li>
              <li className="flex items-start gap-2">
                <span className="text-orange-500 mt-0.5">✓</span>
      ...
      <div className="min-h-screen bg-gradient-to-br from-orange-50 via-white to-amber-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-orange-100 dark:bg-orange-900/30 text-orange-600' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600'}`}
                      >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
              href="/ap-physics-1"
              className="px-6 py-3 rounded-xl border-2 border-orange-300 dark:border-orange-600 text-orange-700 dark:text-orange-400 font-semibold hover:bg-orange-50 dark:hover:bg-orange-900/20 transition"
            >
              Back to AP Physics 1
            </Link>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            <button
              onClick={() => setMode('menu')}
              className="text-sm text-orange-600 dark:text-orange-400 hover:underline mb-1"
            >
              ← Back to Menu
            </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-orange-600 to-amber-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-orange-800' : 'bg-purple-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-orange-200">Unit {currentFRQ.unit}</span>
                <h2 className="text-lg font-bold mt-1">{currentFRQ.title}</h2>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <span className="bg-orange-700 px-3 py-1 rounded-full">
                ...
                <span
                  className={`px-3 py-1 rounded-full ${currentFRQ.calculatorAllowed ? 'bg-orange-700' : 'bg-red-700'}`}
                >
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <span className="bg-orange-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">
                          {part.label}
                        </span>
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... Show all work, state principles used, and include units for full credit."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-orange-500 focus:border-orange-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                      ...
                      <div className="mt-3 space-y-3">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-orange-100 dark:bg-orange-900/30 text-orange-700 dark:text-orange-300 hover:bg-orange-200 transition font-medium"
                          >
                          ...
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 hover:bg-amber-200 transition font-medium"
                          >
                        ...
                        {showRubric[key] && (
                          <div className="bg-orange-50 dark:bg-orange-900/20 rounded-lg p-4 border border-orange-200 dark:border-orange-700">
                            <h5 className="font-semibold text-orange-800 dark:text-orange-300 mb-2 text-xs">
                              Scoring Rubric:
                            </h5>
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
                                <li
                                  key={i}
                                  className="text-xs text-orange-700 dark:text-orange-400 flex items-start gap-2"
                                >
                        ...
                        {showSample[key] && (
                          <div className="bg-amber-50 dark:bg-amber-900/20 rounded-lg p-4 border border-amber-200 dark:border-amber-700">
                            <h5 className="font-semibold text-amber-800 dark:text-amber-300 mb-2 text-xs">
                              Sample Response:
                            </h5>
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-orange-600 text-white hover:bg-orange-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
            <button
              onClick={finishExam}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-orange-600 to-amber-600 text-white hover:shadow-lg transition font-medium"
            >
              Finish & Score
            </button>
          )}
...
export default function APPhysics1FRQPage() {
  return (
    <>
      <APPhysics1FRQPageInner />
      <ToolPageSeoBody subjectName="AP Physics 1: Algebra-Based" />
    </>
  )
}
