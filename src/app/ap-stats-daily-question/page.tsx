...
function APStatsDailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-stats-daily-question')
      .then(r => r.json())
      .then(data => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <Link href="/ap-statistics" className="mb-4 inline-flex items-center gap-1 text-sm text-amber-600 hover:underline dark:text-amber-400">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            AP Statistics
          </Link>
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">AP Statistics — Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh statistics question every day. Master inference, probability, and data analysis!</p>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-amber-500 to-orange-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Statistics Question</span>
              </div>
              <div className="p-6">
...
export default function APStatsDailyQuestionPage() {
  return (
    <>
      <APStatsDailyQuestionPageInner />
