...
import { config, AP_PHYSICS1_PLANS } from '@/data/ap-physics1-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-physics-1', AP_PHYSICS1_PLANS)
