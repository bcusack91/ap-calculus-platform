...
export default function APCalcBCDailyQuestionPage() {
  ...
  useEffect(() => {
    fetch('/api/ap-calcbc-daily-question')
      .then(r => r.json())
      ...
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            A fresh BC calculus question every day. Master series, parametrics, and advanced integration!
          </p>
        ...
        {loading ? (
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-indigo-500 to-purple-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Calculus BC Question</span>
                <div className="mt-1 text-xs opacity-70">
                  Topic: {q.topicSlug.replace(/-calcbc$/, '').replace(/-/g, ' ')}
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="mb-5 space-y-2">
                  {q.question.options.map((opt, i) => {
                    ...
                    if (revealed) {
                      ...
                      cls += 'border-indigo-500 bg-indigo-50 text-indigo-800 dark:bg-indigo-900/30 dark:text-indigo-300 dark:border-indigo-500'
                    } else {
                      cls += 'border-gray-200 text-gray-700 hover:border-indigo-300 hover:bg-indigo-50/50 dark:border-gray-600 dark:text-gray-300 dark:hover:border-indigo-500'
                    }
                    return (
                ...
                {!revealed ? (
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 py-2.5 font-semibold text-white shadow transition hover:shadow-lg disabled:opacity-40"
                  >
                    Check Answer
                  </button>
                ) : (
