...
function APChemDailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-chem-daily-question')
      .then(r => r.json())
      .then(data => {
      ...
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            A fresh chemistry question every day. Master reactions, equilibrium, and thermodynamics!
          </p>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-emerald-500 to-teal-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Chemistry Question</span>
                <div className="mt-1 text-xs opacity-70">
                  Topic: {q.topicSlug.replace(/-/g, ' ')}
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="mb-5 space-y-2">
                  {q.question.options.map((opt, i) => {
                    ...
                    if (revealed) {
                      ...
                      cls += 'border-emerald-500 bg-emerald-50 text-emerald-800 dark:bg-emerald-900/30 dark:text-emerald-300 dark:border-emerald-500'
                    } else {
                      cls += 'border-gray-200 text-gray-700 hover:border-emerald-300 hover:bg-emerald-50/50 dark:border-gray-600 dark:text-gray-300 dark:hover:border-emerald-500'
                    }
                    return (
        ...
        <div className="mx-auto mt-10 max-w-md text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link href="/ap-chem-diagnostic" className="rounded-lg bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 transition hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400">
              Diagnostic Test
            </Link>
            <Link href="/ap-chemistry" className="rounded-lg bg-emerald-100 px-4 py-2 text-sm font-medium text-emerald-700 transition hover:bg-emerald-200 dark:bg-emerald-900/30 dark:text-emerald-400">
              All Chem Topics
            </Link>
          </div>
        </div>
...
export default function APChemDailyQuestionPage() {
  return (
    <>
      <APChemDailyQuestionPageInner />
