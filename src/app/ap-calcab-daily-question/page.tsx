...
function APCalcABDailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-calcab-daily-question')
      .then(r => r.json())
      .then(data => {
      ...
      <div className="container py-12">
        ...
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            A fresh calculus question every day. Build your AB skills one problem at a time!
          </p>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-blue-500 to-indigo-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Calculus AB Question</span>
                <div className="mt-1 text-xs opacity-70">
                  Topic: {q.topicSlug.replace(/-calcab$/, '').replace(/-/g, ' ')}
                </div>
              </div>
              <div className="p-6">
                ...
                <div className="mb-5 space-y-2">
                  {q.question.options.map((opt, i) => {
                    ...
                    if (revealed) {
                      ...
                      cls += 'border-blue-500 bg-blue-50 text-blue-800 dark:bg-blue-900/30 dark:text-blue-300 dark:border-blue-500'
                    } else {
                      cls += 'border-gray-200 text-gray-700 hover:border-blue-300 hover:bg-blue-50/50 dark:border-gray-600 dark:text-gray-300 dark:hover:border-blue-500'
                    }
                    return (
                ...
                {!revealed ? (
                  <button
                    ...
                    className="w-full rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 py-2.5 font-semibold text-white shadow transition hover:shadow-lg disabled:opacity-40"
                  >
                    Check Answer
                  </button>
                ) : (
...
export default function APCalcABDailyQuestionPage() {
  return (
    <>
      <APCalcABDailyQuestionPageInner />
