...
export default function APPhysicsCMechFRQPage() {
  ...
  const [frqs, setFrqs] = useState<PhysicsCMechFRQ[]>([])
  // FRQ pool from the content store (DB) with a static fallback (#10). Practice uses DB; timed exam stays static.
  const [allFrqs, setAllFrqs] = useState<PhysicsCMechFRQ[]>(() => getAllFRQs())
  ...
  useEffect(() => {
    let active = true
    fetch('/api/frq/ap-physics-c-mech')
  ...
  const startTimedExam = useCallback(() => {
    ...
    setShowSample({})
    setShowRubric({})
    setTimeRemaining(90 * 60) // 90 minutes for Mechanics FRQ section
    setMode('timed')
  }, [])
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          <Link
            href="/ap-physics-c-mechanics"
            className="inline-flex items-center gap-1 text-sm text-blue-600 dark:text-blue-400 hover:underline mb-6"
          >
            ← Back to AP Physics C: Mechanics
          </Link>

          <div className="text-center mb-10">
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-indigo-100 px-4 py-1.5 text-sm font-semibold text-indigo-700 dark:bg-indigo-900/40 dark:text-indigo-300">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with calculus-based AP Physics C: Mechanics free-response questions. Each
              question includes a scoring rubric and sample response — the FRQ section is 50% of
              your AP exam score.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  <li>• Calculus-based derivations and proofs</li>
                  <li>• Setting up and solving differential equations</li>
                  <li>• Multi-step quantitative problems</li>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part problems covering kinematics, Newton&apos;s laws, energy, momentum,
                rotation, and oscillations with calculus.
              </p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on integration techniques, force analysis, energy methods, and
                rotational dynamics.
              </p>
            </button>
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-indigo-300 dark:border-indigo-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Physics C: Mechanics Section II under exam conditions with a
                countdown timer.
              </p>
            </button>
          </div>
          ...
          {/* Tips */}
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl p-6 border border-indigo-200 dark:border-indigo-700">
            <h3 className="font-bold text-indigo-800 dark:text-indigo-300 mb-3">
              💡 FRQ Tips from AP Graders
            </h3>
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-indigo-700 dark:text-indigo-400">
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Show all calculus steps — partial credit is awarded for correct setup
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Draw free-body diagrams when forces are involved
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                State the physics principle before applying it (e.g., &quot;By Newton&apos;s 2nd
                law...&quot;)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                For &quot;derive&quot; questions, start from fundamental equations
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Check dimensional consistency of your answers
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-indigo-100 dark:bg-indigo-900/30 text-indigo-600' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600'}`}
                      >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 to-blue-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-indigo-600 to-blue-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-indigo-800' : 'bg-purple-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-indigo-200">Unit {currentFRQ.unit}</span>
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                    ...
                    {!result ? (
                      <div className="mt-3">
                        <button
                          ...
                          className="px-4 py-2 text-sm bg-indigo-600 text-white rounded-lg hover:bg-indigo-700 transition-colors disabled:opacity-50 font-medium"
                          ...
                          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4 border border-indigo-200 dark:border-indigo-700">
                            ...
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
                                <li
                                  key={i}
                                  className="text-xs text-indigo-700 dark:text-indigo-400 flex items-start gap-2"
                                >
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-indigo-600 text-white hover:bg-indigo-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
