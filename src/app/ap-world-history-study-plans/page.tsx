...
import { config, AP_WORLD_HISTORY_PLANS } from '@/data/ap-world-history-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-world-history', AP_WORLD_HISTORY_PLANS)
