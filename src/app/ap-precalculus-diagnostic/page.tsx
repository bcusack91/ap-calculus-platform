            ...
            <div className="mb-8 rounded-2xl border-2 border-cyan-300 bg-cyan-50 p-6 dark:border-cyan-700 dark:bg-cyan-900/20">
              ...
              <div className="space-y-2">
                {results.recommendedTopics.map((topic, i) => (
                  <Link key={topic.slug} href={`/topics/${topic.slug}`} className="flex items-center justify-between rounded-xl border border-cyan-200 bg-white px-4 py-3 transition hover:border-cyan-400 hover:shadow-sm dark:border-cyan-700 dark:bg-gray-800 dark:hover:border-cyan-500 group">
                    <div className="flex items-center gap-3">
          ...
          <div className="mb-6 rounded-2xl border-2 border-cyan-300 bg-cyan-50 p-6 dark:border-cyan-700 dark:bg-cyan-900/20">
            ...
            <div className="space-y-2">
              {lastRecommendedTopics.map((topic, i) => (
                <Link key={topic.slug} href={`/topics/${topic.slug}`} className="flex items-center justify-between rounded-xl border border-cyan-200 bg-white px-4 py-3 transition hover:border-cyan-400 hover:shadow-sm dark:border-cyan-700 dark:bg-gray-800 group">
