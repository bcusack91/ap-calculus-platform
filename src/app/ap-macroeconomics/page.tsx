...
export const metadata: Metadata = {
  ...
  description:
    'Master AP Macroeconomics with interactive lessons, diagnostic tests, daily questions, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-macroeconomics',
  },
  openGraph: {
    title: 'AP Macroeconomics | Free Practice & Review',
    description:
      'Interactive lessons on GDP, monetary & fiscal policy, international trade, and all macroeconomics concepts.',
    url: 'https://www.studymondo.com/ap-macroeconomics',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP Macro unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-macroeconomics',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Practice Exam',
    description: 'Full-length practice exam modeled on the official College Board AP Macro exam — 60 stimulus-based MCQs and 3 FRQs (1 long + 2 short) with self-grading rubrics.',
    href: '/ap-macro-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    ...
    topics: ['Scarcity & Opportunity Cost', 'Comparative Advantage', 'Supply & Demand', 'Market Equilibrium'],
    color: 'emerald',
  },
  {
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-5 sm:p-8 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• ~17% of students score a 5</li>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/ap-macro-diagnostic"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg"
            >
              Get Started Free
