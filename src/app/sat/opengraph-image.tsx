...
export const alt = 'Study Mondo SAT Prep'
    ...
    (
      ...
      >
        ...
        >
          ...
          >
            Free practice tests, diagnostics, daily questions & score predictions
          </div>
        </div>

        {/* Feature pills */}
        <div style={{ display: 'flex', gap: '12px', flexWrap: 'wrap' }}>
          {['Practice Tests', 'Diagnostic', 'Score Predictor', 'Daily Question', 'Study Plans'].map(
            (label) => (
              <div
                key={label}
                style={{
