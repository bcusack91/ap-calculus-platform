...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive AP Physics 1 preparation with 161+ interactive lessons, diagnostic tests, flashcards, daily questions, and competitive challenges. Free for all students.',
  alternates: { canonical: 'https://www.studymondo.com/ap-physics-1' },
  openGraph: {
    title: 'AP Physics 1 | Free AP Physics Practice & Review',
    description: 'Master AP Physics 1 with 161+ interactive lessons, diagnostics, and daily practice.',
    url: 'https://www.studymondo.com/ap-physics-1',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP Physics 1 unit with practice problems, diagrams, and exit quizzes.',
  ...
  },
  {
    ...
    description: 'Quick assessment across all AP Physics 1 units to pinpoint your strengths and weak areas.',
    href: '/ap-physics1-diagnostic',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Flashcards',
    description: 'Review physics equations, key concepts, and unit definitions with spaced-repetition flashcards.',
    href: '/flashcards?course=ap-physics-1',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'A fresh AP Physics 1 question every day covering different units. Build consistency.',
    href: '/ap-physics1-daily-question',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: '40 MCQs + 4 FRQs modeled on the official CB exam (2024+ CED). Timed, calculator allowed, with self-graded rubrics.',
    href: '/ap-physics1-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    ...
    topics: ['Position & Displacement', 'Velocity & Acceleration', 'Kinematic Equations', 'Projectile Motion'],
    color: 'blue',
  },
  {
    title: 'Unit 2: Dynamics (Newton\'s Laws)',
    topics: ['Newton\'s Three Laws', 'Free-Body Diagrams', 'Friction & Normal Force', 'Circular Motion'],
    color: 'purple',
  },
  {
    title: 'Unit 3–4: Work, Energy & Momentum',
    topics: ['Work-Energy Theorem', 'Conservation of Energy', 'Power', 'Linear Momentum', 'Impulse & Collisions'],
    color: 'green',
  },
  {
    title: 'Unit 5–7: Rotation, Oscillations & Waves',
    topics: ['Torque & Rotational Motion', 'Angular Momentum', 'Simple Harmonic Motion', 'Mechanical Waves & Sound'],
    color: 'amber',
  },
]
...
const checkColors: Record<string, string> = {
  blue: 'text-blue-500', purple: 'text-purple-500', green: 'text-green-500', amber: 'text-amber-500',
}

export default function APPhysics1Hub() {
  return (
    ...
    />
      ...
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/ap-physics1-diagnostic" className="rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-3.5 text-lg font-semibold text-white shadow-lg transition hover:shadow-xl">Start with Diagnostic</Link>
            <Link href="/courses/ap-physics-1" className="rounded-xl border-2 border-blue-300 px-8 py-3.5 text-lg font-semibold text-blue-700 transition hover:bg-blue-50 dark:border-blue-600 dark:text-blue-400 dark:hover:bg-blue-900/20">Browse Lessons</Link>
          </div>
        </div>
      </section>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {features.map(f => (
              <Link key={f.title} href={f.href} className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition hover:shadow-lg dark:border-gray-700 dark:bg-gray-800">
                ...
                <h3 className="mb-1 text-lg font-bold text-gray-900 group-hover:text-blue-600 dark:text-white dark:group-hover:text-blue-400">{f.title}</h3>
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-700 dark:bg-gray-800">
          <h2 className="mb-4 text-xl font-bold text-gray-900 dark:text-white">About the AP Physics 1 Exam</h2>
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• Section II: 5 FRQs in 90 minutes</li>
          ...
          <div className="mt-6 text-center">
            <Link href="/ap-physics1-diagnostic" className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-cyan-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg">
              Get Started Free
