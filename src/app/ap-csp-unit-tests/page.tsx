...
export default async function APCSPUnitTestsPage() {
  const units = await getUnitTestUnits(AP_CSP_UNIT_TESTS_CONFIG.courseSlug, AP_CSP_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_CSP_UNIT_TESTS_CONFIG, units }}
      theme={{
