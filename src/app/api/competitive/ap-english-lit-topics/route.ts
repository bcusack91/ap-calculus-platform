...
export async function GET() {
  try {
    ...
    if (!course) return NextResponse.json({ error: 'AP English Literature course not found' }, { status: 404 })
    ...
    console.error('Error fetching AP English Literature topics:', error)
