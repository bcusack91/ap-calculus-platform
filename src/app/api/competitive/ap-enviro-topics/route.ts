...
export async function GET() {
  try {
    ...
    if (!course) return NextResponse.json({ error: 'AP Environmental Science course not found' }, { status: 404 })
    ...
    console.error('Error fetching AP Environmental Science topics:', error)
