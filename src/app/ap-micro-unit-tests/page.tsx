...
export default async function APMicroUnitTestsPage() {
  const units = await getUnitTestUnits(AP_MICRO_UNIT_TESTS_CONFIG.courseSlug, AP_MICRO_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_MICRO_UNIT_TESTS_CONFIG, units }}
      theme={{
