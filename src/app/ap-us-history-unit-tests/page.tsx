...
export default async function APUSHistoryUnitTestsPage() {
  const units = await getUnitTestUnits(AP_US_HISTORY_UNIT_TESTS_CONFIG.courseSlug, AP_US_HISTORY_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_US_HISTORY_UNIT_TESTS_CONFIG, units }}
      theme={{
