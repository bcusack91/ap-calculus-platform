...
function APPrecalcFRQPageInner() {
  const { status } = useSession()
  const router = useRouter()

  const [mode, setMode] = useState<Mode>('menu')
  const [filter, setFilter] = useState<Filter>('all')
  const [frqs, setFrqs] = useState<PrecalcFRQ[]>([])
  // FRQ pool from the content store (DB) with a static fallback (#10). Practice uses DB; timed exam stays static.
  const [allFrqs, setAllFrqs] = useState<PrecalcFRQ[]>(() => getPrecalcFRQs())
  ...
  useRecordFrqAttempt('ap-precalc', mode, totalEarned, totalPossible, frqs.length)
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with AP Precalculus free-response questions. Each question includes a scoring
              rubric and sample response — the FRQ section is ~37.5% of your AP exam score.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">AP Precalculus FRQ Format</h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <ul className="space-y-1">
                  <li>• 2 FRQs with calculator (~15 min each)</li>
                  <li>• 2 FRQs without calculator (~15 min each)</li>
                  <li>• Total: 4 questions in 60 minutes</li>
                  <li>• ~37.5% of total AP score</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Trigonometric and polar functions</li>
                  <li>• Functions involving parameters, vectors, and matrices</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-emerald-500 to-green-500 text-white text-xl">
                  📄
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500">6 points · ~15 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Extended multi-step modeling with exponential, trigonometric, or polynomial functions
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">4 points · ~8 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused problems on polynomials, logs, inverses, polar coordinates, sequences,
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-emerald-300 dark:border-emerald-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">2 long + 2 short · 60 min</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Precalculus Section II under exam conditions with a countdown timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-2xl p-6 border border-emerald-200 dark:border-emerald-700">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-emerald-700 dark:text-emerald-400">
              <li className="flex items-start gap-2">
                ...
                Show clear algebraic steps — partial credit is awarded
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5">✓</span>
                Identify the type of function (polynomial, exponential, trig) before analyzing
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5">✓</span>
                Provide units and context when interpreting results
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5">✓</span>
                Justify domain restrictions and explain extraneous solutions
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5">✓</span>
                For polar/parametric, relate back to rectangular if asked
              </li>
              <li className="flex items-start gap-2">
                <span className="text-emerald-500 mt-0.5">✓</span>
                Budget: ~15 min calculator FRQs, ~8 min no-calculator FRQs
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-emerald-100 dark:bg-emerald-900/30 text-emerald-700 dark:text-emerald-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-emerald-100 dark:bg-emerald-900/30 text-emerald-600' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600'}`}
                      >
                        {frq.type === 'long' ? 'Modeling' : 'Short FRQ'}
                      </span>
                    ...
                    <span
                      className={`font-bold ${frqTotal >= frq.totalPoints * 0.7 ? 'text-emerald-600' : frqTotal >= frq.totalPoints * 0.4 ? 'text-yellow-600' : 'text-red-600'}`}
                    >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
              href="/ap-precalculus"
              className="px-6 py-3 rounded-xl border-2 border-emerald-300 dark:border-emerald-600 text-emerald-700 dark:text-emerald-400 font-semibold hover:bg-emerald-50 dark:hover:bg-emerald-900/20 transition"
            >
              Back to AP Precalculus
            </Link>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            <button
              onClick={() => setMode('menu')}
              className="text-sm text-emerald-600 dark:text-emerald-400 hover:underline mb-1"
            >
              ← Back to Menu
            </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-emerald-600 to-green-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-emerald-800' : 'bg-purple-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Modeling' : 'Short FRQ'}
                </span>
                <span className="text-xs text-emerald-200">Unit {currentFRQ.unit}</span>
                <h2 className="text-lg font-bold mt-1">{currentFRQ.title}</h2>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <span className="bg-emerald-700 px-3 py-1 rounded-full">
                ...
                <span
                  className={`px-3 py-1 rounded-full ${currentFRQ.calculatorAllowed ? 'bg-emerald-700' : 'bg-red-700'}`}
                >
          ...
          <div className="px-6 py-5">
            {currentFRQ.dataTableHtml && (
              <div
                className="bg-gray-50 dark:bg-gray-700/50 rounded-xl p-5 mb-4 border border-gray-200 dark:border-gray-600 overflow-x-auto prose prose-sm max-w-none dark:prose-invert [&_table]:w-full [&_th]:bg-emerald-100 [&_th]:dark:bg-emerald-900/30 [&_th]:px-3 [&_th]:py-1.5 [&_td]:px-3 [&_td]:py-1.5 [&_td]:border [&_th]:border [&_td]:border-gray-300 [&_th]:border-gray-300 [&_td]:dark:border-gray-600 [&_th]:dark:border-gray-600"
                ...
                return (
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      ...
                      {result && (
                        <span
                          className={`font-bold text-sm ${result.pointsEarned === part.maxPoints ? 'text-emerald-600' : result.pointsEarned > 0 ? 'text-yellow-600' : 'text-red-600'}`}
                        >
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... Show your work step by step for partial credit."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                      ...
                      <div className="mt-3 space-y-3">
                        <div className="space-y-1">
                          {result.breakdown.map((b, i) => (
                            <div
                              key={i}
                              className={`text-xs flex items-start gap-2 p-2 rounded ${b.earned ? 'bg-emerald-50 dark:bg-emerald-900/20' : 'bg-red-50 dark:bg-red-900/20'}`}
                            >
                              <span>{b.earned ? '✅' : '❌'}</span>
                              <span
                                className={
                          ...
                          <div className="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 border border-emerald-200 dark:border-emerald-700">
                            ...
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
                                <li
                                  key={i}
                                  className="text-xs text-emerald-700 dark:text-emerald-400 flex items-start gap-2"
                                >
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-emerald-600 text-white hover:bg-emerald-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
            <button
              onClick={finishExam}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-emerald-600 to-green-600 text-white hover:shadow-lg transition font-medium"
            >
              Finish & Score
            </button>
          )}
...
export default function APPrecalcFRQPage() {
  return (
    <>
      <APPrecalcFRQPageInner />
      <ToolPageSeoBody subjectName="AP Precalculus" />
    </>
  )
}
