...
function APChemFRQPageInner() {
  ...
  const startTimedExam = useCallback(() => {
    ...
    setShowSample({})
    setShowRubric({})
    setTimeRemaining(105 * 60) // 105 minutes like real exam
    setMode('timed')
  }, [])
  ...
  useRecordFrqAttempt('ap-chem', mode, totalEarned, totalPossible, frqs.length)
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with authentic AP Chemistry free-response questions. Each question includes a
              scoring rubric and sample response — the FRQ section is 50% of your AP exam score.
            </p>
          </div>

          {/* Exam Format Info */}
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">AP Chemistry FRQ Format</h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <ul className="space-y-1">
                  <li>• 3 long free-response questions (10 pts each)</li>
                  <li>• 4 short free-response questions (4 pts each)</li>
                  <li>• Total: 46 points in 105 minutes</li>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Quantitative calculations with work shown</li>
                  <li>• Conceptual explanations & justifications</li>
                  <li>• Applying chemical principles to scenarios</li>
                </ul>
              </div>
            </div>
          </div>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">10 points · ~23 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part problems covering kinetics, equilibrium, acid-base, thermodynamics, and
                electrochemistry.
              </p>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">4 points · ~9 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on periodic trends, VSEPR, IMFs, reactions, stoichiometry, buffers,
                and more.
              </p>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">3 long + 4 short · 105 min</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Chemistry Section II under exam conditions with a countdown timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-2xl p-6 border border-indigo-200 dark:border-indigo-700">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-indigo-700 dark:text-indigo-400">
              <li className="flex items-start gap-2">
                ...
                Show all work — partial credit is awarded for correct steps
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
              ...
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Use correct chemical notation (subscripts, charges)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                For &quot;justify&quot; questions, cite a specific principle or law
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Answer what is asked — don&apos;t add irrelevant information
              </li>
              <li className="flex items-start gap-2">
                <span className="text-indigo-500 mt-0.5">✓</span>
                Budget your time: ~23 min per long, ~9 min per short
              </li>
            </ul>
          </div>
        </div>
