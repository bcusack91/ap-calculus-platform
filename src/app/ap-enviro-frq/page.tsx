...
function APAPESFRQPageInner() {
  ...
  const [allFrqs, setAllFrqs] = useState<APESFRQ[]>(() => getApAPESFRQs())
  ...
  useRecordFrqAttempt('ap-enviro', mode, totalEarned, totalPossible, frqs.length)
