...
export default async function APBioUnitTestsPage() {
  const units = await getUnitTestUnits(AP_BIOLOGY_UNIT_TESTS_CONFIG.courseSlug, AP_BIOLOGY_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_BIOLOGY_UNIT_TESTS_CONFIG, units }}
      theme={{
