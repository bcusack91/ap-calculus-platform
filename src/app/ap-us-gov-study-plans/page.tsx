...
import { config, AP_US_GOV_PLANS } from '@/data/ap-us-gov-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-us-government', AP_US_GOV_PLANS)
