...
function APEngLangFRQPageInner() {
  ...
  const [allFrqs, setAllFrqs] = useState<EngLangFRQ[]>(() => getApEngLangFRQs())
  ...
  useRecordFrqAttempt('ap-english-lang', mode, totalEarned, totalPossible, frqs.length)
