...
export default function PreAlgebraDailyQuestionPage() {
  const [questions, setQuestions] = useState<DailyQ[]>([])
  const [loading, setLoading] = useState(true)
  const [selected, setSelected] = useState<number | null>(null)
  const [revealed, setRevealed] = useState(false)
  const ctaVariant: PostCompletionCtaVariant = getOrAssignPostCompletionCtaVariant('pre-algebra')
    ...
    <div className="min-h-screen bg-gradient-to-br from-lime-50 via-white to-green-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">Pre-Algebra - Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh Pre-Algebra question every day to build math confidence.</p>
        ...
        {loading ? (
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-lime-600 to-green-600 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Pre-Algebra Question</span>
              </div>
              <div className="p-6">
