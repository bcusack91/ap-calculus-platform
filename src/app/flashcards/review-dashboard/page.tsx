...
export default function FlashcardReviewDashboard() {
  ...
  async function loadStats() {
    try {
      ...
      console.log('🎴 Stats.due:', data.stats?.due)
      console.log('🎴 Stats.total:', data.stats?.total)
      console.log('🎴 Stats.new:', data.stats?.new)
      console.log('🎴 Cards returned:', data.cards?.length)
      setStats(data.stats)
    } catch (error) {
