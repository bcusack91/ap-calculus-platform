...
export default async function APPhysics2UnitTestsPage() {
  const units = await getUnitTestUnits(AP_PHYSICS2_UNIT_TESTS_CONFIG.courseSlug, AP_PHYSICS2_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_PHYSICS2_UNIT_TESTS_CONFIG, units }}
      theme={{
