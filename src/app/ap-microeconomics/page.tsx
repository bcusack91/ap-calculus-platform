...
export const metadata: Metadata = {
  title: 'AP Microeconomics | Free Practice & Review',
  description:
    'Comprehensive AP Microeconomics preparation with interactive lessons, practice exams, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-microeconomics',
  },
  openGraph: {
    title: 'AP Microeconomics | Free Practice & Review',
    description:
      'Interactive lessons on supply & demand, market structures, elasticity, factor markets, and market failure.',
    url: 'https://www.studymondo.com/ap-microeconomics',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP Micro unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-microeconomics',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Practice Exam',
    description: 'Full-length practice exam modeled on the official College Board AP Micro exam — 60 stimulus-based MCQs and 3 FRQs (1 long + 2 short) with self-grading rubrics.',
    href: '/ap-micro-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    ...
    topics: ['Scarcity & Marginal Analysis', 'Supply & Demand', 'Market Equilibrium', 'Elasticity'],
    color: 'violet',
  },
  {
    title: 'Unit 2–3: Production & Market Structures',
    topics: ['Production & Costs', 'Perfect Competition', 'Monopoly', 'Oligopoly'],
    color: 'blue',
  },
  {
    title: 'Unit 4: Factor Markets',
    topics: ['Labor Markets', 'Factor Pricing', 'Monopsony', 'Wage Determination'],
    color: 'green',
  },
  {
    title: 'Unit 5–6: Market Failure & Government',
    topics: ['Externalities', 'Public Goods', 'Income Distribution', 'Government Intervention'],
    color: 'amber',
  },
]
...
export default function ApMicroeconomicsHub() {
  return (
    ...
    />
      {/* Hero */}
      <CourseUniqueIntro slug="ap-microeconomics" />
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-micro-diagnostic"
              className="rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
              Start with Diagnostic
            </Link>
            <Link
              href="/courses/ap-microeconomics"
              className="rounded-xl border-2 border-violet-300 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-violet-700 transition hover:bg-violet-50 dark:border-violet-600 dark:text-violet-400 dark:hover:bg-violet-900/20"
            >
              Browse Lessons
            </Link>
          </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            {features.map(f => (
              ...
              >
                ...
                <h3 className="mb-1 text-lg font-bold text-gray-900 group-hover:text-violet-600 dark:text-white dark:group-hover:text-violet-400">
                  {f.title}
                </h3>
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-5 sm:p-8 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                <li>• Section I: 60 MCQs in 70 minutes</li>
                <li>• Section II: 3 FRQs in 60 minutes</li>
                <li>• 1 long FRQ + 2 short FRQs</li>
                <li>• Total exam time: 2 hours 10 minutes</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• ~19% of students score a 5</li>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/ap-micro-diagnostic"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg"
            >
              Get Started Free
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <CourseToolGrid courseSlug="ap-microeconomics" />
    </div>
  )
}
