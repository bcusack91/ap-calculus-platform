      ...
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-micro-diagnostic"
              className="rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-8 py-3.5 text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
              Start with Diagnostic
            </Link>
            <Link
              href="/courses/ap-microeconomics"
              className="rounded-xl border-2 border-violet-300 px-8 py-3.5 text-lg font-semibold text-violet-700 transition hover:bg-violet-50 dark:border-violet-600 dark:text-violet-400 dark:hover:bg-violet-900/20"
            >
              Browse Lessons
            </Link>
          </div>
