...
export default function ApEnglishLiteratureHub() {
  return (
    ...
    />
      ...
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-english-lit-diagnostic"
              className="rounded-xl bg-gradient-to-r from-rose-600 to-pink-600 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
              Start with Diagnostic
            </Link>
            <Link
              href="/courses/ap-english-literature"
              className="rounded-xl border-2 border-rose-300 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-rose-700 transition hover:bg-rose-50 dark:border-rose-600 dark:text-rose-400 dark:hover:bg-rose-900/20"
            >
              Browse Lessons
            </Link>
          </div>
      ...
      <CourseToolGrid courseSlug="ap-english-literature" />
    </div>
  )
}
