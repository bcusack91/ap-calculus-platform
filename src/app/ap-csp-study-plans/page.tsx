...
import { config, AP_CSP_PLANS } from '@/data/ap-csp-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-computer-science-principles', AP_CSP_PLANS)
