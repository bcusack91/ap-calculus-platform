...
import {
  ...
  type CalcABFRQ,
  type FRQRubricItem,
} from '@/data/ap-calc-ab-frq/questions'
...
function APCalcABFRQPageInner() {
  const { status } = useSession()
  const router = useRouter()

  const [mode, setMode] = useState<Mode>('menu')
  const [filter, setFilter] = useState<Filter>('all')
  const [frqs, setFrqs] = useState<CalcABFRQ[]>([])
  // FRQ pool from the content store (DB) with a static fallback (#10).
  const [allFrqs, setAllFrqs] = useState<CalcABFRQ[]>(() => getCalcABFRQs())
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push('/auth/signin?callbackUrl=/ap-calc-ab-frq')
    }
  }, [status, router])

  useEffect(() => {
    let active = true
    fetch('/api/frq/ap-calc-ab')
  ...
  useRecordFrqAttempt('ap-calc-ab', mode, totalEarned, totalPossible, frqs.length)
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with AP Calculus AB free-response questions. Each question includes a scoring
              rubric and sample response — the FRQ section is 50% of your AP exam score.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">AP Calculus AB FRQ Format</h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Differentiation and its applications</li>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-blue-500 to-indigo-500 text-white text-xl">
                  📄
                </div>
                <div>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part problems involving accumulation, related rates, differential equations, and applications with data analysis.
              </p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on limits, derivatives, integration techniques, and the Fundamental Theorem of Calculus.
              </p>
            </button>
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-blue-300 dark:border-blue-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Calculus AB Section II under exam conditions with a countdown timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-2xl p-6 border border-blue-200 dark:border-blue-700">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-blue-700 dark:text-blue-400">
              <li className="flex items-start gap-2">
                ...
                Show all work — setup integrals, derivatives step by step
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">✓</span>
                Always state the theorem/rule being applied (e.g., FTC, MVT)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">✓</span>
                Label all units in answers involving real-world contexts
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">✓</span>
                For graph-based questions, reference specific coordinates
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">✓</span>
                When asked to &quot;justify,&quot; connect your mathematical result to the question
              </li>
              <li className="flex items-start gap-2">
                <span className="text-blue-500 mt-0.5">✓</span>
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-blue-100 dark:bg-blue-900/30 text-blue-600' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600'}`}
                      >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-blue-800' : 'bg-purple-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-blue-200">Unit {currentFRQ.unit}</span>
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span
                  className={`px-3 py-1 rounded-full ${currentFRQ.calculatorAllowed ? 'bg-blue-700' : 'bg-red-700'}`}
                >
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... Show all work including setup of integrals and derivatives for full credit."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                      ...
                      <div className="mt-3 space-y-3">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 hover:bg-blue-200 transition font-medium"
                          >
                        ...
                        {showRubric[key] && (
                          <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-4 border border-blue-200 dark:border-blue-700">
                            <h5 className="font-semibold text-blue-800 dark:text-blue-300 mb-2 text-xs">
                              Scoring Rubric:
                            </h5>
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-blue-600 text-white hover:bg-blue-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
            <button
              onClick={finishExam}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white hover:shadow-lg transition font-medium"
            >
              Finish & Score
            </button>
          )}
...
export default function APCalcABFRQPage() {
  return (
    <>
      <APCalcABFRQPageInner />
      <ToolPageSeoBody subjectName="AP Calculus AB" />
    </>
  )
}
