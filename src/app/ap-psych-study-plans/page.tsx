...
import { config, AP_PSYCH_PLANS } from '@/data/ap-psych-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-psychology', AP_PSYCH_PLANS)
