...
export const metadata: Metadata = {
  title: 'AP African American Studies | Free Practice & Review',
  description:
    'Master AP African American Studies with interactive lessons, diagnostic tests, practice, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-african-american-studies',
  },
  openGraph: {
    title: 'AP African American Studies | Free Practice & Review',
    description:
      'Interactive lessons covering African origins, the diaspora, resistance, cultural movements, and contemporary issues.',
    url: 'https://www.studymondo.com/ap-african-american-studies',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP AAS unit with practice problems and exit quizzes.',
  ...
  {
    title: 'Unit Tests',
    description: 'Drill a single AP unit at a time. 4 units · 4 different variations each — perfect for end-of-unit review.',
    href: '/ap-aas-unit-tests',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-african-american-studies',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-african-american-studies-daily-question',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-african-american-studies-study-plans',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-african-american-studies-score-predictor',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-african-american-studies-frq',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: 'Take a complete, timed AP African American Studies practice exam: 40 MCQs across all four units, 2 short-answer questions, and 1 document-based question modeled on the official exam.',
    href: '/ap-african-american-studies-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4" />
      </svg>
    ...
    color: 'from-amber-500 to-orange-500',
    stats: '40 MCQ + 2 SAQ + 1 DBQ · Timed',
  },]

const units = [
  {
    title: 'Unit 1: Origins of the African Diaspora',
    topics: ['African Kingdoms', 'Transatlantic Slave Trade', 'Middle Passage', 'Colonial Slavery'],
    color: 'amber',
  },
  {
    title: 'Unit 2: Freedom, Enslavement & Resistance',
    topics: ['Resistance & Abolition', 'Underground Railroad', 'Civil War & Emancipation', 'Reconstruction'],
    color: 'blue',
  },
  {
    title: 'Unit 3: The Practice of Freedom',
    topics: ['Jim Crow Era', 'Great Migration', 'Harlem Renaissance', 'WWII Era'],
    color: 'green',
  },
  {
    title: 'Unit 4: Movements & Debates',
    topics: ['Civil Rights Movement', 'Black Power', 'Contemporary Issues', 'Cultural Contributions'],
    color: 'purple',
  },
]
...
export default function ApAfricanAmericanStudiesHub() {
  return (
    ...
    />
      {/* Hero */}
      <CourseUniqueIntro slug="ap-african-american-studies" />
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-5 sm:p-8 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                <li>• Section I: 60 MCQs in 60 minutes</li>
                <li>• Section II: 3 FRQs in 120 minutes</li>
                <li>• Source analysis, argument, and research-based FRQs</li>
            ...
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• First administered in 2024–25</li>
                <li>• No penalty for guessing</li>
                <li>• Check with your college for credit</li>
              </ul>
            </div>
          </div>
          <div className="mt-6 text-center">
            <Link
              href="/ap-african-american-studies-diagnostic"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-amber-600 to-yellow-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg"
            >
              Get Started Free
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <CourseToolGrid courseSlug="ap-african-american-studies" />
    </div>
  )
}
