...
export const metadata: Metadata = {
  title: 'AP US History | Free Practice & Review',
  description:
    'Comprehensive APUSH preparation with interactive lessons, practice exams, FRQ practice, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-us-history',
  },
  openGraph: {
    title: 'AP US History | Free Practice & Review',
    description:
      'From colonial America to the modern era — interactive lessons covering every APUSH period with DBQ and LEQ practice.',
    url: 'https://www.studymondo.com/ap-us-history',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every APUSH unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-us-history',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-us-history-daily-question',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-us-history-study-plans',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-us-history-score-predictor',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    title: 'Period 1–3: Colonial & Revolutionary (1491–1800)',
    topics: ['Native Societies', 'Colonial America', 'Revolution & Independence', 'Constitution'],
    color: 'red',
  },
  {
    title: 'Period 4–5: Expansion & Civil War (1800–1877)',
    topics: ['Democracy & Expansion', 'Reform Movements', 'Civil War', 'Reconstruction'],
    color: 'blue',
  },
  {
    title: 'Period 6–7: Industrialization & Wars (1865–1945)',
    topics: ['Gilded Age', 'Progressivism', 'WWI', 'Depression & WWII'],
    color: 'green',
  },
  {
    title: 'Period 8–9: Modern America (1945–present)',
    topics: ['Cold War', 'Civil Rights', 'Vietnam & Watergate', 'Contemporary Issues'],
    color: 'purple',
  },
]
...
export default function ApUsHistoryHub() {
  return (
    ...
    />
      {/* Hero */}
      <CourseUniqueIntro slug="ap-us-history" />
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-us-history-diagnostic"
              className="rounded-xl bg-gradient-to-r from-red-600 to-rose-600 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-5 sm:p-8 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="mt-6 text-center">
            <Link
              href="/ap-us-history-diagnostic"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-red-600 to-rose-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg"
            >
              Get Started Free
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <CourseToolGrid courseSlug="ap-us-history" />
    </div>
  )
}
