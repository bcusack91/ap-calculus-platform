...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive AP US Government preparation with interactive lessons, practice exams, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-us-government',
  },
  openGraph: {
    title: 'AP US Government | Free Practice & Review',
    description:
      'Interactive lessons covering the Constitution, civil liberties, political parties, voting, and all AP Gov units.',
    url: 'https://www.studymondo.com/ap-us-government',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP US Gov unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-us-government',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-us-gov-score-predictor',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Practice Exam',
    description: 'Full-length practice exam modeled on the official College Board AP Gov exam — 55 stimulus-based MCQs and 4 FRQs (Concept App, Quant Analysis, SCOTUS Comparison, Argument Essay) with self-grading rubrics.',
    href: '/ap-us-gov-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    title: 'Unit 1: Foundations of Democracy',
    topics: ['Constitutional Principles', 'Federalism', 'Separation of Powers', 'Checks & Balances'],
    color: 'blue',
  },
  {
    title: 'Unit 2: Branches of Government',
    topics: ['Congress', 'The Presidency', 'Federal Judiciary', 'Bureaucracy'],
    color: 'green',
  },
  {
    title: 'Unit 3: Civil Liberties & Rights',
    topics: ['Bill of Rights', 'Selective Incorporation', 'Civil Rights Legislation', 'Equal Protection'],
    color: 'purple',
  },
  {
    title: 'Unit 4–5: Political Participation',
    topics: ['Voting & Elections', 'Political Parties', 'Interest Groups', 'Media & Public Opinion'],
    color: 'amber',
  },
]
...
export default function ApUsGovernmentHub() {
  return (
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                <li>• Section I: 55 MCQs in 80 minutes</li>
                <li>• Section II: 4 FRQs in 100 minutes</li>
                <li>• Concept Application, Quantitative, SCOTUS Comparison, Argument Essay</li>
