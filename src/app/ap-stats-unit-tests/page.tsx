...
export default async function APStatsUnitTestsPage() {
  const units = await getUnitTestUnits(AP_STATISTICS_UNIT_TESTS_CONFIG.courseSlug, AP_STATISTICS_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_STATISTICS_UNIT_TESTS_CONFIG, units }}
      theme={{
