...
export const metadata: Metadata = {
  ...
  description:
    'Master AP Environmental Science with interactive lessons, diagnostic tests, daily questions, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-environmental-science',
  },
  openGraph: {
    title: 'AP Environmental Science | Free Practice & Review',
    description:
      'Interactive lessons covering ecosystems, biodiversity, energy, pollution, climate change, and sustainability.',
    url: 'https://www.studymondo.com/ap-environmental-science',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP Enviro unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/flashcards?course=ap-environmental-science',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    href: '/ap-enviro-score-predictor',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  },
  {
    ...
    description: '80 MCQs + 3 long FRQs (Design an Investigation, Analyze + Solve) modeled on the official CB exam. Timed sections, self-graded rubrics.',
    href: '/ap-enviro-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    stats: '80 MCQ + 3 FRQ · 2h 40m · Timed',
  },]

const units = [
  {
    title: 'Unit 1–2: Ecosystems & Biodiversity',
    topics: ['Ecosystem Structure', 'Energy Flow', 'Biogeochemical Cycles', 'Biodiversity'],
    color: 'green',
  },
  {
    title: 'Unit 3–4: Populations & Earth Systems',
    topics: ['Population Ecology', 'Human Population', 'Earth Systems', 'Land & Water Use'],
    color: 'blue',
  },
  {
    title: 'Unit 5–6: Land & Water Resources',
    topics: ['Agriculture', 'Forestry', 'Water Resources', 'Mining & Fishing'],
    color: 'amber',
  },
  {
    title: 'Unit 7–9: Energy & Pollution',
    topics: ['Energy Sources', 'Atmospheric Pollution', 'Climate Change', 'Global Change'],
    color: 'purple',
  },
]
...
export default function ApEnvironmentalScienceHub() {
  return (
    ...
    />
      {/* Hero */}
      <CourseUniqueIntro slug="ap-environmental-science" />
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-enviro-diagnostic"
              className="rounded-xl bg-gradient-to-r from-green-600 to-emerald-600 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
              Start with Diagnostic
            </Link>
            <Link
              href="/courses/ap-environmental-science"
              className="rounded-xl border-2 border-green-300 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-green-700 transition hover:bg-green-50 dark:border-green-600 dark:text-green-400 dark:hover:bg-green-900/20"
            >
              Browse Lessons
            </Link>
          </div>
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                <li>• Section I: 80 MCQs in 90 minutes</li>
                <li>• Section II: 3 FRQs in 70 minutes</li>
                <li>• 1 Design an Investigation + 2 Analyze an Environmental Problem</li>
                <li>• Total exam time: 2 hours 40 minutes</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• ~11% of students score a 5</li>
