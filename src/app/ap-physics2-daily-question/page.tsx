...
function APPhysics2DailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-physics2-daily-question')
      .then(r => r.json())
      .then(data => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          <Link href="/ap-physics-2" className="mb-4 inline-flex items-center gap-1 text-sm text-indigo-600 hover:underline dark:text-indigo-400">
            <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" /></svg>
            AP Physics 2
          </Link>
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">AP Physics 2 — Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh physics question every day. Master fluids, thermodynamics, electricity, optics, and modern physics one problem at a time!</p>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-indigo-500 to-violet-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s Physics 2 Question</span>
              </div>
              <div className="p-6">
...
export default function APPhysics2DailyQuestionPage() {
  return (
    <>
      <APPhysics2DailyQuestionPageInner />
