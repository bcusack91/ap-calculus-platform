...
export default function APCalcBCFRQPage() {
  ...
  const [frqs, setFrqs] = useState<CalcBCFRQ[]>([])
  ...
  useEffect(() => {
    if (status === 'unauthenticated') {
      router.push('/auth/signin?callbackUrl=/ap-calc-bc-frq')
    }
  }, [status, router])
  ...
  const startPractice = useCallback((f: Filter) => {
    setFilter(f)
    const pool = f === 'long' ? getLongFRQs() : f === 'short' ? getShortFRQs() : getCalcBCFRQs()
    setFrqs(pool)
    setCurrentIdx(0)
    setResponses({})
    setResults({})
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            <div className="mb-3 inline-flex items-center gap-2 rounded-full bg-purple-100 px-4 py-1.5 text-sm font-semibold text-purple-700 dark:bg-purple-900/40 dark:text-purple-300">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with AP Calculus BC free-response questions focusing on series, parametric/polar
              curves, advanced integration, and more. The FRQ section is 50% of your AP exam score.
            </p>
          </div>

          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6 mb-8">
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">AP Calculus BC FRQ Format</h3>
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <ul className="space-y-1">
                  <li>• 2 long free-response questions (~9 pts each)</li>
                  <li>• 4 short free-response questions (~9 pts each)</li>
                  <li>• Total: ~54 points in 90 minutes</li>
                  <li>• Calculator allowed for some FRQs</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">
                ...
                <ul className="space-y-1">
                  <li>• Taylor &amp; Maclaurin series, convergence tests</li>
                  <li>• Parametric equations, polar curves, arc length</li>
                  <li>• Integration by parts, partial fractions</li>
                  <li>• Euler&apos;s method &amp; logistic growth</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-purple-500 to-indigo-500 text-white text-xl">
                  📄
                </div>
                <div>
                  ...
                  <p className="text-xs text-gray-500">~9 points · ~30 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part problems on Taylor series, parametric motion, power series convergence, and arc length.
              </p>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">~9 points · ~15 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on polar area, integration by parts, convergence tests, Euler&apos;s method, and Lagrange error.
              </p>
            </button>
              ...
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">
                    {getCalcBCFRQs().length} questions · Untimed
                  </p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Browse and practice all available BC FRQ questions at your own pace.
              </p>
            </button>

            <button
              onClick={startTimedExam}
              className="group rounded-2xl border-2 border-purple-300 dark:border-purple-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Calculus BC Section II under exam conditions with a countdown timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-2xl p-6 border border-purple-200 dark:border-purple-700">
            <h3 className="font-bold text-purple-800 dark:text-purple-300 mb-3">
              💡 BC FRQ Tips from AP Graders
            </h3>
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-purple-700 dark:text-purple-400">
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                Show all work — set up series, state convergence tests used
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                For series, always verify all conditions of the test you apply
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                In parametric/polar problems, show dx/dt and dy/dt separately
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                State error bounds clearly with the first omitted term
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                For Euler&apos;s method, show each step in a table format
              </li>
              <li className="flex items-start gap-2">
                <span className="text-purple-500 mt-0.5">✓</span>
                Budget time: ~30 min per long FRQ, ~15 min per short
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-indigo-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-purple-100 dark:bg-purple-900/30 text-purple-600' : 'bg-pink-100 dark:bg-pink-900/30 text-pink-600'}`}
                      >
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            <button
              onClick={() => setMode('menu')}
              className="text-sm text-purple-600 dark:text-purple-400 hover:underline mb-1"
            >
              ← Back to Menu
            </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-purple-800' : 'bg-pink-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-purple-200">Unit {currentFRQ.unit}</span>
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span
                  className={`px-3 py-1 rounded-full ${currentFRQ.calculatorAllowed ? 'bg-purple-700' : 'bg-red-700'}`}
                >
          ...
          <div className="px-6 py-5">
            <div className="bg-purple-50 dark:bg-purple-900/20 rounded-xl p-5 mb-6 border border-purple-200 dark:border-purple-700">
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... Show all work including setup, series terms, and convergence justification for full credit."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-purple-500 focus:border-purple-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                      ...
                      <div className="mt-3 space-y-3">
                        ...
                        <div className="flex gap-3">
                          ...
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-indigo-100 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-200 transition font-medium"
                          >
                          ...
                          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
                            ...
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
                                <li
                                  key={i}
                                  className="text-xs text-purple-700 dark:text-purple-400 flex items-start gap-2"
                                >
                        ...
                        {showSample[key] && (
                          <div className="bg-indigo-50 dark:bg-indigo-900/20 rounded-lg p-4 border border-indigo-200 dark:border-indigo-700">
                            <h5 className="font-semibold text-indigo-800 dark:text-indigo-300 mb-2 text-xs">
                              Sample Response:
                            </h5>
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-purple-600 text-white hover:bg-purple-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
            <button
              onClick={finishExam}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:shadow-lg transition font-medium"
            >
              Finish & Score
            </button>
          )}
