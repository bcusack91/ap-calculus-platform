      ...
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/ap-psych-diagnostic" className="rounded-xl bg-gradient-to-r from-pink-600 to-rose-600 px-8 py-3.5 text-lg font-semibold text-white shadow-lg transition hover:shadow-xl">Start with Diagnostic</Link>
            <Link href="/courses/ap-psychology" className="rounded-xl border-2 border-pink-300 px-8 py-3.5 text-lg font-semibold text-pink-700 transition hover:bg-pink-50 dark:border-pink-600 dark:text-pink-400 dark:hover:bg-pink-900/20">Browse Lessons</Link>
          </div>
        </div>
      </section>
