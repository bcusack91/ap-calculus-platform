...
export const metadata: Metadata = {
  title: "Contact Us | AP Study Platform",
  description: "Get in touch with us - we'd love to hear your feedback, questions, or suggestions",
};
          ...
          <div className="space-y-12">
            ...
            <div>
              ...
              <div className="space-y-4">
                <details className="group border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
