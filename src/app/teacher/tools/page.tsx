...
const TOOLS = [
  { key: 'frq-grader', label: 'FRQ Grader', icon: PenLine, description: 'AI-grade free-response answers' },
  { key: 'flashcards', label: 'Flashcard Sets', icon: Layers, description: 'Create and share custom flashcard sets' },
] as const
    ...
    <div className="min-h-screen bg-gradient-to-br from-accent-subtle via-white to-accent-subtle dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      <div className="max-w-7xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3 mb-2">
          <Link href="/teacher" className="text-accent hover:text-accent-hover text-sm font-medium">
            ← Dashboard
          </Link>
        </div>
        <div className="mb-8">
