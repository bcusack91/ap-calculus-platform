...
function APMacroDailyQuestionPageInner() {
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-white to-emerald-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">AP Macroeconomics — Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh question every day covering all AP Macroeconomics units!</p>
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-green-500 to-emerald-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s AP Macroeconomics Question</span>
              </div>
              <div className="p-6">
        ...
        <div className="mx-auto mt-10 max-w-md text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link href="/ap-macro-diagnostic" className="rounded-lg bg-green-100 px-4 py-2 text-sm font-medium text-green-700 transition hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400">Diagnostic Test</Link>
            <Link href="/courses/ap-macroeconomics" className="rounded-lg bg-green-100 px-4 py-2 text-sm font-medium text-green-700 transition hover:bg-green-200 dark:bg-green-900/30 dark:text-green-400">All Topics</Link>
          </div>
        </div>
      </div>
    </div>
...
export default function APMacroDailyQuestionPage() {
  return (
    <>
      <APMacroDailyQuestionPageInner />
