...
function APUsHistoryDailyQuestionPageInner() {
  ...
  useEffect(() => {
    fetch('/api/ap-us-history-daily-question')
      .then(r => r.json())
      .then(data => {
    ...
    <div className="min-h-screen bg-gradient-to-br from-red-50 via-white to-rose-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
      <div className="container py-12">
        <div className="mx-auto mb-10 max-w-3xl text-center">
          ...
          <h1 className="mb-3 text-3xl font-black tracking-tight text-gray-900 sm:text-4xl dark:text-white">AP US History — Question of the Day</h1>
          <p className="text-gray-600 dark:text-gray-400">A fresh question every day covering all AP US History units!</p>
        ...
        {loading ? (
          ...
          <div className="mx-auto max-w-2xl">
            <div className="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-700 dark:bg-gray-800">
              <div className="rounded-t-2xl bg-gradient-to-r from-red-500 to-rose-500 p-4 text-white">
                <span className="text-sm font-medium opacity-80">Today&apos;s AP US History Question</span>
              </div>
              <div className="p-6">
...
export default function APUsHistoryDailyQuestionPage() {
  return (
    <>
      <APUsHistoryDailyQuestionPageInner />
