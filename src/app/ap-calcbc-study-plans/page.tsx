...
import { config, AP_CALCBC_PLANS } from '@/data/ap-calcbc-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-calculus-bc', AP_CALCBC_PLANS)
