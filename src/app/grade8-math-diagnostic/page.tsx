            ...
            <div className="mb-8 rounded-2xl border-2 border-pink-300 bg-pink-50 p-6 dark:border-pink-700 dark:bg-pink-900/20">
              ...
              <div className="space-y-2">
                {results.recommendedTopics.map((topic, i) => (
                  <Link key={topic.slug} href={`/topics/${topic.slug}`} className="flex items-center justify-between rounded-xl border border-pink-200 bg-white px-4 py-3 transition hover:border-pink-400 hover:shadow-sm dark:border-pink-700 dark:bg-gray-800 dark:hover:border-pink-500 group">
                    <div className="flex items-center gap-3">
      ...
      <div className="container py-8 sm:py-12"><div className="mx-auto max-w-2xl">
          ...
          <div className="mb-6 rounded-2xl border-2 border-pink-300 bg-pink-50 p-6 dark:border-pink-700 dark:bg-pink-900/20">
            ...
            <div className="space-y-2">
              {lastRecommendedTopics.map((topic, i) => (
                <Link key={topic.slug} href={`/topics/${topic.slug}`} className="flex items-center justify-between rounded-xl border border-pink-200 bg-white px-4 py-3 transition hover:border-pink-400 hover:shadow-sm dark:border-pink-700 dark:bg-gray-800 group">
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
          ...
          <ul className="mb-6 space-y-2 text-sm text-gray-600 dark:text-gray-400">
            {['~30 questions spanning 6 Grade 8 Math domains', '30 minute time limit', 'Proficiency level assessment with per-domain breakdown', 'Personalized topic recommendations', 'Alternating forms (A/B) with different questions each time'].map(item => (
