    ...
    try {
      ...
      if (challengeToken) {
        const challengeRes = await fetch(`/api/diagnostic-challenges/${challengeToken}/submit`, {
          ...
          body: JSON.stringify({
            category: `grade8-math-diagnostic-${diagnosticResults.form}`,
      ...
      <div className="min-h-screen bg-gradient-to-br from-pink-50 via-white to-rose-50 py-8 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="container"><div className="mx-auto max-w-3xl">
          ...
          <DiagnosticChallengeCard
            category={`grade8-math-diagnostic-${results.form ?? 1}`}
          ...
          {results.recommendedTopics.length > 0 && !planAccess.loading && !planAccess.canAccess && <DiagnosticPlanPaywall />}
            ...
            <StartStudyPlanButton diagnosticPath="/grade8-math-diagnostic" className="mb-8" />
