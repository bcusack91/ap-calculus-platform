...
export const metadata: Metadata = {
  title: 'AP Human Geography | Free Practice & Review',
  description:
    'Master AP Human Geography with interactive lessons, diagnostic tests, daily questions, and study plans — free for all students.',
  alternates: {
    canonical: 'https://www.studymondo.com/ap-human-geography',
  },
  openGraph: {
    title: 'AP Human Geography | Free Practice & Review',
    description:
    ...
    url: 'https://www.studymondo.com/ap-human-geography',
  },
}
...
const features = [
  {
    ...
    description: 'Step-by-step lessons covering every AP Human Geo unit with practice problems and exit quizzes.',
  ...
  },
  {
    ...
    href: '/ap-human-geo-score-predictor',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  {
    title: 'Practice Exam',
    description: 'Full-length practice exam modeled on the official College Board APHG exam — 60 stimulus-based MCQs and 3 multi-part FRQs with self-grading rubrics.',
    href: '/ap-human-geo-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
...
const units = [
  {
    ...
    topics: ['Maps & Spatial Data', 'Geographic Concepts', 'Scale of Analysis', 'Data Collection'],
    color: 'blue',
  },
  {
    title: 'Unit 2: Population & Migration',
    topics: ['Population Distribution', 'Population Growth', 'Migration Patterns', 'Demographic Transition'],
    color: 'green',
  },
  {
    title: 'Unit 3–4: Cultural & Political Geography',
    topics: ['Cultural Diffusion', 'Language & Religion', 'Political Boundaries', 'Forms of Government'],
    color: 'purple',
  },
  {
    title: 'Unit 5–7: Agriculture, Cities & Industry',
    topics: ['Agricultural Origins', 'Urbanization Models', 'Industrialization', 'Globalization'],
    color: 'amber',
  },
]
...
export default function ApHumanGeographyHub() {
  return (
    ...
    />
      {/* Hero */}
      <CourseUniqueIntro slug="ap-human-geography" />
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              href="/ap-human-geo-diagnostic"
              className="rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3.5 text-lg font-semibold text-white shadow-lg transition hover:shadow-xl"
            >
      ...
      <section className="container pb-16">
        <div className="mx-auto max-w-3xl rounded-2xl border border-gray-200 bg-white p-8 dark:border-gray-700 dark:bg-gray-800">
          ...
          <div className="grid gap-6 text-sm text-gray-600 sm:grid-cols-2 dark:text-gray-400">
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• Section II: 3 FRQs in 75 minutes</li>
                <li>• 1 FRQ with stimulus, 1 no stimulus, 1 with stimulus</li>
                <li>• Total exam time: 2 hours 15 minutes</li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-1">
                ...
                <li>• ~15% of students score a 5</li>
          ...
          <div className="mt-6 text-center">
            <Link
              href="/ap-human-geo-diagnostic"
              className="inline-flex items-center gap-2 rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 px-8 py-3 font-semibold text-white shadow transition hover:shadow-lg"
            >
              Get Started Free
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
