...
import { config, AP_ENG_LIT_PLANS } from '@/data/ap-english-lit-study-plans'
...
export default async function Page() {
  const plans = await getContentItems(CONTENT_TYPES.studyPlanTemplate, 'ap-english-literature', AP_ENG_LIT_PLANS)
