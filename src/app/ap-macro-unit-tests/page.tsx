...
export default async function APMacroUnitTestsPage() {
  const units = await getUnitTestUnits(AP_MACRO_UNIT_TESTS_CONFIG.courseSlug, AP_MACRO_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_MACRO_UNIT_TESTS_CONFIG, units }}
      theme={{
