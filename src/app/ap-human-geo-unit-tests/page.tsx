...
export default async function APHumanGeoUnitTestsPage() {
  const units = await getUnitTestUnits(AP_HUMAN_GEO_UNIT_TESTS_CONFIG.courseSlug, AP_HUMAN_GEO_UNIT_TESTS_CONFIG.units)
  return (
    <UnitTestsClient
      config={{ ...AP_HUMAN_GEO_UNIT_TESTS_CONFIG, units }}
      theme={{
