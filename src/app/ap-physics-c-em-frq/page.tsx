...
function APPhysicsCEMFRQPageInner() {
  ...
  const startTimedExam = useCallback(() => {
    ...
    setFrqs([...longQuestions, ...shortQuestions])
    setCurrentIdx(0)
    setResponses({})
    setResults({})
    setShowSample({})
    setShowRubric({})
    setTimeRemaining(90 * 60) // 90 minutes for E&M FRQ section
    setMode('timed')
  }, [])
  ...
  useRecordFrqAttempt('ap-physics-c-em', mode, totalEarned, totalPossible, frqs.length)
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with calculus-based AP Physics C: Electricity & Magnetism free-response
              questions. Each question includes a scoring rubric and sample response — the FRQ
              section is 50% of your AP exam score.
            </p>
          </div>
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <ul className="space-y-1">
                  <li>• 3 long free-response questions (15 pts each)</li>
                  <li>• Total: 45 points in 45 minutes</li>
                  <li>• Calculator allowed for all FRQs</li>
                  <li>• Equation sheet provided</li>
                </ul>
              </div>
              <div>
                <h4 className="font-semibold text-gray-800 dark:text-gray-200 mb-2">
                ...
                <ul className="space-y-1">
                  <li>• Gauss&apos;s law and surface integral setup</li>
                  <li>• Circuit analysis with differential equations</li>
                  <li>• Faraday&apos;s law and inductance calculations</li>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xl">
                  📄
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-amber-600 dark:group-hover:text-amber-400">
                    Long FRQs
                  </h3>
                  <p className="text-xs text-gray-500">10 points · ~25 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part problems covering electrostatics, Gauss&apos;s law, circuits, magnetic
                fields, and electromagnetic induction with calculus.
              </p>
            </button>
            ...
            >
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on capacitors, dielectrics, RC circuits, magnetic forces, and
                RL transients.
              </p>
            </button>
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-amber-300 dark:border-amber-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">3 long + 4 short · 90 min</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Physics C: E&M Section II under exam conditions with a
                countdown timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-amber-50 dark:bg-amber-900/20 rounded-2xl p-6 border border-amber-200 dark:border-amber-700">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-amber-700 dark:text-amber-400">
              <li className="flex items-start gap-2">
                ...
                Draw clear diagrams with Gaussian surfaces or Amperian loops
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✓</span>
                Show integral setup before evaluating — partial credit for correct limits
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✓</span>
                State symmetry arguments explicitly when applying Gauss&apos;s or Ampere&apos;s law
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✓</span>
                For circuit problems, clearly label current directions and apply Kirchhoff&apos;s
                rules
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✓</span>
                Check limiting cases (t → 0, t → ∞) for RC and RL transients
              </li>
              <li className="flex items-start gap-2">
                <span className="text-amber-500 mt-0.5">✓</span>
                Include units and verify dimensional consistency
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-amber-50 via-white to-orange-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-amber-100 dark:bg-amber-900/30 text-amber-700 dark:text-amber-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-amber-100 dark:bg-amber-900/30 text-amber-600' : 'bg-purple-100 dark:bg-purple-900/30 text-purple-600'}`}
                      >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-amber-600 to-orange-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
              href="/ap-physics-c-em"
              className="px-6 py-3 rounded-xl border-2 border-amber-300 dark:border-amber-600 text-amber-700 dark:text-amber-400 font-semibold hover:bg-amber-50 dark:hover:bg-amber-900/20 transition"
            >
              Back to AP Physics C: E&M
            </Link>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="flex items-center justify-between mb-6 flex-wrap gap-3">
          <div>
            <button
              onClick={() => setMode('menu')}
              className="text-sm text-amber-600 dark:text-amber-400 hover:underline mb-1"
            >
              ← Back to Menu
            </button>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-amber-600 to-orange-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-amber-800' : 'bg-purple-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-amber-200">Unit {currentFRQ.unit}</span>
              ...
              <div className="flex items-center gap-3 text-sm">
                ...
                <span className="bg-amber-700 px-3 py-1 rounded-full">
                  {currentFRQ.timeRecommendation} min
                </span>
                <span
                  ...
                  >
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        <span className="bg-amber-600 text-white w-8 h-8 rounded-full flex items-center justify-center text-sm font-bold">
                          {part.label}
                        </span>
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... Show all work including calculus steps for full credit."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-amber-500 focus:border-amber-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                    ...
                    {!result ? (
                      <div className="mt-3">
                        <button
                          ...
                          className="px-4 py-2 text-sm bg-amber-600 text-white rounded-lg hover:bg-amber-700 transition-colors disabled:opacity-50 font-medium"
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-amber-600 text-white hover:bg-amber-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
...
export default function APPhysicsCEMFRQPage() {
  return (
    <>
      <APPhysicsCEMFRQPageInner />
      <ToolPageSeoBody subjectName="AP Physics C: Electricity and Magnetism" />
    </>
  )
}
