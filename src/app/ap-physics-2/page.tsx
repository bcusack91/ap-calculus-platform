...
const features = [
  ...
  },
  {
    ...
    description: '40 MCQs + 4 FRQs covering all 7 units (fluids → modern physics). Timed, calculator allowed, with self-graded rubrics.',
    href: '/ap-physics2-practice',
    icon: (
      <svg className="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <section className="container py-12 sm:py-20">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link href="/ap-physics2-diagnostic" className="rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-white shadow-lg transition hover:shadow-xl">Start with Diagnostic</Link>
            <Link href="/courses/ap-physics-2" className="rounded-xl border-2 border-violet-300 px-5 sm:px-8 py-3 sm:py-3.5 text-base sm:text-lg font-semibold text-violet-700 transition hover:bg-violet-50 dark:border-violet-600 dark:text-violet-400 dark:hover:bg-violet-900/20">Browse Lessons</Link>
          </div>
        </div>
      </section>
