...
function APPhysics2FRQPageInner() {
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
              Practice with AP Physics 2 free-response questions. Each question includes a scoring
            ...
            <div className="grid sm:grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400">
              <div>
                ...
                <ul className="space-y-1">
                  <li>• 2 long free-response questions (7 pts each)</li>
                  <li>• 3 short free-response questions (5 pts each)</li>
                  <li>• Total: ~29 points in 90 minutes</li>
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>• Applying physics principles to novel scenarios</li>
                  <li>• Constructing paragraph-length arguments</li>
                  <li>• Deriving equations and showing calculations</li>
                </ul>
              </div>
            </div>
          </div>
          ...
          <div className="grid sm:grid-cols-2 gap-4 mb-8">
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-violet-500 to-purple-500 text-white text-xl">
                  📄
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-violet-600 dark:group-hover:text-violet-400">
                    Long FRQs
                  </h3>
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Multi-part experimental design and analysis covering circuits, electromagnetic
                induction, fluids, and thermodynamics.
              </p>
            </button>
            ...
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="h-12 w-12 flex items-center justify-center rounded-xl bg-gradient-to-r from-fuchsia-500 to-pink-500 text-white text-xl">
                  📝
                </div>
                <div>
                  <h3 className="font-bold text-gray-900 dark:text-white group-hover:text-fuchsia-600 dark:group-hover:text-fuchsia-400">
                    Short FRQs
                  </h3>
                  <p className="text-xs text-gray-500">5 points · ~15 min each</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Focused questions on electric fields, optics, nuclear physics, the photoelectric
                effect, and RC circuits.
              </p>
            </button>
            ...
            <button
              ...
              className="group rounded-2xl border-2 border-violet-300 dark:border-violet-600 bg-white dark:bg-gray-800 p-6 text-left hover:shadow-lg transition"
            >
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">2 long + 3 short · 90 min</p>
                </div>
              </div>
              <p className="text-sm text-gray-600 dark:text-gray-400">
                Simulate the real AP Physics 2 Section II under exam conditions with a countdown
                timer.
              </p>
            </button>
          </div>
          ...
          <div className="bg-violet-50 dark:bg-violet-900/20 rounded-2xl p-6 border border-violet-200 dark:border-violet-700">
            <h3 className="font-bold text-violet-800 dark:text-violet-300 mb-3">
            ...
            <ul className="grid sm:grid-cols-2 gap-2 text-sm text-violet-700 dark:text-violet-400">
              <li className="flex items-start gap-2">
                ...
                Draw circuit diagrams or field line diagrams when relevant
              </li>
              <li className="flex items-start gap-2">
                <span className="text-violet-500 mt-0.5">✓</span>
                State physical principles (Gauss&apos;s law, Faraday&apos;s law, conservation of
                charge, etc.)
              </li>
              <li className="flex items-start gap-2">
                <span className="text-violet-500 mt-0.5">✓</span>
                For experimental design, include variables, equipment, and a clear procedure
              </li>
              <li className="flex items-start gap-2">
                <span className="text-violet-500 mt-0.5">✓</span>
                Show calculations with proper units throughout
              </li>
              <li className="flex items-start gap-2">
                <span className="text-violet-500 mt-0.5">✓</span>
                For paragraph arguments, explicitly connect evidence to the physics model
              </li>
              <li className="flex items-start gap-2">
                <span className="text-violet-500 mt-0.5">✓</span>
                Budget: ~25 min per long FRQ, ~15 min per short
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="min-h-screen bg-gradient-to-br from-violet-50 via-white to-purple-50 dark:from-gray-900 dark:via-gray-950 dark:to-gray-900">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-5 sm:p-8 text-center mb-6 sm:mb-8">
            ...
            <div className="inline-flex items-center gap-2 text-lg font-bold bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 px-4 py-2 rounded-xl">
              ...
              return (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <span
                        className={`text-xs font-bold px-2 py-0.5 rounded ${frq.type === 'long' ? 'bg-violet-100 dark:bg-violet-900/30 text-violet-600' : 'bg-fuchsia-100 dark:bg-fuchsia-900/30 text-fuchsia-600'}`}
                      >
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button
              ...
              className="px-6 py-3 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 text-white font-semibold hover:shadow-lg transition"
            >
              Practice More
            </button>
            <Link
              href="/ap-physics-2"
              className="px-6 py-3 rounded-xl border-2 border-violet-300 dark:border-violet-600 text-violet-700 dark:text-violet-400 font-semibold hover:bg-violet-50 dark:hover:bg-violet-900/20 transition"
            >
              Back to AP Physics 2
            </Link>
          </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-violet-600 to-purple-600 text-white px-6 py-4">
            <div className="flex items-center justify-between flex-wrap gap-2">
              <div>
                <span
                  className={`text-xs font-bold px-2 py-0.5 rounded mr-2 ${currentFRQ.type === 'long' ? 'bg-violet-800' : 'bg-fuchsia-700'}`}
                >
                  {currentFRQ.type === 'long' ? 'Long FRQ' : 'Short FRQ'}
                </span>
                <span className="text-xs text-violet-200">Unit {currentFRQ.unit}</span>
                <h2 className="text-lg font-bold mt-1">{currentFRQ.title}</h2>
              </div>
              <div className="flex items-center gap-3 text-sm">
                <span className="bg-violet-700 px-3 py-1 rounded-full">
                ...
                <span
                  className={`px-3 py-1 rounded-full ${currentFRQ.calculatorAllowed ? 'bg-violet-700' : 'bg-red-700'}`}
                >
          ...
          <div className="px-6 py-5">
            ...
            {currentFRQ.dataTableHtml && (
              <div
                className="mb-6 overflow-x-auto rounded-xl border border-gray-200 dark:border-gray-700 p-4 bg-gray-50 dark:bg-gray-900"
                ...
                return (
                  ...
                  >
                    ...
                    <textarea
                      ...
                      placeholder="Write your response here... State physical principles, show calculations with units, and draw diagrams where appropriate."
                      className="w-full h-36 p-3 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100 resize-y text-sm focus:ring-2 focus:ring-violet-500 focus:border-violet-500"
                      disabled={!!result}
                      maxLength={2000}
                    />
                      ...
                      <div className="mt-3 space-y-3">
                        ...
                        <div className="flex gap-3">
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-violet-100 dark:bg-violet-900/30 text-violet-700 dark:text-violet-300 hover:bg-violet-200 transition font-medium"
                          >
                          ...
                          <button
                            ...
                            className="text-xs px-3 py-1.5 rounded-lg bg-purple-100 dark:bg-purple-900/30 text-purple-700 dark:text-purple-300 hover:bg-purple-200 transition font-medium"
                          >
                        ...
                        {showRubric[key] && (
                          <div className="bg-violet-50 dark:bg-violet-900/20 rounded-lg p-4 border border-violet-200 dark:border-violet-700">
                            <h5 className="font-semibold text-violet-800 dark:text-violet-300 mb-2 text-xs">
                              Scoring Rubric:
                            </h5>
                            <ul className="space-y-1">
                              {part.rubric.map((r, i) => (
                                <li
                                  key={i}
                                  className="text-xs text-violet-700 dark:text-violet-400 flex items-start gap-2"
                                >
                        ...
                        {showSample[key] && (
                          <div className="bg-purple-50 dark:bg-purple-900/20 rounded-lg p-4 border border-purple-200 dark:border-purple-700">
                            <h5 className="font-semibold text-purple-800 dark:text-purple-300 mb-2 text-xs">
                              Sample Response:
                            </h5>
        ...
        <div className="flex items-center justify-between">
          ...
          {currentIdx < frqs.length - 1 ? (
            <button
              ...
              className="px-5 py-2.5 rounded-xl bg-violet-600 text-white hover:bg-violet-700 transition font-medium"
            >
              Next →
            </button>
          ) : (
            <button
              onClick={finishExam}
              className="px-5 py-2.5 rounded-xl bg-gradient-to-r from-violet-600 to-purple-600 text-white hover:shadow-lg transition font-medium"
            >
              Finish & Score
            </button>
          )}
...
export default function APPhysics2FRQPage() {
  return (
    <>
      <APPhysics2FRQPageInner />
      <ToolPageSeoBody subjectName="AP Physics 2: Algebra-Based" />
    </>
  )
}
