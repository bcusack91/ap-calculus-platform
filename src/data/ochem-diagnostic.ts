...
const OCHEM_DOMAINS: OChemDomain[] = [
  { id: 'structure-bonding', name: 'Structure & Bonding', topicSlugs: ['molecular-orbital-theory', 'hybridization-geometry'], questionTarget: 5 },
  { id: 'stereochemistry', name: 'Stereochemistry', topicSlugs: ['chirality-enantiomers', 'diastereomers-meso'], questionTarget: 5 },
  { id: 'reactions-mechanisms', name: 'Reactions & Mechanisms', topicSlugs: ['sn1-sn2-reactions', 'e1-e2-elimination'], questionTarget: 6 },
  { id: 'functional-groups', name: 'Functional Groups & Nomenclature', topicSlugs: ['iupac-nomenclature', 'functional-group-chemistry'], questionTarget: 5 },
  { id: 'carbonyl-chemistry', name: 'Carbonyl Chemistry', topicSlugs: ['aldehydes-ketones', 'carboxylic-acid-derivatives'], questionTarget: 5 },
  { id: 'spectroscopy', name: 'Spectroscopy & Analysis', topicSlugs: ['nmr-spectroscopy', 'ir-mass-spec'], questionTarget: 4 },
  { id: 'aromatic-chemistry', name: 'Aromatic Chemistry', topicSlugs: ['electrophilic-aromatic-substitution', 'aromaticity-huckel'], questionTarget: 4 },
]
...
const questionPool: PoolQuestion[] = [
  // ---- Structure & Bonding ----
  { question: 'A carbon with sp³ hybridization has what geometry?', options: ['Linear', 'Trigonal planar', 'Tetrahedral', 'Octahedral'], correctAnswer: 2, explanation: 'sp³ hybridization gives a tetrahedral geometry with ~109.5° bond angles.', domain: 'structure-bonding', topicSlug: 'hybridization-geometry', formSet: 'A' },
  { question: 'Which bond is the shortest?', options: ['C−C', 'C=C', 'C≡C', 'C−O'], correctAnswer: 2, explanation: 'Triple bonds (C≡C) are the shortest due to the greatest electron density between the atoms.', domain: 'structure-bonding', topicSlug: 'molecular-orbital-theory', formSet: 'A' },
  { question: 'In a π bond, orbitals overlap:', options: ['Head-to-head', 'Side-by-side', 'At 109.5°', 'Not at all'], correctAnswer: 1, explanation: 'π bonds form from side-by-side (lateral) overlap of p orbitals, above and below the internuclear axis.', domain: 'structure-bonding', topicSlug: 'molecular-orbital-theory', formSet: 'A' },
  { question: 'An sp² hybridized carbon is involved in how many π bonds?', options: ['0', '1', '2', '3'], correctAnswer: 1, explanation: 'sp² leaves one unhybridized p orbital available for one π bond (as in alkenes or carbonyls).', domain: 'structure-bonding', topicSlug: 'hybridization-geometry', formSet: 'B' },
  { question: 'Electronegativity increases going:', options: ['Down a group and left across a period', 'Up a group and right across a period', 'Down a group and right across a period', 'It stays constant'], correctAnswer: 1, explanation: 'Electronegativity increases up a group (smaller atoms hold electrons tighter) and right across a period.', domain: 'structure-bonding', topicSlug: 'molecular-orbital-theory', formSet: 'B' },
  ...
  { question: 'A carbon-carbon double bond consists of:', options: ['Two σ bonds', 'One σ bond and one π bond', 'Two π bonds', 'One σ bond only'], correctAnswer: 1, explanation: 'A double bond = one σ (head-to-head overlap) + one π (side-by-side overlap).', domain: 'structure-bonding', topicSlug: 'hybridization-geometry', formSet: 'both' },
  { question: 'The most electronegative element commonly found in organic molecules is:', options: ['Carbon', 'Nitrogen', 'Oxygen', 'Fluorine'], correctAnswer: 3, explanation: 'Fluorine is the most electronegative element (EN ≈ 4.0).', domain: 'structure-bonding', topicSlug: 'molecular-orbital-theory', formSet: 'both' },

  // ---- Stereochemistry ----
  { question: 'Enantiomers are molecules that are:', options: ['Identical', 'Non-superimposable mirror images', 'Structural isomers', 'Geometric isomers'], correctAnswer: 1, explanation: 'Enantiomers are stereoisomers that are non-superimposable mirror images of each other.', domain: 'stereochemistry', topicSlug: 'chirality-enantiomers', formSet: 'A' },
  ...
  { question: 'cis/trans isomerism requires:', options: ['Four different groups', 'A double bond or ring and two different groups on each carbon', 'An asymmetric carbon', 'Only single bonds'], correctAnswer: 1, explanation: 'cis/trans (geometric) isomers arise from restricted rotation around double bonds or rings.', domain: 'stereochemistry', topicSlug: 'diastereomers-meso', formSet: 'both' },
  { question: 'Optical activity is measured using:', options: ['A spectrometer', 'A polarimeter', 'A calorimeter', 'NMR'], correctAnswer: 1, explanation: 'A polarimeter measures the rotation of plane-polarized light by chiral compounds.', domain: 'stereochemistry', topicSlug: 'chirality-enantiomers', formSet: 'both' },

  // ---- Reactions & Mechanisms ----
  { question: 'SN2 reactions are characterized by:', options: ['A two-step mechanism with a carbocation intermediate', 'A one-step concerted mechanism with backside attack', 'Lack of stereochemistry change', 'Rearrangement of the carbon skeleton'], correctAnswer: 1, explanation: 'SN2: one step, backside attack, inversion of stereochemistry, favored by strong nucleophiles and primary substrates.', domain: 'reactions-mechanisms', topicSlug: 'sn1-sn2-reactions', formSet: 'A' },
  { question: 'SN1 reactions proceed through:', options: ['Concerted mechanism', 'A carbocation intermediate (two steps)', 'A carbanion intermediate', 'Radical intermediates'], correctAnswer: 1, explanation: 'SN1: step 1 = formation of carbocation (rate-limiting), step 2 = nucleophilic attack on carbocation.', domain: 'reactions-mechanisms', topicSlug: 'sn1-sn2-reactions', formSet: 'A' },
  { question: 'E2 elimination requires:', options: ['A weak base', 'A strong base and anti-periplanar arrangement', 'A carbocation intermediate', 'Room temperature only'], correctAnswer: 1, explanation: 'E2: one-step mechanism requiring a strong base and anti-periplanar geometry of H and leaving group.', domain: 'reactions-mechanisms', topicSlug: 'e1-e2-elimination', formSet: 'A' },
  { question: 'Zaitsev\'s rule predicts that elimination favors:', options: ['The least substituted alkene', 'The most substituted alkene', 'Only terminal alkenes', 'Cyclic products'], correctAnswer: 1, explanation: 'Zaitsev\'s rule: the major product is the more substituted (more stable) alkene.', domain: 'reactions-mechanisms', topicSlug: 'e1-e2-elimination', formSet: 'B' },
  { question: 'Which substrate best undergoes SN1?', options: ['Methyl halide', 'Primary alkyl halide', 'Tertiary alkyl halide', 'Vinyl halide'], correctAnswer: 2, explanation: 'SN1 favors tertiary substrates because they form the most stable carbocation intermediate.', domain: 'reactions-mechanisms', topicSlug: 'sn1-sn2-reactions', formSet: 'B' },
  { question: 'A Markovnikov addition of HBr to propene gives:', options: ['1-bromopropane', '2-bromopropane', 'A mixture of both equally', 'Cyclopropane'], correctAnswer: 1, explanation: 'Markovnikov: H goes to the less substituted carbon, Br to the more substituted → 2-bromopropane.', domain: 'reactions-mechanisms', topicSlug: 'sn1-sn2-reactions', formSet: 'B' },
  { question: 'E1 elimination shares a rate-determining step with:', options: ['SN2', 'E2', 'SN1', 'Free radical halogenation'], correctAnswer: 2, explanation: 'Both E1 and SN1 begin with the same rate-limiting step: formation of a carbocation.', domain: 'reactions-mechanisms', topicSlug: 'e1-e2-elimination', formSet: 'B' },
  { question: 'In SN2, the rate law is:', options: ['Rate = k[substrate]', 'Rate = k[nucleophile]', 'Rate = k[substrate][nucleophile]', 'Rate = k[substrate]²'], correctAnswer: 2, explanation: 'SN2 is bimolecular: rate depends on both substrate and nucleophile concentrations.', domain: 'reactions-mechanisms', topicSlug: 'sn1-sn2-reactions', formSet: 'both' },
  { question: 'A primary substrate with a strong base and bulky nucleophile typically undergoes:', options: ['SN1', 'SN2', 'E2', 'E1'], correctAnswer: 2, explanation: 'Bulky strong bases favor E2 elimination even on primary substrates (steric hindrance reduces SN2).', domain: 'reactions-mechanisms', topicSlug: 'e1-e2-elimination', formSet: 'both' },

  // ---- Functional Groups & Nomenclature ----
  { question: 'The IUPAC name for CH₃CH₂OH is:', options: ['Methanol', 'Ethanol', 'Propanol', 'Ethanal'], correctAnswer: 1, explanation: 'Two carbons (eth-) with an -OH group: ethanol.', domain: 'functional-groups', topicSlug: 'iupac-nomenclature', formSet: 'A' },
  { question: 'A ketone functional group is:', options: ['−CHO', 'C=O between two carbons', '−COOH', '−NH₂'], correctAnswer: 1, explanation: 'A ketone has C=O flanked by two carbon groups (R−CO−R\').', domain: 'functional-groups', topicSlug: 'functional-group-chemistry', formSet: 'A' },
  { question: 'Which functional group has the highest priority in IUPAC naming?', options: ['Alcohol (−OH)', 'Amine (−NH₂)', 'Carboxylic acid (−COOH)', 'Aldehyde (−CHO)'], correctAnswer: 2, explanation: 'Carboxylic acid has the highest IUPAC naming priority among common functional groups.', domain: 'functional-groups', topicSlug: 'iupac-nomenclature', formSet: 'A' },
  { question: 'The suffix "-al" in IUPAC nomenclature indicates:', options: ['An alcohol', 'An aldehyde', 'An alkene', 'A carboxylic acid'], correctAnswer: 1, explanation: '-al indicates an aldehyde (e.g., ethanal = CH₃CHO).', domain: 'functional-groups', topicSlug: 'iupac-nomenclature', formSet: 'B' },
  { question: 'Ethers have the general structure:', options: ['R−OH', 'R−O−R\'', 'R−CO−R\'', 'R−NH₂'], correctAnswer: 1, explanation: 'Ethers: R−O−R\' (two organic groups linked by an oxygen).', domain: 'functional-groups', topicSlug: 'functional-group-chemistry', formSet: 'B' },
  { question: 'An amide contains which bond?', options: ['C−O−C', 'C(=O)−N', 'C≡N', 'C−S−H'], correctAnswer: 1, explanation: 'An amide has a carbonyl (C=O) bonded directly to a nitrogen: C(=O)−N.', domain: 'functional-groups', topicSlug: 'functional-group-chemistry', formSet: 'B' },
  { question: 'The IUPAC name for CH₃COCH₃ is:', options: ['Propanal', 'Propanone', 'Propanol', 'Propanoic acid'], correctAnswer: 1, explanation: 'CH₃COCH₃ is a ketone (three carbons), IUPAC: propanone (common name: acetone).', domain: 'functional-groups', topicSlug: 'iupac-nomenclature', formSet: 'both' },
  { question: 'An ester is formed from:', options: ['Two alcohols', 'A carboxylic acid and an alcohol', 'Two ketones', 'An amine and a ketone'], correctAnswer: 1, explanation: 'Ester formation (Fischer esterification): carboxylic acid + alcohol → ester + water.', domain: 'functional-groups', topicSlug: 'functional-group-chemistry', formSet: 'both' },

  // ---- Carbonyl Chemistry ----
  { question: 'In a nucleophilic addition to a carbonyl, the nucleophile attacks:', options: ['The oxygen', 'The carbon of C=O', 'The α-carbon', 'The leaving group'], correctAnswer: 1, explanation: 'The carbonyl carbon is electrophilic (δ+) due to the electronegative oxygen, so nucleophiles attack it.', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones', formSet: 'A' },
  { question: 'Aldehydes differ from ketones in that aldehydes have:', options: ['No carbonyl group', 'At least one hydrogen on the carbonyl carbon', 'Two alkyl groups on the carbonyl', 'A carboxyl group'], correctAnswer: 1, explanation: 'Aldehydes: R−CHO (at least one H on carbonyl carbon); ketones: R−CO−R\' (no H on carbonyl C).', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones', formSet: 'A' },
  { question: 'The Grignard reagent (RMgBr) acts as:', options: ['An electrophile', 'A nucleophile / source of carbanion', 'A radical', 'An acid'], correctAnswer: 1, explanation: 'Grignard reagents (RMgBr) are strong nucleophiles/bases, effectively delivering R⁻ to electrophilic carbons.', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones', formSet: 'A' },
  { question: 'Acyl chlorides are more reactive than esters toward nucleophilic acyl substitution because:', options: ['They have weaker C=O bonds', 'Cl⁻ is a better leaving group than OR⁻', 'Esters are more electrophilic', 'Acyl chlorides are more sterically hindered'], correctAnswer: 1, explanation: 'Cl⁻ is an excellent leaving group (weak base), making acyl chlorides the most reactive carboxylic acid derivatives.', domain: 'carbonyl-chemistry', topicSlug: 'carboxylic-acid-derivatives', formSet: 'B' },
  { question: 'In an aldol condensation, the key bond formed is between:', options: ['Two carboxylic acids', 'An enolate α-carbon and another carbonyl carbon', 'An amine and a ketone', 'Two alcohols'], correctAnswer: 1, explanation: 'Aldol: the enolate (from one carbonyl) attacks the carbonyl carbon of another, forming a β-hydroxy carbonyl.', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones', formSet: 'B' },
  { question: 'Hydrolysis of an ester gives:', options: ['Two alcohols', 'A carboxylic acid and an alcohol', 'An aldehyde and water', 'A ketone and an amine'], correctAnswer: 1, explanation: 'Ester hydrolysis (acid or base catalyzed) reverses esterification: ester + H₂O → acid + alcohol.', domain: 'carbonyl-chemistry', topicSlug: 'carboxylic-acid-derivatives', formSet: 'B' },
  { question: 'The order of reactivity of carboxylic acid derivatives toward nucleophilic acyl substitution is:', options: ['Ester > anhydride > acyl chloride > amide', 'Acyl chloride > anhydride > ester > amide', 'Amide > ester > anhydride > acyl chloride', 'All are equally reactive'], correctAnswer: 1, explanation: 'Reactivity: acyl chloride > anhydride > ester > amide (based on leaving group ability).', domain: 'carbonyl-chemistry', topicSlug: 'carboxylic-acid-derivatives', formSet: 'both' },
  { question: 'Reduction of a ketone with NaBH₄ gives:', options: ['A primary alcohol', 'A secondary alcohol', 'An aldehyde', 'A carboxylic acid'], correctAnswer: 1, explanation: 'NaBH₄ reduces ketones to secondary alcohols (R₂CO → R₂CHOH).', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones', formSet: 'both' },
  ...
  { question: 'A broad O−H stretch in IR spectroscopy appears around:', options: ['1700 cm⁻¹', '2200 cm⁻¹', '3200-3500 cm⁻¹', '1000 cm⁻¹'], correctAnswer: 2, explanation: 'O−H stretch: broad absorption ~3200-3500 cm⁻¹. Hydrogen bonding causes the broadness.', domain: 'spectroscopy', topicSlug: 'ir-mass-spec', formSet: 'A' },
  ...
  { question: 'In mass spectrometry, the molecular ion (M⁺) indicates:', options: ['The number of functional groups', 'The molecular weight of the compound', 'The number of protons', 'Bond strength'], correctAnswer: 1, explanation: 'The M⁺ peak in mass spec corresponds to the molecular weight of the intact molecule.', domain: 'spectroscopy', topicSlug: 'ir-mass-spec', formSet: 'B' },
  { question: 'A carbonyl C=O stretch in IR appears near:', options: ['3000 cm⁻¹', '2200 cm⁻¹', '1700 cm⁻¹', '1000 cm⁻¹'], correctAnswer: 2, explanation: 'C=O stretch: strong absorption ~1700 cm⁻¹ (varies slightly with type of carbonyl).', domain: 'spectroscopy', topicSlug: 'ir-mass-spec', formSet: 'B' },
  ...
  { question: 'The "degree of unsaturation" (index of hydrogen deficiency) for C₆H₆ is:', options: ['1', '2', '3', '4'], correctAnswer: 3, explanation: 'IHD = (2×6 + 2 − 6)/2 = (14 − 6)/2 = 4. Benzene has 3 double bonds + 1 ring = 4.', domain: 'spectroscopy', topicSlug: 'ir-mass-spec', formSet: 'both' },

  // ---- Aromatic Chemistry ----
  { question: 'Hückel\'s rule states that aromatic compounds have ___ π electrons.', options: ['4n', '4n + 2', '2n', '2n + 1'], correctAnswer: 1, explanation: 'Hückel\'s rule: aromatic compounds have 4n+2 π electrons (where n = 0, 1, 2, ...) in a cyclic, planar, conjugated system.', domain: 'aromatic-chemistry', topicSlug: 'aromaticity-huckel', formSet: 'A' },
  ...
  { question: 'Cyclopentadienyl anion (C₅H₅⁻) is aromatic because:', options: ['It has 4 π electrons', 'It has 6 π electrons in a planar cyclic system', 'It has 8 π electrons', 'It is not aromatic'], correctAnswer: 1, explanation: 'C₅H₅⁻ has 6 π electrons (4n+2, n=1), is cyclic, planar, and fully conjugated — aromatic.', domain: 'aromatic-chemistry', topicSlug: 'aromaticity-huckel', formSet: 'B' },
  { question: 'Benzene undergoes substitution rather than addition because:', options: ['It lacks double bonds', 'Substitution preserves aromaticity', 'Addition is sterically impossible', 'Benzene is too unreactive for addition'], correctAnswer: 1, explanation: 'Aromatic stabilization energy makes substitution (preserving the aromatic ring) more favorable than addition.', domain: 'aromatic-chemistry', topicSlug: 'aromaticity-huckel', formSet: 'both' },
...
const SLUG_LABELS: Record<string, string> = {
  ...
  'hybridization-geometry': 'Hybridization & Geometry',
  'chirality-enantiomers': 'Chirality & Enantiomers',
  'diastereomers-meso': 'Diastereomers & Meso Compounds',
  'sn1-sn2-reactions': 'SN1 & SN2 Reactions',
  'e1-e2-elimination': 'E1 & E2 Elimination',
  'iupac-nomenclature': 'IUPAC Nomenclature',
  'functional-group-chemistry': 'Functional Group Chemistry',
  ...
  'ir-mass-spec': 'IR & Mass Spectrometry',
  'electrophilic-aromatic-substitution': 'Electrophilic Aromatic Substitution',
  'aromaticity-huckel': 'Aromaticity & Hückel\'s Rule',
}
