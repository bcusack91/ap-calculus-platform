...
const questionPool: PoolQuestion[] = [
  // ---- Structure & Bonding ----
  { question: 'A carbon with $sp^{3}$ hybridization has what geometry?', options: ['Linear', 'Trigonal planar', 'Tetrahedral', 'Octahedral'], correctAnswer: 2, explanation: '$sp^{3}$ hybridization gives a tetrahedral geometry with ~109.5° bond angles.', domain: 'structure-bonding', topicSlug: 'atomic-structure-bonding-ochem', formSet: 'A' },
  ...
  { question: 'An $sp^{2}$ hybridized carbon is involved in how many π bonds?', options: ['0', '1', '2', '3'], correctAnswer: 1, explanation: '$sp^{2}$ leaves one unhybridized p orbital available for one π bond (as in alkenes or carbonyls).', domain: 'structure-bonding', topicSlug: 'atomic-structure-bonding-ochem', formSet: 'B' },
  ...
  { question: 'In SN2, the rate law is:', options: ['Rate = k[substrate]', 'Rate = k[nucleophile]', 'Rate = k[substrate][nucleophile]', 'Rate = k[substrate]$ {}^{2}$'], correctAnswer: 2, explanation: 'SN2 is bimolecular: rate depends on both substrate and nucleophile concentrations.', domain: 'reactions-mechanisms', topicSlug: 'nucleophilic-substitution', formSet: 'both' },
  ...
  { question: 'The IUPAC name for $CH_{3}CH_{2}OH$ is:', options: ['Methanol', 'Ethanol', 'Propanol', 'Ethanal'], correctAnswer: 1, explanation: 'Two carbons (eth-) with an -OH group: ethanol.', domain: 'functional-groups', topicSlug: 'molecular-representations', formSet: 'A' },
  { question: 'A ketone functional group is:', options: ['−CHO', 'C=O between two carbons', '−COOH', '$-NH_{2}$'], correctAnswer: 1, explanation: 'A ketone has C=O flanked by two carbon groups (R−CO−R\').', domain: 'functional-groups', topicSlug: 'alkenes-reactions', formSet: 'A' },
  { question: 'Which functional group has the highest priority in IUPAC naming?', options: ['Alcohol (−OH)', 'Amine $(-NH_{2})$', 'Carboxylic acid (−COOH)', 'Aldehyde (−CHO)'], correctAnswer: 2, explanation: 'Carboxylic acid has the highest IUPAC naming priority among common functional groups.', domain: 'functional-groups', topicSlug: 'molecular-representations', formSet: 'A' },
  { question: 'The suffix "-al" in IUPAC nomenclature indicates:', options: ['An alcohol', 'An aldehyde', 'An alkene', 'A carboxylic acid'], correctAnswer: 1, explanation: '-al indicates an aldehyde (e.g., ethanal = $CH_{3}CHO$).', domain: 'functional-groups', topicSlug: 'molecular-representations', formSet: 'B' },
  { question: 'Ethers have the general structure:', options: ['R−OH', 'R−O−R\'', 'R−CO−R\'', '$R-NH_{2}$'], correctAnswer: 1, explanation: 'Ethers: R−O−R\' (two organic groups linked by an oxygen).', domain: 'functional-groups', topicSlug: 'alkenes-reactions', formSet: 'B' },
  ...
  { question: 'The IUPAC name for $CH_{3}COCH_{3}$ is:', options: ['Propanal', 'Propanone', 'Propanol', 'Propanoic acid'], correctAnswer: 1, explanation: '$CH_{3}COCH_{3}$ is a ketone (three carbons), IUPAC: propanone (common name: acetone).', domain: 'functional-groups', topicSlug: 'molecular-representations', formSet: 'both' },
  ...
  { question: 'Hydrolysis of an ester gives:', options: ['Two alcohols', 'A carboxylic acid and an alcohol', 'An aldehyde and water', 'A ketone and an amine'], correctAnswer: 1, explanation: 'Ester hydrolysis (acid or base catalyzed) reverses esterification: ester + $H_{2}O$ → acid + alcohol.', domain: 'carbonyl-chemistry', topicSlug: 'carboxylic-acids-derivatives', formSet: 'B' },
  ...
  { question: 'Reduction of a ketone with $NaBH_{4}$ gives:', options: ['A primary alcohol', 'A secondary alcohol', 'An aldehyde', 'A carboxylic acid'], correctAnswer: 1, explanation: '$NaBH_{4}$ reduces ketones to secondary alcohols ($R_{2}CO$ → $R_{2}CHOH$).', domain: 'carbonyl-chemistry', topicSlug: 'aldehydes-ketones-reactions', formSet: 'both' },

  // ---- Spectroscopy ----
  { question: 'In $ {}^{1}H$ NMR, the number of signals indicates:', options: ['The molecular weight', 'The number of distinct hydrogen environments', 'The number of carbons', 'The boiling point'], correctAnswer: 1, explanation: 'Each signal in $ {}^{1}H$ NMR represents a set of chemically equivalent (non-equivalent) hydrogens.', domain: 'spectroscopy', topicSlug: 'nmr-spectroscopy', formSet: 'A' },
  { question: 'A broad O−H stretch in IR spectroscopy appears around:', options: ['1700 $cm^{-1}$', '2200 $cm^{-1}$', '3200-3500 $cm^{-1}$', '1000 $cm^{-1}$'], correctAnswer: 2, explanation: 'O−H stretch: broad absorption ~3200-3500 $cm^{-1}$. Hydrogen bonding causes the broadness.', domain: 'spectroscopy', topicSlug: 'infrared-mass-spectrometry', formSet: 'A' },
  ...
  { question: 'A carbonyl C=O stretch in IR appears near:', options: ['3000 $cm^{-1}$', '2200 $cm^{-1}$', '1700 $cm^{-1}$', '1000 $cm^{-1}$'], correctAnswer: 2, explanation: 'C=O stretch: strong absorption ~1700 $cm^{-1}$ (varies slightly with type of carbonyl).', domain: 'spectroscopy', topicSlug: 'infrared-mass-spectrometry', formSet: 'B' },
  { question: 'In $ {}^{1}H$ NMR, protons on an aromatic ring typically appear at:', options: ['0-1 ppm', '1-2 ppm', '3-4 ppm', '6.5-8.5 ppm'], correctAnswer: 3, explanation: 'Aromatic protons are deshielded by the ring current and appear downfield at ~6.5-8.5 ppm.', domain: 'spectroscopy', topicSlug: 'nmr-spectroscopy', formSet: 'B' },
  { question: 'Chemical shift in NMR is measured in:', options: ['Hertz', 'ppm (parts per million)', '$cm^{-1}$', 'Wavelength'], correctAnswer: 1, explanation: 'Chemical shift (δ) is expressed in ppm, relative to a reference standard (TMS).', domain: 'spectroscopy', topicSlug: 'nmr-spectroscopy', formSet: 'both' },
  { question: 'The "degree of unsaturation" (index of hydrogen deficiency) for $C_{6}H_{6}$ is:', options: ['1', '2', '3', '4'], correctAnswer: 3, explanation: 'IHD = (2×6 + 2 − 6)/2 = (14 − 6)/2 = 4. Benzene has 3 double bonds + 1 ring = 4.', domain: 'spectroscopy', topicSlug: 'infrared-mass-spectrometry', formSet: 'both' },
  ...
  { question: 'Nitration of benzene uses which electrophile?', options: ['$NO_{2}^{+}$ (nitronium ion)', '$NO_{3}^{-}$', '$NH_{3}$', '$N_{2}$'], correctAnswer: 0, explanation: 'Nitration: $HNO_{3}$ + $H_{2}SO_{4}$ → $NO_{2}^{+}$ (nitronium ion), the active electrophile.', domain: 'aromatic-chemistry', topicSlug: 'electrophilic-aromatic-substitution', formSet: 'A' },
  { question: 'An electron-donating group (e.g., −OH) on benzene:', options: ['Deactivates the ring and is meta-directing', 'Activates the ring and is ortho/para-directing', 'Has no effect on reactivity', 'Prevents all substitution'], correctAnswer: 1, explanation: 'EDGs (like −OH, $-NH_{2}$) activate the ring by increasing electron density and direct to ortho/para positions.', domain: 'aromatic-chemistry', topicSlug: 'electrophilic-aromatic-substitution', formSet: 'B' },
  { question: 'A nitro group $(-NO_{2})$ on benzene is:', options: ['Activating, ortho/para-directing', 'Deactivating, meta-directing', 'Activating, meta-directing', 'Has no directing effect'], correctAnswer: 1, explanation: '$-NO_{2}$ is a strong electron-withdrawing group: deactivates the ring and directs incoming electrophiles to meta.', domain: 'aromatic-chemistry', topicSlug: 'electrophilic-aromatic-substitution', formSet: 'B' },
  { question: 'Cyclopentadienyl anion $(C_{5}H_{5}^{-})$ is aromatic because:', options: ['It has 4 π electrons', 'It has 6 π electrons in a planar cyclic system', 'It has 8 π electrons', 'It is not aromatic'], correctAnswer: 1, explanation: '$C_{5}H_{5}^{-}$ has 6 π electrons (4n+2, n=1), is cyclic, planar, and fully conjugated — aromatic.', domain: 'aromatic-chemistry', topicSlug: 'aromatic-compounds-benzene', formSet: 'B' },
  ...
  { question: 'Friedel-Crafts alkylation requires:', options: ['Only benzene and an alkyl halide', 'A Lewis acid catalyst (e.g., $AlCl_{3}$)', 'An oxidizing agent', 'UV light'], correctAnswer: 1, explanation: 'Friedel-Crafts alkylation needs a Lewis acid $(AlCl_{3})$ to generate the electrophilic carbocation from the alkyl halide.', domain: 'aromatic-chemistry', topicSlug: 'electrophilic-aromatic-substitution', formSet: 'both' },
]
