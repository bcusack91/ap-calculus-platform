...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'Simplify: $\\log (x^{3})$ = ?', options: ['3 log x', 'log(3x)', '$(\\log x)^{3}$', '3 + log x'], correctAnswer: 0, explanation: 'Power rule: $\\log (x^{3})$ = 3 log x.', domain: 'exponential-logarithmic', topicSlug: 'logarithmic-functions-precalc' },
  ...
  { question: 'If g(x) = $x^{2}$ + 3 and h(x) = $\\sqrt{x - 3}$, then (h ∘ g)(x) = ?', options: ['|x|', '$\\sqrt{x^{2} + 3}$', 'x', '$x^{2}$ + 3 − $\\sqrt{3}$'], correctAnswer: 0, explanation: 'h(g(x)) = $\\sqrt{g(x) - 3}$ = $\\sqrt{x^{2} + 3 - 3}$ = $\\sqrt{x^{2}}$ = |x|.', domain: 'functions-modeling', topicSlug: 'function-composition-inverses-precalc' },
  ...
  { question: 'The telescoping series Σ(1/n − 1/(n+1)) from n = 1 to N equals:', options: ['1 − 1/(N+1)', '1', '1/(N+1)', '1/N'], correctAnswer: 0, explanation: 'Most terms cancel: (1 − 1/2) + (1/2 − 1/3) + ... = 1 − 1/(N+1).', domain: 'functions-modeling', topicSlug: 'sequences-series-precalc' },
