...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sds-ent-3a', question: 'A survey table shows: 60 students prefer math, 40 prefer English. What percent prefer math?', options: ['40%', '50%', '60%', '75%'], correctIndex: 2, explanation: 'Total = 100. Percent preferring math = 60/100 = 60%.', partNumber: 3, partTitle: 'Reading Tables' },
  { id: 'sds-ent-3b', question: 'A two-way table shows 200 students: 90 male (50 prefer science), 110 female (60 prefer science). What fraction of all students prefer science?', options: ['1/2', '11/20', '55%', '1/4'], correctIndex: 1, explanation: '50 + 60 = 110 students prefer science out of 200 total. 110/200 = 55% = 11/20.', partNumber: 3, partTitle: 'Reading Tables' },
