...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sds-ent-6b', question: 'The mean of 6 numbers is 10. Five of the numbers are 8, 9, 11, 12, and 7. What is the sixth number?', options: ['10', '11', '13', '15'], correctIndex: 2, explanation: 'Total sum = $6 \\times 10$ = 60. Known sum = 8+9+11+12+7 = 47. Sixth number = 60 − 47 = 13.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
