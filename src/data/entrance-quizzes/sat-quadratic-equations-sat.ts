...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sqe-ent-3a', question: 'Use the quadratic formula to solve $2x^{2}$ − 4x − 6 = 0. What are the solutions?', options: ['x = 1 and x = −3', 'x = 3 and x = −1', 'x = 3 and x = 1', 'x = −3 and x = −1'], correctIndex: 1, explanation: 'Divide by 2: $x^{2}$ − 2x − 3 = 0. x = $(2 \\pm \\sqrt{4+12})/2$ = $(2 \\pm 4)/2$. x = 3 or x = −1.', partNumber: 3, partTitle: 'Quadratic Formula' },
  { id: 'sqe-ent-3b', question: 'What is the quadratic formula for $ax^{2}$ + bx + c = 0?', options: ['$x = -b \\pm \\sqrt{b^{2} - 4ac}$', '$x = (-b \\pm \\sqrt{b^{2} - 4ac}) / (2a)$', '$x = (b \\pm \\sqrt{b^{2} + 4ac}) / 2a$', '$x = b^{2} - 4ac$'], correctIndex: 1, explanation: 'The quadratic formula is $x = (-b \\pm \\sqrt{b^{2} - 4ac}) / (2a)$, which gives the solutions for any quadratic.', partNumber: 3, partTitle: 'Quadratic Formula' },
  ...
  { id: 'sqe-ent-4b', question: 'The parabola y = $x^{2}$ − 4 has how many x-intercepts?', options: ['Zero', 'One', 'Two', 'Three'], correctIndex: 2, explanation: 'Set y = 0: $x^{2}$ = 4 → x = $\\pm 2$. There are two x-intercepts at x = 2 and x = −2.', partNumber: 4, partTitle: 'Vertex & Intercepts' },
