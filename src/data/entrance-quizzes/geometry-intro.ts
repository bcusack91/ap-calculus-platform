...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'geo-ent-3a', question: 'In a right triangle with legs 3 and 4, what is the hypotenuse?', options: ['5', '6', '7', '√7'], correctIndex: 0, explanation: 'Pythagorean Theorem: a² + b² = c². 3² + 4² = 9 + 16 = 25. c = √25 = 5.', partNumber: 3, partTitle: 'Right Triangles & Trigonometry' },
  { id: 'geo-ent-3b', question: 'In a 45-45-90 triangle, if the legs are each 1, what is the hypotenuse?', options: ['1', '√2', '2', '√3'], correctIndex: 1, explanation: 'In a 45-45-90 triangle, the hypotenuse = leg × √2. So hypotenuse = 1 × √2 = √2.', partNumber: 3, partTitle: 'Right Triangles & Trigonometry' },
  ...
  { id: 'geo-ent-5a', question: 'What is the area of a trapezoid with bases 6 and 10 and height 4?', options: ['24', '32', '40', '48'], correctIndex: 1, explanation: 'Area of trapezoid = ½(b₁ + b₂) × h = ½(6 + 10) × 4 = ½ × 16 × 4 = 32.', partNumber: 5, partTitle: 'Area & Perimeter' },
  { id: 'geo-ent-5b', question: 'What is the area of a regular hexagon with side length 4? (Area = (3√3/2)s²)', options: ['24√3', '16√3', '12√3', '8√3'], correctIndex: 0, explanation: 'Area = (3√3/2)(4²) = (3√3/2)(16) = 24√3.', partNumber: 5, partTitle: 'Area & Perimeter' },

  // Part 6: Surface Area & Volume
  { id: 'geo-ent-6a', question: 'What is the volume of a cylinder with radius 3 and height 5?', options: ['15π', '30π', '45π', '90π'], correctIndex: 2, explanation: 'Volume of cylinder = πr²h = π(3²)(5) = π(9)(5) = 45π.', partNumber: 6, partTitle: 'Surface Area & Volume' },
  { id: 'geo-ent-6b', question: 'A sphere has radius 6. What is its volume? (V = (4/3)πr³)', options: ['72π', '144π', '216π', '288π'], correctIndex: 3, explanation: 'V = (4/3)π(6³) = (4/3)π(216) = 288π.', partNumber: 6, partTitle: 'Surface Area & Volume' },

  // Part 7: Coordinate Geometry
  { id: 'geo-ent-7a', question: 'What is the midpoint of the segment with endpoints (2, 6) and (8, −2)?', options: ['(3, 2)', '(5, 2)', '(6, 4)', '(10, 4)'], correctIndex: 1, explanation: 'Midpoint = ((x₁+x₂)/2, (y₁+y₂)/2) = ((2+8)/2, (6+(−2))/2) = (5, 2).', partNumber: 7, partTitle: 'Coordinate Geometry' },
