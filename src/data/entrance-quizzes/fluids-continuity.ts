...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'fco-ent-1b', question: 'The SI units of volume flow rate $Q$ are:', options: ['m/s', '$m^{2}/s$', '$m^{3}/s$', 'kg/s'], correctIndex: 2, explanation: '$Q = Av$ → $m^{2}$ · m/s = $m^{3}/s$.', partNumber: 1, partTitle: 'Volume Flow Rate' },
  ...
  { id: 'fco-ent-3a', question: 'Water flows at 2.0 m/s through a pipe of cross-section 4.0 $cm^{2}$. It enters a section of cross-section 1.0 $cm^{2}$. The new speed is:', options: ['0.5 m/s', '2.0 m/s', '4.0 m/s', '8.0 m/s'], correctIndex: 3, explanation: '$v_2 = v_1 (A_1/A_2) = 2.0(4.0/1.0) = 8.0$ m/s.', partNumber: 3, partTitle: 'Pipe Narrowing & Speed' },
  ...
  { id: 'fco-ent-5b', question: 'Water ($\\rho = 1000$ $kg/m^{3}$) flows through a pipe of cross-section $5.0\\times10^{-3}$ $m^{2}$ at 2.0 m/s. The mass flow rate is:', options: ['10 kg/s', '5.0 kg/s', '2.0 kg/s', '0.5 kg/s'], correctIndex: 0, explanation: '$\\dot m = \\rho A v = 1000(5.0\\times10^{-3})(2.0) = 10$ kg/s.', partNumber: 5, partTitle: 'Mass Flow Rate' },
  ...
  { id: 'fco-ent-6b', question: 'A 250 mL/s shower head must be supplied by a pipe with what minimum cross-sectional area if the water in the pipe must not exceed 1.0 m/s?', options: ['$2.5\\times10^{-2}$ $m^{2}$', '$2.5\\times10^{-4}$ $m^{2}$', '$1.0$ $m^{2}$', '$2.5\\times10^{-3}$ $m^{2}$'], correctIndex: 1, explanation: '$Q = 250\\text{ mL/s} = 2.5\\times10^{-4}$ $m^{3}/s$. $A = Q/v = 2.5\\times10^{-4}/1.0 = 2.5\\times10^{-4}$ $m^{2}$.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
