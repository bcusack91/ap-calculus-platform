...
const questions: EntranceQuizQuestion[] = [
  { id: 'acg-ent-1a', question: 'What is the formula for the slope of a line through two points (x₁, y₁) and (x₂, y₂)?', options: ['(x₂ − x₁) / (y₂ − y₁)', '(y₂ − y₁) / (x₂ − x₁)', '(y₂ + y₁) / (x₂ + x₁)', '(x₂ + x₁) / (y₂ + y₁)'], correctIndex: 1, explanation: 'Slope = rise/run = (y₂ − y₁) / (x₂ − x₁).', partNumber: 1, partTitle: 'Graphing Lines' },
  ...
  { id: 'acg-ent-2a', question: 'What is the distance formula between two points (x₁, y₁) and (x₂, y₂)?', options: ['|x₂ − x₁| + |y₂ − y₁|', '√[(x₂ − x₁)² + (y₂ − y₁)²]', '(x₂ − x₁)² + (y₂ − y₁)²', '√[(x₂ + x₁)² + (y₂ + y₁)²]'], correctIndex: 1, explanation: 'The distance formula d = √[(x₂ − x₁)² + (y₂ − y₁)²] comes from the Pythagorean theorem.', partNumber: 2, partTitle: 'Distance & Midpoint' },
  ...
  { id: 'acg-ent-4a', question: 'Which equation represents a circle with center (3, −2) and radius 5?', options: ['(x − 3)² + (y + 2)² = 5', '(x + 3)² + (y − 2)² = 25', '(x − 3)² + (y + 2)² = 25', '(x − 3)² + (y − 2)² = 25'], correctIndex: 2, explanation: 'Circle equation: (x − h)² + (y − k)² = r². With center (3, −2) and radius 5: (x − 3)² + (y + 2)² = 25.', partNumber: 4, partTitle: 'Conic Sections Basics' },
  { id: 'acg-ent-4b', question: 'The parabola y = −2x² + 3x + 1 opens in which direction?', options: ['Up', 'Down', 'Left', 'Right'], correctIndex: 1, explanation: 'For y = ax² + bx + c, the parabola opens up if a > 0 and down if a < 0. Here a = −2 < 0, so it opens down.', partNumber: 4, partTitle: 'Conic Sections Basics' },
  ...
  { id: 'acg-ent-6a', question: 'What is the distance between (1, 2) and (4, 6)?', options: ['3', '4', '5', '7'], correctIndex: 2, explanation: 'd = √[(4−1)² + (6−2)²] = √[9 + 16] = √25 = 5.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  ...
  { id: 'acg-ent-7a', question: 'What is the point-slope form of a line?', options: ['y = mx + b', 'Ax + By = C', 'y − y₁ = m(x − x₁)', 'y₂ − y₁ = x₂ − x₁'], correctIndex: 2, explanation: 'Point-slope form is y − y₁ = m(x − x₁), where m is the slope and (x₁, y₁) is a point on the line.', partNumber: 7, partTitle: 'Review & Applications' },
