...
const questions: EntranceQuizQuestion[] = [
  { id: 'mpm-ent-1a', question: 'A ball is thrown horizontally from a cliff. Which of the following best describes its motion?', options: ['Constant velocity in both horizontal and vertical directions', 'Constant horizontal velocity and increasing vertical velocity (downward)', 'Decreasing horizontal velocity and constant vertical velocity', 'Constant speed throughout the fall'], correctIndex: 1, explanation: 'Projectile motion: horizontal velocity is constant (no air resistance), vertical velocity increases due to gravitational acceleration (9.8 m/s²).', partNumber: 1, partTitle: 'Kinematics' },
  { id: 'mpm-ent-1b', question: 'An object starts from rest and accelerates uniformly at 4 m/s². How far does it travel in 3 seconds?', options: ['6 m', '12 m', '18 m', '36 m'], correctIndex: 2, explanation: '$d = \\frac{1}{2}at^2 = \\frac{1}{2}(4)(3^2) = \\frac{1}{2}(4)(9) = 18$ m.', partNumber: 1, partTitle: 'Kinematics' },
  ...
  { id: 'mpm-ent-3b', question: 'A 2 kg object is lifted 5 m above the ground. Its gravitational potential energy increase (g = 10 m/s²) is:', options: ['10 J', '25 J', '100 J', '200 J'], correctIndex: 2, explanation: '$\\Delta PE = mgh = (2)(10)(5) = 100$ J. This energy is stored and can be converted to kinetic energy.', partNumber: 3, partTitle: 'Work & Energy' },
  ...
  { id: 'mpm-ent-6a', question: 'A 60 kg person stands on a scale in an elevator accelerating upward at 2 m/s² (g = 10 m/s²). The scale reads:', options: ['480 N', '600 N', '720 N', '780 N'], correctIndex: 2, explanation: '$N = m(g + a) = 60(10 + 2) = 60(12) = 720$ N. Upward acceleration increases apparent weight.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'mpm-ent-6b', question: 'A 4 kg block slides down a frictionless incline of 30°. The acceleration along the incline is (g = 10 m/s²):', options: ['5 m/s²', '8.66 m/s²', '10 m/s²', '40 m/s²'], correctIndex: 0, explanation: 'On a frictionless incline: $a = g\\sin\\theta = 10\\sin(30°) = 10(0.5) = 5$ m/s².', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
