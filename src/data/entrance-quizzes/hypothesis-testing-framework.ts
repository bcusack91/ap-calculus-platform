...
const questions: EntranceQuizQuestion[] = [
  // Part 1: Null & Alternative Hypotheses
  {
    ...
    correctIndex: 1,
    explanation: 'H₀ states "no effect" or "no difference" — it represents the status quo. Hₐ (the alternative hypothesis) states the claim we are testing.',
    partNumber: 1,
  ...
  // Part 2: Test Statistics
  {
    ...
    correctIndex: 1,
    explanation: 'Test statistic = (statistic − parameter₀) / standard error. It measures how far the observed data is from what H₀ predicts, expressed in standard error units.',
    partNumber: 2,
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: 'For a one-proportion z-test: z = (p̂ − p₀) / √[p₀(1−p₀)/n]. The standard error uses p₀ (not p̂) because we compute it under the assumption that H₀ is true.',
    partNumber: 2,
    partTitle: 'Test Statistics'
  },
  ...
  // Part 3: P-Values
  {
    ...
    options: [
      ...
      'The probability of getting a result as extreme or more extreme than observed, assuming H₀ is true',
      'The probability that Hₐ is true',
      'The significance level chosen by the researcher'
    ],
    correctIndex: 1,
    explanation: 'The p-value is the probability of obtaining a test statistic as extreme or more extreme than the one observed, assuming H₀ is true. It is NOT the probability that H₀ is true.',
    partNumber: 3,
    partTitle: 'P-Values'
  },
  {
    ...
    options: [
      'Fail to reject H₀ because 0.02 is small',
      'Reject H₀ because p < α',
      'Accept H₀ because p > 0',
      'Reject Hₐ because p < α'
    ],
    correctIndex: 1,
    explanation: 'Since p = 0.02 < α = 0.05, we reject H₀. A small p-value provides evidence against H₀. The decision rule is: if p < α, reject H₀.',
    partNumber: 3,
    partTitle: 'P-Values'
  },
  ...
  // Part 4: Type I & Type II Errors
  {
    ...
    options: [
      'We fail to reject H₀ when Hₐ is true',
      'We reject H₀ when H₀ is actually true (false positive)',
      'We correctly reject a false H₀',
      'The p-value equals α exactly'
    ],
    correctIndex: 1,
    explanation: 'A Type I error is rejecting H₀ when it is actually true — a false positive. The probability of a Type I error equals α, the significance level.',
    partNumber: 4,
  ...
  },
  {
    ...
    options: [
      ...
      'We fail to reject H₀ when Hₐ is actually true (false negative)',
      'We correctly fail to reject a true H₀',
      'The p-value is exactly 0.05'
    ],
    correctIndex: 1,
    explanation: 'A Type II error is failing to reject H₀ when Hₐ is actually true — a false negative. The probability of a Type II error is denoted β.',
    partNumber: 4,
    partTitle: 'Type I & Type II Errors'
  },
  ...
  // Part 5: One-Sample t-Test
  {
    ...
    correctIndex: 1,
    explanation: 'The one-sample t-test statistic is t = (x̄ − μ₀) / (s/√n) with df = n − 1, where μ₀ is the hypothesized population mean.',
    partNumber: 5,
  ...
  // Part 6: Problem-Solving Workshop
  {
    ...
    options: [
      'Reject H₀ at α = 0.05 and at α = 0.01',
    ...
    correctIndex: 1,
    explanation: 'With p = 0.03: at α = 0.05, p < α so reject H₀; at α = 0.01, p > α so fail to reject H₀. The decision depends on the chosen significance level.',
    partNumber: 6,
  ...
  },
  {
    ...
    options: [
      ...
      'The p-value is less than α, so the result is unlikely under H₀',
      'The sample size was very large',
      'The effect size is large enough to matter'
    ],
    correctIndex: 1,
    explanation: '"Statistically significant" means the p-value is less than α — the result is unlikely to occur by chance under H₀. It does NOT necessarily mean the result is practically important.',
    partNumber: 6,
    partTitle: 'Problem-Solving Workshop'
  },
  ...
  },
  {
    ...
    options: [
      '"We accept H₀. The claim is proven false."',
      '"We reject/fail to reject H₀. There is/is not convincing evidence that [context]."',
      '"H₀ is true/false based on the data."',
      '"The p-value proves the alternative hypothesis."'
    ],
    correctIndex: 1,
    explanation: 'The proper conclusion format is: "We [reject/fail to reject] H₀. There [is/is not] convincing evidence that [conclusion in context]." Never say "accept H₀" or "prove."',
    partNumber: 7,
    partTitle: 'Review & Applications'
  }
]
