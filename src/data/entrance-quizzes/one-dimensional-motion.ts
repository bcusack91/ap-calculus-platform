...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 3: Acceleration
  {
    ...
    correctIndex: 1,
    explanation: '$a = \\Delta v / \\Delta t = (30 - 10)/5 = 20/5 = 4$ m/s².',
    partNumber: 3,
  ...
  {
    id: 'odm-ent-4a',
    question: 'A ball is dropped from rest and falls for $3$ s. How far does it fall? (Use $g = 10$ m/s².)',
    options: ['$15$ m', '$30$ m', '$45$ m', '$90$ m'],
    correctIndex: 2,
    explanation: 'Using $d = v_0 t + \\frac{1}{2}at^2$, with $v_0 = 0$ and $a = 10$ m/s²: $d = \\frac{1}{2}(10)(3^2) = 45$ m.',
    partNumber: 4,
  ...
  {
    id: 'odm-ent-5a',
    question: 'A ball is thrown straight up at $20$ m/s. How long does it take to reach its highest point? (Use $g = 10$ m/s².)',
  ...
  {
    id: 'odm-ent-6a',
    question: 'A car traveling at $20$ m/s brakes with an acceleration of $-4$ m/s². How far does it travel before stopping?',
  ...
  {
    id: 'odm-ent-6b',
    question: 'A train accelerates from rest at $2$ m/s² for $10$ s, then travels at constant speed for $20$ s. What is the total distance?',
  ...
  {
    id: 'odm-ent-7a',
    question: 'An object starts at $x = 0$ with velocity $+5$ m/s and constant acceleration $-2$ m/s². When does it return to $x = 0$?',
  ...
  {
    id: 'odm-ent-7b',
    question: 'A ball is thrown downward at $5$ m/s from a $45$ m tall building. How long does it take to hit the ground? (Use $g = 10$ m/s².)',
