...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'mbf-ent-3b', question: 'The Krebs cycle (citric acid cycle) takes place in the:', options: ['Cytoplasm', 'Mitochondrial matrix', 'Inner mitochondrial membrane', 'Nucleus'], correctIndex: 1, explanation: 'The Krebs cycle occurs in the mitochondrial matrix. Acetyl-CoA enters and is oxidized to $CO_{2}$, producing NADH, $FADH_{2}$, and GTP per turn.', partNumber: 3, partTitle: 'Carbohydrate Metabolism' },
  { id: 'mbf-ent-4a', question: 'Beta-oxidation of fatty acids primarily produces:', options: ['Glucose and glycerol', 'Acetyl-CoA, NADH, and $FADH_{2}$', 'Amino acids and ATP', 'Glycogen and urea'], correctIndex: 1, explanation: 'Each round of β-oxidation removes two carbons from a fatty acid as acetyl-CoA, plus generating one NADH and one $FADH_{2}$. These feed into the Krebs cycle and ETC.', partNumber: 4, partTitle: 'Lipid Metabolism' },
  ...
  { id: 'mbf-ent-5b', question: 'The complete oxidation of one glucose molecule via aerobic respiration yields approximately how many ATP?', options: ['2 ATP', '8 ATP', '30–32 ATP', '100 ATP'], correctIndex: 2, explanation: 'Aerobic respiration: glycolysis (2 ATP net) + Krebs cycle (2 GTP) + ETC (~26–28 ATP from $NADH/FADH_{2}$) = ~30–32 ATP total. The ETC makes the majority.', partNumber: 5, partTitle: 'Bioenergetics' },
