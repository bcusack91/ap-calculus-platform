...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'mgd-ent-5b', question: 'For an organism with a haploid number n, how many unique chromosome combinations are possible from independent assortment alone?', options: ['n', '2n', 'n²', '2^n'], correctIndex: 3, explanation: 'Independent assortment produces 2^n possible combinations of chromosomes in the gametes, where n is the haploid number.', partNumber: 5, partTitle: 'Independent Assortment' },
  // Part 6
