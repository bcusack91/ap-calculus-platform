/**
 * Entrance Quiz — Civil Rights (AP US Government)
...
const questions: EntranceQuizQuestion[] = [
  { id: 'govc-ent-1a', question: 'Which of the following best describes the main focus of Civil Rights?', options: ['An unrelated topic', 'The core principles and patterns within Civil Rights', 'A mathematical formula', 'A literary technique'], correctIndex: 1, explanation: 'Civil Rights focuses on understanding key principles and patterns within AP US Government.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'govc-ent-1b', question: 'Why is Civil Rights important in AP US Government?', options: ['It is not important', 'It connects to multiple units and is frequently tested on the AP exam', 'It is only relevant to one question', 'It has been removed from the curriculum'], correctIndex: 1, explanation: 'Civil Rights is a key topic in AP US Government that connects to multiple course themes.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'govc-ent-2a', question: 'Which best describes a key process in Civil Rights?', options: ['A random event', 'A systematic mechanism that produces predictable patterns', 'An unexplainable phenomenon', 'A one-time occurrence'], correctIndex: 1, explanation: 'Key processes are systematic mechanisms that produce identifiable, often predictable patterns.', partNumber: 2, partTitle: 'Key Processes' },
  { id: 'govc-ent-2b', question: 'Understanding cause and effect in Civil Rights helps students:', options: ['Memorize dates', 'Explain why patterns exist rather than just describing them', 'Avoid analysis', 'Skip exam questions'], correctIndex: 1, explanation: 'Cause-and-effect reasoning helps explain WHY patterns exist — a higher-order skill tested on the AP exam.', partNumber: 2, partTitle: 'Key Processes' },
