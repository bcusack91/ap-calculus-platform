...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 2: Binomial Probability Formula
  {
    ...
    correctIndex: 2,
    explanation: 'P(X = k) = C(n,k) · $p^{k}$ · $(1-p)^{n-k}$, where C(n,k) counts the ways to choose which k trials are successes.',
    partNumber: 2,
  ...
  },
  {
    ...
    correctIndex: 0,
    explanation: 'μ = np = 100(0.3) = 30. σ = √[np(1−p)] = √[100(0.3)(0.7)] = $\\sqrt{21}$ ≈ 4.58.',
    partNumber: 3,
    partTitle: 'Binomial Mean & Variance',
  },
  ...
  // Part 6: Problem-Solving Workshop
  {
    ...
    correctIndex: 2,
    explanation: 'P(X = 8) = C(10,8)$(0.8)^{8}(0.2)^{2}$ = 45 × 0.16777 × 0.04 ≈ 0.302.',
    partNumber: 6,
