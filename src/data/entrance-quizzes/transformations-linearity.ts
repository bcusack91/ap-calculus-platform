...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'tl-ent-2a', question: 'If the relationship between y and x is exponential, which transformation should produce a linear plot?', options: ['Plot $y^{2}$ vs x', 'Plot ln(y) vs x', 'Plot y vs $x^{2}$', 'Plot 1/y vs 1/x'], correctIndex: 1, explanation: 'If y vs x is exponential, plotting ln(y) vs x should produce a linear relationship.', partNumber: 2, partTitle: 'Logarithmic Transformations' },
  { id: 'tl-ent-2b', question: 'The equation ln(y) = a + bx represents which type of model when back-transformed?', options: ['Linear model', 'Quadratic model', 'Exponential growth model: y = $e^{a}$ · $e^{bx}$', 'Power model'], correctIndex: 2, explanation: 'ln(y) = a + bx → y = $e^{a}$ · $e^{bx}$, which is an exponential growth model.', partNumber: 2, partTitle: 'Logarithmic Transformations' },
  { id: 'tl-ent-3a', question: 'To linearize a power model y = a · $x^{b}$, you should plot:', options: ['y vs ln(x)', 'ln(y) vs x', 'ln(y) vs ln(x)', '$y^{2}$ vs $x^{2}$'], correctIndex: 2, explanation: 'Power model: y = a · $x^{b}$ → linearize by plotting ln(y) vs ln(x).', partNumber: 3, partTitle: 'Power Transformations' },
  ...
  { id: 'tl-ent-4b', question: 'Which of these is NOT a common transformation used to linearize data?', options: ['log(y)', '$\\sqrt{y}$', '1/y', 'y + x'], correctIndex: 3, explanation: 'Common transformations include log(y), $\\sqrt{y}$, 1/y, and log(x). Simply adding y + x is not a standard linearizing transformation.', partNumber: 4, partTitle: 'Linearizing Data' },
  ...
  { id: 'tl-ent-5b', question: 'If you modeled ln(y) and obtained a predicted ln(ŷ) = 3.2, how do you find ŷ on the original scale?', options: ['ŷ = 3.2', 'ŷ = ln(3.2)', 'ŷ = $e^{3}\\cdot^{2}$', 'ŷ = $3.2^{2}$'], correctIndex: 2, explanation: 'Predictions in the ln(y) scale must be exponentiated: ŷ = $e^{3}\\cdot^{2}$ to get the prediction on the original scale.', partNumber: 5, partTitle: 'Inverse Transformations' },
  { id: 'tl-ent-6a', question: 'A dataset follows y = $3\\cdot x^{2}$. When you plot ln(y) vs ln(x), the slope is approximately:', options: ['3', '0.5', '2', '1'], correctIndex: 2, explanation: 'y = $3\\cdot x^{2}$ → ln(y) = ln(3) + 2·ln(x), so the slope is 2, confirming a power model with exponent 2.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'tl-ent-6b', question: 'How do you confirm that a transformation improved the model?', options: ['Check if $R^{2}$ decreased', 'Compare residual plots before and after transformation', 'Only look at the scatterplot of original data', 'Ignore residual plots'], correctIndex: 1, explanation: 'Always compare residual plots before and after transformation to confirm that the transformation improved the model.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
