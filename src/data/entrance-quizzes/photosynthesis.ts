...
const questions: EntranceQuizQuestion[] = [
  // Part 1
  { id: 'ps-ent-1a', question: 'Where do the light reactions of photosynthesis take place, and what are their products?', options: ['Thylakoid membranes; ATP, NADPH, and O₂', 'Stroma; glucose and O₂', 'Cytoplasm; ATP and CO₂', 'Inner mitochondrial membrane; NADH and FADH₂'], correctIndex: 0, explanation: 'The light reactions occur in the thylakoid membranes of chloroplasts. They use light energy to split water, releasing O₂, and produce ATP and NADPH that power the Calvin cycle.', partNumber: 1, partTitle: 'Light Reactions' },
  { id: 'ps-ent-1b', question: 'Which equation correctly represents the overall reaction of photosynthesis?', options: ['C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O', '6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂', '2H₂O₂ → 2H₂O + O₂', 'CO₂ + H₂O → CH₄ + O₂'], correctIndex: 1, explanation: 'Photosynthesis uses carbon dioxide and water, powered by light energy, to produce glucose and oxygen: 6CO₂ + 6H₂O → C₆H₁₂O₆ + 6O₂.', partNumber: 1, partTitle: 'Light Reactions' },

  // Part 2
  { id: 'ps-ent-2a', question: 'What is the role of Photosystem II (PSII) in the light reactions?', options: ['It fixes CO₂ into organic molecules', 'It splits water molecules, releasing electrons, H⁺ ions, and O₂', 'It reduces NADP⁺ to NADPH', 'It synthesizes glucose from G3P'], correctIndex: 1, explanation: 'PSII absorbs light energy and uses it to split water (photolysis): H₂O → 2H⁺ + 2e⁻ + ½O₂. The electrons replace those excited out of the PSII reaction center, and O₂ is released as a byproduct.', partNumber: 2, partTitle: 'Photosystems' },
  ...
  // Part 3
  { id: 'ps-ent-3a', question: 'In the Calvin cycle, what enzyme fixes CO₂ into an organic molecule?', options: ['ATP synthase', 'DNA polymerase', 'RuBisCO', 'Helicase'], correctIndex: 2, explanation: 'RuBisCO (ribulose-1,5-bisphosphate carboxylase/oxygenase) catalyzes carbon fixation in the Calvin cycle, combining CO₂ with RuBP (a 5-carbon sugar) to eventually produce G3P in the stroma.', partNumber: 3, partTitle: 'Calvin Cycle' },
  { id: 'ps-ent-3b', question: 'The Calvin cycle requires inputs from the light reactions. Which molecules does it use?', options: ['O₂ and glucose', 'ATP and NADPH', 'NADH and FADH₂', 'H₂O and CO₂ only'], correctIndex: 1, explanation: 'The Calvin cycle uses ATP (for energy) and NADPH (for reducing power) produced by the light reactions to fix CO₂ and synthesize G3P. Without the light reactions, the Calvin cycle cannot proceed.', partNumber: 3, partTitle: 'Calvin Cycle' },

  // Part 4
  { id: 'ps-ent-4a', question: 'How do C4 plants minimize photorespiration?', options: ['They close stomata during the day and open them at night', 'They fix CO₂ initially in mesophyll cells, then concentrate it in bundle-sheath cells for the Calvin cycle', 'They use a different final electron acceptor in the light reactions', 'They lack RuBisCO entirely'], correctIndex: 1, explanation: 'C4 plants use PEP carboxylase to fix CO₂ into a 4-carbon compound in mesophyll cells, then shuttle it to bundle-sheath cells where CO₂ is released at high concentration near RuBisCO, minimizing photorespiration.', partNumber: 4, partTitle: 'C3 vs C4 vs CAM' },
  { id: 'ps-ent-4b', question: 'What adaptation allows CAM plants to survive in arid environments?', options: ['They perform photosynthesis only in their roots', 'They open stomata at night to fix CO₂, reducing water loss during the day', 'They do not perform the Calvin cycle', 'They absorb water through their leaves instead of roots'], correctIndex: 1, explanation: 'CAM plants open stomata at night (when it is cooler and more humid) to take in CO₂ and store it as organic acids. During the day, stomata close to conserve water, and the stored CO₂ is released for the Calvin cycle.', partNumber: 4, partTitle: 'C3 vs C4 vs CAM' },

  // Part 5
  { id: 'ps-ent-5a', question: 'Which factors directly affect the rate of photosynthesis?', options: ['Light intensity, CO₂ concentration, and temperature', 'Oxygen concentration, nitrogen levels, and gravity', 'Soil pH, wind speed, and humidity only', 'ATP concentration, NADH levels, and glucose supply'], correctIndex: 0, explanation: 'The rate of photosynthesis is primarily influenced by light intensity (drives light reactions), CO₂ concentration (substrate for Calvin cycle), and temperature (affects enzyme activity, especially RuBisCO).', partNumber: 5, partTitle: 'Photosynthesis Factors' },
