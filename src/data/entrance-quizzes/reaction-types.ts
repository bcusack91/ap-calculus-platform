...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'rt-ent-7b', question: 'Which clue suggests a chemical reaction has occurred?', options: ['A solid is crushed, ground, or cut into smaller pieces', 'A precipitate forms, gas evolves, or color changes', 'Ice melts, water boils, or steam condenses on glass', 'Sugar dissolves, salt dissolves, or sand settles out'], correctIndex: 1, explanation: 'Precipitate formation, gas production, and a color change are classic evidence that a chemical reaction has occurred. Crushing, melting, and dissolving are physical changes: the substances keep their chemical identity.', partNumber: 7, partTitle: 'Synthesis & AP Review' },
]
