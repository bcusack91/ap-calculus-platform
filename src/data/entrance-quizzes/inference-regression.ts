...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'ir-ent-1b', question: 'The population regression line is written as:', options: ['ŷ = a + bx', 'μy = α + βx', 'y = mx + b', 'ȳ = β₀ + β₁x̄'], correctIndex: 1, explanation: 'The population regression line is μy = α + βx; we estimate it with the sample line ŷ = a + bx.', partNumber: 1, partTitle: 'Regression Inference Overview' },
  { id: 'ir-ent-2a', question: 'In a t-test for the slope of a regression line, what is the null hypothesis?', options: ['H₀: β = 1', 'H₀: β = 0 (no linear relationship)', 'H₀: α = 0', 'H₀: r = 1'], correctIndex: 1, explanation: 'The null hypothesis is H₀: β = 0 (no linear relationship). The test statistic is t = b / SE_b with df = n − 2.', partNumber: 2, partTitle: 't-Test for Slope' },
  ...
  { id: 'ir-ent-6a', question: 'Computer output: b = 2.3, SE_b = 0.5, n = 22. What is the t-statistic and conclusion?', options: ['t = 0.5, fail to reject H₀', 't = 4.6, reject H₀ — significant linear relationship', 't = 2.3, inconclusive', 't = 22, reject H₀'], correctIndex: 1, explanation: 't = b / SE_b = 2.3 / 0.5 = 4.6 with df = 20. This gives p < 0.001, so we reject H₀.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  ...
  { id: 'ir-ent-7a', question: 'On the AP exam, when given computer regression output, you should be able to identify:', options: ['Only the R² value', 'b, SE_b, t, p, R², and s — and interpret each', 'Only the slope and intercept', 'The raw data values'], correctIndex: 1, explanation: 'On the AP exam, read computer output to find b, SE_b, t, p, R², and s, and interpret each in context.', partNumber: 7, partTitle: 'AP Review & Applications' },
