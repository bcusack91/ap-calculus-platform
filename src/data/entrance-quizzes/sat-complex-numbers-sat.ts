...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'scn-ent-4b', question: 'What is (3 + 5i)(3 − 5i)?', options: ['−34', '−16 + 30i', '34', '−16'], correctIndex: 2, explanation: '(a + bi)(a − bi) = a² + b². Here: 3² + 5² = 9 + 25 = 34 (a real number).', partNumber: 4, partTitle: 'Conjugates' },
