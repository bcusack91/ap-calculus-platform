...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'abt-ent-4a', question: 'Which of the following is a strong acid?', options: ['$CH_3COOH$', '$HF$', '$HCl$', '$H_2CO_3$'], correctIndex: 2, explanation: 'HCl is one of the six common strong acids (HCl, HBr, HI, HNO₃, H₂SO₄, HClO₄) that fully dissociate in water.', partNumber: 4, partTitle: 'Strong Acids & Bases' },
  ...
  { id: 'abt-ent-6a', question: 'The pH of a 0.0010 M HNO₃ solution is:', options: ['1', '2', '3', '4'], correctIndex: 2, explanation: '$HNO_3$ is a strong acid: $[H^+] = 0.0010 = 10^{-3}$ M. $pH = -\\log(10^{-3}) = 3$.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
