...
const questions: EntranceQuizQuestion[] = [
  { id: 'sef-ent-1a', question: 'A population of bacteria starts at 500 and doubles every hour. What is the population after 3 hours?', options: ['1,500', '2,000', '3,000', '4,000'], correctIndex: 3, explanation: 'Population = 500 × $2^{3}$ = 500 × 8 = 4,000.', partNumber: 1, partTitle: 'Exponential Growth' },
  ...
  { id: 'sef-ent-6b', question: 'An account grows from $\\$500$ to $\\$1{,}000$ in 8 years with annual compounding. What is the approximate annual rate?', options: ['About 7%', 'About 8%', 'About 9%', 'About 10%'], correctIndex: 2, explanation: '1000 = $500(1+r)^{8}$ → 2 = $(1+r)^{8}$ → (1+r) = $2^{1/8}$ ≈ 1.0905 → r ≈ 9%.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'sef-ent-7a', question: 'For the exponential function y = a · $b^{x}$, what does a represent?', options: ['The rate of change', 'The initial value (y-intercept)', 'The growth factor', 'The horizontal asymptote'], correctIndex: 1, explanation: 'When x = 0, y = a · $b^{0}$ = a · 1 = a. So a is the initial value or y-intercept.', partNumber: 7, partTitle: 'Review & Applications' },
