...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sle-ent-5b', question: 'Which linear equation models the data in the table?\n\n| x | y |\n| --- | --- |\n| 1 | 5 |\n| 2 | 8 |\n| 3 | 11 |', options: ['y = 2x + 3', 'y = 3x + 2', 'y = x + 4', 'y = 4x + 1'], correctIndex: 1, explanation: 'Slope = (8−5)/(2−1) = 3. Using point (1, 5): 5 = 3(1) + b → b = 2. Equation: y = 3x + 2.', partNumber: 5, partTitle: 'Modeling' },
