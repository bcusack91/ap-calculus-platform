...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'dr-ent-2b', question: 'Which experiment confirmed that DNA replication is semiconservative?', options: ['Hershey-Chase experiment', 'Chargaff\'s base ratio analysis', 'Griffith\'s transformation experiment', 'Meselson-Stahl experiment'], correctIndex: 3, explanation: 'The Meselson-Stahl experiment used heavy nitrogen $(^{15}N)$ labeling to demonstrate that replication is semiconservative.', partNumber: 2, partTitle: 'Semiconservative Replication' },
  // Part 3
