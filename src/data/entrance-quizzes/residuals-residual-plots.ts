...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'rrp-ent-7b', question: 'The formula s = √[$\\Sigma (residuals^{2})$ / (n − 2)] gives:', options: ['The correlation coefficient', 'The coefficient of determination', 'The typical size of prediction errors', 'The y-intercept of the regression line'], correctIndex: 2, explanation: 's = √[$\\Sigma (residuals^{2})$ / (n − 2)] gives the typical size of prediction errors (standard deviation of residuals).', partNumber: 7, partTitle: 'AP Review & Applications' },
]
