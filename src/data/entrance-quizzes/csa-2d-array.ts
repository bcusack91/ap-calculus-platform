/**
 * Entrance Quiz — 2D Arrays (AP Computer Science A)
...
const questions: EntranceQuizQuestion[] = [
  { id: 'csa2-ent-1a', question: 'Which of the following best describes the main focus of 2D Arrays?', options: ['An unrelated topic', 'The core principles and patterns within 2D Arrays', 'A mathematical formula', 'A literary technique'], correctIndex: 1, explanation: '2D Arrays focuses on understanding key principles and patterns within AP Computer Science A.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'csa2-ent-1b', question: 'Why is 2D Arrays important in AP Computer Science A?', options: ['It is not important', 'It connects to multiple units and is frequently tested on the AP exam', 'It is only relevant to one question', 'It has been removed from the curriculum'], correctIndex: 1, explanation: '2D Arrays is a key topic in AP Computer Science A that connects to multiple course themes.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'csa2-ent-2a', question: 'Which best describes a key process in 2D Arrays?', options: ['A random event', 'A systematic mechanism that produces predictable patterns', 'An unexplainable phenomenon', 'A one-time occurrence'], correctIndex: 1, explanation: 'Key processes are systematic mechanisms that produce identifiable, often predictable patterns.', partNumber: 2, partTitle: 'Key Processes' },
  { id: 'csa2-ent-2b', question: 'Understanding cause and effect in 2D Arrays helps students:', options: ['Memorize dates', 'Explain why patterns exist rather than just describing them', 'Avoid analysis', 'Skip exam questions'], correctIndex: 1, explanation: 'Cause-and-effect reasoning helps explain WHY patterns exist — a higher-order skill tested on the AP exam.', partNumber: 2, partTitle: 'Key Processes' },
