...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'moc-ent-6b', question: 'A compound has the molecular formula $C_4H_8O$ and shows a strong IR absorption at ~1715 cm⁻¹. It is most likely a:', options: ['Primary alcohol', 'Ether', 'Aldehyde or ketone (carbonyl compound)', 'Carboxylic acid'], correctIndex: 2, explanation: 'A strong IR absorption at ~1715 cm⁻¹ is the signature of a $C=O$ (carbonyl) stretch. With no broad O-H stretch, it is a ketone or aldehyde.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
