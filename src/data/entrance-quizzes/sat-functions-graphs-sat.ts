...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sfg-ent-2a', question: 'What is the domain of f(x) = $\\sqrt{x - 4}$?', options: ['x > 4', 'x ≥ 4', 'x ≤ 4', 'all real numbers'], correctIndex: 1, explanation: 'The expression under a square root must be ≥ 0: x − 4 ≥ 0 → x ≥ 4.', partNumber: 2, partTitle: 'Domain & Range' },
  { id: 'sfg-ent-2b', question: 'What is the range of f(x) = $x^{2}$ + 3?', options: ['y ≥ 0', 'y ≥ 3', 'all real numbers', 'y ≤ 3'], correctIndex: 1, explanation: '$x^{2}$ ≥ 0 for all real x, so $x^{2}$ + 3 ≥ 3. The range is y ≥ 3.', partNumber: 2, partTitle: 'Domain & Range' },
  ...
  { id: 'sfg-ent-3b', question: 'If h(t) = $t^{2}$ − 4 and h(a) = 21, what is a positive value of a?', options: ['3', '4', '5', '6'], correctIndex: 2, explanation: '$a^{2}$ − 4 = 21 → $a^{2}$ = 25 → a = ±5. The positive value is 5.', partNumber: 3, partTitle: 'Evaluating Functions' },
