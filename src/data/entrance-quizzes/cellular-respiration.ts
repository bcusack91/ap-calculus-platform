...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 3
  { id: 'cr-ent-3a', question: 'What happens during pyruvate oxidation?', options: ['Glucose is split into two pyruvate molecules', 'Pyruvate is converted to acetyl-CoA, releasing CO₂ and producing NADH', 'Pyruvate is converted directly to ATP', 'Pyruvate is transported to the thylakoid membrane'], correctIndex: 1, explanation: 'In the mitochondrial matrix, each pyruvate is oxidized: it loses a carbon as CO₂, is reduced to form NADH, and the remaining 2-carbon fragment joins coenzyme A to form acetyl-CoA.', partNumber: 3, partTitle: 'Pyruvate Oxidation' },
  ...
  // Part 4
  { id: 'cr-ent-4a', question: 'What are the primary products of the citric acid (Krebs) cycle?', options: ['Glucose and oxygen', 'Mostly electron carriers: NADH and FADH₂', 'Large quantities of ATP only', 'Pyruvate and acetyl-CoA'], correctIndex: 1, explanation: 'The Krebs cycle primarily generates electron carriers (NADH and FADH₂) that will donate electrons to the ETC. While it does produce some ATP (GTP), its main role is to harvest high-energy electrons.', partNumber: 4, partTitle: 'Citric Acid Cycle' },
  { id: 'cr-ent-4b', question: 'Per single turn of the citric acid cycle, what is produced?', options: ['3 NADH, 1 FADH₂, 1 ATP (or GTP), and 2 CO₂', '1 NADH, 3 FADH₂, 2 ATP, and 1 CO₂', '6 NADH, 2 FADH₂, 4 ATP, and 6 CO₂', '2 NADH, 2 FADH₂, 2 ATP, and 4 CO₂'], correctIndex: 0, explanation: 'Each turn of the Krebs cycle produces 3 NADH, 1 FADH₂, 1 ATP (via GTP), and releases 2 CO₂. Since each glucose yields 2 acetyl-CoA, the cycle turns twice per glucose.', partNumber: 4, partTitle: 'Citric Acid Cycle' },

  // Part 5
  { id: 'cr-ent-5a', question: 'Where does the electron transport chain (ETC) occur, and what is the final electron acceptor?', options: ['Outer mitochondrial membrane; NADH is the final acceptor', 'Inner mitochondrial membrane; oxygen (O₂) is the final electron acceptor', 'Cytoplasm; carbon dioxide is the final acceptor', 'Thylakoid membrane; water is the final acceptor'], correctIndex: 1, explanation: 'The ETC is embedded in the inner mitochondrial membrane. Electrons pass through protein complexes and ultimately reduce O₂ to form H₂O. Without oxygen, the chain cannot function.', partNumber: 5, partTitle: 'Oxidative Phosphorylation' },
