...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 5
  { id: 'wpb-ent-5a', question: 'A solution has a pH of 3 and another has a pH of 6. How much greater is the H⁺ concentration in the pH 3 solution?', options: ['3 times greater', '10 times greater', '100 times greater', '1,000 times greater'], correctIndex: 3, explanation: 'pH = −log[H⁺], and the scale is logarithmic. Each pH unit represents a 10-fold change in [H⁺]. A difference of 3 pH units means 10³ = 1,000 times more H⁺ ions in the pH 3 solution.', partNumber: 5, partTitle: 'pH & Buffers' },
