...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sga-ent-4a', question: 'What is the area of a trapezoid with parallel bases of 6 and 10, and height 4?', options: ['32', '40', '48', '60'], correctIndex: 0, explanation: 'Area of trapezoid = $\\tfrac{1}{2} (b_{1} + b_{2})h$ = ½(6 + 10)(4) = ½(16)(4) = 32.', partNumber: 4, partTitle: 'Area & Perimeter' },
  ...
  { id: 'sga-ent-5a', question: 'A circle has a radius of 7. What is its area? (Use π ≈ 3.14)', options: ['21.98', '43.96', '153.86', '307.72'], correctIndex: 2, explanation: 'Area = $\\pi r^{2}$ = 3.14 × $7^{2}$ = 3.14 × 49 ≈ 153.86.', partNumber: 5, partTitle: 'Circle Basics' },
  ...
  { id: 'sga-ent-6a', question: 'Two similar triangles have corresponding sides in the ratio 3:5. If the area of the smaller triangle is 27, what is the area of the larger?', options: ['45', '75', '135', '225'], correctIndex: 1, explanation: 'Area ratio = (3:5)$ {}^{2}$ = 9:25. Area of larger = 27 × (25/9) = 75.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'sga-ent-6b', question: 'An isosceles right triangle has legs of length 6. What is the length of the hypotenuse?', options: ['$6\\sqrt{2}$', '$6\\sqrt{3}$', '12', '$3\\sqrt{2}$'], correctIndex: 0, explanation: 'Isosceles right triangle: hypotenuse = leg × $\\sqrt{2}$ = $6\\sqrt{2}$.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  ...
  { id: 'sga-ent-7b', question: 'In the figure, a right triangle has hypotenuse 17 and one leg 15. What is the area of the triangle?', options: ['60', '64', '75', '127.5'], correctIndex: 0, explanation: 'Find the missing leg: $\\sqrt{17^{2} - 15^{2}}$ = $\\sqrt{289 - 225}$ = $\\sqrt{64}$ = 8. Area = ½(15)(8) = 60.', partNumber: 7, partTitle: 'Review & Applications' },
]
