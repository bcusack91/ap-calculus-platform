...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'fbu-ent-3b', question: 'Which object would sink in fresh water ($\\rho = 1000$ $kg/m^{3}$)?', options: ['Cork ($\\rho = 240$)', 'Ice ($\\rho = 917$)', 'Olive oil ($\\rho = 920$)', 'Aluminum ($\\rho = 2700$)'], correctIndex: 3, explanation: 'Only aluminum is denser than water, so only it sinks.', partNumber: 3, partTitle: 'Floating vs Sinking' },

  // Part 4 — Submerged Object Calculations
  { id: 'fbu-ent-4a', question: 'A block fully submerged in water displaces $5.0\\times10^{-4}$ $m^{3}$. The buoyant force on it is ($g = 9.8$):', options: ['0.49 N', '4.9 N', '49 N', '490 N'], correctIndex: 1, explanation: '$F_b = \\rho g V = 1000(9.8)(5.0\\times10^{-4}) = 4.9$ N.', partNumber: 4, partTitle: 'Submerged Object Calculations' },
  { id: 'fbu-ent-4b', question: 'A 2.0 kg metal block (volume $2.5\\times10^{-4}$ $m^{3}$) is fully submerged in water and held by a string. The tension in the string is ($g = 9.8$):', options: ['17.1 N', '19.6 N', '22.1 N', '2.45 N'], correctIndex: 0, explanation: '$W = 2.0(9.8) = 19.6$ N. $F_b = 1000(9.8)(2.5\\times10^{-4}) = 2.45$ N. $T = W − F_b = 17.15$ N.', partNumber: 4, partTitle: 'Submerged Object Calculations' },

  // Part 5 — Floating Object Calculations
  { id: 'fbu-ent-5a', question: 'A wood block ($\\rho = 600$ $kg/m^{3}$) floats in fresh water. The fraction of its volume submerged is:', options: ['40%', '50%', '60%', '100%'], correctIndex: 2, explanation: '$V_{sub}/V = \\rho_{obj}/\\rho_{fluid} = 600/1000 = 0.60 = 60\\%$.', partNumber: 5, partTitle: 'Floating Object Calculations' },
  ...
  { id: 'fbu-ent-6a', question: 'A 0.30 kg object has volume $4.0\\times10^{-4}$ $m^{3}$. When released in fresh water, it will:', options: ['Float at the surface', 'Sink to the bottom', 'Remain stationary at any depth', 'Rise then sink alternately'], correctIndex: 0, explanation: '$\\rho_{obj} = 0.30 / 4.0\\times10^{-4} = 750$ $kg/m^{3}$, less than water (1000), so it floats.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'fbu-ent-6b', question: 'A 1.0 kg object weighs 7.0 N when fully submerged in water (apparent weight). Its volume is approximately ($g = 9.8$):', options: ['$1.0\\times10^{-4}$ $m^{3}$', '$2.86\\times10^{-4}$ $m^{3}$', '$1.0\\times10^{-3}$ $m^{3}$', '$7.14\\times10^{-3}$ $m^{3}$'], correctIndex: 1, explanation: 'True weight = 9.8 N. Buoyant force = 9.8 − 7.0 = 2.8 N. $V = F_b/(\\rho g) = 2.8 / (1000)(9.8) ≈ 2.86\\times10^{-4}$ $m^{3}$.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
