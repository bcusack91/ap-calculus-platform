...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'alg1-ent-4a', question: 'What is the slope of the line passing through (1, 2) and (3, 8)?', options: ['2', '3', '4', '6'], correctIndex: 1, explanation: 'Slope = (y₂ − y₁)/(x₂ − x₁) = (8 − 2)/(3 − 1) = 6/2 = 3.', partNumber: 4, partTitle: 'Graphing Linear Equations' },
  ...
  { id: 'alg1-ent-6a', question: 'Factor completely: x² − 9', options: ['(x − 3)²', '(x + 3)(x − 3)', '(x − 9)(x + 1)', '(x + 9)(x − 1)'], correctIndex: 1, explanation: 'x² − 9 is a difference of squares: a² − b² = (a + b)(a − b), so x² − 9 = (x + 3)(x − 3).', partNumber: 6, partTitle: 'Polynomials & Factoring' },
  { id: 'alg1-ent-6b', question: 'Factor: x² + 5x + 6', options: ['(x + 1)(x + 6)', '(x + 2)(x + 3)', '(x + 3)(x + 2)', '(x − 2)(x − 3)'], correctIndex: 1, explanation: 'Find two numbers that multiply to 6 and add to 5: 2 × 3 = 6 and 2 + 3 = 5. So x² + 5x + 6 = (x + 2)(x + 3).', partNumber: 6, partTitle: 'Polynomials & Factoring' },

  // Part 7: Quadratics & Functions Intro
  { id: 'alg1-ent-7a', question: 'What are the solutions to x² − 5x + 6 = 0?', options: ['x = 1 and x = 6', 'x = 2 and x = 3', 'x = −2 and x = −3', 'x = −1 and x = 6'], correctIndex: 1, explanation: 'Factor: (x − 2)(x − 3) = 0. Set each factor to zero: x = 2 or x = 3.', partNumber: 7, partTitle: 'Quadratics & Functions Intro' },
