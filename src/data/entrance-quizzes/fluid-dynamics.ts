...
const questions: EntranceQuizQuestion[] = [
  ...
  {
    id: 'fd-ent-1b',
    question: 'Water flows through a pipe that narrows from $0.04$ m² to $0.01$ m². If the speed at the wide end is $2$ m/s, the speed at the narrow end is:',
  ...
  {
    id: 'fd-ent-4b',
    question: 'Water exits a hole $5$ m below the surface of a tank. The exit speed is approximately: ($g = 10$ m/s²)',
  ...
  // Part 5: Flow Rate
  {
    ...
    correctIndex: 0,
    explanation: 'Volume flow rate $Q = Av$, where $A$ is cross-sectional area and $v$ is flow speed. Units: m³/s.',
    partNumber: 5,
    partTitle: 'Flow Rate',
  },
  {
    ...
    options: ['$0.03\\pi$ m³/s', '$0.3\\pi$ m³/s', '$0.003\\pi$ m³/s', '$3\\pi$ m³/s'],
    correctIndex: 0,
    explanation: '$Q = Av = \\pi r^2 v = \\pi(0.1)^2(3) = 0.03\\pi$ m³/s.',
    partNumber: 5,
    partTitle: 'Flow Rate',
  },
