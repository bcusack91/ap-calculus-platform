...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'as-ent-4b', question: 'Using the Rydberg formula $1/\\lambda = R_H (1/n_f^2 - 1/n_i^2)$ with $R_H = 1.097 \\times 10^7$ m⁻¹, the wavelength for $n=3 \\to n=2$ in hydrogen is approximately:', options: ['97 nm', '434 nm', '656 nm', '1875 nm'], correctIndex: 2, explanation: '$1/\\lambda = (1.097 \\times 10^7)(1/4 - 1/9) = 1.524 \\times 10^6$ m⁻¹, so $\\lambda \\approx 656$ nm — the red Hα line.', partNumber: 4, partTitle: 'The Hydrogen Spectrum & Rydberg Formula' },
