...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'atrig-ent-1b', question: 'In a right triangle with a 30° angle and a hypotenuse of 10, what is the length of the side opposite the 30° angle?', options: ['10', '$5\\sqrt{3}$', '5', '$10\\sqrt{3}$'], correctIndex: 2, explanation: 'opposite = hypotenuse × sin(30°) = 10 × 0.5 = 5.', partNumber: 1, partTitle: 'Right Triangle Trig' },
  ...
  { id: 'atrig-ent-2b', question: 'Which of the following is the Pythagorean identity?', options: ['$\\sin^{2}\\theta$ + $\\cos^{2}\\theta$ = 1', '$\\sin^{2}\\theta$ − $\\cos^{2}\\theta$ = 1', 'sinθ + cosθ = 1', '$\\tan^{2}\\theta$ + 1 = $\\sin^{2}\\theta$'], correctIndex: 0, explanation: 'The fundamental Pythagorean identity states $\\sin^{2}\\theta$ + $\\cos^{2}\\theta$ = 1.', partNumber: 2, partTitle: 'Trig Ratios & Applications' },
  ...
  { id: 'atrig-ent-3b', question: 'What is sin(π/6)?', options: ['$\\sqrt{3}/2$', '1/2', '$\\sqrt{2}/2$', '$1/\\sqrt{3}$'], correctIndex: 1, explanation: 'sin(π/6) = sin(30°) = 1/2.', partNumber: 3, partTitle: 'Unit Circle' },
  ...
  { id: 'atrig-ent-7b', question: 'Which of the following is the exact value of sin(45°)?', options: ['1/2', '$\\sqrt{3}/2$', '1', '$\\sqrt{2}/2$'], correctIndex: 3, explanation: 'sin(45°) = $\\sqrt{2}/2$. Knowing exact values for 0°, 30°, 45°, 60°, and 90° is essential for the ACT.', partNumber: 7, partTitle: 'Review & Applications' },
]
