...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 3
  { id: 'ccs-ent-3a', question: 'Which molecules are common second messengers in cell signaling?', options: ['DNA and RNA', 'Glucose and fructose', 'cAMP and Ca²⁺', 'Hemoglobin and myoglobin'], correctIndex: 2, explanation: 'cAMP (cyclic AMP) and Ca²⁺ (calcium ions) are the most common second messengers. They are small, rapidly diffusible molecules released inside the cell after receptor activation to relay and amplify the signal.', partNumber: 3, partTitle: 'Second Messengers' },
