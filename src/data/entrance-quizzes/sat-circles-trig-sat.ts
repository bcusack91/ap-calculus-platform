...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'sct-ent-3b', question: 'In a right triangle with legs 6 and 8, what is the cosine of the angle opposite the side of length 8?', options: ['3/5', '4/5', '6/10', '8/10'], correctIndex: 0, explanation: 'Hypotenuse = √(36+64) = 10. The angle opposite the side of length 8 has adjacent side = 6. cos θ = 6/10 = 3/5.', partNumber: 3, partTitle: 'Right Triangle Trig' },
