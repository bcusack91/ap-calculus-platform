...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'cr-ent-3b', question: 'Find $\\frac{d}{dx}[\\ln(x^2)]$:', options: ['$\\frac{2}{x}$', '$\\frac{1}{x^2}$', '$\\frac{1}{2x}$', '$2\\ln x$'], correctIndex: 0, explanation: '$\\frac{1}{x^2} \\cdot 2x = \\frac{2}{x}$. (Also: $\\ln(x^2) = 2\\ln x$, derivative $= 2/x$.)', partNumber: 3, partTitle: 'Chain Rule with Exponentials & Logs' },
  ...
  { id: 'cr-ent-4b', question: 'Find $\\frac{d}{dx}[\\sqrt{4x+1}]$:', options: ['$\\frac{2}{\\sqrt{4x+1}}$', '$\\frac{4}{\\sqrt{4x+1}}$', '$\\frac{1}{2\\sqrt{4x+1}}$', '$\\frac{1}{\\sqrt{4x+1}}$'], correctIndex: 0, explanation: '$\\frac{1}{2\\sqrt{4x+1}} \\cdot 4 = \\frac{2}{\\sqrt{4x+1}}$.', partNumber: 4, partTitle: 'Nested Chain Rule' },
  { id: 'cr-ent-5a', question: 'Using implicit differentiation on $x^2 + y^2 = 25$, $\\frac{dy}{dx} =$', options: ['$\\frac{-x}{y}$', '$\\frac{x}{y}$', '$\\frac{-y}{x}$', '$\\frac{-2x}{y}$'], correctIndex: 0, explanation: '$2x + 2y\\frac{dy}{dx} = 0 \\Rightarrow \\frac{dy}{dx} = -\\frac{x}{y}$.', partNumber: 5, partTitle: 'Implicit Differentiation' },
