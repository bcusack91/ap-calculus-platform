...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'fbe-ent-1b', question: "Each term in Bernoulli's equation has units of:", options: ['Newtons', 'Joules', 'Pascals (energy per unit volume)', 'Watts'], correctIndex: 2, explanation: 'All three terms are energy per unit volume — equivalent to pressure (Pa = J/m³).', partNumber: 1, partTitle: "Bernoulli's Equation Setup" },
  ...
  { id: 'fbe-ent-4b', question: 'Water leaves a small hole 5.0 m below the open top of a tank ($g = 9.8$ m/s²). The exit speed is approximately:', options: ['7.0 m/s', '9.9 m/s', '14.0 m/s', '19.6 m/s'], correctIndex: 1, explanation: '$v = \\sqrt{2gh} = \\sqrt{2(9.8)(5.0)} = \\sqrt{98} \\approx 9.9$ m/s.', partNumber: 4, partTitle: "Torricelli's Theorem" },
  ...
  { id: 'fbe-ent-6a', question: 'Water at 20 kPa flows at 1.0 m/s in a horizontal pipe of area $A_1$. It enters a section of area $A_2 = A_1/2$. The pressure in the narrow section is ($\\rho = 1000$ kg/m³):', options: ['18.5 kPa', '20 kPa', '21.5 kPa', '17 kPa'], correctIndex: 0, explanation: 'Continuity: $v_2 = 1.0(A_1/A_2) = 2.0$ m/s. Bernoulli (horizontal): $P_2 = P_1 + \\tfrac12\\rho(v_1^2 - v_2^2) = 20{,}000 + \\tfrac12(1000)(1 - 4) = 18{,}500$ Pa.', partNumber: 6, partTitle: 'Combined Continuity + Bernoulli' },
