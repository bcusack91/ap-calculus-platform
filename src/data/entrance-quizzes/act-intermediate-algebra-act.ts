...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'aia-ent-2b', question: 'What is the completely factored form of $6x^{3}$ + $9x^{2}$?', options: ['$3x(2x^{2} + 3x)$', '$3x^{2}(2x + 3)$', '$6x^{2}(x + 3)$', '$9x(x^{2} + 1)$'], correctIndex: 1, explanation: 'Factor out the GCF of $3x^{2}$: $6x^{3}$ + $9x^{2}$ = $3x^{2}(2x + 3)$.', partNumber: 2, partTitle: 'Polynomial Operations' },
