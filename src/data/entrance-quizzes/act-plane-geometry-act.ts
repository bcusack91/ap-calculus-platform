...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'apg-ent-2b', question: 'In a right triangle with legs 3 and 4, what is the hypotenuse?', options: ['5', '6', '7', '√7'], correctIndex: 0, explanation: 'By the Pythagorean theorem: c² = 3² + 4² = 9 + 16 = 25, so c = 5.', partNumber: 2, partTitle: 'Triangle Properties' },
  ...
  { id: 'apg-ent-4a', question: 'What is the area of a circle with radius 6?', options: ['12π', '36π', '6π', '24π'], correctIndex: 1, explanation: 'Area of a circle = πr² = π(6²) = 36π.', partNumber: 4, partTitle: 'Circles' },
  ...
  { id: 'apg-ent-5b', question: 'What is the area of a trapezoid with parallel bases 8 and 12 and height 5?', options: ['40', '50', '60', '100'], correctIndex: 1, explanation: 'Area of a trapezoid = ½(b₁ + b₂) × h = ½(8 + 12) × 5 = ½(20)(5) = 50.', partNumber: 5, partTitle: 'Area & Perimeter' },
  { id: 'apg-ent-6a', question: 'A circle has radius 5. What is the area of a sector with a central angle of 72°?', options: ['π', '3π', '5π', '10π'], correctIndex: 2, explanation: 'Sector area = (72/360) × π(5²) = (1/5) × 25π = 5π.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'apg-ent-6b', question: 'In a 30-60-90 triangle, if the shortest side is 4, what is the hypotenuse?', options: ['4√2', '4√3', '8', '6'], correctIndex: 2, explanation: 'In a 30-60-90 triangle, the sides are x, x√3, 2x. With x = 4, the hypotenuse = 2(4) = 8.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
  { id: 'apg-ent-7a', question: 'Which special right triangles should you memorize for the ACT?', options: ['30-60-90 only', '45-45-90 only', 'Both 30-60-90 and 45-45-90', 'Neither — they are always given'], correctIndex: 2, explanation: 'Know both special right triangles: 30-60-90 (sides x, x√3, 2x) and 45-45-90 (sides x, x, x√2). They save time on the ACT.', partNumber: 7, partTitle: 'Review & Applications' },
