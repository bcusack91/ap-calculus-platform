...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'spf-ent-3b', question: 'Factor: $2x^{2}$ + 5x − 3', options: ['(2x − 1)(x + 3)', '(2x + 3)(x − 1)', '(x + 3)(2x − 1)', '(2x − 3)(x + 1)'], correctIndex: 0, explanation: 'Looking for factors of $2x^{2}$ + 5x − 3: try (2x − 1)(x + 3) = $2x^{2}$ + 6x − x − 3 = $2x^{2}$ + 5x − 3. ✓', partNumber: 3, partTitle: 'Factoring Trinomials' },
  ...
  { id: 'spf-ent-5a', question: 'Divide: $(x^{2} - x - 6)$ ÷ (x − 3)', options: ['x + 2', 'x − 2', 'x + 3', 'x − 3'], correctIndex: 0, explanation: 'Factor numerator: (x − 3)(x + 2). Cancel (x − 3): result is x + 2.', partNumber: 5, partTitle: 'Polynomial Division' },
  ...
  { id: 'spf-ent-6b', question: 'What are the zeros of P(x) = $x^{3}$ − 4x?', options: ['x = 0 only', 'x = ±4', 'x = 0, x = 2, x = −2', 'x = ±2 only'], correctIndex: 2, explanation: 'Factor: $x(x^{2} - 4)$ = x(x − 2)(x + 2). Zeros at x = 0, x = 2, and x = −2.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
