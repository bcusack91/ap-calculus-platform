...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'bt-ent-3b', question: 'After n cycles of PCR, approximately how many copies of the target DNA are produced?', options: ['n copies', '$n^{2}$ copies', '2n copies', '$2^{n}$ copies'], correctIndex: 3, explanation: 'PCR amplification is exponential — each cycle doubles the number of target copies, resulting in approximately $2^{n}$ copies after n cycles.', partNumber: 3, partTitle: 'PCR' },
  // Part 4
