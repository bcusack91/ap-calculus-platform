...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'imd-ent-3b', question: 'For $e^y = x^2$, $\\frac{dy}{dx} =$', options: ['$\\frac{2x}{e^y}$', '$\\frac{2}{x}$', '$\\frac{x^2}{e^y}$', '$\\frac{e^y}{2x}$'], correctIndex: 1, explanation: '$e^y \\frac{dy}{dx} = 2x \\Rightarrow \\frac{dy}{dx} = \\frac{2x}{e^y} = \\frac{2x}{x^2} = \\frac{2}{x}$.', partNumber: 3, partTitle: 'Trigonometric & Exponential Implicit Equations' },
