...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'imd-ent-1b', question: 'For $x^2 + y^2 = 25$, find $\\frac{dy}{dx}$:', options: ['$-\\frac{x}{y}$', '$\\frac{x}{y}$', '$-\\frac{y}{x}$', '$-\\frac{2x}{y}$'], correctIndex: 0, explanation: 'Solving $2x + 2y\\frac{dy}{dx} = 0$ for $\\frac{dy}{dx}$ gives $-x/y$.', partNumber: 1, partTitle: 'Differentiating Equations Not Solved for $y$' },
  ...
  { id: 'imd-ent-3a', question: 'Differentiate $\\sin(y) = x$ implicitly. Then $\\frac{dy}{dx} =$', options: ['$\\cos(y)$', '$\\frac{1}{\\cos y}$', '$-\\sin y$', '$\\tan y$'], correctIndex: 1, explanation: '$\\cos(y)\\frac{dy}{dx} = 1 \\Rightarrow \\frac{dy}{dx} = \\frac{1}{\\cos y}$ (equivalently $\\sec y$).', partNumber: 3, partTitle: 'Trigonometric & Exponential Implicit Equations' },
  { id: 'imd-ent-3b', question: 'For $e^y = x^2$, $\\frac{dy}{dx} =$', options: ['$2xe^y$', '$\\frac{2}{x}$', '$\\frac{x^2}{e^y}$', '$\\frac{e^y}{2x}$'], correctIndex: 1, explanation: '$e^y \\frac{dy}{dx} = 2x \\Rightarrow \\frac{dy}{dx} = \\frac{2x}{e^y} = \\frac{2x}{x^2} = \\frac{2}{x}$.', partNumber: 3, partTitle: 'Trigonometric & Exponential Implicit Equations' },
