...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'mos-ent-4a', question: 'Variance is related to standard deviation by:', options: ['Variance = SD / 2', 'Variance = SD²', 'Variance = √SD', 'Variance = SD + mean'], correctIndex: 1, explanation: 'Variance (s²) is the square of the standard deviation (s). Because variance is in squared units, SD is more interpretable.', partNumber: 4, partTitle: 'Variance' },
