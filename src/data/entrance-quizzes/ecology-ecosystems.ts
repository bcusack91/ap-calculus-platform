...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 3
  { id: 'eco-ent-3a', question: 'In the carbon cycle, how does carbon enter the biotic part of the ecosystem?', options: ['Through nitrogen fixation by bacteria', 'Through photosynthesis, which fixes CO₂ into organic molecules', 'Through the water cycle via precipitation', 'Through volcanic eruptions only'], correctIndex: 1, explanation: 'Carbon enters the living (biotic) part of the ecosystem when producers fix atmospheric CO₂ into organic molecules via photosynthesis. It is released back by respiration, combustion, and decomposition.', partNumber: 3, partTitle: 'Biogeochemical Cycles' },
  { id: 'eco-ent-3b', question: 'Nitrogen fixation is essential because it:', options: ['Converts CO₂ to glucose for plants', 'Converts atmospheric N₂ into ammonia (NH₃) usable by organisms', 'Breaks down dead organisms to release minerals', 'Converts water into hydrogen and oxygen'], correctIndex: 1, explanation: 'Nitrogen fixation converts atmospheric N₂ (which most organisms cannot use) into NH₃ by specialized bacteria. Nitrogen is essential for making amino acids and nucleotides.', partNumber: 3, partTitle: 'Biogeochemical Cycles' },
