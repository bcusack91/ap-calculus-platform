/**
 * Entrance Quiz — Creative Development (AP CS Principles)
...
const questions: EntranceQuizQuestion[] = [
  { id: 'cspc-ent-1a', question: 'Which of the following best describes the main focus of Creative Development?', options: ['An unrelated topic', 'The core principles and patterns within Creative Development', 'A mathematical formula', 'A literary technique'], correctIndex: 1, explanation: 'Creative Development focuses on understanding key principles and patterns within AP CS Principles.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'cspc-ent-1b', question: 'Why is Creative Development important in AP CS Principles?', options: ['It is not important', 'It connects to multiple units and is frequently tested on the AP exam', 'It is only relevant to one question', 'It has been removed from the curriculum'], correctIndex: 1, explanation: 'Creative Development is a key topic in AP CS Principles that connects to multiple course themes.', partNumber: 1, partTitle: 'Core Concepts' },
  { id: 'cspc-ent-2a', question: 'Which best describes a key process in Creative Development?', options: ['A random event', 'A systematic mechanism that produces predictable patterns', 'An unexplainable phenomenon', 'A one-time occurrence'], correctIndex: 1, explanation: 'Key processes are systematic mechanisms that produce identifiable, often predictable patterns.', partNumber: 2, partTitle: 'Key Processes' },
  { id: 'cspc-ent-2b', question: 'Understanding cause and effect in Creative Development helps students:', options: ['Memorize dates', 'Explain why patterns exist rather than just describing them', 'Avoid analysis', 'Skip exam questions'], correctIndex: 1, explanation: 'Cause-and-effect reasoning helps explain WHY patterns exist — a higher-order skill tested on the AP exam.', partNumber: 2, partTitle: 'Key Processes' },
