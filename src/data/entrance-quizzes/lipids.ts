...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'lip-eq-2b', question: 'A triglyceride forms when one glycerol binds with three fatty acids. What type of bond is formed, and what is released?', options: ['Ionic bonds; sodium ions are released', 'Phosphodiester bonds; phosphate groups are released', 'Ester bonds; three water molecules are released', 'Disulfide bonds; hydrogen gas is released'], correctIndex: 2, explanation: 'Triglycerides form via dehydration synthesis: each fatty acid bonds to glycerol through an ester linkage, releasing one water molecule per bond (three $H_{2}O$ total).', partNumber: 2, partTitle: 'Fatty Acid Structure' },
