...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'mgab-ent-1a', question: 'A solution has [$H^{+}$] = $1 \\times 10^{-4}$ M. What is its pH?', options: ['2', '4', '7', '10'], correctIndex: 1, explanation: 'pH = −log[$H^{+}$] = $-\\log (10^{-4})$ = 4.', partNumber: 1, partTitle: 'pH, pOH & Strong vs. Weak Acids' },
  { id: 'mgab-ent-1b', question: 'Which is a strong acid in water?', options: ['HF', 'HCN', 'HCl', '$CH_{3}COOH$'], correctIndex: 2, explanation: 'HCl dissociates ~100% in water. HF, HCN, and acetic acid are weak (only partial dissociation).', partNumber: 1, partTitle: 'pH, pOH & Strong vs. Weak Acids' },
  ...
  { id: 'mgab-ent-3b', question: 'The primary buffer system in human blood plasma is:', options: ['Phosphate $(H_{2}PO_{4}^{-} / HPO_{4}^{2-})$', 'Carbonic acid / bicarbonate $(H_{2}CO_{3} / HCO_{3}^{-})$', 'Ammonia / ammonium', 'Acetic acid / acetate'], correctIndex: 1, explanation: 'Blood pH (~7.4) is maintained by the carbonic acid/bicarbonate system, regulated by the lungs $(CO_{2})$ and kidneys $(HCO_{3}^{-})$.', partNumber: 3, partTitle: 'Buffers & Physiological Chemistry' },
  ...
  { id: 'mgab-ent-5a', question: 'For AgCl(s) ⇌ $Ag^{+}(aq)$ + $Cl^{-}(aq)$, if Ksp = $1.8 \\times 10^{-10}$, what is the molar solubility of AgCl in pure water?', options: ['$1.8 \\times 10^{-10}$ M', '$1.3 \\times 10^{-5}$ M', '$9.0 \\times 10^{-6}$ M', '$1.0 \\times 10^{-5}$ M'], correctIndex: 1, explanation: 'Let s = solubility. Ksp = $s^{2}$ = $1.8 \\times 10^{-10}$ → s ≈ $\\sqrt{1.8 \\times 10^{-10}}$ ≈ $1.3 \\times 10^{-5}$ M.', partNumber: 5, partTitle: "Equilibrium, Ksp & Le Chatelier's Principle" },
  { id: 'mgab-ent-5b', question: 'For $N_{2}(g)$ + 3 $H_{2}(g)$ ⇌ 2 $NH_{3}(g)$, ΔH < 0. Increasing temperature will:', options: ['Shift equilibrium right $(more NH_{3})$', 'Shift equilibrium left $(less NH_{3})$', 'Have no effect on the position of equilibrium', 'Increase Kp without shifting'], correctIndex: 1, explanation: "For an exothermic reaction, heat is a 'product.' Adding heat (raising T) shifts equilibrium toward reactants — Le Châtelier.", partNumber: 5, partTitle: "Equilibrium, Ksp & Le Chatelier's Principle" },
]
