...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'ams-ent-6a', question: 'What is x² + 2x when x = 3?', options: ['11', '18', '15', '12'], correctIndex: 2, explanation: 'Plug in directly: 3² + 2(3) = 9 + 6 = 15. Skip algebra when direct substitution works.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
