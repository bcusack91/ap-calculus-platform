...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'igl-ent-3a', question: 'In the ideal gas law $PV = nRT$, what is the value of $R$ when pressure is in atm?', options: ['8.314 J/(mol·K)', '0.0821 L·atm/(mol·K)', '62.36 L·torr/(mol·K)', '1.987 cal/(mol·K)'], correctIndex: 1, explanation: 'When P is in atm and V in liters, use $R = 0.0821$ L·atm/(mol·K). The value 8.314 is used with SI units (Pa, m³).', partNumber: 3, partTitle: 'The Ideal Gas Law (PV=nRT)' },
