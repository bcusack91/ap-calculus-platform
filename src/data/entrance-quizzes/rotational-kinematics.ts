...
const questions: EntranceQuizQuestion[] = [
  ...
  // Part 3: Angular Acceleration
  {
    ...
    correctIndex: 1,
    explanation: 'Angular acceleration is the rate of change of angular velocity: $\\alpha = \\Delta\\omega / \\Delta t$, in rad/s².',
    partNumber: 3,
  ...
  },
  {
    ...
    correctIndex: 1,
    explanation: '$\\alpha = (30 - 10)/4 = 20/4 = 5$ rad/s².',
    partNumber: 3,
    partTitle: 'Angular Acceleration',
  },
  ...
  {
    id: 'rk-ent-4b',
    question: 'A wheel starts from rest and accelerates at $4$ rad/s² for $3$ s. How many radians does it rotate?',
  ...
  {
    id: 'rk-ent-7b',
    question: 'A net torque of $12$ N·m acts on a wheel with $I = 4$ kg·m². The angular acceleration is:',
    options: ['$0.33$ rad/s²', '$3$ rad/s²', '$16$ rad/s²', '$48$ rad/s²'],
    correctIndex: 1,
    explanation: '$\\alpha = \\tau/I = 12/4 = 3$ rad/s².',
    partNumber: 7,
    partTitle: 'Synthesis & AP Review',
  },
]
