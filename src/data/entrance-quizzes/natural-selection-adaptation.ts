...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'nsa-ent-5b', question: 'In Hardy-Weinberg equations, what does 2pq represent?', options: ['Frequency of homozygous dominant individuals', 'Frequency of homozygous recessive individuals', 'Frequency of heterozygous individuals', 'Total number of alleles in the population'], correctIndex: 2, explanation: 'In the Hardy-Weinberg equation p² + 2pq + q² = 1, p² = homozygous dominant, 2pq = heterozygous, and q² = homozygous recessive.', partNumber: 5, partTitle: 'Hardy-Weinberg' },

  // Part 6
  { id: 'nsa-ent-6a', question: 'In a population in Hardy-Weinberg equilibrium, q² = 0.09. What is the frequency of the dominant allele (p)?', options: ['0.09', '0.3', '0.7', '0.91'], correctIndex: 2, explanation: 'If q² = 0.09, then q = √0.09 = 0.3. Since p + q = 1, p = 1 − 0.3 = 0.7.', partNumber: 6, partTitle: 'Problem-Solving Workshop' },
