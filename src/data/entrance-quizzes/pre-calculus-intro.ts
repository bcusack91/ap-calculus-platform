...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'pc-ent-1b', question: 'If f(x) = 3x² − 2x + 1, what is f(−1)?', options: ['2', '4', '6', '0'], correctIndex: 2, explanation: 'f(−1) = 3(−1)² − 2(−1) + 1 = 3(1) + 2 + 1 = 6.', partNumber: 1, partTitle: 'Functions & Analysis' },

  // Part 2: Polynomial & Rational Functions
  { id: 'pc-ent-2a', question: 'What is the end behavior of f(x) = −2x³ + 5x as x → +∞?', options: ['f(x) → +∞', 'f(x) → −∞', 'f(x) → 0', 'f(x) → 2'], correctIndex: 1, explanation: 'The leading term is −2x³. Since the leading coefficient is negative and the degree is odd, f(x) → −∞ as x → +∞.', partNumber: 2, partTitle: 'Polynomial & Rational Functions' },
  ...
  { id: 'pc-ent-3a', question: 'Evaluate log₂(32).', options: ['4', '5', '6', '16'], correctIndex: 1, explanation: '2⁵ = 32, so log₂(32) = 5.', partNumber: 3, partTitle: 'Exponential & Logarithmic Functions' },
  ...
  { id: 'pc-ent-4b', question: 'What is the value of sin(90°)?', options: ['0', '½', '√2/2', '1'], correctIndex: 3, explanation: 'On the unit circle, the point at 90° is (0, 1). The sine equals the y-coordinate, so sin(90°) = 1.', partNumber: 4, partTitle: 'Trigonometry Foundations' },

  // Part 5: Trigonometric Identities & Equations
  { id: 'pc-ent-5a', question: 'Which Pythagorean identity is always true?', options: ['sin²(x) − cos²(x) = 1', 'sin²(x) + cos²(x) = 1', 'tan²(x) + 1 = sin²(x)', 'cos²(x) − sin²(x) = 1'], correctIndex: 1, explanation: 'The fundamental Pythagorean identity is sin²(x) + cos²(x) = 1, derived from the unit circle definition.', partNumber: 5, partTitle: 'Trig Identities & Equations' },
