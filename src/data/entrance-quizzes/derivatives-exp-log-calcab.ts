...
const questions: EntranceQuizQuestion[] = [
  ...
  { id: 'del-ent-4a', question: 'A population grows according to $P(t) = 100e^{0.05t}$. The rate of growth at time $t$ is:', options: ['$100e^{0.05t}$', '$0.05e^{0.05t}$', '$0.05 \\cdot 100e^{0.05t}$', '$5 \\cdot 0.05e^t$'], correctIndex: 2, explanation: '$P\'(t) = 100 \\cdot 0.05 e^{0.05t} = 5e^{0.05t}$ (written unsimplified as $0.05 \\cdot 100e^{0.05t}$).', partNumber: 4, partTitle: 'Growth, Decay & Applications' },
