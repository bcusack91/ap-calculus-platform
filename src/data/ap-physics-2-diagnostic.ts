...
const AP_PHYSICS2_DOMAINS: APPhysics2Domain[] = [
  { id: 'fluids', name: 'Fluids', topicSlugs: ['fluid-statics', 'fluid-dynamics'], questionTarget: 5 },
  { id: 'thermodynamics', name: 'Thermodynamics', topicSlugs: ['thermal-energy', 'laws-of-thermodynamics'], questionTarget: 5 },
  { id: 'electric-force-field', name: 'Electric Force, Field & Potential', topicSlugs: ['coulombs-law-electric-field', 'electric-potential-energy'], questionTarget: 5 },
  { id: 'electric-circuits', name: 'Electric Circuits', topicSlugs: ['dc-circuits', 'capacitors'], questionTarget: 5 },
  ...
  { id: 'modern-physics', name: 'Quantum, Atomic & Nuclear Physics', topicSlugs: ['photoelectric-effect', 'nuclear-physics'], questionTarget: 4 },
]
...
const questionPool: PoolQuestion[] = [
  // ---- Fluids ----
  { question: 'A cube of wood floats in water with 60% of its volume submerged. The density of the wood is:', options: ['400 kg/m³', '600 kg/m³', '800 kg/m³', '1000 kg/m³'], correctAnswer: 1, explanation: 'For floating objects, ρ_object/ρ_fluid = fraction submerged. ρ = 0.60 × 1000 = 600 kg/m³.', domain: 'fluids', topicSlug: 'fluid-statics', formSet: 'A' },
  { question: 'Gauge pressure at a depth h in a fluid of density ρ is:', options: ['ρh', 'ρgh', 'ρg/h', 'P₀ + ρgh'], correctAnswer: 1, explanation: 'Gauge pressure = ρgh (pressure due to the fluid column above). Absolute pressure = P₀ + ρgh.', domain: 'fluids', topicSlug: 'fluid-statics', formSet: 'A' },
  ...
  { question: 'A hydraulic press has pistons of area 10 cm² and 100 cm². A 50 N force on the small piston produces what force on the large piston?', options: ['5 N', '50 N', '500 N', '5000 N'], correctAnswer: 2, explanation: 'By Pascal\'s principle: F₂ = F₁ × (A₂/A₁) = 50 × (100/10) = 500 N.', domain: 'fluids', topicSlug: 'fluid-statics', formSet: 'B' },

  // ---- Thermodynamics ----
  { question: 'Heat transfer by conduction is driven by:', options: ['Temperature difference between objects in contact', 'Electromagnetic waves', 'Fluid motion', 'Pressure difference'], correctAnswer: 0, explanation: 'Conduction transfers thermal energy through direct contact due to a temperature gradient.', domain: 'thermodynamics', topicSlug: 'thermal-energy', formSet: 'A' },
  ...
  { question: 'Specific heat capacity is the amount of energy required to:', options: ['Change the state of 1 kg of a substance', 'Raise the temperature of 1 kg by 1°C', 'Melt one mole of a substance', 'Double the temperature of any mass'], correctAnswer: 1, explanation: 'Specific heat c: Q = mcΔT. It is the energy per unit mass per degree of temperature change.', domain: 'thermodynamics', topicSlug: 'thermal-energy', formSet: 'B' },
  ...
  { question: 'During a phase change (e.g., melting), the temperature of a substance:', options: ['Increases rapidly', 'Decreases', 'Remains constant', 'Fluctuates'], correctAnswer: 2, explanation: 'During a phase change, added heat goes into breaking intermolecular bonds, not increasing temperature.', domain: 'thermodynamics', topicSlug: 'thermal-energy', formSet: 'both' },

  // ---- Electric Force, Field & Potential ----
  { question: 'Coulomb\'s law states that the electric force between two charges is proportional to:', options: ['The sum of the charges', 'The product of the charges divided by distance squared', 'The square of the distance', 'The difference of the charges'], correctAnswer: 1, explanation: 'F = kq₁q₂/r². Force is proportional to the product of charges and inversely proportional to distance squared.', domain: 'electric-force-field', topicSlug: 'coulombs-law-electric-field', formSet: 'A' },
  { question: 'Electric field lines point:', options: ['From negative to positive charges', 'From positive to negative charges', 'In circles around charges', 'Perpendicular to the force on a test charge'], correctAnswer: 1, explanation: 'By convention, electric field lines originate on positive charges and terminate on negative charges.', domain: 'electric-force-field', topicSlug: 'coulombs-law-electric-field', formSet: 'A' },
  { question: 'The electric potential due to a point charge q at distance r is:', options: ['kq/r²', 'kq/r', 'kq²/r', 'kqr'], correctAnswer: 1, explanation: 'V = kq/r. Potential is a scalar that falls off as 1/r (not 1/r² like the field).', domain: 'electric-force-field', topicSlug: 'electric-potential-energy', formSet: 'A' },
  { question: 'Two equal positive charges are placed 1 m apart. The electric field at the midpoint is:', options: ['Zero', 'Pointing left', 'Pointing right', 'Twice the field of one charge'], correctAnswer: 0, explanation: 'At the midpoint, the fields from each charge are equal in magnitude but opposite in direction, so they cancel.', domain: 'electric-force-field', topicSlug: 'coulombs-law-electric-field', formSet: 'B' },
  { question: 'Electric potential energy of two charges q₁ and q₂ separated by distance r is:', options: ['kq₁q₂/r²', 'kq₁q₂/r', 'kq₁q₂r', 'q₁q₂/4πε₀r²'], correctAnswer: 1, explanation: 'U = kq₁q₂/r. Potential energy (like potential) falls off as 1/r.', domain: 'electric-force-field', topicSlug: 'electric-potential-energy', formSet: 'B' },
  { question: 'Equipotential surfaces are always:', options: ['Parallel to electric field lines', 'Perpendicular to electric field lines', 'Circular', 'At the same distance from all charges'], correctAnswer: 1, explanation: 'Equipotential surfaces are perpendicular to electric field lines. No work is done moving a charge along one.', domain: 'electric-force-field', topicSlug: 'electric-potential-energy', formSet: 'B' },
  { question: 'The electric field inside a conductor in electrostatic equilibrium is:', options: ['Maximum', 'Equal to the surface field', 'Zero', 'Proportional to the charge'], correctAnswer: 2, explanation: 'In electrostatic equilibrium, free charges arrange so the internal field is zero; all excess charge resides on the surface.', domain: 'electric-force-field', topicSlug: 'coulombs-law-electric-field', formSet: 'both' },
  { question: 'If the distance between two charges is tripled, the electric force becomes:', options: ['1/3 as strong', '1/9 as strong', '3 times as strong', '9 times as strong'], correctAnswer: 1, explanation: 'F ∝ 1/r². Tripling r: F_new = F/(3²) = F/9.', domain: 'electric-force-field', topicSlug: 'coulombs-law-electric-field', formSet: 'both' },

  // ---- Electric Circuits ----
  { question: 'In a series circuit, the current through each resistor is:', options: ['Different for each', 'The same through all', 'Zero', 'Proportional to resistance'], correctAnswer: 1, explanation: 'In series, there is only one path for current, so the same current flows through every component.', domain: 'electric-circuits', topicSlug: 'dc-circuits', formSet: 'A' },
  { question: 'The equivalent resistance of two 10 Ω resistors in parallel is:', options: ['20 Ω', '10 Ω', '5 Ω', '0.2 Ω'], correctAnswer: 2, explanation: '1/R_eq = 1/10 + 1/10 = 2/10 → R_eq = 5 Ω. Parallel resistance is always less than the smallest individual resistor.', domain: 'electric-circuits', topicSlug: 'dc-circuits', formSet: 'A' },
  { question: 'The energy stored in a capacitor is:', options: ['CV', '½CV', '½CV²', 'C²V'], correctAnswer: 2, explanation: 'Energy stored = ½CV² = ½QV = Q²/(2C).', domain: 'electric-circuits', topicSlug: 'capacitors', formSet: 'A' },
  { question: 'Kirchhoff\'s junction rule is based on conservation of:', options: ['Energy', 'Charge', 'Momentum', 'Voltage'], correctAnswer: 1, explanation: 'The junction rule states that total current entering a node equals total current leaving — conservation of charge.', domain: 'electric-circuits', topicSlug: 'dc-circuits', formSet: 'B' },
  { question: 'When capacitors are connected in series, the total capacitance:', options: ['Increases', 'Decreases (less than the smallest)', 'Stays the same', 'Doubles'], correctAnswer: 1, explanation: '1/C_total = 1/C₁ + 1/C₂ + ... Series capacitance is always less than the smallest individual capacitor.', domain: 'electric-circuits', topicSlug: 'capacitors', formSet: 'B' },
  { question: 'Power dissipated by a resistor R carrying current I is:', options: ['IR', 'I²R', 'IR²', 'I/R'], correctAnswer: 1, explanation: 'P = I²R = IV = V²/R. Power is proportional to the square of the current times resistance.', domain: 'electric-circuits', topicSlug: 'dc-circuits', formSet: 'B' },
  { question: 'Ohm\'s law states:', options: ['V = IR', 'V = I/R', 'I = VR', 'R = IV'], correctAnswer: 0, explanation: 'Ohm\'s law: V = IR. Voltage across a resistor equals current times resistance.', domain: 'electric-circuits', topicSlug: 'dc-circuits', formSet: 'both' },
  { question: 'The time constant of an RC circuit is:', options: ['R/C', 'RC', 'R + C', '1/RC'], correctAnswer: 1, explanation: 'τ = RC. After one time constant, a charging capacitor reaches ~63% of its final voltage.', domain: 'electric-circuits', topicSlug: 'capacitors', formSet: 'both' },
...
const SLUG_LABELS: Record<string, string> = {
  ...
  'thermal-energy': 'Thermal Energy & Heat Transfer',
  'laws-of-thermodynamics': 'Laws of Thermodynamics',
  'coulombs-law-electric-field': 'Coulomb\'s Law & Electric Field',
