...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'If f(x) = $2x^{2}$ − 3x + 1, what is f(−1)?', options: ['6', '4', '2', '0'], correctAnswer: 0, explanation: 'f(−1) = 2(1) − 3(−1) + 1 = 2 + 3 + 1 = 6.', domain: 'functions', topicSlug: 'composite-inverse-functions', formSet: 'A' },
  { question: 'The domain of f(x) = $\\sqrt{x - 3}$ is:', options: ['x ≥ 3', 'x > 3', 'x ≤ 3', 'All real numbers'], correctAnswer: 0, explanation: 'The expression under the square root must be ≥ 0, so x − 3 ≥ 0, meaning x ≥ 3.', domain: 'functions', topicSlug: 'composite-inverse-functions', formSet: 'A' },
  { question: 'If f(x) = $x^{2}$ and g(x) = x + 3, what is (f ∘ g)(x)?', options: ['$x^{2}$ + 3', '$(x + 3)^{2}$', '$x^{2}$ + 6x + 9', 'Both B and C'], correctAnswer: 3, explanation: '(f ∘ g)(x) = f(g(x)) = f(x + 3) = $(x + 3)^{2}$ = $x^{2}$ + 6x + 9. B and C are equivalent.', domain: 'functions', topicSlug: 'composite-inverse-functions', formSet: 'A' },
  ...
  { question: 'Which function is odd? f(x) = $x^{3}$, g(x) = $x^{2}$, h(x) = |x|', options: ['f(x) only', 'g(x) only', 'h(x) only', 'All three'], correctAnswer: 0, explanation: 'A function is odd if f(−x) = −f(x). Only $x^{3}$ satisfies this: $(-x)^{3}$ = $-x^{3}$.', domain: 'functions', topicSlug: 'composite-inverse-functions', formSet: 'B' },
  ...
  { question: 'If f(x) = 3x − 1, then $f^{-1}(x)$ =', options: ['(x + 1)/3', '(x − 1)/3', '3x + 1', '1/(3x − 1)'], correctAnswer: 0, explanation: 'Set y = 3x − 1, solve for x: x = (y + 1)/3. So $f^{-1}(x)$ = (x + 1)/3.', domain: 'functions', topicSlug: 'composite-inverse-functions', formSet: 'both' },
  ...
  { question: 'What are the zeros of f(x) = $x^{3}$ − 4x?', options: ['0, 2, −2', '0, 4', '2, −2', '0, 2'], correctAnswer: 0, explanation: 'Factor: $x(x^{2} - 4)$ = x(x − 2)(x + 2). Zeros: x = 0, 2, −2.', domain: 'polynomial-rational', topicSlug: 'polynomial-division-remainder-theorem', formSet: 'A' },
  ...
  { question: 'The end behavior of f(x) = $-2x^{5}$ + $3x^{2}$ is:', options: ['Up left, down right', 'Down left, up right', 'Up both', 'Down both'], correctAnswer: 0, explanation: 'Odd degree with negative leading coefficient: as x→−∞, f→+∞; as x→+∞, f→−∞.', domain: 'polynomial-rational', topicSlug: 'polynomial-functions-end-behavior', formSet: 'B' },
  { question: 'The horizontal asymptote of f(x) = $(3x^{2} + 1)/(x^{2} - 4)$ is:', options: ['y = 0', 'y = 3', 'y = −1/4', 'No horizontal asymptote'], correctAnswer: 1, explanation: 'When degrees are equal, HA = ratio of leading coefficients = 3/1 = 3.', domain: 'polynomial-rational', topicSlug: 'rational-functions-asymptotes', formSet: 'B' },
  ...
  { question: 'Using the Remainder Theorem, the remainder when f(x) = $x^{3}$ − 2x + 1 is divided by (x − 1) is:', options: ['0', '1', '−1', '2'], correctAnswer: 0, explanation: 'f(1) = 1 − 2 + 1 = 0. The remainder equals f(c) when dividing by (x − c).', domain: 'polynomial-rational', topicSlug: 'polynomial-functions-end-behavior', formSet: 'both' },
  ...
  { question: 'Solve: $2^{x}$ = 16', options: ['x = 2', 'x = 3', 'x = 4', 'x = 8'], correctAnswer: 2, explanation: '$2^{4}$ = 16, so x = 4.', domain: 'exponential-logarithmic', topicSlug: 'solving-exponential-logarithmic-equations', formSet: 'A' },
  { question: '$\\log_{2}(32)$ =', options: ['4', '5', '6', '3'], correctAnswer: 1, explanation: '$2^{5}$ = 32, so $\\log_{2}(32)$ = 5.', domain: 'exponential-logarithmic', topicSlug: 'logarithmic-functions', formSet: 'A' },
  { question: 'The graph of f(x) = $e^{x}$ always passes through:', options: ['(0, 0)', '(0, 1)', '(1, 0)', '(1, e)'], correctAnswer: 1, explanation: 'For any exponential $b^{x}$, when x = 0, f(0) = $b^{0}$ = 1. So it passes through (0, 1).', domain: 'exponential-logarithmic', topicSlug: 'exponential-functions-growth-decay', formSet: 'A' },
  { question: '$\\ln (e^{5})$ =', options: ['$e^{5}$', '5', '5e', '1/5'], correctAnswer: 1, explanation: 'ln and e are inverse functions: $\\ln (e^{x})$ = x. So $\\ln (e^{5})$ = 5.', domain: 'exponential-logarithmic', topicSlug: 'logarithmic-functions', formSet: 'B' },
  { question: 'The half-life formula A = $A_{0}(\\tfrac{1}{2} )^{t/h}$ models:', options: ['Linear decay', 'Exponential decay', 'Exponential growth', 'Quadratic decay'], correctAnswer: 1, explanation: 'The half-life formula is an exponential decay model where the quantity halves every h time units.', domain: 'exponential-logarithmic', topicSlug: 'exponential-functions-growth-decay', formSet: 'B' },
  { question: 'Solve: log(x) + log(x − 3) = 1', options: ['x = 5', 'x = −2', 'x = 5 or x = −2', 'x = 10'], correctAnswer: 0, explanation: 'log(x(x−3)) = 1 → $x^{2}$ − 3x = 10 → $x^{2}$ − 3x − 10 = 0 → (x−5)(x+2) = 0. Since x must be > 3, x = 5.', domain: 'exponential-logarithmic', topicSlug: 'solving-exponential-logarithmic-equations', formSet: 'B' },
  ...
  { question: 'sin(π/6) =', options: ['1/2', '$\\sqrt{2}/2$', '$\\sqrt{3}/2$', '1'], correctAnswer: 0, explanation: 'On the unit circle, sin(30°) = sin(π/6) = 1/2.', domain: 'trigonometry', topicSlug: 'the-unit-circle', formSet: 'A' },
  ...
  { question: 'tan(π/4) =', options: ['0', '1', '$\\sqrt{3}$', 'undefined'], correctAnswer: 1, explanation: 'tan(45°) = sin(45°)/cos(45°) = $(\\sqrt{2}/2)/(\\sqrt{2}/2)$ = 1.', domain: 'trigonometry', topicSlug: 'the-unit-circle', formSet: 'A' },
  { question: 'Which identity is correct?', options: ['$\\sin^{2}\\theta$ + $\\cos^{2}\\theta$ = 1', '$\\sin^{2}\\theta$ − $\\cos^{2}\\theta$ = 1', 'sinθ + cosθ = 1', '$\\tan^{2}\\theta$ + 1 = $\\sec^{2}\\theta$'], correctAnswer: 0, explanation: 'The Pythagorean identity $\\sin^{2}\\theta$ + $\\cos^{2}\\theta$ = 1 is fundamental. (Note: $\\tan^{2}\\theta$ + 1 = $\\sec^{2}\\theta$ is also correct, but $\\sin^{2}\\theta$ + $\\cos^{2}\\theta$ = 1 is the foundational identity.)', domain: 'trigonometry', topicSlug: 'trigonometric-identities', formSet: 'B' },
  { question: 'cos(2π/3) =', options: ['1/2', '−1/2', '$\\sqrt{3}/2$', '$-\\sqrt{3}/2$'], correctAnswer: 1, explanation: '2π/3 is in quadrant II where cosine is negative. cos(2π/3) = −cos(π/3) = −1/2.', domain: 'trigonometry', topicSlug: 'the-unit-circle', formSet: 'B' },
  ...
  { question: 'The Law of Sines states:', options: ['a/sin A = b/sin B = c/sin C', '$a^{2}$ = $b^{2}$ + $c^{2}$ − 2bc·cos A', 'sin(A+B) = sinA·cosB + cosA·sinB', 'tan A = sin A / cos A'], correctAnswer: 0, explanation: 'The Law of Sines relates sides to the sines of their opposite angles.', domain: 'analytic-trig', topicSlug: 'law-of-sines-cosines', formSet: 'A' },
  ...
  { question: 'In triangle ABC, if a = 8, b = 5, and C = 60°, find c using the Law of Cosines:', options: ['$\\sqrt{89}$ ≈ 9.43', '$\\sqrt{129}$ ≈ 11.36', '$\\sqrt{19.7}$ ≈ 4.44', '$c^{2}$ = 64 + 25 − 2(8)(5)cos60° = 49, so c = 7'], correctAnswer: 3, explanation: '$c^{2}$ = $a^{2}$ + $b^{2}$ − 2ab·cosC = 64 + 25 − 80(0.5) = 89 − 40 = 49. c = 7.', domain: 'analytic-trig', topicSlug: 'law-of-sines-cosines', formSet: 'A' },
  ...
  { question: 'Using the double angle formula, sin(2θ) =', options: ['2sinθ', '2sinθcosθ', '$\\sin^{2}\\theta$ − $\\cos^{2}\\theta$', '$2\\cos^{2}\\theta$ − 1'], correctAnswer: 1, explanation: 'The double angle formula: sin(2θ) = 2sinθcosθ.', domain: 'analytic-trig', topicSlug: 'inverse-trig-functions', formSet: 'B' },
  { question: 'The Law of Cosines reduces to the Pythagorean theorem when:', options: ['A = 90°', 'a = b', 'C = 0°', 'All sides are equal'], correctAnswer: 0, explanation: 'When A = 90°, cos(90°) = 0, so $c^{2}$ = $a^{2}$ + $b^{2}$ − 0 = $a^{2}$ + $b^{2}$.', domain: 'analytic-trig', topicSlug: 'law-of-sines-cosines', formSet: 'B' },
  ...
  { question: 'The 10th term of the arithmetic sequence 3, 7, 11, 15, … is:', options: ['39', '43', '37', '41'], correctAnswer: 0, explanation: '$a_{10}$ = $a_{1}$ + (n−1)d = 3 + 9(4) = 3 + 36 = 39.', domain: 'sequences-series', topicSlug: 'sequences-arithmetic-geometric', formSet: 'A' },
  { question: 'The sum of the first 5 terms of the geometric series 2, 6, 18, 54, … is:', options: ['242', '162', '486', '122'], correctAnswer: 0, explanation: '$S_{5}$ = $a_{1}(r^{5} - 1)/(r - 1)$ = 2(243 − 1)/2 = 242.', domain: 'sequences-series', topicSlug: 'sequences-arithmetic-geometric', formSet: 'A' },
  { question: 'Convert the polar point (4, π/3) to rectangular coordinates:', options: ['(2, $2\\sqrt{3}$)', '($2\\sqrt{3}$, 2)', '(4, 4)', '(−2, $2\\sqrt{3}$)'], correctAnswer: 0, explanation: 'x = r·cosθ = 4·cos(π/3) = 4(1/2) = 2. y = r·sinθ = 4·sin(π/3) = $4(\\sqrt{3}/2)$ = $2\\sqrt{3}$.', domain: 'sequences-series', topicSlug: 'polar-coordinates', formSet: 'A' },
  ...
  { question: 'The recursive formula $a_{n}$ = $a_{n-1}$ + 5 with $a_{1}$ = 2 defines:', options: ['Geometric sequence', 'Arithmetic sequence with d = 5', 'Fibonacci sequence', 'Harmonic sequence'], correctAnswer: 1, explanation: 'Adding a constant difference (5) each time creates an arithmetic sequence.', domain: 'sequences-series', topicSlug: 'sequences-arithmetic-geometric', formSet: 'B' },
  ...
  { question: 'The sum formula for an arithmetic series is:', options: ['S = n/2 · $(a_{1} + a_{n})$', 'S = $a_{1}(1 - r^{n})/(1 - r)$', 'S = n · $a_{1}$', 'S = $a_{1}$ · $r^{n}$'], correctAnswer: 0, explanation: 'For an arithmetic series, S = n/2 · (first + last) = n/2 · $(a_{1} + a_{n})$.', domain: 'sequences-series', topicSlug: 'sequences-arithmetic-geometric', formSet: 'both' },
]
