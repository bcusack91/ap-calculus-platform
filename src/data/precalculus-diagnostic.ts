...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'In triangle ABC, if a = 8, b = 5, and C = 60°, find c using the Law of Cosines:', options: ['√49 = 7', '√89 − 40 = 7', '√49 = 7', 'c² = 64 + 25 − 2(8)(5)cos60° = 49, so c = 7'], correctAnswer: 3, explanation: 'c² = a² + b² − 2ab·cosC = 64 + 25 − 80(0.5) = 89 − 40 = 49. c = 7.', domain: 'analytic-trig', topicSlug: 'law-of-sines-cosines', formSet: 'A' },
