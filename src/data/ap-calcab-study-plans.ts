...
const sprint: StudyPlanTemplate = {
  ...
  tasks: [
    ...
    ...weekTasks(2, [
      ...
      { title: 'FTC & U-Substitution', type: 'LESSON', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 1 },
...
const standard: StudyPlanTemplate = {
  ...
  tasks: [
    ...
    ...weekTasks(3, [
      ...
      { title: 'Implicit Differentiation', type: 'LESSON', topicSlug: 'implicit-differentiation-calcab', dayOfWeek: 2 },
    ...
    ...weekTasks(4, [
      ...
      { title: 'Mean Value Theorem', type: 'LESSON', topicSlug: 'mean-value-theorem-calcab', dayOfWeek: 1 },
    ...
    ...weekTasks(5, [
      ...
      { title: 'Linear Approximation', type: 'LESSON', topicSlug: 'linearization-calcab', dayOfWeek: 2 },
    ...
    ...weekTasks(7, [
      { title: 'Fundamental Theorem of Calculus', type: 'LESSON', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 0 },
      { title: 'U-Substitution', type: 'LESSON', topicSlug: 'u-substitution-calcab', dayOfWeek: 2 },
      { title: 'FTC & Substitution Practice', type: 'PRACTICE', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 4 },
      { title: 'Integration Flashcards', type: 'FLASHCARD', dayOfWeek: 5 },
    ]),
    ...weekTasks(8, [
...
const comprehensive: StudyPlanTemplate = {
  ...
  tasks: [
    ...
    ...weekTasks(4, [
      ...
      { title: 'Derivatives of Trig Functions', type: 'LESSON', topicSlug: 'derivatives-trig-functions-calcab', dayOfWeek: 2 },
    ...
    ...weekTasks(6, [
      { title: 'Related Rates', type: 'LESSON', topicSlug: 'related-rates-calcab', dayOfWeek: 0 },
      { title: 'Related Rates Practice', type: 'PRACTICE', topicSlug: 'related-rates-calcab', dayOfWeek: 2 },
      { title: 'Derivatives of Inverse Functions', type: 'LESSON', topicSlug: 'derivatives-inverse-functions-calcab', dayOfWeek: 4 },
      { title: 'Related Rates Quiz', type: 'QUIZ', topicSlug: 'related-rates-calcab', dayOfWeek: 5 },
    ]),
    ...weekTasks(7, [
      { title: 'Mean Value Theorem', type: 'LESSON', topicSlug: 'mean-value-theorem-calcab', dayOfWeek: 0 },
      ...
      { title: 'MVT & Extrema Practice', type: 'PRACTICE', topicSlug: 'mean-value-theorem-calcab', dayOfWeek: 5 },
    ]),
    ...weekTasks(8, [
    ...
    ...weekTasks(9, [
      ...
      { title: 'Linearization & Differentials', type: 'LESSON', topicSlug: 'linearization-calcab', dayOfWeek: 2 },
      { title: 'L\'Hôpital\'s Rule', type: 'LESSON', topicSlug: 'lhopitals-rule-calcab', dayOfWeek: 4 },
      { title: 'Derivatives Comprehensive Quiz', type: 'QUIZ', dayOfWeek: 5 },
    ]),
    ...weekTasks(10, [
      { title: 'Antiderivatives & Basic Integration', type: 'LESSON', topicSlug: 'antiderivatives-calcab', dayOfWeek: 0 },
    ...
    ...weekTasks(11, [
      { title: 'FTC Part 1', type: 'LESSON', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 0 },
      { title: 'FTC Part 2', type: 'LESSON', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 2 },
      { title: 'FTC Practice', type: 'PRACTICE', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 4 },
      { title: 'FTC Quiz', type: 'QUIZ', topicSlug: 'fundamental-theorem-calculus-calcab', dayOfWeek: 5 },
    ]),
    ...weekTasks(12, [
