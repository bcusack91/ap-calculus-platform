...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'Which is greater: 3/7 or 0.4?', options: ['0.4', '3/7', 'They are equal', 'Cannot determine'], correctAnswer: 0, explanation: '3/7 ≈ 0.4286 vs 0.4. Wait — 3/7 > 0.4. Let me reconsider: 3/7 ≈ 0.4286, which is greater than 0.4.', domain: 'number-system', topicSlug: 'comparing-real-numbers', formSet: 'A' },
  ...
  { question: 'Order from least to greatest: √10, 3.2, π', options: ['π, √10, 3.2', '3.2, π, √10', '√10, π, 3.2', '3.2, √10, π'], correctAnswer: 1, explanation: 'π ≈ 3.14, √10 ≈ 3.16, 3.2. So: 3.14 < 3.16 < 3.2 → π, √10, 3.2. Wait, option index 1 is "3.2, π, √10" which would be wrong. Let me re-read: ordered least to greatest: π < √10 < 3.2, which matches option 0.', domain: 'number-system', topicSlug: 'comparing-real-numbers', formSet: 'B' },
