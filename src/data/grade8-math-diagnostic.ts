...
const questionPool: PoolQuestion[] = [
  // ---- The Number System ----
  { question: 'Which of the following is an irrational number?', options: ['√2', '3/4', '0.5', '−7'], correctAnswer: 0, explanation: '√2 cannot be expressed as a fraction — it is irrational.', domain: 'number-system', topicSlug: 'rational-irrational-numbers-grade8', formSet: 'A' },
  { question: 'Between which two integers does √50 lie?', options: ['7 and 8', '6 and 7', '8 and 9', '5 and 6'], correctAnswer: 0, explanation: '7² = 49 and 8² = 64. Since 49 < 50 < 64, √50 is between 7 and 8.', domain: 'number-system', topicSlug: 'radicals-integer-exponents-grade8', formSet: 'A' },
  ...
  { question: 'Which number is rational?', options: ['0.333... (repeating)', '√3', 'π', '√7'], correctAnswer: 0, explanation: '0.333... = 1/3, which is a ratio of integers — rational.', domain: 'number-system', topicSlug: 'rational-irrational-numbers-grade8', formSet: 'B' },
  { question: 'Approximate √20 to the nearest tenth.', options: ['4.5', '4.0', '5.0', '4.2'], correctAnswer: 0, explanation: '4.4² = 19.36, 4.5² = 20.25. √20 ≈ 4.47, rounds to 4.5.', domain: 'number-system', topicSlug: 'radicals-integer-exponents-grade8', formSet: 'B' },
  { question: 'Order from least to greatest: √10, 3.2, π', options: ['π, √10, 3.2', '3.2, π, √10', '√10, π, 3.2', '3.2, √10, π'], correctAnswer: 0, explanation: 'π ≈ 3.14, √10 ≈ 3.16, 3.2. Ordered least to greatest: π < √10 < 3.2.', domain: 'number-system', topicSlug: 'rational-irrational-numbers-grade8', formSet: 'B' },
  ...
  { question: 'Which is NOT a real number?', options: ['√(−4)', '−√4', '0', 'π'], correctAnswer: 0, explanation: '√(−4) is not a real number (it is imaginary: 2i).', domain: 'number-system', topicSlug: 'rational-irrational-numbers-grade8', formSet: 'both' },
