...
const QUESTION_POOL: Question[] = [
  ...
  { section: 'Math', question: 'What is the slope of the line passing through (2, 3) and (6, 11)?', options: ['1', '2', '3', '4'], correctAnswer: 1, explanation: 'Slope = (y₂ − y₁)/(x₂ − x₁) = (11 − 3)/(6 − 2) = 8/4 = 2.' },
  { section: 'Math', question: 'A circle has a radius of 5. What is its area?', options: ['10π', '25π', '50π', '5π'], correctAnswer: 1, explanation: 'Area = πr² = π(5)² = 25π.' },
  { section: 'Math', question: 'If f(x) = 2x² − 3x + 1, what is f(2)?', options: ['3', '4', '5', '7'], correctAnswer: 0, explanation: 'f(2) = 2(4) − 3(2) + 1 = 8 − 6 + 1 = 3.' },
  { section: 'Math', question: 'What is the value of |−7| + |3|?', options: ['4', '10', '−4', '−10'], correctAnswer: 1, explanation: '|−7| = 7 and |3| = 3, so 7 + 3 = 10.' },
  { section: 'Math', question: 'A triangle has sides of length 3, 4, and 5. What type of triangle is it?', options: ['Equilateral', 'Isosceles', 'Right', 'Obtuse'], correctAnswer: 2, explanation: '3² + 4² = 9 + 16 = 25 = 5². Since it satisfies the Pythagorean theorem, it is a right triangle.' },
  { section: 'Math', question: 'What is 30% of 250?', options: ['50', '75', '80', '100'], correctAnswer: 1, explanation: '30% × 250 = 0.30 × 250 = 75.' },
  { section: 'Math', question: 'If log₂(x) = 5, what is x?', options: ['10', '25', '32', '64'], correctAnswer: 2, explanation: 'log₂(x) = 5 means 2⁵ = x, so x = 32.' },
  // Reading
  ...
  { section: 'Science', question: 'How many molecules of CO₂ are produced when one molecule of glucose (C₆H₁₂O₆) undergoes complete combustion?', options: ['1', '3', '6', '12'], correctAnswer: 2, explanation: 'C₆H₁₂O₆ + 6O₂ → 6CO₂ + 6H₂O. Complete combustion of one glucose molecule produces 6 molecules of CO₂.' },
