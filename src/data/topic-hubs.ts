...
export type TopicHub = {
  ...
  links: TopicHubLink[]
  /**
   * Category.slug values this unit covers. A hub groups by the AP unit a
   * student is actually taught, which can span several categories (AP Bio
   * Unit 5 is Heredity plus Gene Expression), and the page lists their
   * topics so it says something beyond a list of links.
   */
...
export const topicHubs: TopicHub[] = [
  {
    ...
    exam: 'AP Calculus',
    categorySlugs: ['calcab-limits-continuity'],
    links: [
      { label: 'Start AP Calc AB Diagnostic', href: '/calcab-diagnostic', type: 'diagnostic' },
  ...
  },
  {
    ...
    exam: 'AP Calculus',
    categorySlugs: ['derivatives', 'calcab-differentiation-fundamentals'],
    links: [
  ...
  },
  {
    ...
    exam: 'AP Calculus',
    categorySlugs: ['calcbc-sequences-series', 'calcbc-power-taylor', 'sequences-series', 'power-taylor-series'],
    links: [
      { label: 'Start AP Calc BC Diagnostic', href: '/calcbc-diagnostic', type: 'diagnostic' },
  ...
  },
  {
    ...
    exam: 'SAT',
    categorySlugs: ['sat-english-conventions'],
    links: [
  ...
  },
  {
    ...
    exam: 'SAT',
    categorySlugs: ['sat-reading-info-ideas', 'sat-craft-structure', 'sat-expression-ideas'],
    links: [
  ...
  },
  {
    ...
    exam: 'SAT',
    categorySlugs: ['sat-passport-advanced-math'],
    links: [
  ...
  },
  {
    ...
    exam: 'AP Biology',
    categorySlugs: ['biology-cell-structure', 'biology-cellular-energetics'],
    links: [
  ...
  },
  {
    ...
    exam: 'AP Biology',
    categorySlugs: ['biology-heredity', 'biology-gene-expression'],
    links: [
  ...
  },
  {
    ...
    exam: 'AP Biology',
    categorySlugs: ['biology-evolution'],
    links: [
