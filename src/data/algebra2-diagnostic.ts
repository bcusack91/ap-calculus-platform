...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'What is the vertex of y = (x − 3)² + 5?', options: ['(3, 5)', '(−3, 5)', '(3, −5)', '(−3, −5)'], correctAnswer: 0, explanation: 'In vertex form y = a(x − h)² + k, the vertex is (h, k) = (3, 5).', domain: 'quadratics', topicSlug: 'graphing-quadratics-algebra1', formSet: 'A' },
  { question: 'Solve: x² − 6x + 8 = 0', options: ['x = 2, 4', 'x = −2, −4', 'x = 3, 8', 'x = 1, 8'], correctAnswer: 0, explanation: 'Factor: (x − 2)(x − 4) = 0 → x = 2 or x = 4.', domain: 'quadratics', topicSlug: 'solving-quadratics-algebra1', formSet: 'A' },
  ...
  { question: 'The discriminant of 2x² + 3x + 5 = 0 is:', options: ['−31', '31', '49', '−49'], correctAnswer: 0, explanation: 'D = b² − 4ac = 9 − 40 = −31. Negative means no real solutions.', domain: 'quadratics', topicSlug: 'solving-quadratics-algebra1', formSet: 'B' },
  { question: 'A parabola opens downward when:', options: ['a < 0', 'a > 0', 'b < 0', 'c < 0'], correctAnswer: 0, explanation: 'In y = ax² + bx + c, if a < 0 the parabola opens downward.', domain: 'quadratics', topicSlug: 'graphing-quadratics-algebra1', formSet: 'B' },
  { question: 'Solve using the quadratic formula: x² + 2x − 15 = 0', options: ['x = 3, −5', 'x = −3, 5', 'x = 5, −3', 'x = 15, −1'], correctAnswer: 0, explanation: 'x = (−2 ± √(4 + 60))/2 = (−2 ± 8)/2. So x = 3 or x = −5.', domain: 'quadratics', topicSlug: 'solving-quadratics-algebra1', formSet: 'B' },
  { question: 'The axis of symmetry of y = x² − 8x + 12 is:', options: ['x = 4', 'x = −4', 'x = 8', 'x = 6'], correctAnswer: 0, explanation: 'Axis of symmetry x = −b/(2a) = 8/2 = 4.', domain: 'quadratics', topicSlug: 'graphing-quadratics-algebra1', formSet: 'both' },
  ...
  { question: 'If f(x) = x⁴ − 5x² + 4, find all zeros:', options: ['±1, ±2', '1, 2, 3, 4', '0, ±1, ±2', '±1, ±4'], correctAnswer: 0, explanation: 'Let u = x²: u² − 5u + 4 = (u − 1)(u − 4) = 0. u = 1 → x = ±1; u = 4 → x = ±2.', domain: 'polynomials', topicSlug: 'polynomial-theorems-algebra2', formSet: 'B' },
  ...
  { question: 'The end behavior of f(x) = 2x⁴ − x³ + 1 is:', options: ['Both ends up', 'Both ends down', 'Left down, right up', 'Left up, right down'], correctAnswer: 0, explanation: 'Even degree with positive leading coefficient → both ends point up.', domain: 'polynomials', topicSlug: 'polynomial-theorems-algebra2', formSet: 'both' },
  ...
  { question: 'Simplify: (x² − 9)/(x + 3)', options: ['x − 3', 'x + 3', 'x² − 3', '(x − 3)/(x + 3)'], correctAnswer: 0, explanation: '(x² − 9)/(x + 3) = (x + 3)(x − 3)/(x + 3) = x − 3, where x ≠ −3.', domain: 'rational-expressions', topicSlug: 'simplifying-rationals-algebra2', formSet: 'A' },
  ...
  { question: 'The domain of f(x) = 1/(x² − 4) excludes:', options: ['x = ±2', 'x = 4', 'x = 0', 'x = ±4'], correctAnswer: 0, explanation: 'x² − 4 = 0 → x = ±2. Undefined at x = 2 and x = −2.', domain: 'rational-expressions', topicSlug: 'simplifying-rationals-algebra2', formSet: 'A' },
  ...
  { question: 'Add: 2/(x+1) + 3/(x−1)', options: ['(5x − 1)/((x+1)(x−1))', '5/(2x)', '(5x+1)/((x+1)(x−1))', '5/(x²−1)'], correctAnswer: 2, explanation: 'LCD = (x+1)(x−1). 2(x−1) + 3(x+1) = 2x − 2 + 3x + 3 = 5x + 1. So the answer is (5x+1)/((x+1)(x−1)).', domain: 'rational-expressions', topicSlug: 'simplifying-rationals-algebra2', formSet: 'B' },
  { question: 'A vertical asymptote of f(x) = (x+1)/(x²−1) is at:', options: ['x = 1 only (hole at x = −1)', 'x = ±1', 'x = −1 only', 'No vertical asymptote'], correctAnswer: 0, explanation: 'x²−1 = (x+1)(x−1). Since (x+1) cancels, there\'s a hole at x = −1 and VA at x = 1.', domain: 'rational-expressions', topicSlug: 'simplifying-rationals-algebra2', formSet: 'both' },
  ...
  { question: 'Solve: 3ˣ = 81', options: ['x = 4', 'x = 3', 'x = 27', 'x = 5'], correctAnswer: 0, explanation: '3⁴ = 81, so x = 4.', domain: 'exponential-log', topicSlug: 'exponential-functions-algebra2', formSet: 'A' },
  { question: 'log₃(27) =', options: ['3', '9', '27', '1/3'], correctAnswer: 0, explanation: '3³ = 27, so log₃(27) = 3.', domain: 'exponential-log', topicSlug: 'logarithms-properties-alg2', formSet: 'A' },
  { question: 'Solve: log(x) = 3', options: ['x = 1000', 'x = 3', 'x = 30', 'x = 10³'], correctAnswer: 0, explanation: 'log base 10: 10³ = 1000. (Both A and D are correct; A is the simplified form.)', domain: 'exponential-log', topicSlug: 'logarithmic-equations-algebra2', formSet: 'A' },
  ...
  { question: 'Expand: log(x²y/z)', options: ['2log(x) + log(y) − log(z)', 'log(2x) + log(y) − log(z)', '2log(xy) − log(z)', 'log(x²) + log(y/z)'], correctAnswer: 0, explanation: 'log(x²y/z) = log(x²) + log(y) − log(z) = 2log(x) + log(y) − log(z).', domain: 'exponential-log', topicSlug: 'logarithms-properties-alg2', formSet: 'B' },
  { question: 'Solve: 2^(x+1) = 32', options: ['x = 4', 'x = 5', 'x = 3', 'x = 16'], correctAnswer: 0, explanation: '32 = 2⁵, so x + 1 = 5 → x = 4.', domain: 'exponential-log', topicSlug: 'logarithmic-equations-algebra2', formSet: 'B' },
  ...
  { question: 'log(1) =', options: ['0', '1', '10', 'Undefined'], correctAnswer: 0, explanation: 'Any log base b of 1 equals 0, because b⁰ = 1.', domain: 'exponential-log', topicSlug: 'logarithms-properties-alg2', formSet: 'both' },

  // ---- Radical Functions & Complex Numbers ----
  { question: 'Simplify: √(x²) for all real x', options: ['|x|', 'x', '−x', 'x²'], correctAnswer: 0, explanation: '√(x²) = |x| because the square root returns the non-negative value.', domain: 'radical-functions', topicSlug: 'radical-equations-algebra2', formSet: 'A' },
  { question: 'Simplify: i² =', options: ['−1', '1', 'i', '−i'], correctAnswer: 0, explanation: 'By definition, i = √(−1), so i² = −1.', domain: 'radical-functions', topicSlug: 'complex-numbers-intro-algebra2', formSet: 'A' },
  { question: 'Rewrite x^(2/3) in radical form:', options: ['∛(x²)', '√(x³)', '(∛x)³', 'x²/3'], correctAnswer: 0, explanation: 'x^(a/b) = ᵇ√(xᵃ). So x^(2/3) = ∛(x²).', domain: 'radical-functions', topicSlug: 'rational-exponents-algebra2', formSet: 'A' },
  { question: '(3 + 2i)(3 − 2i) =', options: ['13', '9 − 4i', '5', '9 + 4i²'], correctAnswer: 0, explanation: 'Conjugate product: (a + bi)(a − bi) = a² + b² = 9 + 4 = 13.', domain: 'radical-functions', topicSlug: 'complex-numbers-intro-algebra2', formSet: 'B' },
  { question: 'Solve: √(2x + 3) = 5', options: ['x = 11', 'x = 1', 'x = 14', 'x = 4'], correctAnswer: 0, explanation: 'Square both sides: 2x + 3 = 25 → 2x = 22 → x = 11. Check: √(25) = 5 ✓.', domain: 'radical-functions', topicSlug: 'radical-equations-algebra2', formSet: 'B' },
  ...
  { question: 'Find the 8th term of the arithmetic sequence: 5, 9, 13, 17, …', options: ['33', '37', '29', '41'], correctAnswer: 0, explanation: 'a₈ = a₁ + (n−1)d = 5 + 7(4) = 5 + 28 = 33.', domain: 'sequences-probability', topicSlug: 'geometric-sequences-algebra2', formSet: 'A' },
  { question: 'The coefficient of x² in (x + 2)⁴ is:', options: ['24', '6', '12', '8'], correctAnswer: 0, explanation: 'C(4,2)·x²·2² = 6·4 = 24.', domain: 'sequences-probability', topicSlug: 'series-summation-algebra2', formSet: 'A' },
  ...
  { question: 'Find the sum: Σ(k=1 to 4) of 3·2^(k-1)', options: ['45', '24', '48', '30'], correctAnswer: 0, explanation: '3(1) + 3(2) + 3(4) + 3(8) = 3 + 6 + 12 + 24 = 45.', domain: 'sequences-probability', topicSlug: 'geometric-sequences-algebra2', formSet: 'B' },
  { question: 'In the expansion of (a + b)⁶, how many terms are there?', options: ['7', '6', '12', '5'], correctAnswer: 0, explanation: '(a + b)ⁿ has n + 1 terms. So (a + b)⁶ has 7 terms.', domain: 'sequences-probability', topicSlug: 'series-summation-algebra2', formSet: 'B' },
