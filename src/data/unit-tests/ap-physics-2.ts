...
export const AP_PHYSICS2_UNITS: UnitDef[] = [
  { id: 'waves-sound', unitNumber: 1, name: 'Unit 1: Waves, Sound & Physical Optics', shortName: 'Waves & Sound', description: 'Wave properties, sound, standing waves, interference, and diffraction (moved into Physics 2 in the 2024-25 CED).', topicSlugs: ['wave-properties', 'sound-waves', 'standing-waves', 'physical-optics'], exam_weight: '10-15%', color: 'from-cyan-500 to-blue-500', icon: '🌊' },
