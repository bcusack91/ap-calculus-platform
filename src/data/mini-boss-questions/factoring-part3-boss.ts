...
export const simpleTrinomialQuestions: MiniBossQuestion[] = [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'D', value: '(x + 2)(x - 3)', isCorrect: false, explanation: 'This gives $x^{2}$ - x - 6' }
    ]
  },
  {
    id: 'simple-tri-3',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'D', value: '(x + 3)(x - 5)', isCorrect: false, explanation: 'This gives $x^{2}$ - 2x - 15' }
    ]
  },
  {
    id: 'simple-tri-5',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '(x + 6)(x - 3)', isCorrect: false, explanation: 'This gives $x^{2}$ + 3x - 18' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'D', value: '(x + 2)(x - 5)', isCorrect: false, explanation: 'This gives $x^{2}$ - 3x - 10' }
    ]
  },
  {
    id: 'simple-tri-9',
    ...
    options: [
      ...
      { label: 'B', value: '(x - 7)(x + 3)', isCorrect: false, explanation: 'This gives $x^{2}$ - 4x - 21' },
      { label: 'C', value: '(x + 21)(x - 1)', isCorrect: false, explanation: '21 + (-1) = 20, not 4' },
      { label: 'D', value: '(x - 21)(x + 1)', isCorrect: false, explanation: 'This gives $x^{2}$ - 20x - 21' }
    ]
  },
  {
    id: 'simple-tri-10',
    ...
    options: [
      ...
      { label: 'D', value: '(x + 2)(x - 4)', isCorrect: false, explanation: 'This gives $x^{2}$ - 2x - 8' }
    ]
  }
]
