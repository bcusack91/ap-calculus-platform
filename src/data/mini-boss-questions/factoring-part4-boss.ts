...
export const complexTrinomialQuestions: MiniBossQuestion[] = [
  {
    ...
    options: [
      ...
      { label: 'B', value: '(2x + 3)(x + 1)', isCorrect: false, explanation: 'This gives $2x^{2}$ + 5x + 3' },
      { label: 'C', value: '(x + 1)(x + 3)', isCorrect: false, explanation: 'Forgot the leading coefficient of 2' },
      { label: 'D', value: '2(x + 1)(x + 3)', isCorrect: false, explanation: 'This gives $2x^{2}$ + 8x + 6' }
    ]
  },
  {
    id: 'complex-tri-2',
    ...
    options: [
      ...
      { label: 'B', value: '(3x - 2)(x - 4)', isCorrect: false, explanation: 'This gives $3x^{2}$ - 14x + 8' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '(2x + 3)(x - 4)', isCorrect: false, explanation: 'This gives $2x^{2}$ - 5x - 12' },
      { label: 'C', value: '(2x + 4)(x - 3)', isCorrect: false, explanation: 'This gives $2x^{2}$ - 2x - 12' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '(5x - 2)(x + 3)', isCorrect: false, explanation: 'This gives $5x^{2}$ + 13x - 6' },
      { label: 'C', value: '(5x - 3)(x + 2)', isCorrect: false, explanation: 'This gives $5x^{2}$ + 7x - 6' },
      { label: 'D', value: '(5x + 6)(x - 1)', isCorrect: false, explanation: 'This gives $5x^{2}$ + x - 6' }
    ]
  },
  {
    id: 'complex-tri-6',
    ...
    options: [
      ...
      { label: 'B', value: '(4x + 1)(x + 3)', isCorrect: false, explanation: 'This gives $4x^{2}$ + 13x + 3' },
      { label: 'C', value: '(4x + 3)(x + 1)', isCorrect: false, explanation: 'This gives $4x^{2}$ + 7x + 3' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '(2x + 3)(3x - 1)', isCorrect: false, explanation: 'This gives $6x^{2}$ + 7x - 3' },
      { label: 'C', value: '(6x - 3)(x + 1)', isCorrect: false, explanation: '6x - 3 has GCF of 3 - not fully factored' },
      { label: 'D', value: '(6x + 1)(x - 3)', isCorrect: false, explanation: 'This gives $6x^{2}$ - 17x - 3' }
    ]
  },
  {
    id: 'complex-tri-8',
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '(2x + 5)(2x - 3)', isCorrect: false, explanation: 'This gives $4x^{2}$ + 4x - 15' },
      { label: 'C', value: '(4x - 5)(x + 3)', isCorrect: false, explanation: 'This gives $4x^{2}$ + 7x - 15' },
      { label: 'D', value: '(4x + 3)(x - 5)', isCorrect: false, explanation: 'This gives $4x^{2}$ - 17x - 15' }
    ]
  }
]
