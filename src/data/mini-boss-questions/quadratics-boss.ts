...
export const quadraticsBossQuestions: MiniBossQuestion[] = [
  {
    id: 'quad-1',
    type: 'vertex-form',
    question: 'What is the vertex of y = $2(x - 3)^{2}$ + 5?',
    correctAnswer: '(3, 5)',
    options: [
      { label: 'A', value: '(3, 5)', isCorrect: true },
      { label: 'B', value: '(-3, 5)', isCorrect: false, explanation: 'y = $a(x - h)^{2}$ + k has vertex (h, k). Since it\'s (x - 3), h = 3' },
      { label: 'C', value: '(3, -5)', isCorrect: false, explanation: 'k = 5, the constant added at the end' },
      { label: 'D', value: '(2, 3)', isCorrect: false, explanation: 'Vertex form y = $a(x-h)^{2}+k$: vertex is (h, k) = (3, 5)' },
    ],
  },
  {
    id: 'quad-2',
    ...
    options: [
      ...
      { label: 'B', value: 'One real solution', isCorrect: false, explanation: '$b^{2}$ - 4ac = 16 - 20 = -4 < 0, so no real solutions' },
      { label: 'C', value: 'Two real solutions', isCorrect: false, explanation: 'Discriminant = $4^{2}$ - 4(1)(5) = -4 < 0' },
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: 'x = -3 or x = 1/2', isCorrect: false, explanation: 'x = $(5 \\pm \\sqrt{25+24})/4$ = (5±7)/4 → 12/4=3 or -2/4=-1/2' },
  ...
  },
  {
    ...
    question: 'Complete the square: $x^{2}$ + 6x + 2 = 0',
    correctAnswer: '$(x + 3)^{2}$ = 7',
    options: [
      { label: 'A', value: '$(x + 3)^{2}$ = 7', isCorrect: true },
      { label: 'B', value: '$(x + 6)^{2}$ = 34', isCorrect: false, explanation: 'Half of 6 is 3, so $(x + 3)^{2}$. Move 2: $(x+3)^{2}$ - 9 + 2 = 0, $(x+3)^{2}$ = 7' },
      { label: 'C', value: '$(x + 3)^{2}$ = 11', isCorrect: false, explanation: '$(x+3)^{2}$ = $x^{2}+6x+9$. So $x^{2}+6x+2$ = $(x+3)^{2}-9+2$ = $(x+3)^{2}-7$=0' },
      { label: 'D', value: '$(x - 3)^{2}$ = 7', isCorrect: false, explanation: 'Since b = +6, half is +3, so $(x + 3)^{2}$' },
    ],
  },
  {
    id: 'quad-5',
    type: 'standard-to-vertex',
    question: 'Convert y = $x^{2}$ - 8x + 12 to vertex form',
    correctAnswer: 'y = $(x - 4)^{2}$ - 4',
    options: [
      { label: 'A', value: 'y = $(x - 4)^{2}$ - 4', isCorrect: true },
      { label: 'B', value: 'y = $(x - 4)^{2}$ + 12', isCorrect: false, explanation: 'Complete the square: $(x-4)^{2}$ = $x^{2}-8x+16$, so $x^{2}-8x+12$ = $(x-4)^{2}-4$' },
      { label: 'C', value: 'y = $(x + 4)^{2}$ - 4', isCorrect: false, explanation: 'Half of -8 is -4, so it\'s $(x - 4)^{2}$' },
      { label: 'D', value: 'y = $(x - 8)^{2}$ + 12', isCorrect: false, explanation: 'Take half the x-coefficient: -8/2 = -4' },
    ],
  },
  {
    id: 'quad-6',
    type: 'applications',
    question: 'A ball is thrown upward with h(t) = $-16t^{2}$ + 64t + 5. What is the maximum height?',
  ...
  },
  {
    id: 'quad-7',
    type: 'discriminant',
    question: 'For what value of k does $kx^{2}$ + 6x + 1 = 0 have exactly one real solution?',
    correctAnswer: 'k = 9',
    options: [
      { label: 'A', value: 'k = 9', isCorrect: true },
      { label: 'B', value: 'k = 36', isCorrect: false, explanation: '$b^{2}-4ac$ = 0: 36-4k = 0 → k = 9' },
      { label: 'C', value: 'k = 6', isCorrect: false, explanation: 'Set discriminant = 0: $6^{2}-4(k)(1)$=0, 36=4k, k=9' },
  ...
  },
  {
    ...
    options: [
      { label: 'A', value: 'y = $-(x - 1)^{2}$ - 2', isCorrect: true },
      { label: 'B', value: 'y = $(x - 1)^{2}$ - 2', isCorrect: false, explanation: 'a must be negative for "opens downward"' },
      { label: 'C', value: 'y = $-(x + 1)^{2}$ - 2', isCorrect: false, explanation: 'Vertex (h,k) = (1,-2) means (x - 1), not (x + 1)' },
      { label: 'D', value: 'y = $-(x - 1)^{2}$ + 2', isCorrect: false, explanation: 'k = -2, so the constant is -2' },
    ],
  },
  {
    id: 'quad-9',
    type: 'quadratic-formula',
    question: 'What is the sum of the solutions to $3x^{2}$ - 12x + 9 = 0?',
    correctAnswer: '4',
    options: [
  ...
  },
  {
    ...
    options: [
      ...
      { label: 'B', value: '5 × 15', isCorrect: false, explanation: 'P=40→ 2l+2w=40, A=w(20-w)=$-w^{2}+20w$, max at w=10' },
