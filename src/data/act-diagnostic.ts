...
const questionPool: PoolQuestion[] = [
  ...
  { question: 'If the area of a circle is 49π, what is the radius?', options: ['7', '14', '49', '24.5'], correctAnswer: 0, explanation: 'A = $\\pi r^{2}$ → $r^{2}$ = 49 → r = 7.', domain: 'math', topicSlug: 'geometry-trig', formSet: 'A' },
  { question: 'Simplify: $(x^{2} - 9)/(x - 3)$', options: ['x − 3', 'x + 3', '$x^{2}$ + 3', '3x'], correctAnswer: 1, explanation: '$x^{2}$ − 9 = (x − 3)(x + 3). Cancel (x − 3): result is x + 3.', domain: 'math', topicSlug: 'algebra-equations', formSet: 'A' },
  { question: 'What is the value of sin(30°)?', options: ['0', '1/2', '$\\sqrt{2}/2$', '$\\sqrt{3}/2$'], correctAnswer: 1, explanation: 'sin(30°) = 1/2. This is a standard trigonometric value.', domain: 'math', topicSlug: 'geometry-trig', formSet: 'B' },
  { question: 'If f(x) = $2x^{2}$ − 3x + 1, what is f(2)?', options: ['1', '3', '5', '7'], correctAnswer: 1, explanation: 'f(2) = 2(4) − 3(2) + 1 = 8 − 6 + 1 = 3.', domain: 'math', topicSlug: 'advanced-math', formSet: 'B' },
  ...
  { question: 'In a right triangle, if one leg is 5 and the hypotenuse is 13, what is the other leg?', options: ['8', '10', '12', '18'], correctAnswer: 2, explanation: '$a^{2}$ + $b^{2}$ = $c^{2}$. $5^{2}$ + $b^{2}$ = $13^{2}$. $b^{2}$ = 169 − 25 = 144. b = 12.', domain: 'math', topicSlug: 'geometry-trig', formSet: 'B' },
  ...
  { question: 'The graph of y = $(x - 2)^{2}$ + 3 has its vertex at:', options: ['(2, 3)', '(−2, 3)', '(2, −3)', '(3, 2)'], correctAnswer: 0, explanation: 'Vertex form y = $(x - h)^{2}$ + k → vertex at (h, k) = (2, 3).', domain: 'math', topicSlug: 'advanced-math', formSet: 'both' },
