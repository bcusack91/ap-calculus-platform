...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Key Insight',
            options: ['Take a full-length practice test to establish your baseline.', 'Focus improvement on your weakest section for the biggest gains.', 'Review every wrong answer — understand WHY you missed it.', 'Practice regularly with official ACT materials.']
          },
          {
            label: 'ACT Tip',
            options: ['Take a full-length practice test to establish your baseline.', 'Review every wrong answer — understand WHY you missed it.', 'Focus improvement on your weakest section for the biggest gains.', 'Practice regularly with official ACT materials.']
          }
        ],
        ...
        explanation: 'Each concept in Problem-Solving Workshop describes a specific idea. Key Insight: Practice regularly with official ACT materials. ACT Tip: Review every wrong answer — understand WHY you missed it.'
      }
    }
  ]
}
