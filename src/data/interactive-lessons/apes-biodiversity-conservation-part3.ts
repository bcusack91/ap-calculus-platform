export const apesBiodiversityConservationPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Biodiversity Conservation across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Biodiversity Conservation?

2) What concept describes a specific real-world example that illustrates Biodiversity Conservation?

3) Name the term for analyzing similarities and differences across examples of Biodiversity Conservation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Biodiversity Conservation), Case study (A specific real-world example that illustrates Biodiversity Conservation), and Comparison (Analyzing similarities and differences across examples of Biodiversity Conservation).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Biodiversity Conservation is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Biodiversity Conservation describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Biodiversity Conservation is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Biodiversity Conservation. Case study — A specific real-world example that illustrates Biodiversity Conservation. Comparison — Analyzing similarities and differences across examples of Biodiversity Conservation.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Biodiversity Conservation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Biodiversity Conservation. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Biodiversity Conservation is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
