export const apushNativeSocietiesExplorationPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Native Societies & European Exploration connects to other course topics through:',
            options: [
            ...
            correctAnswer: 1,
            explanation: 'Topics in AP US History are interconnected through shared processes, causes, and outcomes.'
          },
          {
            question: 'A feedback loop in Native Societies & European Exploration means:',
            options: [
              'The process stops',
...
1) What term refers to how Native Societies & European Exploration links to other course topics?

2) What concept describes how Native Societies & European Exploration operates differently at local, national, and global scales?

3) Name the term for how outcomes of Native Societies & European Exploration can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Native Societies & European Exploration links to other course topics), Scale interaction (How Native Societies & European Exploration operates differently at local, national, and global scales), and Feedback loop (How outcomes of Native Societies & European Exploration can reinforce or modify the original process).'
      }
    },
    {
      id: 'apushnat4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Native Societies & European Exploration links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Native Societies & European Exploration operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Native Societies & European Exploration can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Native Societies & European Exploration links to other course topics. Scale interaction — How Native Societies & European Exploration operates differently at local, national, and global scales. Feedback loop — How outcomes of Native Societies & European Exploration can reinforce or modify the original process.'
      }
    },
    {
      id: 'apushnat4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Native Societies & European Exploration.
...
- Connect connections & interactions to broader themes in AP US History for higher scores.
      `
    },
    {
      id: 'apushnat4-applied',
      type: 'multiple-choice' as const,
      content: `
**Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Native Societies & European Exploration and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Native Societies & European Exploration produces outcomes that further intensify the original process, this is:',
            options: [
