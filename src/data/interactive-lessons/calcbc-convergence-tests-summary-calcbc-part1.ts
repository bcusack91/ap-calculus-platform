...
**Quick Check**
    ...
    {
      id: 'calcbcconvergence-p1-example',
      type: 'text' as const,
      content: `
## Worked Example
...
Students often report only the numeric value and skip interpretation. On AP-style items, interpretation can be required for full credit.
    ...
    {
      id: 'calcbcconvergence-p1-inputs',
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcconvergence-p1-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcconvergence-p1-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
