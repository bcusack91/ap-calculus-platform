export const csa2dArraysPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within 2D Array Algorithms |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of 2D Array Algorithms across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within 2D Array Algorithms. Understanding this concept is essential for mastering 2D Array Algorithms in AP Computer Science A.
...
1) What term refers to a recurring structure within 2D Array Algorithms?

2) What concept describes a specific real-world example that illustrates 2D Array Algorithms?

3) Name the term for analyzing similarities and differences across examples of 2D Array Algorithms.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within 2D Array Algorithms), Case study (A specific real-world example that illustrates 2D Array Algorithms), and Comparison (Analyzing similarities and differences across examples of 2D Array Algorithms).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within 2D Array Algorithms is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates 2D Array Algorithms describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of 2D Array Algorithms is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within 2D Array Algorithms. Case study — A specific real-world example that illustrates 2D Array Algorithms. Comparison — Analyzing similarities and differences across examples of 2D Array Algorithms.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of 2D Array Algorithms.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of 2D Array Algorithms. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in 2D Array Algorithms is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
