...
The deceleration is $a = -g\\sin 30° = -5$ $m/s^{2}$ (opposing motion up the slope).
...
**Check Your Understanding** 🧠
      ...
      exercise: {
        questions: [
          {
            question: 'On a frictionless 45° incline, a 2 kg block accelerates at ($g = 10$ $m/s^{2}$, $\\sin 45° \\approx 0.707$):',
            options: [
              '5.0 $m/s^{2}$',
              '7.07 $m/s^{2}$',
              '10.0 $m/s^{2}$',
            ...
            correctAnswer: 1,
            explanation: '$a = g\\sin 45° = 10 \\times 0.707 = 7.07$ $m/s^{2}$. Mass doesn\'t matter!'
          },
          {
...
1) A block starts from rest on a 37° frictionless incline and slides for 2 seconds. What is its speed (m/s)? ($g = 10$ $m/s^{2}$, $\\sin 37° = 0.60$)

2) How far has it traveled in those 2 seconds (in m)?

3) A block is launched at 10 m/s up a 30° frictionless incline. How far up the slope does it travel before stopping (in m)? ($g = 10$ $m/s^{2}$, $\\sin 30° = 0.50$)
      `,
      exercise: {
        boxes: 3,
        correctAnswers: ['12', '12', '10'],
        hint1: '$a = g\\sin 37° = 6$ $m/s^{2}$. $v = at = 6 \\times 2$.',
        hint2: '$\\Delta x = \\frac{1}{2}at^2 = \\frac{1}{2}(6)(4)$.',
        hint3: '$a = 5$ $m/s^{2}$. $v^2 = v_0^2 - 2a\\Delta x$. $0 = 100 - 10\\Delta x$.',
        explanation: '1) $a = 6$ $m/s^{2}$, $v = 12$ m/s. 2) $\\Delta x = 12$ m. 3) $\\Delta x = 100/10 = 10$ m.'
      }
    },
    {
      id: 'ip2-dropdown',
...
**Exit Quiz** ✅
      ...
      exercise: {
        questions: [
          {
            question: 'A block slides from rest down a 53° frictionless incline for 3 m. What is its speed at the bottom? ($g = 10$ $m/s^{2}$, $\\sin 53° = 0.80$)',
            options: [
              '4.9 m/s',
              '6.0 m/s',
              '6.9 m/s',
            ...
            correctAnswer: 2,
            explanation: '$a = g\\sin 53° = 8$ $m/s^{2}$. $v^2 = 2(8)(3) = 48$. $v = \\sqrt{48} \\approx 6.9$ m/s.'
          },
          {
