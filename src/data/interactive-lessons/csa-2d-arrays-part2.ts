export const csa2dArraysPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in 2D Array Algorithms?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in 2D Array Algorithms helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in 2D Array Algorithms?

2) What concept describes a secondary process that shapes outcomes in 2D Array Algorithms?

3) Name the term for the relationship between actions and outcomes in 2D Array Algorithms.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in 2D Array Algorithms), Process 2 (A secondary process that shapes outcomes in 2D Array Algorithms), and Cause and effect (The relationship between actions and outcomes in 2D Array Algorithms).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in 2D Array Algorithms is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in 2D Array Algorithms describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in 2D Array Algorithms is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in 2D Array Algorithms. Process 2 — A secondary process that shapes outcomes in 2D Array Algorithms. Cause and effect — The relationship between actions and outcomes in 2D Array Algorithms.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of 2D Array Algorithms.
