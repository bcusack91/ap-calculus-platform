export const macroGdpGrowthPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about GDP & Economic Growth, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about GDP & Economic Growth requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to GDP & Economic Growth?

2) What concept describes making evidence-based claims about GDP & Economic Growth?

3) Name the term for using geographic thinking to analyze GDP & Economic Growth.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to GDP & Economic Growth), Argumentation (Making evidence-based claims about GDP & Economic Growth), and Spatial reasoning (Using geographic thinking to analyze GDP & Economic Growth).'
      }
    },
    {
      id: 'macrogdp6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to GDP & Economic Growth is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about GDP & Economic Growth describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze GDP & Economic Growth is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to GDP & Economic Growth. Argumentation — Making evidence-based claims about GDP & Economic Growth. Spatial reasoning — Using geographic thinking to analyze GDP & Economic Growth.'
      }
    },
    {
      id: 'macrogdp6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of GDP & Economic Growth.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about GDP & Economic Growth and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about GDP & Economic Growth. The best approach is:',
            options: [
