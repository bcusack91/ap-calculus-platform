...
**Part 3 of 7 — Hypotheses and predictions**
...
Keep your process measurable: spend about 15–20 seconds scanning a figure and save full reading for questions that require detail.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "A table shows reaction yield rising from 55% at trial 1 to 72% at trial 2 and 89% at trial 3. Which statement is best supported?",
              options: [
              ...
              correctAnswer: 1,
              explanation: "The values 55%, 72%, and 89% increase each trial, so the supported claim is a rising trend."
            },
            {
              question: "A graph shows temperature at 23°C and 33°C with all other conditions fixed. If output is higher at 33°C, what is the safest inference?",
              options: [
...
3) You spend 2 minutes 20 seconds on a hard item but target 50 seconds. Enter how many extra seconds you used.\n        `,
      ...
      {
        id: "act-rsci-p3-strategy",
        type: 'text' as const,
        content: `\n## Trap Avoidance for Hypotheses and predictions
