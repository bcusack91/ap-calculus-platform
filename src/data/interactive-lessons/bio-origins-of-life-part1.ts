...
- **reducing atmosphere** — an atmosphere lacking free $O_{2}$, rich in gases like $CH_{4}$, $NH_{3}$, $H_{2}O$, $H_{2}$, and $CO_{2}$
        ...
        questions: [
          {
            ...
            options: [
              'It lacked free oxygen $(O_{2})$ and contained gases like $CH_{4}$, $NH_{3}$, and $H_{2}$',
              'It was extremely cold, reducing molecular motion',
              'Atmospheric pressure was lower than today',
              'It contained high concentrations of ozone $(O_{3})$'
            ],
            correctAnswer: 0,
            explanation: 'A reducing atmosphere is one that lacks free $O_{2}$ and is rich in electron-donating gases such as $CH_{4}$, $NH_{3}$, and $H_{2}$. Without $O_{2}$, organic molecules could accumulate without being oxidized and destroyed.'
          },
          {
...
- **Water vapor $(H_{2}O)$** — condensed to form the oceans as Earth cooled
- **Carbon dioxide $(CO_{2})$** — greenhouse gas that kept the surface warm
- **Nitrogen $(N_{2})$** — relatively inert, accumulated over time
- **Methane $(CH_{4})$ and Ammonia $(NH_{3})$** — carbon and nitrogen sources for organic synthesis
- **Hydrogen gas $(H_{2})$** — a strong reducing agent

**Critically absent:** free oxygen $(O_{2})$. Molecular oxygen did not accumulate in the atmosphere until photosynthetic cyanobacteria evolved billions of years later.
...
| **Hydrothermal vents** | Superheated water (300–400°C) with dissolved minerals like $Fe^{2+}$ and $H_{2}S$ |
| **Meteorite impacts** | Delivered organic molecules and energy upon impact |

### Why Reducing Conditions Matter

In a reducing atmosphere, organic molecules are thermodynamically **stable**. In an oxidizing atmosphere (like today's), they would be rapidly broken down. The absence of $O_{2}$ was therefore a prerequisite for the accumulation of prebiotic organic compounds — the so-called **"primordial soup."**
      `
    },
    {
      id: 'ori1-dropdown',
      ...
      exercise: {
        dropdowns: [
          ...
          },
          {
            ...
            options: ['free oxygen $(O_{2})$', 'carbon dioxide $(CO_{2})$', 'water vapor', 'nitrogen gas']
          },
          {
        ...
        correctAnswers: ['outgassing', 'free oxygen $(O_{2})$', 'hydrothermal vents'],
        ...
        explanation: 'Outgassing from volcanoes produced the early atmosphere. The absence of free $O_{2}$ (reducing conditions) allowed organic molecules to persist. Hydrothermal vents provided both energy and mineral catalysts for prebiotic chemistry.'
      }
    },
    {
      id: 'ori1-content3',
...
- Abundant $H_{2}$ and $CO_{2}$ provide chemical energy and carbon sources
...
- The early atmosphere was **reducing** (no free $O_{2}$), produced by volcanic outgassing
- Energy sources included UV radiation, lightning, volcanic heat, and hydrothermal vents
- The absence of $O_{2}$ allowed organic molecules to accumulate without oxidation
