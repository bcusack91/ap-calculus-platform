export const englangClaimsEvidencePart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Claims & Evidence connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Claims & Evidence means:',
            options: [
              'The process stops',
...
1) What term refers to how Claims & Evidence links to other course topics?

2) What concept describes how Claims & Evidence operates differently at local, national, and global scales?

3) Name the term for how outcomes of Claims & Evidence can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Claims & Evidence links to other course topics), Scale interaction (How Claims & Evidence operates differently at local, national, and global scales), and Feedback loop (How outcomes of Claims & Evidence can reinforce or modify the original process).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Claims & Evidence links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Claims & Evidence operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Claims & Evidence can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Claims & Evidence links to other course topics. Scale interaction — How Claims & Evidence operates differently at local, national, and global scales. Feedback loop — How outcomes of Claims & Evidence can reinforce or modify the original process.'
      }
    },
    {
...
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Claims & Evidence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Claims & Evidence and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Claims & Evidence produces outcomes that further intensify the original process, this is:',
            options: [
