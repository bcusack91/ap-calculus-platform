export const actReadingStratPart3Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p3-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 3 of 7 — Line reference evidence**
