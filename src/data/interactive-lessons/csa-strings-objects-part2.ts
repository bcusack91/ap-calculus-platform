export const csaStringsObjectsPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Strings & Objects?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Strings & Objects helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Strings & Objects?

2) What concept describes a secondary process that shapes outcomes in Strings & Objects?

3) Name the term for the relationship between actions and outcomes in Strings & Objects.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Strings & Objects), Process 2 (A secondary process that shapes outcomes in Strings & Objects), and Cause and effect (The relationship between actions and outcomes in Strings & Objects).'
      }
    },
    {
      id: 'csastrin2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Strings & Objects is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Strings & Objects describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Strings & Objects is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Strings & Objects. Process 2 — A secondary process that shapes outcomes in Strings & Objects. Cause and effect — The relationship between actions and outcomes in Strings & Objects.'
      }
    },
    {
      id: 'csastrin2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Strings & Objects.
