export const hgEthnicityIdentityPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Ethnicity, Race & Identity across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Ethnicity, Race & Identity?

2) What concept describes a specific real-world example that illustrates Ethnicity, Race & Identity?

3) Name the term for analyzing similarities and differences across examples of Ethnicity, Race & Identity.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Ethnicity, Race & Identity), Case study (A specific real-world example that illustrates Ethnicity, Race & Identity), and Comparison (Analyzing similarities and differences across examples of Ethnicity, Race & Identity).'
      }
    },
    {
      id: 'hgethnic3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Ethnicity, Race & Identity is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Ethnicity, Race & Identity describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Ethnicity, Race & Identity is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Ethnicity, Race & Identity. Case study — A specific real-world example that illustrates Ethnicity, Race & Identity. Comparison — Analyzing similarities and differences across examples of Ethnicity, Race & Identity.'
      }
    },
    {
      id: 'hgethnic3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Ethnicity, Race & Identity.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Ethnicity, Race & Identity. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Ethnicity, Race & Identity is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
