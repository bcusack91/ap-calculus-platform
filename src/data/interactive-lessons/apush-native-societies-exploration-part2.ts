export const apushNativeSocietiesExplorationPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Native Societies & European Exploration?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Native Societies & European Exploration helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Native Societies & European Exploration?

2) What concept describes a secondary process that shapes outcomes in Native Societies & European Exploration?

3) Name the term for the relationship between actions and outcomes in Native Societies & European Exploration.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Native Societies & European Exploration), Process 2 (A secondary process that shapes outcomes in Native Societies & European Exploration), and Cause and effect (The relationship between actions and outcomes in Native Societies & European Exploration).'
      }
    },
    {
      id: 'apushnat2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Native Societies & European Exploration is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Native Societies & European Exploration describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Native Societies & European Exploration is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Native Societies & European Exploration. Process 2 — A secondary process that shapes outcomes in Native Societies & European Exploration. Cause and effect — The relationship between actions and outcomes in Native Societies & European Exploration.'
      }
    },
    {
      id: 'apushnat2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Native Societies & European Exploration.
...
- Connect key processes to broader themes in AP US History for higher scores.
      `
    },
    {
      id: 'apushnat2-applied',
      type: 'multiple-choice' as const,
      content: `
**Applied Scenarios** 🎯
      `,
