...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcarclength-p7-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcarclength-p7-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
