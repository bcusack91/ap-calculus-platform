...
A 10 kg block is pulled at 30° above horizontal with 60 N across a rough surface ($\\mu_k = 0.20$, $g = 10$ $m/s^{2}$).
...
What force is needed to pull a 20 kg box at constant velocity at 25° above horizontal? ($\\mu_k = 0.35$, $g = 10$ $m/s^{2}$)
...
**Workshop Multiple Choice** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'A 10 kg block on a rough surface ($\\mu_s = 0.60$, $\\mu_k = 0.40$) is pushed with 50 N horizontally. The block ($g = 10$ $m/s^{2}$):',
            options: [
              'Doesn\'t move; friction = 50 N',
              'Doesn\'t move; friction = 60 N',
              'Accelerates at 1 $m/s^{2}$',
          ...
          {
            question: 'A block slides on a surface with $\\mu_k = 0.25$. What is the deceleration? ($g = 10$ $m/s^{2}$)',
            options: [
              '0.25 $m/s^{2}$',
              '2.5 $m/s^{2}$',
              '25 $m/s^{2}$',
            ...
            correctAnswer: 1,
            explanation: 'On a horizontal surface with no applied force: $a = \\mu_k g = 0.25 \\times 10 = 2.5$ $m/s^{2}$ (deceleration).'
          },
          {
            question: 'A block is pushed at 45° below horizontal with 80 N on a surface ($\\mu_k = 0.20$). The normal force on the 10 kg block is ($g = 10$ $m/s^{2}$, $\\sin 45° \\approx 0.707$):',
            options: [
              '43.4 N',
              '100 N',
              '156.6 N',
...
1) A 8 kg block is pushed with 60 N horizontally across a rough floor ($\\mu_k = 0.25$, $g = 10$ $m/s^{2}$). What is the acceleration $(in m/s^{2})$?

2) A block slides to a stop in 4 seconds from an initial speed of 12 m/s on a horizontal surface. What is $\\mu_k$? ($g = 10$ $m/s^{2}$)
...
*Round all answers to 3 significant figures.*
      ...
      exercise: {
        ...
        hint2: '$a = \\Delta v/\\Delta t = 12/4 = 3$ $m/s^{2}$. $\\mu_k = a/g = 3/10$.',
        hint3: '$\\mu_s = \\tan\\theta_c$, so $\\theta_c = \\tan^{-1}(\\mu_s)$.',
        explanation: '1) $a = (60 - 20)/8 = 40/8 = 5$ $m/s^{2}$. 2) $a = 3$ $m/s^{2}$. $\\mu_k = 3/10 = 0.3$. 3) $\\theta_c = \\tan^{-1}(0.577) = 30°$.'
      }
    },
    {
...
**Exit Quiz — Friction Workshop** ✅
      ...
      exercise: {
        questions: [
          {
            question: 'A 12 kg block is pushed horizontally with 90 N across a rough surface ($\\mu_k = 0.40$, $g = 10$ $m/s^{2}$). What is the acceleration?',
            options: [
              '2.5 $m/s^{2}$',
              '3.5 $m/s^{2}$',
              '4.5 $m/s^{2}$',
            ...
            correctAnswer: 1,
            explanation: '$N = mg = 120$ N. $f_k = 0.40 \\times 120 = 48$ N. $a = (90 - 48)/12 = 42/12 = 3.5$ $m/s^{2}$.'
          },
          {
            question: 'A 4 kg block on a horizontal surface ($\\mu_k = 0.50$) is given an initial push of 8 m/s. How far does it slide before stopping? ($g = 10$ $m/s^{2}$)',
            options: [
              '3.2 m',
              '6.4 m',
              '8.0 m',
            ...
            correctAnswer: 1,
            explanation: '$a = \\mu_k g = 0.50 \\times 10 = 5$ $m/s^{2}$. $v^2 = v_0^2 + 2a\\Delta x$. $0 = 64 - 10\\Delta x$. $\\Delta x = 64/10 = 6.4$ m.'
          }
        ]
      }
    }
