...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Rectangle',
            options: ['A = ½bh.', 'A = lw, P = 2l + 2w.', 'Circle: A = $\\pi r^{2}$, C = 2πr.', 'Composite figures: break into simple shapes, add/subtract areas.']
          },
          {
            label: 'Triangle',
            options: ['Composite figures: break into simple shapes, add/subtract areas.', 'A = ½bh.', 'A = lw, P = 2l + 2w.', 'Circle: A = $\\pi r^{2}$, C = 2πr.']
          },
          {
            label: 'Key Insight',
            options: ['A = lw, P = 2l + 2w.', 'Composite figures: break into simple shapes, add/subtract areas.', 'A = ½bh.', 'Circle: A = $\\pi r^{2}$, C = 2πr.']
          }
        ],
        ...
        explanation: 'Each concept in Area & Perimeter describes a specific idea. Rectangle: A = lw, P = 2l + 2w. Triangle: A = ½bh. Key Insight: Circle: A = $\\pi r^{2}$, C = 2πr.'
      }
    }
  ]
}
