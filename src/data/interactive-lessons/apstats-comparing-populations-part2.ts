...
**Part 2 of 7 — Two-Sample T-Test for Means**

---

### Key Concepts

This section covers essential concepts related to **two-sample t-test for means** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Two-Sample T-Test for Means Check** 🎯
      `,
      exercise: {
        questions: [
          {
