export const csaArraylistUsagePart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in ArrayList Algorithms?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in ArrayList Algorithms helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in ArrayList Algorithms?

2) What concept describes a secondary process that shapes outcomes in ArrayList Algorithms?

3) Name the term for the relationship between actions and outcomes in ArrayList Algorithms.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in ArrayList Algorithms), Process 2 (A secondary process that shapes outcomes in ArrayList Algorithms), and Cause and effect (The relationship between actions and outcomes in ArrayList Algorithms).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in ArrayList Algorithms is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in ArrayList Algorithms describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in ArrayList Algorithms is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in ArrayList Algorithms. Process 2 — A secondary process that shapes outcomes in ArrayList Algorithms. Cause and effect — The relationship between actions and outcomes in ArrayList Algorithms.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of ArrayList Algorithms.
