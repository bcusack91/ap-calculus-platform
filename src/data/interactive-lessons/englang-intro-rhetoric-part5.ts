export const englangIntroRhetoricPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Introduction to Rhetoric helps:',
            options: [
          ...
          {
            question: 'Continuity in Introduction to Rhetoric means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Introduction to Rhetoric that have remained stable over time?

2) What concept describes how Introduction to Rhetoric has transformed due to new forces and conditions?

3) Name the term for the direction of change in Introduction to Rhetoric over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Introduction to Rhetoric that have remained stable over time), Change (How Introduction to Rhetoric has transformed due to new forces and conditions), and Trend (The direction of change in Introduction to Rhetoric over time).'
      }
    },
    {
      id: 'englangi5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'Continuity — Aspects of Introduction to Rhetoric that have remained stable over time. Change — How Introduction to Rhetoric has transformed due to new forces and conditions. Trend — The direction of change in Introduction to Rhetoric over time.'
      }
    },
    {
      id: 'englangi5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Introduction to Rhetoric.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Introduction to Rhetoric has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Introduction to Rhetoric shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
