export const englitToneSpeakerPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Tone, Voice & Speaker |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Tone, Voice & Speaker across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'englitto3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Tone, Voice & Speaker. Understanding this concept is essential for mastering Tone, Voice & Speaker in AP English Literature.
...
1) What term refers to a recurring structure within Tone, Voice & Speaker?

2) What concept describes a specific real-world example that illustrates Tone, Voice & Speaker?

3) Name the term for analyzing similarities and differences across examples of Tone, Voice & Speaker.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Tone, Voice & Speaker), Case study (A specific real-world example that illustrates Tone, Voice & Speaker), and Comparison (Analyzing similarities and differences across examples of Tone, Voice & Speaker).'
      }
    },
    {
      id: 'englitto3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Tone, Voice & Speaker is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Tone, Voice & Speaker describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Tone, Voice & Speaker is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Tone, Voice & Speaker. Case study — A specific real-world example that illustrates Tone, Voice & Speaker. Comparison — Analyzing similarities and differences across examples of Tone, Voice & Speaker.'
      }
    },
    {
      id: 'englitto3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Tone, Voice & Speaker.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Tone, Voice & Speaker. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Tone, Voice & Speaker is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
