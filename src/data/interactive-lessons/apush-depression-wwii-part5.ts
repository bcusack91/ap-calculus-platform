export const apushDepressionWwiiPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in The Great Depression & World War II helps:',
            options: [
          ...
          {
            question: 'Continuity in The Great Depression & World War II means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of The Great Depression & World War II that have remained stable over time?

2) What concept describes how The Great Depression & World War II has transformed due to new forces and conditions?

3) Name the term for the direction of change in The Great Depression & World War II over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of The Great Depression & World War II that have remained stable over time), Change (How The Great Depression & World War II has transformed due to new forces and conditions), and Trend (The direction of change in The Great Depression & World War II over time).'
      }
    },
    {
      id: 'apushdep5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of The Great Depression & World War II that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How The Great Depression & World War II has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in The Great Depression & World War II over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of The Great Depression & World War II that have remained stable over time. Change — How The Great Depression & World War II has transformed due to new forces and conditions. Trend — The direction of change in The Great Depression & World War II over time.'
      }
    },
    {
      id: 'apushdep5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of The Great Depression & World War II.
...
- Connect change over time to broader themes in AP US History for higher scores.
      `
    },
    {
      id: 'apushdep5-applied',
      type: 'multiple-choice' as const,
      content: `
**Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'An AP question asks how The Great Depression & World War II has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in The Great Depression & World War II shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
