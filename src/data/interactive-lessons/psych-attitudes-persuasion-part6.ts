export const psychAttitudesPart6Data = {
  ...
  sections: [
    {
      id: 'attitudes-persuasion-p6-s1-intro',
      type: 'text' as const,
      content: `
      # 🧠 Attitudes and Persuasion

      **Part 6 of 7 — Case Analysis and Data Interpretation**
    ...
    {
      id: 'attitudes-persuasion-p6-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about survey results before and after a persuasion intervention, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'central route',
              'attitude',
              'ABC model',
    ...
    {
      id: 'attitudes-persuasion-p6-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'attitudes-persuasion-p6-s4-input',
    ...
    {
      id: 'attitudes-persuasion-p6-s5-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['cognitive dissonance', 'mere exposure effect', 'attitude', 'central route']
          },
          {
            label: 'Select the concept that best matches: the affective, behavioral, and cognitive components of an attitude',
            options: ['cognitive dissonance', 'central route', 'ABC model', 'peripheral route']
          },
          {
            label: 'Select the concept that best matches: increased liking after repeated exposure',
            options: ['peripheral route', 'mere exposure effect', 'ABC model', 'cognitive dissonance']
          }
        ],
        correctAnswers: ['attitude', 'ABC model', 'mere exposure effect'],
    ...
    {
      id: 'attitudes-persuasion-p6-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about survey results before and after a persuasion intervention, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'attitudes-persuasion-p6-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating survey results before and after a persuasion intervention finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'ABC model',
              'mere exposure effect',
              'attitude',
