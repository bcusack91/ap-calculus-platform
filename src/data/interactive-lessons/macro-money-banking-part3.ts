...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Money & Banking across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Money & Banking?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Money & Banking), Case study (A specific real-world example that illustrates Money & Banking), and Comparison (Analyzing similarities and differences across examples of Money & Banking).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Money & Banking is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Money & Banking. Case study — A specific real-world example that illustrates Money & Banking. Comparison — Analyzing similarities and differences across examples of Money & Banking.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Money & Banking.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Money & Banking is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
