export const macroMoneyBankingPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Money & Banking |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Money & Banking across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Money & Banking. Understanding this concept is essential for mastering Money & Banking in AP Macroeconomics.
...
1) What term refers to a recurring structure within Money & Banking?

2) What concept describes a specific real-world example that illustrates Money & Banking?

3) Name the term for analyzing similarities and differences across examples of Money & Banking.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Money & Banking), Case study (A specific real-world example that illustrates Money & Banking), and Comparison (Analyzing similarities and differences across examples of Money & Banking).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Money & Banking is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Money & Banking describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Money & Banking is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Money & Banking. Case study — A specific real-world example that illustrates Money & Banking. Comparison — Analyzing similarities and differences across examples of Money & Banking.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Money & Banking.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Money & Banking. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Money & Banking is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
