export const g4MultiDigitMultPart7Data = {
  topicSlug: "multi-digit-multiplication-grade4",
  sections: [
    {
      id: 'grade4-multi-digit-multiplication-p7-intro',
      type: 'text' as const,
      content: `
# 🏆 Review & Applications
...
Welcome to **Review & Applications** — Part 7 of 7 in the Grade 4 Math Multi-Digit Multiplication series.

This lesson covers key concepts and practice problems.
      `
    },
    {
      id: 'grade4-multi-digit-multiplication-p7-worked',
      type: 'text' as const,
      content: `
## Worked Example
...
See the detailed steps in the practice sections below.
    ...
    {
      id: 'grade4-multi-digit-multiplication-p7-mcq1',
...
**Quick Check** 🎯
    ...
    {
      id: 'grade4-multi-digit-multiplication-p7-input',
...
Answer the following about review & applications.
    ...
    {
      id: 'grade4-multi-digit-multiplication-p7-dropdown',
...
**Concept Check** 🔍
    ...
    {
      id: 'grade4-multi-digit-multiplication-p7-practice',
      type: 'text' as const,
      content: `
## Practice
...
| 3 | Extension | Advanced connections |
    ...
    {
      id: 'grade4-multi-digit-multiplication-p7-mcq2',
      type: 'multiple-choice' as const,
      content: `
**Challenge Questions** 📋
      `,
