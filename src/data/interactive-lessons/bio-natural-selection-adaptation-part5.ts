      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation: 'Carriers are heterozygotes (Aa), with frequency 2pq = 2(0.70)(0.30) = 0.42, or 42%. The 0.49 option is the trap: that is $p^{2}$ = $0.70^{2}$ = 0.49, the frequency of HOMOZYGOUS DOMINANT (AA) plants, not heterozygotes. Be careful to use 2pq for carriers, not $p^{2}$.'
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            correctAnswer: 2,
            explanation: 'Heterozygote frequency = 2pq = 2(0.9)(0.1) = 0.18; count = 0.18 × 400 = 72. The 324 option is the trap: that is $p^{2}$ × 400 = 0.81 × 400 = 324, the number of HOMOZYGOUS DOMINANT birds, not heterozygotes. The answer 4 is $q^{2}$ × 400 = 0.01 × 400 = 4 (homozygous recessive). Match the term to 2pq for heterozygotes.'
          },
          {
