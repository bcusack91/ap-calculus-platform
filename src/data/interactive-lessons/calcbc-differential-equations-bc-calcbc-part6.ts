export const calcbcDiffEqPart6Data = {
  ...
  sections: [
    {
      id: 'differentialequationsbc-p6-intro',
      type: 'text' as const,
...
This section covers key concepts and techniques for problem-solving workshop in AP Calculus BC.

Mastery of these ideas is essential for both the multiple-choice and free-response sections of the AP exam.`
    },
    {
      id: 'differentialequationsbc-p6-mcq',
        ...
        questions: [
          {
            ...
            correctAnswer: 0,
            explanation: 'Problem-Solving Workshop is a key topic tested on the AP Calculus BC exam.'
          }
        ]
      }
    }
