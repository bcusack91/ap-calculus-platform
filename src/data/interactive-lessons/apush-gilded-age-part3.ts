export const apushGildedAgePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within The Gilded Age & Progressive Era |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Gilded Age & Progressive Era across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushgil3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within The Gilded Age & Progressive Era. Understanding this concept is essential for mastering The Gilded Age & Progressive Era in AP US History.
...
1) What term refers to a recurring structure within The Gilded Age & Progressive Era?

2) What concept describes a specific real-world example that illustrates The Gilded Age & Progressive Era?

3) Name the term for analyzing similarities and differences across examples of The Gilded Age & Progressive Era.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within The Gilded Age & Progressive Era), Case study (A specific real-world example that illustrates The Gilded Age & Progressive Era), and Comparison (Analyzing similarities and differences across examples of The Gilded Age & Progressive Era).'
      }
    },
    {
      id: 'apushgil3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within The Gilded Age & Progressive Era is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates The Gilded Age & Progressive Era describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of The Gilded Age & Progressive Era is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within The Gilded Age & Progressive Era. Case study — A specific real-world example that illustrates The Gilded Age & Progressive Era. Comparison — Analyzing similarities and differences across examples of The Gilded Age & Progressive Era.'
      }
    },
    {
      id: 'apushgil3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of The Gilded Age & Progressive Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of The Gilded Age & Progressive Era. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in The Gilded Age & Progressive Era is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
