...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Gilded Age & Progressive Era across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to The Gilded Age & Progressive Era?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to The Gilded Age & Progressive Era), Case study (A specific real-world example that illustrates The Gilded Age & Progressive Era), and Comparison (Analyzing similarities and differences across examples of The Gilded Age & Progressive Era).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to The Gilded Age & Progressive Era is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to The Gilded Age & Progressive Era. Case study — A specific real-world example that illustrates The Gilded Age & Progressive Era. Comparison — Analyzing similarities and differences across examples of The Gilded Age & Progressive Era.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of The Gilded Age & Progressive Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in The Gilded Age & Progressive Era is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
