export const actReadingStratPart6Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p6-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 6 of 7 — Timing and pacing**
