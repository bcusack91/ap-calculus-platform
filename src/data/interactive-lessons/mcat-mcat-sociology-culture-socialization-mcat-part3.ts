      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 3,
            explanation: `Sutherland's mechanism is positive transmission: intimate groups teach the how (techniques) and the why-it-is-acceptable (favorable definitions), and deviance follows when favorable definitions predominate. Hirschi's mechanism is the ABSENCE of bonds (attachment, commitment, involvement, belief) restraining a motivation he treats as universal — missing attachment, weak commitment, and an unrestrained innate impulse belong to the control-theory family, with the innate impulse stating its premise.`
          },
          {
