        ...
        questions: [
          {
            ...
            options: [`Innovator`, `Retreatist`, `Ritualist — cultural goals abandoned, legitimate means compulsively retained`, `Rebel`],
            correctAnswer: 2,
          ...
          },
          {
            ...
            options: [`The absence of attachment to conventional adults`, `Weak stakes in conformity`, `An innate impulse to deviate that friends fail to restrain`, `Learned techniques and definitions favorable to deviance acquired in intimate groups`],
            correctAnswer: 3,
          ...
          },
          {
            ...
            options: [`Master status and stigma`, `Primary deviance and secondary deviance — the second produced by societal reaction to the label`, `Innovation and rebellion`, `Folkway violation and taboo violation`],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: [`Public reaction to a scandal visibly re-teaches a community's rules and temporarily strengthens its cohesion`, `Crime rates rise when policing declines`, `Deviants report higher personal wellbeing`, `Most deviant acts go undetected`],
            correctAnswer: 0,
          ...
          },
          {
            ...
            options: [`Strain theory, because restitution restores legitimate means`, `Differential association, because offenders avoided deviant peers`, `General deterrence, because the public learned the consequences`, `Labeling theory — withholding the public label prevents stigma, preserved opportunities, and the slide into secondary deviance`],
            correctAnswer: 3,
