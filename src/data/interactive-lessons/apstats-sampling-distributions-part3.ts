...
**Part 3 of 7 — Distribution of Sample Proportions**

---

### Key Concepts

This section covers essential concepts related to **distribution of sample proportions** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Distribution of Sample Proportions Check** 🎯
      `,
      exercise: {
        questions: [
          {
