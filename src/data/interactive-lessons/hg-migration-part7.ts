export const hgMigrationPart7Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'The most important exam strategy for Migration Patterns & Processes is:',
            options: [
              'Guess randomly',
          ...
          {
            question: 'AP multiple-choice questions about Migration Patterns & Processes often test:',
            options: [
              'Random trivia',
...
1) What term refers to essential terms and definitions for Migration Patterns & Processes?

2) What concept describes the most frequent ways Migration Patterns & Processes is tested on the AP exam?

3) Name the term for approaches for answering Migration Patterns & Processes questions effectively.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: E',
        explanation: 'Expected answers: Key vocabulary (Essential terms and definitions for Migration Patterns & Processes), Common question types (The most frequent ways Migration Patterns & Processes is tested on the AP exam), and Exam strategy (Approaches for answering Migration Patterns & Processes questions effectively).'
      }
    },
    {
      id: 'hgmigrat7-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Essential terms and definitions for Migration Patterns & Processes is called ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'None of these']
          },
          {
            label: 'The most frequent ways Migration Patterns & Processes is tested on the AP exam describes ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'All of these']
          },
          {
            label: 'Approaches for answering Migration Patterns & Processes questions effectively is known as ___',
        ...
        explanation: 'Key vocabulary — Essential terms and definitions for Migration Patterns & Processes. Common question types — The most frequent ways Migration Patterns & Processes is tested on the AP exam. Exam strategy — Approaches for answering Migration Patterns & Processes questions effectively.'
      }
    },
    {
      id: 'hgmigrat7-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Key vocabulary** with **Common question types** — while related, they address different aspects of Migration Patterns & Processes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, a question presents a scenario you have never seen before about Migration Patterns & Processes. You should:',
            options: [
              'Panic',
          ...
          {
            question: 'For free-response questions on Migration Patterns & Processes, the most common mistake is:',
            options: [
              'Writing too clearly',
