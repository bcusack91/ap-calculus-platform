export const psychMemoryEncodePart2Data = {
  ...
  sections: [
    {
      id: 'memory-encoding-storage-p2-s1-intro',
      type: 'text' as const,
      content: `
      # 🧠 Memory Encoding and Storage

      **Part 2 of 7 — Encoding Strategies**
    ...
    {
      id: 'memory-encoding-storage-p2-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about language vocabulary retention in two practice conditions, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'chunking',
              'long-term memory',
    ...
    {
      id: 'memory-encoding-storage-p2-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'memory-encoding-storage-p2-s4-input',
    ...
    {
      id: 'memory-encoding-storage-p2-s5-dropdown',
    ...
    {
      id: 'memory-encoding-storage-p2-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about language vocabulary retention in two practice conditions, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'memory-encoding-storage-p2-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating language vocabulary retention in two practice conditions finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'elaborative rehearsal',
              'chunking',
              'encoding',
