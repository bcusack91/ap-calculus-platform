export const csaExpressionsOperatorsPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Expressions & Operators |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Expressions & Operators across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'csaexpre3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Expressions & Operators. Understanding this concept is essential for mastering Expressions & Operators in AP Computer Science A.
...
1) What term refers to a recurring structure within Expressions & Operators?

2) What concept describes a specific real-world example that illustrates Expressions & Operators?

3) Name the term for analyzing similarities and differences across examples of Expressions & Operators.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Expressions & Operators), Case study (A specific real-world example that illustrates Expressions & Operators), and Comparison (Analyzing similarities and differences across examples of Expressions & Operators).'
      }
    },
    {
      id: 'csaexpre3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Expressions & Operators is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Expressions & Operators describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Expressions & Operators is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Expressions & Operators. Case study — A specific real-world example that illustrates Expressions & Operators. Comparison — Analyzing similarities and differences across examples of Expressions & Operators.'
      }
    },
    {
      id: 'csaexpre3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Expressions & Operators.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Expressions & Operators. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Expressions & Operators is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
