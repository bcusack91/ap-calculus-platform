export const csaClassDesignPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Class Design & Encapsulation, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Class Design & Encapsulation requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Class Design & Encapsulation?

2) What concept describes making evidence-based claims about Class Design & Encapsulation?

3) Name the term for using geographic thinking to analyze Class Design & Encapsulation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Class Design & Encapsulation), Argumentation (Making evidence-based claims about Class Design & Encapsulation), and Spatial reasoning (Using geographic thinking to analyze Class Design & Encapsulation).'
      }
    },
    {
      id: 'csaclass6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Class Design & Encapsulation is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Class Design & Encapsulation describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Class Design & Encapsulation is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Class Design & Encapsulation. Argumentation — Making evidence-based claims about Class Design & Encapsulation. Spatial reasoning — Using geographic thinking to analyze Class Design & Encapsulation.'
      }
    },
    {
      id: 'csaclass6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Class Design & Encapsulation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Class Design & Encapsulation and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Class Design & Encapsulation. The best approach is:',
            options: [
