...
**Application Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A 5 kg object hangs from a rope attached to the ceiling. What is the tension in the rope? ($g = 9.8$ m/s²)',
            options: [
              '5 N',
              '9.8 N',
              '49 N',
...
1) A 60 kg person stands on a scale in an elevator accelerating downward at 3 m/s². What does the scale read (in N)? Use $g = 9.8$ m/s².

2) A horizontal force of 50 N pushes a 10 kg box across a frictionless floor. What is the acceleration (in m/s²)?

3) A person pulls a box with 100 N at 37° above horizontal (frictionless surface). The box has mass 25 kg. What is the horizontal acceleration (in m/s²)? Use $\\cos 37° = 0.80$.
...
*Round all answers to 3 significant figures.*
      ...
      exercise: {
        ...
        explanation: '1) $N = m(g - 3) = 60(9.8 - 3) = 60 \\times 6.8 = 408$ N. 2) $a = 50/10 = 5$ m/s². 3) $F_x = 100 \\times 0.80 = 80$ N. $a = 80/25 = 3.2$ m/s².'
      }
    },
    {
      ...
      exercise: {
        dropdowns: [
          ...
          },
          {
            ...
            options: ['0.2 m/s²', '5 m/s²', '36 m/s²', '180 m/s²'],
            correctIndex: 1,
            explanation: '$a = F/m = 30/6 = 5$ m/s².'
          }
        ]
      }
    },
...
**Exit Quiz — Applying F = ma** ✅
      ...
      exercise: {
        questions: [
          {
            question: 'A 50 kg box is pushed with a horizontal force $F$ across a frictionless floor, accelerating at 4 m/s². What is $F$?',
            options: [
              '12.5 N',
              '50 N',
              '200 N',
          ...
          },
          {
            ...
            correctAnswer: 0,
            explanation: '$F_x = 50\\cos 60° = 50 \\times 0.50 = 25$ N. $a = F_x/m = 25/10 = 2.5$ m/s².'
          }
        ]
      }
    }
