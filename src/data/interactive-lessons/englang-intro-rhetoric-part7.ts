export const englangIntroRhetoricPart7Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'The most important exam strategy for Introduction to Rhetoric is:',
            options: [
              'Guess randomly',
          ...
          {
            question: 'AP multiple-choice questions about Introduction to Rhetoric often test:',
            options: [
              'Random trivia',
...
1) What term refers to essential terms and definitions for Introduction to Rhetoric?

2) What concept describes the most frequent ways Introduction to Rhetoric is tested on the AP exam?

3) Name the term for approaches for answering Introduction to Rhetoric questions effectively.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: E',
        explanation: 'Expected answers: Key vocabulary (Essential terms and definitions for Introduction to Rhetoric), Common question types (The most frequent ways Introduction to Rhetoric is tested on the AP exam), and Exam strategy (Approaches for answering Introduction to Rhetoric questions effectively).'
      }
    },
    {
      id: 'englangi7-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'Key vocabulary — Essential terms and definitions for Introduction to Rhetoric. Common question types — The most frequent ways Introduction to Rhetoric is tested on the AP exam. Exam strategy — Approaches for answering Introduction to Rhetoric questions effectively.'
      }
    },
    {
      id: 'englangi7-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Key vocabulary** with **Common question types** — while related, they address different aspects of Introduction to Rhetoric.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, a question presents a scenario you have never seen before about Introduction to Rhetoric. You should:',
            options: [
              'Panic',
          ...
          {
            question: 'For free-response questions on Introduction to Rhetoric, the most common mistake is:',
            options: [
              'Writing too clearly',
