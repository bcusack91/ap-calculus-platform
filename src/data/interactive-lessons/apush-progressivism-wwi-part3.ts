export const apushProgressivismWwiPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Progressivism & World War I across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Progressivism & World War I?

2) What concept describes a specific real-world example that illustrates Progressivism & World War I?

3) Name the term for analyzing similarities and differences across examples of Progressivism & World War I.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Progressivism & World War I), Case study (A specific real-world example that illustrates Progressivism & World War I), and Comparison (Analyzing similarities and differences across examples of Progressivism & World War I).'
      }
    },
    {
      id: 'apushpro3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Progressivism & World War I is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Progressivism & World War I describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Progressivism & World War I is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Progressivism & World War I. Case study — A specific real-world example that illustrates Progressivism & World War I. Comparison — Analyzing similarities and differences across examples of Progressivism & World War I.'
      }
    },
    {
      id: 'apushpro3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Progressivism & World War I.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Progressivism & World War I. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Progressivism & World War I is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
