export const csaLoopsPart2Data = {
  topicSlug: 'csa-loops',
  sections: [
    {
      id: 'csaloops2-intro',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Advanced Loop Patterns?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Advanced Loop Patterns helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Advanced Loop Patterns?

2) What concept describes a secondary process that shapes outcomes in Advanced Loop Patterns?

3) Name the term for the relationship between actions and outcomes in Advanced Loop Patterns.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Advanced Loop Patterns), Process 2 (A secondary process that shapes outcomes in Advanced Loop Patterns), and Cause and effect (The relationship between actions and outcomes in Advanced Loop Patterns).'
      }
    },
    {
      id: 'csaloops2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Advanced Loop Patterns is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Advanced Loop Patterns describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Advanced Loop Patterns is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Advanced Loop Patterns. Process 2 — A secondary process that shapes outcomes in Advanced Loop Patterns. Cause and effect — The relationship between actions and outcomes in Advanced Loop Patterns.'
      }
    },
    {
      id: 'csaloops2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Advanced Loop Patterns.
