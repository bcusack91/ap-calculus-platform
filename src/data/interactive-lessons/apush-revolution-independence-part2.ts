export const apushRevolutionIndependencePart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Revolution & Independence?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Revolution & Independence helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Revolution & Independence?

2) What concept describes a secondary process that shapes outcomes in Revolution & Independence?

3) Name the term for the relationship between actions and outcomes in Revolution & Independence.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Revolution & Independence), Process 2 (A secondary process that shapes outcomes in Revolution & Independence), and Cause and effect (The relationship between actions and outcomes in Revolution & Independence).'
      }
    },
    {
      id: 'apushrev2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Revolution & Independence is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Revolution & Independence describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Revolution & Independence is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Revolution & Independence. Process 2 — A secondary process that shapes outcomes in Revolution & Independence. Cause and effect — The relationship between actions and outcomes in Revolution & Independence.'
      }
    },
    {
      id: 'apushrev2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Revolution & Independence.
