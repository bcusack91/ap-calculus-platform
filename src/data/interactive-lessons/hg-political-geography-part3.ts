export const hgPoliticalGeographyPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Political Geography & Territoriality across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Political Geography & Territoriality?

2) What concept describes a specific real-world example that illustrates Political Geography & Territoriality?

3) Name the term for analyzing similarities and differences across examples of Political Geography & Territoriality.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Political Geography & Territoriality), Case study (A specific real-world example that illustrates Political Geography & Territoriality), and Comparison (Analyzing similarities and differences across examples of Political Geography & Territoriality).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Political Geography & Territoriality is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Political Geography & Territoriality describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Political Geography & Territoriality is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Political Geography & Territoriality. Case study — A specific real-world example that illustrates Political Geography & Territoriality. Comparison — Analyzing similarities and differences across examples of Political Geography & Territoriality.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Political Geography & Territoriality.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Political Geography & Territoriality. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Political Geography & Territoriality is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
