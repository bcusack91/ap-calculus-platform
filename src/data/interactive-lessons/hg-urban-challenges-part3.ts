export const hgUrbanChallengesPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Urban Challenges & Sustainability across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Urban Challenges & Sustainability?

2) What concept describes a specific real-world example that illustrates Urban Challenges & Sustainability?

3) Name the term for analyzing similarities and differences across examples of Urban Challenges & Sustainability.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Urban Challenges & Sustainability), Case study (A specific real-world example that illustrates Urban Challenges & Sustainability), and Comparison (Analyzing similarities and differences across examples of Urban Challenges & Sustainability).'
      }
    },
    {
      id: 'hgurbanc3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Urban Challenges & Sustainability is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Urban Challenges & Sustainability describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Urban Challenges & Sustainability is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Urban Challenges & Sustainability. Case study — A specific real-world example that illustrates Urban Challenges & Sustainability. Comparison — Analyzing similarities and differences across examples of Urban Challenges & Sustainability.'
      }
    },
    {
      id: 'hgurbanc3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Urban Challenges & Sustainability.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Urban Challenges & Sustainability. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Urban Challenges & Sustainability is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
