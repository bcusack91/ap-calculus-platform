export const microExternalitiesPublicGoodsPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Externalities & Public Goods across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Externalities & Public Goods?

2) What concept describes a specific real-world example that illustrates Externalities & Public Goods?

3) Name the term for analyzing similarities and differences across examples of Externalities & Public Goods.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Externalities & Public Goods), Case study (A specific real-world example that illustrates Externalities & Public Goods), and Comparison (Analyzing similarities and differences across examples of Externalities & Public Goods).'
      }
    },
    {
      id: 'microext3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Externalities & Public Goods is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Externalities & Public Goods describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Externalities & Public Goods is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Externalities & Public Goods. Case study — A specific real-world example that illustrates Externalities & Public Goods. Comparison — Analyzing similarities and differences across examples of Externalities & Public Goods.'
      }
    },
    {
      id: 'microext3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Externalities & Public Goods.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Externalities & Public Goods. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Externalities & Public Goods is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
