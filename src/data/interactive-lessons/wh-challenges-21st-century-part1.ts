export const whChallenges21stCenturyPart1Data = {
  ...
  sections: [
    {
      id: 'whchallenges21stcentury1-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whchallenges21stcentury1-mcq',
    ...
    {
      id: 'whchallenges21stcentury1-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whchallenges21stcentury1-dropdown',
    ...
    {
      id: 'whchallenges21stcentury1-ap',
      type: 'multiple-choice' as const,
