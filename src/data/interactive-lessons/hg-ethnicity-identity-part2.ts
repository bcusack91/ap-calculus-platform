export const hgEthnicityIdentityPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Ethnicity, Race & Identity?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Ethnicity, Race & Identity helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Ethnicity, Race & Identity?

2) What concept describes a secondary process that shapes outcomes in Ethnicity, Race & Identity?

3) Name the term for the relationship between actions and outcomes in Ethnicity, Race & Identity.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Ethnicity, Race & Identity), Process 2 (A secondary process that shapes outcomes in Ethnicity, Race & Identity), and Cause and effect (The relationship between actions and outcomes in Ethnicity, Race & Identity).'
      }
    },
    {
      id: 'hgethnic2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Ethnicity, Race & Identity is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Ethnicity, Race & Identity describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Ethnicity, Race & Identity is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Ethnicity, Race & Identity. Process 2 — A secondary process that shapes outcomes in Ethnicity, Race & Identity. Cause and effect — The relationship between actions and outcomes in Ethnicity, Race & Identity.'
      }
    },
    {
      id: 'hgethnic2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Ethnicity, Race & Identity.
