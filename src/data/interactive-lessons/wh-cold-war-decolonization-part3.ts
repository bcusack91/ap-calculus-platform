export const whColdWarDecolonizationPart3Data = {
  ...
  sections: [
    {
      id: 'whcoldwardecolonization3-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whcoldwardecolonization3-mcq',
    ...
    {
      id: 'whcoldwardecolonization3-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to decolonization movements in asia and africa.
- Compare two regions or states affected by non-aligned movement and postcolonial diplomacy.
- Evaluate continuity and change involving cold war legacies after 1991.
`
    },
    {
      id: 'whcoldwardecolonization3-dropdown',
    ...
    {
      id: 'whcoldwardecolonization3-ap',
      type: 'multiple-choice' as const,
