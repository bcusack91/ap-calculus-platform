export const apesHumanPopulationPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Human Population Dynamics, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Human Population Dynamics requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Human Population Dynamics?

2) What concept describes making evidence-based claims about Human Population Dynamics?

3) Name the term for using geographic thinking to analyze Human Population Dynamics.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Human Population Dynamics), Argumentation (Making evidence-based claims about Human Population Dynamics), and Spatial reasoning (Using geographic thinking to analyze Human Population Dynamics).'
      }
    },
    {
      id: 'apeshuma6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Human Population Dynamics is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Human Population Dynamics describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Human Population Dynamics is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Human Population Dynamics. Argumentation — Making evidence-based claims about Human Population Dynamics. Spatial reasoning — Using geographic thinking to analyze Human Population Dynamics.'
      }
    },
    {
      id: 'apeshuma6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Human Population Dynamics.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Human Population Dynamics and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Human Population Dynamics. The best approach is:',
            options: [
