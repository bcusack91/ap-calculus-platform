export const csaStringsObjectsPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Strings & Objects connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Strings & Objects means:',
            options: [
              'The process stops',
...
1) What term refers to how Strings & Objects links to other course topics?

2) What concept describes how Strings & Objects operates differently at local, national, and global scales?

3) Name the term for how outcomes of Strings & Objects can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Strings & Objects links to other course topics), Scale interaction (How Strings & Objects operates differently at local, national, and global scales), and Feedback loop (How outcomes of Strings & Objects can reinforce or modify the original process).'
      }
    },
    {
      id: 'csastrin4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Strings & Objects links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Strings & Objects operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Strings & Objects can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Strings & Objects links to other course topics. Scale interaction — How Strings & Objects operates differently at local, national, and global scales. Feedback loop — How outcomes of Strings & Objects can reinforce or modify the original process.'
      }
    },
    {
      id: 'csastrin4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Strings & Objects.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Strings & Objects and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Strings & Objects produces outcomes that further intensify the original process, this is:',
            options: [
