export const macroMultiplierEffectPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within The Multiplier Effect |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Multiplier Effect across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macromul3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within The Multiplier Effect. Understanding this concept is essential for mastering The Multiplier Effect in AP Macroeconomics.
...
1) What term refers to a recurring structure within The Multiplier Effect?

2) What concept describes a specific real-world example that illustrates The Multiplier Effect?

3) Name the term for analyzing similarities and differences across examples of The Multiplier Effect.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within The Multiplier Effect), Case study (A specific real-world example that illustrates The Multiplier Effect), and Comparison (Analyzing similarities and differences across examples of The Multiplier Effect).'
      }
    },
    {
      id: 'macromul3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within The Multiplier Effect is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates The Multiplier Effect describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of The Multiplier Effect is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within The Multiplier Effect. Case study — A specific real-world example that illustrates The Multiplier Effect. Comparison — Analyzing similarities and differences across examples of The Multiplier Effect.'
      }
    },
    {
      id: 'macromul3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of The Multiplier Effect.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of The Multiplier Effect. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in The Multiplier Effect is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
