export const englangWritingForAudiencePart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Writing for Different Audiences connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Writing for Different Audiences means:',
            options: [
              'The process stops',
...
1) What term refers to how Writing for Different Audiences links to other course topics?

2) What concept describes how Writing for Different Audiences operates differently at local, national, and global scales?

3) Name the term for how outcomes of Writing for Different Audiences can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Writing for Different Audiences links to other course topics), Scale interaction (How Writing for Different Audiences operates differently at local, national, and global scales), and Feedback loop (How outcomes of Writing for Different Audiences can reinforce or modify the original process).'
      }
    },
    {
      id: 'englangw4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Writing for Different Audiences links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Writing for Different Audiences operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Writing for Different Audiences can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Writing for Different Audiences links to other course topics. Scale interaction — How Writing for Different Audiences operates differently at local, national, and global scales. Feedback loop — How outcomes of Writing for Different Audiences can reinforce or modify the original process.'
      }
    },
    {
      id: 'englangw4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Writing for Different Audiences.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Writing for Different Audiences and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Writing for Different Audiences produces outcomes that further intensify the original process, this is:',
            options: [
