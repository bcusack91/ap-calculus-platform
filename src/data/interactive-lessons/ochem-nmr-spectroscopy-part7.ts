...
4. **$^{13}\\text{C}$ / DEPT $\\rightarrow$ carbon skeleton.** Count environments, locate carbonyls ($160\\text{–}220$) and $sp^{2}$ carbons ($100\\text{–}150$); use DEPT to classify $\\text{CH}_3$/$\\text{CH}_2$/$\\text{CH}$/quaternary.
