export const apushColonialAmericaPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Colonial America |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Colonial America across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Colonial America. Understanding this concept is essential for mastering Colonial America in AP US History.
...
1) What term refers to a recurring structure within Colonial America?

2) What concept describes a specific real-world example that illustrates Colonial America?

3) Name the term for analyzing similarities and differences across examples of Colonial America.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Colonial America), Case study (A specific real-world example that illustrates Colonial America), and Comparison (Analyzing similarities and differences across examples of Colonial America).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Colonial America is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Colonial America describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Colonial America is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Colonial America. Case study — A specific real-world example that illustrates Colonial America. Comparison — Analyzing similarities and differences across examples of Colonial America.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Colonial America.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Colonial America. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Colonial America is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
