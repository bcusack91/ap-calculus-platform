...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Colonial America across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Colonial America?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Colonial America), Case study (A specific real-world example that illustrates Colonial America), and Comparison (Analyzing similarities and differences across examples of Colonial America).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Colonial America is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Colonial America. Case study — A specific real-world example that illustrates Colonial America. Comparison — Analyzing similarities and differences across examples of Colonial America.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Colonial America.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Colonial America is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
