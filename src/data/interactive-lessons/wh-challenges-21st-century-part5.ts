export const whChallenges21stCenturyPart5Data = {
  ...
  sections: [
    {
      id: 'whchallenges21stcentury5-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whchallenges21stcentury5-mcq',
    ...
    {
      id: 'whchallenges21stcentury5-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to international cooperation and institutional limits.
- Compare two regions or states affected by climate change and environmental stress.
- Evaluate continuity and change involving transnational terrorism and security policy.
`
    },
    {
      id: 'whchallenges21stcentury5-dropdown',
    ...
    {
      id: 'whchallenges21stcentury5-ap',
      type: 'multiple-choice' as const,
