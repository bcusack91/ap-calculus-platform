export const hgUrbanizationPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Urbanization & Urban Models, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Urbanization & Urban Models requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Urbanization & Urban Models?

2) What concept describes making evidence-based claims about Urbanization & Urban Models?

3) Name the term for using geographic thinking to analyze Urbanization & Urban Models.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Urbanization & Urban Models), Argumentation (Making evidence-based claims about Urbanization & Urban Models), and Spatial reasoning (Using geographic thinking to analyze Urbanization & Urban Models).'
      }
    },
    {
      id: 'hgurbani6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Urbanization & Urban Models is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Urbanization & Urban Models describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Urbanization & Urban Models is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Urbanization & Urban Models. Argumentation — Making evidence-based claims about Urbanization & Urban Models. Spatial reasoning — Using geographic thinking to analyze Urbanization & Urban Models.'
      }
    },
    {
      id: 'hgurbani6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Urbanization & Urban Models.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Urbanization & Urban Models and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Urbanization & Urban Models. The best approach is:',
            options: [
