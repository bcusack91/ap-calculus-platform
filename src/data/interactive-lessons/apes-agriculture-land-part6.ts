export const apesAgricultureLandPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Agriculture & Land Use, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Agriculture & Land Use requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Agriculture & Land Use?

2) What concept describes making evidence-based claims about Agriculture & Land Use?

3) Name the term for using geographic thinking to analyze Agriculture & Land Use.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Agriculture & Land Use), Argumentation (Making evidence-based claims about Agriculture & Land Use), and Spatial reasoning (Using geographic thinking to analyze Agriculture & Land Use).'
      }
    },
    {
      id: 'apesagri6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Agriculture & Land Use is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Agriculture & Land Use describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Agriculture & Land Use is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Agriculture & Land Use. Argumentation — Making evidence-based claims about Agriculture & Land Use. Spatial reasoning — Using geographic thinking to analyze Agriculture & Land Use.'
      }
    },
    {
      id: 'apesagri6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Agriculture & Land Use.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Agriculture & Land Use and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Agriculture & Land Use. The best approach is:',
            options: [
