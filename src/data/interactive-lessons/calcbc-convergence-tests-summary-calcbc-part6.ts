...
**Quick Check**
    ...
    {
      id: 'calcbcconvergence-p6-example',
      type: 'text' as const,
      content: `
## Worked Example
...
Students often report only the numeric value and skip interpretation. On AP-style items, interpretation can be required for full credit.
    ...
    {
      id: 'calcbcconvergence-p6-inputs',
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcconvergence-p6-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcconvergence-p6-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
