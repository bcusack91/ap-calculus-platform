        ...
        questions: [
          {
            ...
            options: [`CD8+ cytotoxic T cells`, `B cells and antibodies`, `CD4+ helper T cells`, `Neutrophils and macrophages`],
            correctAnswer: 0,
            explanation: `Virus-infected cells display viral peptides on MHC I (present on all nucleated cells). CD8+ T cells recognize this and kill the cell via perforin/granzyme — "MHC I = license to kill." Antibodies act on extracellular pathogens; CD4+ cells coordinate but don't directly kill; neutrophils and macrophages mainly engulf extracellular microbes.`
          },
          {
            ...
            options: [`NK cells, because they kill cells lacking normal MHC I`, `CD8+ T cells, because they recognize MHC II instead`, `B cells, because their receptors bind MHC I directly`, `Helper T cells, because they kill via MHC II recognition`],
            correctAnswer: 0,
          ...
          },
          {
            ...
            options: [`Memory B cells that already class-switched and affinity-matured`, `A larger innate neutrophil response triggered by the vaccine`, `Higher baseline IgM that neutralizes the pathogen immediately`, `Increased complement protein synthesis from the vaccine`],
            correctAnswer: 0,
            explanation: `Vaccination generates memory B cells that have already undergone class switching and affinity maturation; on re-exposure they rapidly produce large amounts of high-affinity, class-switched IgG — the secondary response (short lag, high titer). The primary response is IgM-first and slow, so higher baseline IgM does not explain it; the speed comes from adaptive memory, not from innate neutrophils or complement levels.`
          }
        ]
      }
    },
