export const microLaborMarketsPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Labor Markets |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Labor Markets across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'microlab3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Labor Markets. Understanding this concept is essential for mastering Labor Markets in AP Microeconomics.
...
1) What term refers to a recurring structure within Labor Markets?

2) What concept describes a specific real-world example that illustrates Labor Markets?

3) Name the term for analyzing similarities and differences across examples of Labor Markets.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Labor Markets), Case study (A specific real-world example that illustrates Labor Markets), and Comparison (Analyzing similarities and differences across examples of Labor Markets).'
      }
    },
    {
      id: 'microlab3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Labor Markets is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Labor Markets describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Labor Markets is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Labor Markets. Case study — A specific real-world example that illustrates Labor Markets. Comparison — Analyzing similarities and differences across examples of Labor Markets.'
      }
    },
    {
      id: 'microlab3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Labor Markets.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Labor Markets. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Labor Markets is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
