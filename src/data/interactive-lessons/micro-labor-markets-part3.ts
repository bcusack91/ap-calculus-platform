...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Labor Markets across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Labor Markets?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Labor Markets), Case study (A specific real-world example that illustrates Labor Markets), and Comparison (Analyzing similarities and differences across examples of Labor Markets).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Labor Markets is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Labor Markets. Case study — A specific real-world example that illustrates Labor Markets. Comparison — Analyzing similarities and differences across examples of Labor Markets.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Labor Markets.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Labor Markets is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
