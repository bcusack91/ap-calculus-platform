...
**Part 4 of 7 — Conditions and Degrees of Freedom**

---

### Key Concepts

This section covers essential concepts related to **conditions and degrees of freedom** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Conditions and Degrees of Freedom Check** 🎯
      `,
      exercise: {
        questions: [
          {
