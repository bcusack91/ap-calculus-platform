export const hgUrbanizationPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Urbanization & Urban Models across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Urbanization & Urban Models?

2) What concept describes a specific real-world example that illustrates Urbanization & Urban Models?

3) Name the term for analyzing similarities and differences across examples of Urbanization & Urban Models.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Urbanization & Urban Models), Case study (A specific real-world example that illustrates Urbanization & Urban Models), and Comparison (Analyzing similarities and differences across examples of Urbanization & Urban Models).'
      }
    },
    {
      id: 'hgurbani3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Urbanization & Urban Models is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Urbanization & Urban Models describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Urbanization & Urban Models is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Urbanization & Urban Models. Case study — A specific real-world example that illustrates Urbanization & Urban Models. Comparison — Analyzing similarities and differences across examples of Urbanization & Urban Models.'
      }
    },
    {
      id: 'hgurbani3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Urbanization & Urban Models.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Urbanization & Urban Models. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Urbanization & Urban Models is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
