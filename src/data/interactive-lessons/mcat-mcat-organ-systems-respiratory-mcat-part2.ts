        ...
        questions: [
          {
            ...
            options: [`CO blocks O2 diffusion across the alveolar membrane, lowering dissolved O2`, `CO occupies heme sites and left-shifts the curve, cutting O2 content`, `CO drives hyperventilation that blows off O2 before tissue delivery`, `CO oxidizes heme iron to the ferric state, forming methemoglobin`],
            correctAnswer: 1,
            explanation: `Arterial $P_{O_2}$ measures only DISSOLVED oxygen, which depends on the alveoli — and alveolar exchange is fine, so dissolved O2 is unchanged. CO outcompetes O2 for heme (~250x affinity), slashing O2 content, and shifts remaining sites toward the R state (left shift), impairing unloading as well. (Oxidized Fe$^{3+}$ is methemoglobin — a different lesion, not caused by CO.)`
          },
          {
            question: `Compared with hemoglobin, myoglobin's oxygen-binding curve is:`,
            options: [`Sigmoidal, with higher O2 affinity than hemoglobin`, `Sigmoidal but right-shifted, favoring O2 release in muscle`, `Hyperbolic, with higher O2 affinity than hemoglobin`, `Hyperbolic, with lower O2 affinity than hemoglobin`],
            correctAnswer: 2,
            explanation: `Cooperativity requires multiple interacting subunits; monomeric myoglobin binds one O2 with simple saturable (hyperbolic) kinetics, so no sigmoidal shape is possible. Its affinity is HIGHER than hemoglobin's at every relevant pressure, not lower — that is precisely what lets muscle strip O2 from arriving blood and store it for use when demand spikes.`
          },
          {
            question: `Most carbon dioxide produced by tissues travels to the lungs:`,
            options: [`Bound to the iron of heme groups`, `As CO2 physically dissolved in plasma`, `As carbamino compounds on hemoglobin`, `As bicarbonate ion in the plasma`],
            correctAnswer: 3,
