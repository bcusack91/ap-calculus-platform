...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'y-intercept',
            options: ['Doubling time: solve a · 2ᵗ/ᵈ or use the formula d = ln(2)/ln(b).', 'growth/decay factor per time period.', 'initial value in context.', 'Exponent: often involves time.']
          },
          {
            label: 'Base',
            options: ['initial value in context.', 'Exponent: often involves time.', 'Doubling time: solve a · 2ᵗ/ᵈ or use the formula d = ln(2)/ln(b).', 'growth/decay factor per time period.']
          },
          {
            label: 'Key Insight',
            options: ['Doubling time: solve a · 2ᵗ/ᵈ or use the formula d = ln(2)/ln(b).', 'Exponent: often involves time.', 'initial value in context.', 'growth/decay factor per time period.']
          }
        ],
        ...
        explanation: 'Each concept in Review & Applications describes a specific idea. y-intercept: initial value in context. Base: growth/decay factor per time period. Key Insight: Exponent: often involves time.'
      }
    }
  ]
}
