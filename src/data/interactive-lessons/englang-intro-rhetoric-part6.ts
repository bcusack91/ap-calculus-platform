export const englangIntroRhetoricPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Introduction to Rhetoric, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Introduction to Rhetoric requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Introduction to Rhetoric?

2) What concept describes making evidence-based claims about Introduction to Rhetoric?

3) Name the term for using geographic thinking to analyze Introduction to Rhetoric.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Introduction to Rhetoric), Argumentation (Making evidence-based claims about Introduction to Rhetoric), and Spatial reasoning (Using geographic thinking to analyze Introduction to Rhetoric).'
      }
    },
    {
      id: 'englangi6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Introduction to Rhetoric is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Introduction to Rhetoric describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Introduction to Rhetoric is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Introduction to Rhetoric. Argumentation — Making evidence-based claims about Introduction to Rhetoric. Spatial reasoning — Using geographic thinking to analyze Introduction to Rhetoric.'
      }
    },
    {
      id: 'englangi6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Introduction to Rhetoric.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Introduction to Rhetoric and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Introduction to Rhetoric. The best approach is:',
            options: [
