...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whglobalizationtech4-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to cultural diffusion and hybrid identities.
- Compare two regions or states affected by backlash and anti-globalization movements.
- Evaluate continuity and change involving integration of global markets and finance.
`
    },
    {
      id: 'whglobalizationtech4-dropdown',
