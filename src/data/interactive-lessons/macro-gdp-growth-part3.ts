export const macroGdpGrowthPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within GDP & Economic Growth |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of GDP & Economic Growth across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macrogdp3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within GDP & Economic Growth. Understanding this concept is essential for mastering GDP & Economic Growth in AP Macroeconomics.
...
1) What term refers to a recurring structure within GDP & Economic Growth?

2) What concept describes a specific real-world example that illustrates GDP & Economic Growth?

3) Name the term for analyzing similarities and differences across examples of GDP & Economic Growth.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within GDP & Economic Growth), Case study (A specific real-world example that illustrates GDP & Economic Growth), and Comparison (Analyzing similarities and differences across examples of GDP & Economic Growth).'
      }
    },
    {
      id: 'macrogdp3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within GDP & Economic Growth is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates GDP & Economic Growth describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of GDP & Economic Growth is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within GDP & Economic Growth. Case study — A specific real-world example that illustrates GDP & Economic Growth. Comparison — Analyzing similarities and differences across examples of GDP & Economic Growth.'
      }
    },
    {
      id: 'macrogdp3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of GDP & Economic Growth.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of GDP & Economic Growth. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in GDP & Economic Growth is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
