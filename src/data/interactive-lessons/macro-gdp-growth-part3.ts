...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of GDP & Economic Growth across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to GDP & Economic Growth?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to GDP & Economic Growth), Case study (A specific real-world example that illustrates GDP & Economic Growth), and Comparison (Analyzing similarities and differences across examples of GDP & Economic Growth).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to GDP & Economic Growth is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to GDP & Economic Growth. Case study — A specific real-world example that illustrates GDP & Economic Growth. Comparison — Analyzing similarities and differences across examples of GDP & Economic Growth.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of GDP & Economic Growth.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in GDP & Economic Growth is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
