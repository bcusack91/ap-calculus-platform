...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Supply & Demand |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Supply & Demand across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Supply & Demand. Understanding this concept is essential for mastering Supply & Demand in AP Microeconomics.
...
1) What term refers to a recurring structure within Supply & Demand?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Supply & Demand), Case study (A specific real-world example that illustrates Supply & Demand), and Comparison (Analyzing similarities and differences across examples of Supply & Demand).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Supply & Demand is called ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Supply & Demand. Case study — A specific real-world example that illustrates Supply & Demand. Comparison — Analyzing similarities and differences across examples of Supply & Demand.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Supply & Demand.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Supply & Demand is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
