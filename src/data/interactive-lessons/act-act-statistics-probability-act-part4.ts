...
**Part 4 of 7 — Conditional probability tables**
...
- P(A or B) = P(A) + P(B) - P(A and B)\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "What is the mean of 12, 16, and 20?",
              options: [
                "18",
                "16",
                "8",
              ...
              correctAnswer: 1,
              explanation: "Mean is (12+16+20)/3 = 16."
            },
            {
