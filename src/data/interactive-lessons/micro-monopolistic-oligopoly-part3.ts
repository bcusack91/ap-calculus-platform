...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Monopolistic Competition & Oligopoly across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Monopolistic Competition & Oligopoly?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Monopolistic Competition & Oligopoly), Case study (A specific real-world example that illustrates Monopolistic Competition & Oligopoly), and Comparison (Analyzing similarities and differences across examples of Monopolistic Competition & Oligopoly).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Monopolistic Competition & Oligopoly is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Monopolistic Competition & Oligopoly. Case study — A specific real-world example that illustrates Monopolistic Competition & Oligopoly. Comparison — Analyzing similarities and differences across examples of Monopolistic Competition & Oligopoly.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Monopolistic Competition & Oligopoly.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Monopolistic Competition & Oligopoly is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
