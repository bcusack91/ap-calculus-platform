...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whglobalizationtech3-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to digital revolution and information flows.
- Compare two regions or states affected by cultural diffusion and hybrid identities.
- Evaluate continuity and change involving backlash and anti-globalization movements.
`
    },
    {
      id: 'whglobalizationtech3-dropdown',
