export const apushReformMovementsPart6Data = {
...
| Concept | Description |
|---------|-------------|
| **Data interpretation** | Analyzing maps, graphs, and tables related to Reform Movements & Antebellum Era |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Reform Movements & Antebellum Era, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Reform Movements & Antebellum Era requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Reform Movements & Antebellum Era?

2) What concept describes making evidence-based claims about Reform Movements & Antebellum Era?

3) Name the term for using geographic thinking to analyze Reform Movements & Antebellum Era.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Reform Movements & Antebellum Era), Argumentation (Making evidence-based claims about Reform Movements & Antebellum Era), and Spatial reasoning (Using geographic thinking to analyze Reform Movements & Antebellum Era).'
      }
    },
    {
      id: 'apushref6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Reform Movements & Antebellum Era is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Reform Movements & Antebellum Era describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Reform Movements & Antebellum Era is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Reform Movements & Antebellum Era. Argumentation — Making evidence-based claims about Reform Movements & Antebellum Era. Spatial reasoning — Using geographic thinking to analyze Reform Movements & Antebellum Era.'
      }
    },
    {
      id: 'apushref6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Reform Movements & Antebellum Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Reform Movements & Antebellum Era and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Reform Movements & Antebellum Era. The best approach is:',
            options: [
