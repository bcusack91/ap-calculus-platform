...
**Quick Check**
    ...
    {
      id: 'calcbcalternating-p4-example',
      type: 'text' as const,
      content: `
## Worked Example
...
Students often report only the numeric value and skip interpretation. On AP-style items, interpretation can be required for full credit.
    ...
    {
      id: 'calcbcalternating-p4-inputs',
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcalternating-p4-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcalternating-p4-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
