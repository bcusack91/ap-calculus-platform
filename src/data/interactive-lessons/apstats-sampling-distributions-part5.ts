...
**Part 5 of 7 — Conditions for Inference**

---

### Key Concepts

This section covers essential concepts related to **conditions for inference** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Conditions for Inference Check** 🎯
      `,
      exercise: {
        questions: [
          {
