export const calcbcExamStrategyPart5Data = {
  ...
  sections: [
    {
      id: 'calcbcexamstrategy-p5-intro',
      type: 'text' as const,
      content: `
# Bc Exam Strategies
...
**Quick Check**
    ...
    {
      id: 'calcbcexamstrategy-p5-example',
      type: 'text' as const,
      content: `
## Worked Example
...
Students often report only the numeric value and skip interpretation. On AP-style items, interpretation can be required for full credit.
    ...
    {
      id: 'calcbcexamstrategy-p5-inputs',
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcexamstrategy-p5-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcexamstrategy-p5-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
