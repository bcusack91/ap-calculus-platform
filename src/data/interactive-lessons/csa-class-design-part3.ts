export const csaClassDesignPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Class Design & Encapsulation |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Class Design & Encapsulation across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'csaclass3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Class Design & Encapsulation. Understanding this concept is essential for mastering Class Design & Encapsulation in AP Computer Science A.
...
1) What term refers to a recurring structure within Class Design & Encapsulation?

2) What concept describes a specific real-world example that illustrates Class Design & Encapsulation?

3) Name the term for analyzing similarities and differences across examples of Class Design & Encapsulation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Class Design & Encapsulation), Case study (A specific real-world example that illustrates Class Design & Encapsulation), and Comparison (Analyzing similarities and differences across examples of Class Design & Encapsulation).'
      }
    },
    {
      id: 'csaclass3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Class Design & Encapsulation is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Class Design & Encapsulation describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Class Design & Encapsulation is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Class Design & Encapsulation. Case study — A specific real-world example that illustrates Class Design & Encapsulation. Comparison — Analyzing similarities and differences across examples of Class Design & Encapsulation.'
      }
    },
    {
      id: 'csaclass3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Class Design & Encapsulation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Class Design & Encapsulation. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Class Design & Encapsulation is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
