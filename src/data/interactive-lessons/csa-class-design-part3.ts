...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Class Design & Encapsulation across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Class Design & Encapsulation?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Class Design & Encapsulation), Case study (A specific real-world example that illustrates Class Design & Encapsulation), and Comparison (Analyzing similarities and differences across examples of Class Design & Encapsulation).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Class Design & Encapsulation is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Class Design & Encapsulation. Case study — A specific real-world example that illustrates Class Design & Encapsulation. Comparison — Analyzing similarities and differences across examples of Class Design & Encapsulation.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Class Design & Encapsulation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Class Design & Encapsulation is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
