...
**Part 2 of 7 — One-Sample Z-Interval for Proportions**

---

### Key Concepts

This section covers essential concepts related to **one-sample z-interval for proportions** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**One-Sample Z-Interval for Proportions Check** 🎯
      `,
      exercise: {
        questions: [
          {
