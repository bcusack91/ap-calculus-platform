export const hgAgriculturalOriginsPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Origins & Diffusion of Agriculture across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Origins & Diffusion of Agriculture?

2) What concept describes a specific real-world example that illustrates Origins & Diffusion of Agriculture?

3) Name the term for analyzing similarities and differences across examples of Origins & Diffusion of Agriculture.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Origins & Diffusion of Agriculture), Case study (A specific real-world example that illustrates Origins & Diffusion of Agriculture), and Comparison (Analyzing similarities and differences across examples of Origins & Diffusion of Agriculture).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Origins & Diffusion of Agriculture is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Origins & Diffusion of Agriculture describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Origins & Diffusion of Agriculture is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Origins & Diffusion of Agriculture. Case study — A specific real-world example that illustrates Origins & Diffusion of Agriculture. Comparison — Analyzing similarities and differences across examples of Origins & Diffusion of Agriculture.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Origins & Diffusion of Agriculture.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Origins & Diffusion of Agriculture. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Origins & Diffusion of Agriculture is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
