export const englangDictionSyntaxPart7Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'The most important exam strategy for Diction & Syntax is:',
            options: [
              'Guess randomly',
          ...
          {
            question: 'AP multiple-choice questions about Diction & Syntax often test:',
            options: [
              'Random trivia',
...
1) What term refers to essential terms and definitions for Diction & Syntax?

2) What concept describes the most frequent ways Diction & Syntax is tested on the AP exam?

3) Name the term for approaches for answering Diction & Syntax questions effectively.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: E',
        explanation: 'Expected answers: Key vocabulary (Essential terms and definitions for Diction & Syntax), Common question types (The most frequent ways Diction & Syntax is tested on the AP exam), and Exam strategy (Approaches for answering Diction & Syntax questions effectively).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Essential terms and definitions for Diction & Syntax is called ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'None of these']
          },
          {
            label: 'The most frequent ways Diction & Syntax is tested on the AP exam describes ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'All of these']
          },
          {
            label: 'Approaches for answering Diction & Syntax questions effectively is known as ___',
        ...
        explanation: 'Key vocabulary — Essential terms and definitions for Diction & Syntax. Common question types — The most frequent ways Diction & Syntax is tested on the AP exam. Exam strategy — Approaches for answering Diction & Syntax questions effectively.'
      }
    },
    {
...
- Don\'\'t confuse **Key vocabulary** with **Common question types** — while related, they address different aspects of Diction & Syntax.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, a question presents a scenario you have never seen before about Diction & Syntax. You should:',
            options: [
              'Panic',
          ...
          {
            question: 'For free-response questions on Diction & Syntax, the most common mistake is:',
            options: [
              'Writing too clearly',
