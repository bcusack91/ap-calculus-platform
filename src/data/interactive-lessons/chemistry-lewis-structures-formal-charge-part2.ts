  ...
  sections: [
    ...
    },
    {
      ...
      exercise: {
        inputs: [
          {
            label: 'Total valence electrons in NF₃',
            correctAnswer: '26',
            explanation: 'N has 5 valence e⁻ and each F has 7. Total = 5 + 3(7) = 5 + 21 = 26.'
          },
          {
            label: 'Electrons remaining after drawing 3 single N—F bonds',
            correctAnswer: '20',
            explanation: '3 bonds × 2 e⁻ = 6 electrons used. 26 − 6 = 20 electrons remain.'
          },
          {
            label: 'How many lone pairs are on the nitrogen atom in the final structure?',
            correctAnswer: '1',
