...
3) Earth orbits the Sun at $v \\approx 30{,}000$ m/s in a roughly circular orbit of radius $1.5 \\times 10^{11}$ m. What is Earth's centripetal acceleration (in $m/s^{2}$, to 3 significant figures)?
      `,
      exercise: {
        boxes: 3,
        ...
        hint3: '$a_c = v^2/r$.',
        explanation: '1) $f = 120/60 = 2$ Hz. $v = 2\\pi(0.5)(2) = 2\\pi = 6.28 \\approx 6.3$ m/s. 2) $T = 90 \\times 60 = 5400$ s. $v = 2\\pi(6.6 \\times 10^6)/5400 = 41.5 \\times 10^6/5400 = 7685 \\approx 7700$ m/s. 3) $a_c = (3 \\times 10^4)^2/(1.5 \\times 10^{11}) = 9 \\times 10^8/1.5 \\times 10^{11} = 6 \\times 10^{-3} = 0.006$ $m/s^{2}$.'
      }
    },
    {
      id: 'uc6-applied-quiz',
...
**Applied Problems** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'A centrifuge with radius 0.1 m produces an acceleration of $1000g$ ($g = 10$ $m/s^{2}$). Its rotation frequency is approximately:',
            options: [
              '16 Hz',
              '50 Hz',
              '160 Hz',
...
2) An amusement park ride spins riders in a circle of radius 8 m. If the maximum safe centripetal acceleration is $3g$ ($g = 10$ $m/s^{2}$), what is the maximum allowed speed (in m/s, round to 3 significant figures)?

3) A wheel of radius 0.4 m accelerates from rest to 10 rad/s in 5 s. What is the tangential acceleration of a point on the rim $(in m/s^{2})$?
      `,
      exercise: {
        boxes: 3,
        ...
        explanation: '1) $d_{outer} = 2\\pi(0.15)(33.3) = 31.4$ m. $d_{inner} = 2\\pi(0.05)(33.3) = 10.5$ m. Difference: $31.4 - 10.5 = 20.9$ m. 2) $v = \\sqrt{30 \\times 8} = \\sqrt{240} = 15.49 \\approx 15.5$ m/s. 3) $\\alpha = 10/5 = 2$ $rad/s^{2}$. $a_t = r\\alpha = 0.4 \\times 2 = 0.8$ $m/s^{2}$.'
      }
    },
    {
      id: 'uc6-dropdown',
...
**Quick Checks** 🔍
      ...
      exercise: {
        dropdowns: [
          ...
          {
            label: 'A point moves in a circle of radius 1 m at $v = 10$ m/s. Its centripetal acceleration compared to gravity ($g = 10$ $m/s^{2}$) is:',
            options: ['About 1g', 'About 10g', 'About 100g', 'Much less than g'],
            correctIndex: 1,
            explanation: '$a_c = v^2/r = 100/1 = 100$ $m/s^{2}$ $= 10g$.'
          },
          {
            ...
            options: ['0.03 $m/s^{2}$', '0.3 $m/s^{2}$', '3 $m/s^{2}$', '10 $m/s^{2}$'],
            correctIndex: 0,
            explanation: '$T = 86400$ s. $a_c = 4\\pi^2(6.4 \\times 10^6)/(86400)^2 = 2.53 \\times 10^8/7.46 \\times 10^9 = 0.034 \\approx 0.03$ $m/s^{2}$. Very small compared to $g$!'
          }
        ]
      }
    },
      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 2,
            explanation: '$f = 1200/60 = 20$ Hz. $a_c = 4\\pi^2(0.25)(20)^2 = 4(9.87)(0.25)(400) = 3948 \\approx 4000$ $m/s^{2}$ (about $400g$!).'
          }
        ]
      }
    }
