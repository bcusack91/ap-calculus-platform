...
**Part 2 of 7 — Experiments and setup logic**
...
Keep your process measurable: spend about 15–20 seconds scanning a figure and save full reading for questions that require detail.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "A table shows reaction yield rising from 50% at trial 1 to 68% at trial 2 and 86% at trial 3. Which statement is best supported?",
              options: [
              ...
              correctAnswer: 1,
              explanation: "The values 50%, 68%, and 86% increase each trial, so the supported claim is a rising trend."
            },
            {
              question: "A graph shows temperature at 22°C and 32°C with all other conditions fixed. If output is higher at 32°C, what is the safest inference?",
              options: [
...
3) You spend 2 minutes 20 seconds on a hard item but target 50 seconds. Enter how many extra seconds you used.\n        `,
      ...
      {
        id: "act-rsci-p2-strategy",
        type: 'text' as const,
        content: `\n## Trap Avoidance for Experiments and setup logic
