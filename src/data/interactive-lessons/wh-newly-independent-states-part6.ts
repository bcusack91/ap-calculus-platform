export const whNewlyIndependentStatesPart6Data = {
  topicSlug: 'wh-newly-independent-states',
  sections: [
    {
      id: 'whnewlyindependentstates6-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whnewlyindependentstates6-mcq',
    ...
    {
      id: 'whnewlyindependentstates6-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to nation-building after formal empire.
- Compare two regions or states affected by borders, ethnicity, and political legitimacy.
- Evaluate continuity and change involving economic development strategies and debt.
`
    },
    {
      id: 'whnewlyindependentstates6-dropdown',
    ...
    {
      id: 'whnewlyindependentstates6-ap',
      type: 'multiple-choice' as const,
