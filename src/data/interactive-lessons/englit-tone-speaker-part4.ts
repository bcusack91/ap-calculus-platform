export const englitToneSpeakerPart4Data = {
...
| Concept | Description |
|---------|-------------|
| **Interconnection** | How Tone, Voice & Speaker links to other course topics |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Tone, Voice & Speaker connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Tone, Voice & Speaker means:',
            options: [
              'The process stops',
...
1) What term refers to how Tone, Voice & Speaker links to other course topics?

2) What concept describes how Tone, Voice & Speaker operates differently at local, national, and global scales?

3) Name the term for how outcomes of Tone, Voice & Speaker can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Tone, Voice & Speaker links to other course topics), Scale interaction (How Tone, Voice & Speaker operates differently at local, national, and global scales), and Feedback loop (How outcomes of Tone, Voice & Speaker can reinforce or modify the original process).'
      }
    },
    {
      id: 'englitto4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Tone, Voice & Speaker links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Tone, Voice & Speaker operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Tone, Voice & Speaker can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Tone, Voice & Speaker links to other course topics. Scale interaction — How Tone, Voice & Speaker operates differently at local, national, and global scales. Feedback loop — How outcomes of Tone, Voice & Speaker can reinforce or modify the original process.'
      }
    },
    {
      id: 'englitto4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Tone, Voice & Speaker.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Tone, Voice & Speaker and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Tone, Voice & Speaker produces outcomes that further intensify the original process, this is:',
            options: [
