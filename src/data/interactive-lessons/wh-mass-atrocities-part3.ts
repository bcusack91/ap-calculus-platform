...
- Explain one cause and one effect linked to resistance, rescue, and survival strategies.
- Compare two regions or states affected by international responses and failures of intervention.
- Evaluate continuity and change involving human-rights law and memory politics.
`
    },
    {
      id: 'whmassatrocities3-dropdown',
