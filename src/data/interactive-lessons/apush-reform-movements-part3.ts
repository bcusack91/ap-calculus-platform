...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Reform Movements & Antebellum Era across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Reform Movements & Antebellum Era?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Reform Movements & Antebellum Era), Case study (A specific real-world example that illustrates Reform Movements & Antebellum Era), and Comparison (Analyzing similarities and differences across examples of Reform Movements & Antebellum Era).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Reform Movements & Antebellum Era is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Reform Movements & Antebellum Era. Case study — A specific real-world example that illustrates Reform Movements & Antebellum Era. Comparison — Analyzing similarities and differences across examples of Reform Movements & Antebellum Era.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Reform Movements & Antebellum Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Reform Movements & Antebellum Era is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
