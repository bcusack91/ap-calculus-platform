export const apushReformMovementsPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Reform Movements & Antebellum Era |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Reform Movements & Antebellum Era across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushref3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Reform Movements & Antebellum Era. Understanding this concept is essential for mastering Reform Movements & Antebellum Era in AP US History.
...
1) What term refers to a recurring structure within Reform Movements & Antebellum Era?

2) What concept describes a specific real-world example that illustrates Reform Movements & Antebellum Era?

3) Name the term for analyzing similarities and differences across examples of Reform Movements & Antebellum Era.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Reform Movements & Antebellum Era), Case study (A specific real-world example that illustrates Reform Movements & Antebellum Era), and Comparison (Analyzing similarities and differences across examples of Reform Movements & Antebellum Era).'
      }
    },
    {
      id: 'apushref3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Reform Movements & Antebellum Era is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Reform Movements & Antebellum Era describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Reform Movements & Antebellum Era is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Reform Movements & Antebellum Era. Case study — A specific real-world example that illustrates Reform Movements & Antebellum Era. Comparison — Analyzing similarities and differences across examples of Reform Movements & Antebellum Era.'
      }
    },
    {
      id: 'apushref3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Reform Movements & Antebellum Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Reform Movements & Antebellum Era. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Reform Movements & Antebellum Era is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
