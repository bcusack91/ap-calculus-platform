export const csaLoopsPart6Data = {
  topicSlug: 'csa-loops',
  sections: [
    {
      id: 'csaloops6-intro',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Advanced Loop Patterns, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Advanced Loop Patterns requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Advanced Loop Patterns?

2) What concept describes making evidence-based claims about Advanced Loop Patterns?

3) Name the term for using geographic thinking to analyze Advanced Loop Patterns.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Advanced Loop Patterns), Argumentation (Making evidence-based claims about Advanced Loop Patterns), and Spatial reasoning (Using geographic thinking to analyze Advanced Loop Patterns).'
      }
    },
    {
      id: 'csaloops6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Advanced Loop Patterns is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Advanced Loop Patterns describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Advanced Loop Patterns is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Advanced Loop Patterns. Argumentation — Making evidence-based claims about Advanced Loop Patterns. Spatial reasoning — Using geographic thinking to analyze Advanced Loop Patterns.'
      }
    },
    {
      id: 'csaloops6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Advanced Loop Patterns.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Advanced Loop Patterns and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Advanced Loop Patterns. The best approach is:',
            options: [
