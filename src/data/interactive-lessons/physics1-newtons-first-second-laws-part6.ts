        ...
        questions: [
          {
            ...
            correctAnswer: 3,
            explanation: 'First: $a = F/m = 28/4 = 7$ $m/s^{2}$. Then: $d = \\frac{1}{2}at^2 = \\frac{1}{2}(7)(3)^2 = \\frac{1}{2}(7)(9) = 31.5$ m.'
          },
          {
...
1) A 8 kg block on a frictionless floor is pushed with 56 N horizontally. What is the acceleration $(in m/s^{2})$?

2) The same block from #1 starts from rest. What is its speed (in m/s) after 4 seconds?

3) A 5 kg mass hangs from a string. The string is pulled upward so the mass accelerates upward at 2 $m/s^{2}$. What is the tension in the string (in N)? Use $g = 9.8$ $m/s^{2}$.
      `,
      exercise: {
        boxes: 3,
        ...
        explanation: '1) $a = 56/8 = 7$ $m/s^{2}$. 2) $v = 0 + 7 \\times 4 = 28$ m/s. 3) $T = 5(9.8 + 2) = 5 \\times 11.8 = 59$ N.'
      }
    },
    {
      ...
      exercise: {
        dropdowns: [
          ...
          },
          {
            ...
            options: ['0 $m/s^{2}$', '4.9 $m/s^{2}$', '9.8 $m/s^{2}$', '19.6 $m/s^{2}$'],
            correctIndex: 2,
            explanation: 'After cutting, only gravity acts: $a = g = 9.8$ $m/s^{2}$ downward (free fall).'
          },
          {
...
**Exit Quiz — Problem-Solving Workshop** ✅
      ...
      exercise: {
        questions: [
          {
            question: 'A 2 kg block on a frictionless table is connected by a string over a frictionless pulley to a hanging 1 kg block. What is the acceleration of the system? ($g = 9.8$ $m/s^{2}$)',
            options: [
              '3.27 $m/s^{2}$',
              '4.9 $m/s^{2}$',
              '6.53 $m/s^{2}$',
            ...
            correctAnswer: 0,
            explanation: 'The net force on the system is the weight of the hanging block: $F_{\\text{net}} = m_2 g = 1(9.8) = 9.8$ N. Total mass = $m_1 + m_2 = 3$ kg. $a = 9.8/3 = 3.27$ $m/s^{2}$.'
          },
          {
            ...
            correctAnswer: 1,
            explanation: '$F_x = 500\\cos 30° = 500 \\times 0.866 = 433$ N. $a = F_x/m = 433/40 = 10.8$ $m/s^{2}$.'
          }
        ]
      }
    }
