...
| Concept | Description |
|---------|-------------|
| **Data interpretation** | Analyzing maps, graphs, and tables related to Separation of Powers |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Separation of Powers, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Separation of Powers requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Separation of Powers?

2) What concept describes making evidence-based claims about Separation of Powers?

3) Name the term for using geographic thinking to analyze Separation of Powers.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Separation of Powers), Argumentation (Making evidence-based claims about Separation of Powers), and Spatial reasoning (Using geographic thinking to analyze Separation of Powers).'
      }
    },
    {
      id: 'govsepar6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Separation of Powers is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Separation of Powers describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Separation of Powers is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Separation of Powers. Argumentation — Making evidence-based claims about Separation of Powers. Spatial reasoning — Using geographic thinking to analyze Separation of Powers.'
      }
    },
    {
      id: 'govsepar6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Separation of Powers.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Separation of Powers and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Separation of Powers. The best approach is:',
            options: [
