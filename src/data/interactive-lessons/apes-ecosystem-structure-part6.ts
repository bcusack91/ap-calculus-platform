export const apesEcosystemStructurePart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Ecosystem Structure & Function, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Ecosystem Structure & Function requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Ecosystem Structure & Function?

2) What concept describes making evidence-based claims about Ecosystem Structure & Function?

3) Name the term for using geographic thinking to analyze Ecosystem Structure & Function.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Ecosystem Structure & Function), Argumentation (Making evidence-based claims about Ecosystem Structure & Function), and Spatial reasoning (Using geographic thinking to analyze Ecosystem Structure & Function).'
      }
    },
    {
      id: 'apesecos6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Ecosystem Structure & Function is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Ecosystem Structure & Function describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Ecosystem Structure & Function is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Ecosystem Structure & Function. Argumentation — Making evidence-based claims about Ecosystem Structure & Function. Spatial reasoning — Using geographic thinking to analyze Ecosystem Structure & Function.'
      }
    },
    {
      id: 'apesecos6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Ecosystem Structure & Function.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Ecosystem Structure & Function and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Ecosystem Structure & Function. The best approach is:',
            options: [
