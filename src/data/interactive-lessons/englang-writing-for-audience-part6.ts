export const englangWritingForAudiencePart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Writing for Different Audiences, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Writing for Different Audiences requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Writing for Different Audiences?

2) What concept describes making evidence-based claims about Writing for Different Audiences?

3) Name the term for using geographic thinking to analyze Writing for Different Audiences.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Writing for Different Audiences), Argumentation (Making evidence-based claims about Writing for Different Audiences), and Spatial reasoning (Using geographic thinking to analyze Writing for Different Audiences).'
      }
    },
    {
      id: 'englangw6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Writing for Different Audiences. Argumentation — Making evidence-based claims about Writing for Different Audiences. Spatial reasoning — Using geographic thinking to analyze Writing for Different Audiences.'
      }
    },
    {
      id: 'englangw6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Writing for Different Audiences.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Writing for Different Audiences and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Writing for Different Audiences. The best approach is:',
            options: [
