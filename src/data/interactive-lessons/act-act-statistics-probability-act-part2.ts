...
**Part 2 of 7 — Spread: range and IQR**
...
- P(A or B) = P(A) + P(B) - P(A and B)\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "What is the mean of 10, 14, and 18?",
              options: [
                "16",
                "14",
                "8",
              ...
              correctAnswer: 1,
              explanation: "Mean is (10+14+18)/3 = 14."
            },
            {
