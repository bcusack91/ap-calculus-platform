export const englangDictionSyntaxPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Diction & Syntax?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Diction & Syntax helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Diction & Syntax?

2) What concept describes a secondary process that shapes outcomes in Diction & Syntax?

3) Name the term for the relationship between actions and outcomes in Diction & Syntax.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Diction & Syntax), Process 2 (A secondary process that shapes outcomes in Diction & Syntax), and Cause and effect (The relationship between actions and outcomes in Diction & Syntax).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Diction & Syntax. Process 2 — A secondary process that shapes outcomes in Diction & Syntax. Cause and effect — The relationship between actions and outcomes in Diction & Syntax.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Diction & Syntax.
