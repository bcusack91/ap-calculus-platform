...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            ...
            options: ['Work with one side at a time to transform it into the other', 'Convert everything to sine and cosine as a strategy', 'Use Pythagorean identities to simplify', 'Factor, combine fractions, or multiply by conjugates']
          },
          {
            label: 'Convert everything to sine and cosine…',
            options: ['Work with one side at a time to transform it into the other', 'Use Pythagorean identities to simplify', 'Convert everything to sine and cosine as a strategy', 'Factor, combine fractions, or multiply by conjugates']
          },
          {
            label: 'Factor, combine fractions, or multiply…',
            options: ['Use Pythagorean identities to simplify', 'Convert everything to sine and cosine as a strategy', 'Factor, combine fractions, or multiply by conjugates', 'Work with one side at a time to transform it into the other']
          }
        ],
        ...
        explanation: 'Each concept in Review & Applications describes a specific idea. Work with one side at a time to transform it into the other. Convert everything to sine and cosine as a strategy. Factor, combine fractions, or multiply by conjugates.'
      }
    }
  ]
}
