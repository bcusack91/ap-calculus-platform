export const microGovernmentInterventionPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Government Intervention |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Government Intervention across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'microgov3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Government Intervention. Understanding this concept is essential for mastering Government Intervention in AP Microeconomics.
...
1) What term refers to a recurring structure within Government Intervention?

2) What concept describes a specific real-world example that illustrates Government Intervention?

3) Name the term for analyzing similarities and differences across examples of Government Intervention.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Government Intervention), Case study (A specific real-world example that illustrates Government Intervention), and Comparison (Analyzing similarities and differences across examples of Government Intervention).'
      }
    },
    {
      id: 'microgov3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Government Intervention is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Government Intervention describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Government Intervention is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Government Intervention. Case study — A specific real-world example that illustrates Government Intervention. Comparison — Analyzing similarities and differences across examples of Government Intervention.'
      }
    },
    {
      id: 'microgov3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Government Intervention.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Government Intervention. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Government Intervention is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
