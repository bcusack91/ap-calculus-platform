...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Government Intervention across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Government Intervention?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Government Intervention), Case study (A specific real-world example that illustrates Government Intervention), and Comparison (Analyzing similarities and differences across examples of Government Intervention).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Government Intervention is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Government Intervention. Case study — A specific real-world example that illustrates Government Intervention. Comparison — Analyzing similarities and differences across examples of Government Intervention.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Government Intervention.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Government Intervention is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
