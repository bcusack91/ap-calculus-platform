export const englangClaimsEvidencePart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Claims & Evidence?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Claims & Evidence helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Claims & Evidence?

2) What concept describes a secondary process that shapes outcomes in Claims & Evidence?

3) Name the term for the relationship between actions and outcomes in Claims & Evidence.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Claims & Evidence), Process 2 (A secondary process that shapes outcomes in Claims & Evidence), and Cause and effect (The relationship between actions and outcomes in Claims & Evidence).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Claims & Evidence is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Claims & Evidence describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Claims & Evidence is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Claims & Evidence. Process 2 — A secondary process that shapes outcomes in Claims & Evidence. Cause and effect — The relationship between actions and outcomes in Claims & Evidence.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Claims & Evidence.
