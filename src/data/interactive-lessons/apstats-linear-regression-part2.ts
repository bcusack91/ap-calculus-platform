...
**Part 2 of 7 — Least-Squares Regression Line**

---

### Key Concepts

This section covers essential concepts related to **least-squares regression line** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Least-Squares Regression Line Check** 🎯
      `,
      exercise: {
        questions: [
          {
