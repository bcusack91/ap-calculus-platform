export const microMonopolyPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Monopoly?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Monopoly helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Monopoly?

2) What concept describes a secondary process that shapes outcomes in Monopoly?

3) Name the term for the relationship between actions and outcomes in Monopoly.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Monopoly), Process 2 (A secondary process that shapes outcomes in Monopoly), and Cause and effect (The relationship between actions and outcomes in Monopoly).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Monopoly is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Monopoly describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Monopoly is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Monopoly. Process 2 — A secondary process that shapes outcomes in Monopoly. Cause and effect — The relationship between actions and outcomes in Monopoly.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Monopoly.
