...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Strings & Objects across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Strings & Objects?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Strings & Objects), Case study (A specific real-world example that illustrates Strings & Objects), and Comparison (Analyzing similarities and differences across examples of Strings & Objects).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Strings & Objects is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Strings & Objects. Case study — A specific real-world example that illustrates Strings & Objects. Comparison — Analyzing similarities and differences across examples of Strings & Objects.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Strings & Objects.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Strings & Objects is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
