        ...
        questions: [
          {
            ...
            correctAnswer: 0,
            explanation: '$V_{disp} = W/(\\rho_{sw} g) = 9000/(1030 \\cdot 10) ≈ 0.874$ m³.'
          },
          {
...
1) A 12 kg block of volume $5.0\\times10^{-3}$ m³ is fully submerged. Apparent weight on a scale (N)?

2) A 2.0 kg piece of foam (volume 0.020 m³) is held UNDER water by a string. String tension (N)?

3) A 1.5 kg wooden block (density 750 kg/m³) floats. Volume submerged (m³)?
      `,
      exercise: {
        boxes: 3,
        ...
        explanation: '1) $W_{app} = 12(10) - 1000(10)(5.0\\times10^{-3}) = 120 - 50 = 70$ N. 2) $F_b = 200$ N, $W = 20$ N → $T = 180$ N. 3) $V_{sub} = 1.5/1000 = 0.0015$ m³.'
      }
    },
    {
      id: 'fb6-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['200 kg/m³', '500 kg/m³', '5000 kg/m³', '8000 kg/m³'],
            correctIndex: 2,
            explanation: '$W_{app}/W = 1 - \\rho_w/\\rho_{obj} = 0.80 \\Rightarrow \\rho_{obj}/\\rho_w = 5 \\Rightarrow \\rho_{obj} = 5000$ kg/m³.'
          },
          {
        ...
        questions: [
          {
            ...
            options: [
              '$2.0\\times10^{-3}$ m³, 10000 kg/m³',
              '$2.0\\times10^{-2}$ m³, 1000 kg/m³',
              '$2.0\\times10^{-3}$ m³, 1000 kg/m³',
              '$2.0\\times10^{-4}$ m³, 100000 kg/m³'
            ],
            correctAnswer: 0,
            explanation: '$F_b = 20$ N → $V = 20/(1000 \\cdot 10) = 2.0\\times10^{-3}$ m³. Mass = 20 kg → density = 20/0.002 = 10000 kg/m³.'
          },
          {
            ...
            correctAnswer: 1,
            explanation: '40% above ⇒ 60% submerged. Density = $0.60 \\times 1000 = 600$ kg/m³.'
          }
        ]
      }
    }
