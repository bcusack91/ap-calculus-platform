export const actReadingStratPart4Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p4-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 4 of 7 — Author tone and purpose**
