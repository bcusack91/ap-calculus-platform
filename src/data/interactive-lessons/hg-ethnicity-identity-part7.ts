export const hgEthnicityIdentityPart7Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'The most important exam strategy for Ethnicity, Race & Identity is:',
            options: [
              'Guess randomly',
          ...
          {
            question: 'AP multiple-choice questions about Ethnicity, Race & Identity often test:',
            options: [
              'Random trivia',
...
1) What term refers to essential terms and definitions for Ethnicity, Race & Identity?

2) What concept describes the most frequent ways Ethnicity, Race & Identity is tested on the AP exam?

3) Name the term for approaches for answering Ethnicity, Race & Identity questions effectively.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: E',
        explanation: 'Expected answers: Key vocabulary (Essential terms and definitions for Ethnicity, Race & Identity), Common question types (The most frequent ways Ethnicity, Race & Identity is tested on the AP exam), and Exam strategy (Approaches for answering Ethnicity, Race & Identity questions effectively).'
      }
    },
    {
      id: 'hgethnic7-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Essential terms and definitions for Ethnicity, Race & Identity is called ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'None of these']
          },
          {
            label: 'The most frequent ways Ethnicity, Race & Identity is tested on the AP exam describes ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'All of these']
          },
          {
            label: 'Approaches for answering Ethnicity, Race & Identity questions effectively is known as ___',
        ...
        explanation: 'Key vocabulary — Essential terms and definitions for Ethnicity, Race & Identity. Common question types — The most frequent ways Ethnicity, Race & Identity is tested on the AP exam. Exam strategy — Approaches for answering Ethnicity, Race & Identity questions effectively.'
      }
    },
    {
      id: 'hgethnic7-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Key vocabulary** with **Common question types** — while related, they address different aspects of Ethnicity, Race & Identity.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, a question presents a scenario you have never seen before about Ethnicity, Race & Identity. You should:',
            options: [
              'Panic',
          ...
          {
            question: 'For free-response questions on Ethnicity, Race & Identity, the most common mistake is:',
            options: [
              'Writing too clearly',
