export const englangIntroRhetoricPart3Data = {
...
3) Name the term for analyzing similarities and differences across examples of Introduction to Rhetoric.
