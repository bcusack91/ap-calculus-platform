...
Precision beats speed-reading in data-heavy passages.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "In a graph, point A is (2, 13) and point B is (4, 21). What is the slope?",
              options: [
                "4.0",
                "0.25",
                "8",
              ...
              correctAnswer: 0,
              explanation: "Slope is rise/run = (21-13)/(4-2) = 4.0."
            },
            {
