export const macroFiscalPolicyToolsPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Fiscal Policy Tools & Outcomes, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Fiscal Policy Tools & Outcomes requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Fiscal Policy Tools & Outcomes?

2) What concept describes making evidence-based claims about Fiscal Policy Tools & Outcomes?

3) Name the term for using geographic thinking to analyze Fiscal Policy Tools & Outcomes.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Fiscal Policy Tools & Outcomes), Argumentation (Making evidence-based claims about Fiscal Policy Tools & Outcomes), and Spatial reasoning (Using geographic thinking to analyze Fiscal Policy Tools & Outcomes).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Fiscal Policy Tools & Outcomes is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Fiscal Policy Tools & Outcomes describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Fiscal Policy Tools & Outcomes is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Fiscal Policy Tools & Outcomes. Argumentation — Making evidence-based claims about Fiscal Policy Tools & Outcomes. Spatial reasoning — Using geographic thinking to analyze Fiscal Policy Tools & Outcomes.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Fiscal Policy Tools & Outcomes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Fiscal Policy Tools & Outcomes and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Fiscal Policy Tools & Outcomes. The best approach is:',
            options: [
