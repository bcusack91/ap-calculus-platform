...
**Part 3 of 7 — Chi-Square Test for Homogeneity**

---

### Key Concepts

This section covers essential concepts related to **chi-square test for homogeneity** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Chi-Square Test for Homogeneity Check** 🎯
      `,
      exercise: {
        questions: [
          {
