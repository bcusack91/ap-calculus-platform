...
Precision beats speed-reading in data-heavy passages.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "In a graph, point A is (6, 25) and point B is (8, 33). What is the slope?",
              options: [
                "4.0",
                "0.25",
                "8",
              ...
              correctAnswer: 0,
              explanation: "Slope is rise/run = (33-25)/(8-6) = 4.0."
            },
            {
