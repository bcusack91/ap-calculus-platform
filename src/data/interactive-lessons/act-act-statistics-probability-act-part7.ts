...
**Part 7 of 7 — Mixed review and test execution**
...
- P(A or B) = P(A) + P(B) - P(A and B)\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "What is the mean of 15, 19, and 23?",
              options: [
                "21",
                "19",
                "8",
              ...
              correctAnswer: 1,
              explanation: "Mean is (15+19+23)/3 = 19."
            },
            {
