export const csaLoopsPart3Data = {
  topicSlug: 'csa-loops',
  sections: [
    {
      id: 'csaloops3-intro',
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Advanced Loop Patterns |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Advanced Loop Patterns across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'csaloops3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Advanced Loop Patterns. Understanding this concept is essential for mastering Advanced Loop Patterns in AP Computer Science A.
...
1) What term refers to a recurring structure within Advanced Loop Patterns?

2) What concept describes a specific real-world example that illustrates Advanced Loop Patterns?

3) Name the term for analyzing similarities and differences across examples of Advanced Loop Patterns.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Advanced Loop Patterns), Case study (A specific real-world example that illustrates Advanced Loop Patterns), and Comparison (Analyzing similarities and differences across examples of Advanced Loop Patterns).'
      }
    },
    {
      id: 'csaloops3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Advanced Loop Patterns is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Advanced Loop Patterns describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Advanced Loop Patterns is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Advanced Loop Patterns. Case study — A specific real-world example that illustrates Advanced Loop Patterns. Comparison — Analyzing similarities and differences across examples of Advanced Loop Patterns.'
      }
    },
    {
      id: 'csaloops3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Advanced Loop Patterns.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Advanced Loop Patterns. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Advanced Loop Patterns is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
