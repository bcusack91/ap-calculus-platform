...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Advanced Loop Patterns across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Advanced Loop Patterns?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Advanced Loop Patterns), Case study (A specific real-world example that illustrates Advanced Loop Patterns), and Comparison (Analyzing similarities and differences across examples of Advanced Loop Patterns).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Advanced Loop Patterns is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Advanced Loop Patterns. Case study — A specific real-world example that illustrates Advanced Loop Patterns. Comparison — Analyzing similarities and differences across examples of Advanced Loop Patterns.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Advanced Loop Patterns.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Advanced Loop Patterns is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
