export const whColdWarDecolonizationPart6Data = {
  ...
  sections: [
    {
      id: 'whcoldwardecolonization6-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whcoldwardecolonization6-mcq',
    ...
    {
      id: 'whcoldwardecolonization6-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whcoldwardecolonization6-dropdown',
    ...
    {
      id: 'whcoldwardecolonization6-ap',
      type: 'multiple-choice' as const,
