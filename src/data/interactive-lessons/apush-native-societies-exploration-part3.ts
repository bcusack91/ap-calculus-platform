export const apushNativeSocietiesExplorationPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Native Societies & European Exploration across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Native Societies & European Exploration?

2) What concept describes a specific real-world example that illustrates Native Societies & European Exploration?

3) Name the term for analyzing similarities and differences across examples of Native Societies & European Exploration.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Native Societies & European Exploration), Case study (A specific real-world example that illustrates Native Societies & European Exploration), and Comparison (Analyzing similarities and differences across examples of Native Societies & European Exploration).'
      }
    },
    {
      id: 'apushnat3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Native Societies & European Exploration is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Native Societies & European Exploration describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Native Societies & European Exploration is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Native Societies & European Exploration. Case study — A specific real-world example that illustrates Native Societies & European Exploration. Comparison — Analyzing similarities and differences across examples of Native Societies & European Exploration.'
      }
    },
    {
      id: 'apushnat3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Native Societies & European Exploration.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Native Societies & European Exploration. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Native Societies & European Exploration is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
