...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Scarcity & Marginal Analysis across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Scarcity & Marginal Analysis?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Scarcity & Marginal Analysis), Case study (A specific real-world example that illustrates Scarcity & Marginal Analysis), and Comparison (Analyzing similarities and differences across examples of Scarcity & Marginal Analysis).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Scarcity & Marginal Analysis is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Scarcity & Marginal Analysis. Case study — A specific real-world example that illustrates Scarcity & Marginal Analysis. Comparison — Analyzing similarities and differences across examples of Scarcity & Marginal Analysis.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Scarcity & Marginal Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Scarcity & Marginal Analysis is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
