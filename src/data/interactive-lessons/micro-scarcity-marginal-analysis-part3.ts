export const microScarcityMarginalAnalysisPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Scarcity & Marginal Analysis |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Scarcity & Marginal Analysis across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'microsca3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Scarcity & Marginal Analysis. Understanding this concept is essential for mastering Scarcity & Marginal Analysis in AP Microeconomics.
...
1) What term refers to a recurring structure within Scarcity & Marginal Analysis?

2) What concept describes a specific real-world example that illustrates Scarcity & Marginal Analysis?

3) Name the term for analyzing similarities and differences across examples of Scarcity & Marginal Analysis.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Scarcity & Marginal Analysis), Case study (A specific real-world example that illustrates Scarcity & Marginal Analysis), and Comparison (Analyzing similarities and differences across examples of Scarcity & Marginal Analysis).'
      }
    },
    {
      id: 'microsca3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Scarcity & Marginal Analysis is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Scarcity & Marginal Analysis describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Scarcity & Marginal Analysis is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Scarcity & Marginal Analysis. Case study — A specific real-world example that illustrates Scarcity & Marginal Analysis. Comparison — Analyzing similarities and differences across examples of Scarcity & Marginal Analysis.'
      }
    },
    {
      id: 'microsca3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Scarcity & Marginal Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Scarcity & Marginal Analysis. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Scarcity & Marginal Analysis is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
