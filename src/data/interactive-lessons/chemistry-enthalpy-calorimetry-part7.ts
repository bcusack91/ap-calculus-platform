...
1) 150.0 mL of 2.00 M HCl reacts with excess NaOH in a coffee-cup calorimeter. The temperature rises by 13.4°C. Assume the solution\'s mass is 150.0 g and $c = 4.184$ J/(g·°C). What is $\\Delta H$ per mole of HCl? (in kJ/mol, to 1 decimal place, include sign)
