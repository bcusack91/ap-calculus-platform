...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Unemployment & Inflation across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Unemployment & Inflation?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Unemployment & Inflation), Case study (A specific real-world example that illustrates Unemployment & Inflation), and Comparison (Analyzing similarities and differences across examples of Unemployment & Inflation).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Unemployment & Inflation is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Unemployment & Inflation. Case study — A specific real-world example that illustrates Unemployment & Inflation. Comparison — Analyzing similarities and differences across examples of Unemployment & Inflation.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Unemployment & Inflation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Unemployment & Inflation is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
