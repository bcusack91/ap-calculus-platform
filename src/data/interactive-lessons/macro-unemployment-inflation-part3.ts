export const macroUnemploymentInflationPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Unemployment & Inflation |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Unemployment & Inflation across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macroune3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Unemployment & Inflation. Understanding this concept is essential for mastering Unemployment & Inflation in AP Macroeconomics.
...
1) What term refers to a recurring structure within Unemployment & Inflation?

2) What concept describes a specific real-world example that illustrates Unemployment & Inflation?

3) Name the term for analyzing similarities and differences across examples of Unemployment & Inflation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Unemployment & Inflation), Case study (A specific real-world example that illustrates Unemployment & Inflation), and Comparison (Analyzing similarities and differences across examples of Unemployment & Inflation).'
      }
    },
    {
      id: 'macroune3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Unemployment & Inflation is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Unemployment & Inflation describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Unemployment & Inflation is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Unemployment & Inflation. Case study — A specific real-world example that illustrates Unemployment & Inflation. Comparison — Analyzing similarities and differences across examples of Unemployment & Inflation.'
      }
    },
    {
      id: 'macroune3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Unemployment & Inflation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Unemployment & Inflation. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Unemployment & Inflation is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
