export const englangClaimsEvidencePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Claims & Evidence |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Claims & Evidence across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Claims & Evidence. Understanding this concept is essential for mastering Claims & Evidence in AP English Language.
...
1) What term refers to a recurring structure within Claims & Evidence?

2) What concept describes a specific real-world example that illustrates Claims & Evidence?

3) Name the term for analyzing similarities and differences across examples of Claims & Evidence.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Claims & Evidence), Case study (A specific real-world example that illustrates Claims & Evidence), and Comparison (Analyzing similarities and differences across examples of Claims & Evidence).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Claims & Evidence is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Claims & Evidence describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Claims & Evidence is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Claims & Evidence. Case study — A specific real-world example that illustrates Claims & Evidence. Comparison — Analyzing similarities and differences across examples of Claims & Evidence.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Claims & Evidence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Claims & Evidence. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Claims & Evidence is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
