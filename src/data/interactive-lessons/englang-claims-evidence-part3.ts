...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Claims & Evidence across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Claims & Evidence?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Claims & Evidence), Case study (A specific real-world example that illustrates Claims & Evidence), and Comparison (Analyzing similarities and differences across examples of Claims & Evidence).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Claims & Evidence is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Claims & Evidence. Case study — A specific real-world example that illustrates Claims & Evidence. Comparison — Analyzing similarities and differences across examples of Claims & Evidence.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Claims & Evidence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Claims & Evidence is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
