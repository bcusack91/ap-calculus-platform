export const csaLoopsPart5Data = {
  topicSlug: 'csa-loops',
  sections: [
    {
      id: 'csaloops5-intro',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Advanced Loop Patterns helps:',
            options: [
          ...
          {
            question: 'Continuity in Advanced Loop Patterns means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Advanced Loop Patterns that have remained stable over time?

2) What concept describes how Advanced Loop Patterns has transformed due to new forces and conditions?

3) Name the term for the direction of change in Advanced Loop Patterns over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Advanced Loop Patterns that have remained stable over time), Change (How Advanced Loop Patterns has transformed due to new forces and conditions), and Trend (The direction of change in Advanced Loop Patterns over time).'
      }
    },
    {
      id: 'csaloops5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Advanced Loop Patterns that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Advanced Loop Patterns has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Advanced Loop Patterns over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Advanced Loop Patterns that have remained stable over time. Change — How Advanced Loop Patterns has transformed due to new forces and conditions. Trend — The direction of change in Advanced Loop Patterns over time.'
      }
    },
    {
      id: 'csaloops5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Advanced Loop Patterns.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Advanced Loop Patterns has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Advanced Loop Patterns shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
