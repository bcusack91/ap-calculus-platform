export const apesWaterResourcesPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Water Resources & Pollution, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Water Resources & Pollution requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Water Resources & Pollution?

2) What concept describes making evidence-based claims about Water Resources & Pollution?

3) Name the term for using geographic thinking to analyze Water Resources & Pollution.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Water Resources & Pollution), Argumentation (Making evidence-based claims about Water Resources & Pollution), and Spatial reasoning (Using geographic thinking to analyze Water Resources & Pollution).'
      }
    },
    {
      id: 'apeswate6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Water Resources & Pollution is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Water Resources & Pollution describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Water Resources & Pollution is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Water Resources & Pollution. Argumentation — Making evidence-based claims about Water Resources & Pollution. Spatial reasoning — Using geographic thinking to analyze Water Resources & Pollution.'
      }
    },
    {
      id: 'apeswate6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Water Resources & Pollution.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Water Resources & Pollution and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Water Resources & Pollution. The best approach is:',
            options: [
