export const govSeparationOfPowersPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Spatial pattern** | The geographic distribution related to Separation of Powers |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Separation of Powers across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Separation of Powers?

2) What concept describes a specific real-world example that illustrates Separation of Powers?

3) Name the term for analyzing similarities and differences across examples of Separation of Powers.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Separation of Powers), Case study (A specific real-world example that illustrates Separation of Powers), and Comparison (Analyzing similarities and differences across examples of Separation of Powers).'
      }
    },
    {
      id: 'govsepar3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Separation of Powers is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Separation of Powers describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Separation of Powers is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Separation of Powers. Case study — A specific real-world example that illustrates Separation of Powers. Comparison — Analyzing similarities and differences across examples of Separation of Powers.'
      }
    },
    {
      id: 'govsepar3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Separation of Powers.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Separation of Powers. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Separation of Powers is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
