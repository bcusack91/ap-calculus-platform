export const psychSensationPart1Data = {
  ...
  sections: [
    {
      id: 'sensation-sensory-processing-p1-s1-intro',
      type: 'text' as const,
      content: `
      # 🧠 Sensation and Sensory Processing

      **Part 1 of 7 — Thresholds and Signal Detection**
    ...
    {
      id: 'sensation-sensory-processing-p1-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about auditory alerts in a noisy hospital setting, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
    ...
    {
      id: 'sensation-sensory-processing-p1-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'sensation-sensory-processing-p1-s4-input',
    ...
    {
      id: 'sensation-sensory-processing-p1-s5-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['transduction', 'sensation', 'signal detection theory', 'difference threshold']
          },
          {
            label: 'Select the concept that best matches: conversion of physical stimulus energy into neural signals',
            options: ['difference threshold', 'selective attention', 'transduction', 'absolute threshold']
          },
          {
            label: 'Select the concept that best matches: minimum stimulus intensity detected 50% of the time',
            options: ['absolute threshold', 'sensation', 'difference threshold', 'selective attention']
          }
        ],
        correctAnswers: ['sensation', 'transduction', 'absolute threshold'],
    ...
    {
      id: 'sensation-sensory-processing-p1-s6-strategy',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'sensation-sensory-processing-p1-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating auditory alerts in a noisy hospital setting finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'difference threshold',
              'transduction',
              'absolute threshold',
