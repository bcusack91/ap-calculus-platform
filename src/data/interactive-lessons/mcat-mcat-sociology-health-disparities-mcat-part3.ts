        ...
        questions: [
          {
            ...
            options: [`An epidemic of new infections is under way`, `The surveillance system is failing`, `Prevention programs have failed, since prevalence rose`, `Longer survival with the disease increased the pool of living cases — prevalence rose through duration, not through new cases`],
            correctAnswer: 3,
            explanation: `Prevalence approximates incidence times average duration; therapy that extends survival lengthens duration, multiplying prevalence with zero change in the rate of NEW cases (flat incidence rules out an epidemic and indicts nothing about prevention). Rising prevalence after treatment advances is a success signature, and misreading it as worsening burden is the classic trap this measure pair sets.`
          },
          {
            ...
            options: [`Has a much younger population, whose youth masked higher age-specific death rates in the crude comparison`, `Has better healthcare than District B`, `Reported fewer deaths than actually occurred`, `Has higher life expectancy`],
            correctAnswer: 0,
            explanation: `Crude rates blend age-specific rates with the population's age mix; a young population generates few deaths overall even when its residents die at higher rates AT EVERY AGE. Adjustment strips the age-mix advantage and reveals the underlying excess — the direction of the crude-to-adjusted flip diagnoses the age structure. Options B and D are contradicted by the adjusted result.`
          },
          {
          ...
          },
          {
            ...
            options: [`Preterm birth rates are equal across groups at all ages`, `The group disparity in preterm birth WIDENS with maternal age and persists among high-income mothers in the disadvantaged group`, `Preterm birth tracks insurance status exactly`, `Disparities disappear after controlling for education`],
            correctAnswer: 1,
            explanation: `Weathering posits cumulative physiological wear from chronic discrimination and disadvantage — so its unique predictions are dose-by-time (disparities growing with age as exposure accumulates) and persistence despite economic success (high SES does not eliminate the exposure). A pure current-income account predicts neither the age-widening nor the high-income residual. Options C and D describe patterns income-based accounts explain comfortably.`
          },
          {
            ...
            options: [`The group differences are produced by social environment and exposure over generations, not by fixed group biology — ancestry stayed constant while health tracked social context`, `The immigrants' genes deteriorated across generations`, `Healthcare in Country V is superior`, `Income is irrelevant to health`],
            correctAnswer: 0,
            explanation: `Genetic endowment is constant across the three generations; what changed is duration of exposure to the receiving society's diet, stressors, discrimination, and neighborhood conditions — and health changed with it. This immigrant-paradox trajectory is a natural experiment separating ancestry from environment, the standard rebuttal to biological readings of racialized health gaps. Option C cannot explain the grandchildren's decline.`
          }
        ]
      }
    },
