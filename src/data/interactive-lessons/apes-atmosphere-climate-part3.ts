export const apesAtmosphereClimatePart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Atmosphere & Climate Change across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Atmosphere & Climate Change?

2) What concept describes a specific real-world example that illustrates Atmosphere & Climate Change?

3) Name the term for analyzing similarities and differences across examples of Atmosphere & Climate Change.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Atmosphere & Climate Change), Case study (A specific real-world example that illustrates Atmosphere & Climate Change), and Comparison (Analyzing similarities and differences across examples of Atmosphere & Climate Change).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Atmosphere & Climate Change is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Atmosphere & Climate Change describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Atmosphere & Climate Change is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Atmosphere & Climate Change. Case study — A specific real-world example that illustrates Atmosphere & Climate Change. Comparison — Analyzing similarities and differences across examples of Atmosphere & Climate Change.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Atmosphere & Climate Change.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Atmosphere & Climate Change. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Atmosphere & Climate Change is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
