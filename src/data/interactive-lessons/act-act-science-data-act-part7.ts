...
Precision beats speed-reading in data-heavy passages.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "In a graph, point A is (8, 31) and point B is (10, 39). What is the slope?",
              options: [
                "4.0",
                "0.25",
                "8",
              ...
              correctAnswer: 0,
              explanation: "Slope is rise/run = (39-31)/(10-8) = 4.0."
            },
            {
