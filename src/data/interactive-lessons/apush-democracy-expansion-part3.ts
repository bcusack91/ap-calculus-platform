...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Democracy & Westward Expansion across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Democracy & Westward Expansion?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Democracy & Westward Expansion), Case study (A specific real-world example that illustrates Democracy & Westward Expansion), and Comparison (Analyzing similarities and differences across examples of Democracy & Westward Expansion).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Democracy & Westward Expansion is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Democracy & Westward Expansion. Case study — A specific real-world example that illustrates Democracy & Westward Expansion. Comparison — Analyzing similarities and differences across examples of Democracy & Westward Expansion.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Democracy & Westward Expansion.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Democracy & Westward Expansion is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
