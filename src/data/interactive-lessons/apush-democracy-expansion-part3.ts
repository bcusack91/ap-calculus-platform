export const apushDemocracyExpansionPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Democracy & Westward Expansion |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Democracy & Westward Expansion across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushdem3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Democracy & Westward Expansion. Understanding this concept is essential for mastering Democracy & Westward Expansion in AP US History.
...
1) What term refers to a recurring structure within Democracy & Westward Expansion?

2) What concept describes a specific real-world example that illustrates Democracy & Westward Expansion?

3) Name the term for analyzing similarities and differences across examples of Democracy & Westward Expansion.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Democracy & Westward Expansion), Case study (A specific real-world example that illustrates Democracy & Westward Expansion), and Comparison (Analyzing similarities and differences across examples of Democracy & Westward Expansion).'
      }
    },
    {
      id: 'apushdem3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Democracy & Westward Expansion is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Democracy & Westward Expansion describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Democracy & Westward Expansion is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Democracy & Westward Expansion. Case study — A specific real-world example that illustrates Democracy & Westward Expansion. Comparison — Analyzing similarities and differences across examples of Democracy & Westward Expansion.'
      }
    },
    {
      id: 'apushdem3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Democracy & Westward Expansion.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Democracy & Westward Expansion. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Democracy & Westward Expansion is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
