export const psychPersonalityPart2Data = {
  ...
  sections: [
    {
      id: 'personality-theories-p2-s1-intro',
      type: 'text' as const,
      content: `
      # 🧠 Personality Theories

      **Part 2 of 7 — Psychodynamic and Humanistic Views**
    ...
    {
      id: 'personality-theories-p2-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about therapy planning with psychodynamic and humanistic perspectives, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'psychodynamic',
    ...
    {
      id: 'personality-theories-p2-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'personality-theories-p2-s4-input',
    ...
    {
      id: 'personality-theories-p2-s5-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['self-actualization', 'psychodynamic', 'self-report inventory', 'reciprocal determinism']
          },
          {
            label: 'Select the concept that best matches: humanistic concept of fulfilling one\'s potential',
            options: ['psychodynamic', 'reciprocal determinism', 'projective test', 'self-actualization']
          },
          {
            label: 'Select the concept that best matches: behavior, cognition, and environment mutually influence each other',
            options: ['reciprocal determinism', 'self-report inventory', 'self-actualization', 'self-efficacy']
          }
        ],
        correctAnswers: ['psychodynamic', 'self-actualization', 'reciprocal determinism'],
    ...
    {
      id: 'personality-theories-p2-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about therapy planning with psychodynamic and humanistic perspectives, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'personality-theories-p2-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating therapy planning with psychodynamic and humanistic perspectives finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'self-efficacy',
              'psychodynamic',
              'self-actualization',
