    ...
    },
    {
      ...
      exercise: {
        inputs: [
          ...
          {
            label: '**4.** How many double bonds does $CO_{2}$ have in its final Lewis structure?',
            correctAnswer: '2',
            explanation: '$CO_{2}$ has the structure O=C=O with two double bonds. Each O converts 1 lone pair into a bonding pair. C: 2 × 4 = 8 $e^{-}$ ✓. Each O: 4 (double bond) + 4 (2 lone pairs) = 8 $e^{-}$ ✓.'
          }
        ]
      }
    },
    ...
    },
    {
      ...
      exercise: {
        dropdowns: [
          {
            id: 'ls-3-7-dd1',
            label: '$N_{2}$ has a _______ (N≡N) to satisfy the octet rule for both nitrogen atoms',
            options: ['Single bond', 'Double bond', 'Triple bond'],
            correctIndex: 2,
            explanation: '$N_{2}$ has a triple bond (N≡N) to satisfy the octet rule for both nitrogen atoms.'
          },
          {
            id: 'ls-3-7-dd2',
            label: '$O_{2}$ has a _______ (O=O) in its Lewis structure',
            options: ['Single bond', 'Double bond', 'Triple bond'],
            correctIndex: 1,
            explanation: '$O_{2}$ has a double bond (O=O) in its Lewis structure.'
          },
          {
            id: 'ls-3-7-dd3',
            label: '$F_{2}$ has a _______ (F—F)',
            options: ['Single bond', 'Double bond', 'Triple bond'],
            correctIndex: 0,
            explanation: '$F_{2}$ has a single bond (F—F). Each fluorine has 7 valence electrons and only needs 1 more, so a single bond suffices.'
          }
        ]
      }
    },
        ...
        questions: [
          {
            ...
            options: ['$F_{2}$ (single bond)', '$O_{2}$ (double bond)', '$N_{2}$ (triple bond)', '$Cl_{2}$ (single bond)'],
            correctAnswer: 2,
            explanation: '$N_{2}$ has a triple bond, which is the highest bond order among these choices. Higher bond order means shorter bond length. Also, nitrogen atoms are smaller than chlorine atoms, further shortening the bond.'
          }
        ]
      }
    }
