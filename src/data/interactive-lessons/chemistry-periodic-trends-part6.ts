...
| Anion ($-$) | **Larger** | Cl⁻ (181 pm) > Cl (99 pm) |`
    },
    {
      ...
      exercise: {
        questions: [
          {
            question: 'Which is larger: a calcium atom (Ca) or a calcium ion (Ca²⁺)?',
            options: [
              'Ca²⁺ is larger',
              'Ca is larger',
            ...
            correctAnswer: 1,
            explanation: 'Ca²⁺ is a cation — it has lost 2 electrons. Cations are always smaller than their parent atoms. Ca loses its two $4s$ electrons, collapsing to the $3p^6$ shell.'
          },
          {
            question: 'Which is larger: a sulfur atom (S) or a sulfide ion (S²⁻)?',
            options: [
              'S is larger',
              'S²⁻ is larger',
              'They are the same size',
            ...
            correctAnswer: 1,
            explanation: 'S²⁻ is an anion — it has gained 2 electrons. Anions are always larger than their parent atoms because the additional electrons increase electron-electron repulsion while the nuclear charge remains the same.'
          },
          {
            question: 'Which ion is smaller: Fe²⁺ or Fe³⁺?',
            options: [
              'Fe²⁺',
              'Fe³⁺',
              'They are the same size'
            ...
            correctAnswer: 1,
            explanation: 'Fe³⁺ has lost more electrons than Fe²⁺ (3 vs. 2). More electrons removed means less electron-electron repulsion and a stronger pull on remaining electrons. Fe³⁺ (65 pm) < Fe²⁺ (76 pm).'
          }
        ]
      }
    },
...
$$\\text{N}^{3-} > \\text{O}^{2-} > \\text{F}^- > \\text{Na}^+ > \\text{Mg}^{2+} > \\text{Al}^{3+}$$`
    },
    {
      ...
      exercise: {
        questions: [
          {
            question: 'In the isoelectronic series O²⁻, F⁻, Na⁺, Mg²⁺ (all with 10 electrons), which ion has the smallest radius?',
            options: [
              'O²⁻',
              'F⁻',
              'Na⁺',
            ...
            correctAnswer: 3,
            explanation: 'All four species have 10 electrons. Mg²⁺ has the most protons (12), so it pulls the electron cloud in most tightly, giving it the smallest radius.'
          },
          {
            ...
            correctAnswer: 3,
            explanation: 'S²⁻, Cl⁻, and K⁺ all have 18 electrons (isoelectronic with argon). Na⁺ has only 10 electrons (isoelectronic with neon).'
          }
        ]
      }
    },
        ...
        inputs: [
          {
            ...
            explanation: 'All have 18 electrons. Proton counts: Ca²⁺ = 20, K⁺ = 19, Cl⁻ = 17, S²⁻ = 16. More protons = smaller radius. So Ca²⁺ < K⁺ < Cl⁻ < S²⁻.'
          },
          {
            label: 'Larger ion:',
            correctAnswer: 'O2-',
            explanation: 'Both have 10 electrons. O²⁻ has 8 protons; Mg²⁺ has 12 protons. Fewer protons means less pull on the electrons → larger radius. O²⁻ (140 pm) >> Mg²⁺ (65 pm).'
          }
        ]
      }
    },
