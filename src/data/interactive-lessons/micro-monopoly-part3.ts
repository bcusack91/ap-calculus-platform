...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Monopoly across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Monopoly?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Monopoly), Case study (A specific real-world example that illustrates Monopoly), and Comparison (Analyzing similarities and differences across examples of Monopoly).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Monopoly is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Monopoly. Case study — A specific real-world example that illustrates Monopoly. Comparison — Analyzing similarities and differences across examples of Monopoly.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Monopoly.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Monopoly is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
