...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key concept of average value of a function?',
            options: [
          ...
          {
            question: 'In the context of average value of a function, which is accurate?',
            options: [
              'rectangle with same area as the region under f',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which concept relates directly to average value of a function?',
            options: [
              'Units of average value are the same as the units of f',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'These concepts are fundamental to understanding Average Value of a Function.'
      }
    }
  ]
}
