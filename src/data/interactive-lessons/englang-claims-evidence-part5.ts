export const englangClaimsEvidencePart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Claims & Evidence helps:',
            options: [
          ...
          {
            question: 'Continuity in Claims & Evidence means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Claims & Evidence that have remained stable over time?

2) What concept describes how Claims & Evidence has transformed due to new forces and conditions?

3) Name the term for the direction of change in Claims & Evidence over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Claims & Evidence that have remained stable over time), Change (How Claims & Evidence has transformed due to new forces and conditions), and Trend (The direction of change in Claims & Evidence over time).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Claims & Evidence that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Claims & Evidence has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Claims & Evidence over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Claims & Evidence that have remained stable over time. Change — How Claims & Evidence has transformed due to new forces and conditions. Trend — The direction of change in Claims & Evidence over time.'
      }
    },
    {
...
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Claims & Evidence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Claims & Evidence has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Claims & Evidence shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
