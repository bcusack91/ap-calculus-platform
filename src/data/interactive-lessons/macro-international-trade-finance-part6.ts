export const macroInternationalTradeFinancePart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about International Trade & Finance, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about International Trade & Finance requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to International Trade & Finance?

2) What concept describes making evidence-based claims about International Trade & Finance?

3) Name the term for using geographic thinking to analyze International Trade & Finance.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to International Trade & Finance), Argumentation (Making evidence-based claims about International Trade & Finance), and Spatial reasoning (Using geographic thinking to analyze International Trade & Finance).'
      }
    },
    {
      id: 'macroint6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to International Trade & Finance is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about International Trade & Finance describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze International Trade & Finance is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to International Trade & Finance. Argumentation — Making evidence-based claims about International Trade & Finance. Spatial reasoning — Using geographic thinking to analyze International Trade & Finance.'
      }
    },
    {
      id: 'macroint6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of International Trade & Finance.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about International Trade & Finance and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about International Trade & Finance. The best approach is:',
            options: [
