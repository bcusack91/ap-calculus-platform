export const apesBiogeochemicalCyclesPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Biogeochemical Cycles, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Biogeochemical Cycles requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Biogeochemical Cycles?

2) What concept describes making evidence-based claims about Biogeochemical Cycles?

3) Name the term for using geographic thinking to analyze Biogeochemical Cycles.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Biogeochemical Cycles), Argumentation (Making evidence-based claims about Biogeochemical Cycles), and Spatial reasoning (Using geographic thinking to analyze Biogeochemical Cycles).'
      }
    },
    {
      id: 'apesbiog6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Biogeochemical Cycles is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Biogeochemical Cycles describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Biogeochemical Cycles is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Biogeochemical Cycles. Argumentation — Making evidence-based claims about Biogeochemical Cycles. Spatial reasoning — Using geographic thinking to analyze Biogeochemical Cycles.'
      }
    },
    {
      id: 'apesbiog6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Biogeochemical Cycles.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Biogeochemical Cycles and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Biogeochemical Cycles. The best approach is:',
            options: [
