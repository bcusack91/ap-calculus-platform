export const apushRevolutionIndependencePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Revolution & Independence |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Revolution & Independence across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushrev3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Revolution & Independence. Understanding this concept is essential for mastering Revolution & Independence in AP US History.
...
1) What term refers to a recurring structure within Revolution & Independence?

2) What concept describes a specific real-world example that illustrates Revolution & Independence?

3) Name the term for analyzing similarities and differences across examples of Revolution & Independence.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Revolution & Independence), Case study (A specific real-world example that illustrates Revolution & Independence), and Comparison (Analyzing similarities and differences across examples of Revolution & Independence).'
      }
    },
    {
      id: 'apushrev3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Revolution & Independence is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Revolution & Independence describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Revolution & Independence is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Revolution & Independence. Case study — A specific real-world example that illustrates Revolution & Independence. Comparison — Analyzing similarities and differences across examples of Revolution & Independence.'
      }
    },
    {
      id: 'apushrev3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Revolution & Independence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Revolution & Independence. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Revolution & Independence is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
