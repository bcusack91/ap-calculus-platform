...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within 2D Arrays |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of 2D Arrays across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within 2D Arrays. Understanding this concept is essential for mastering 2D Arrays in AP Computer Science A.
...
1) What term refers to a recurring structure within 2D Arrays?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within 2D Arrays), Case study (A specific real-world example that illustrates 2D Arrays), and Comparison (Analyzing similarities and differences across examples of 2D Arrays).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within 2D Arrays is called ___',
        ...
        explanation: 'Structural pattern — A recurring structure within 2D Arrays. Case study — A specific real-world example that illustrates 2D Arrays. Comparison — Analyzing similarities and differences across examples of 2D Arrays.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of 2D Arrays.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in 2D Arrays is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
