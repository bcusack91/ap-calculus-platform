export const macroUnemploymentInflationPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Unemployment & Inflation, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Unemployment & Inflation requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Unemployment & Inflation?

2) What concept describes making evidence-based claims about Unemployment & Inflation?

3) Name the term for using geographic thinking to analyze Unemployment & Inflation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Unemployment & Inflation), Argumentation (Making evidence-based claims about Unemployment & Inflation), and Spatial reasoning (Using geographic thinking to analyze Unemployment & Inflation).'
      }
    },
    {
      id: 'macroune6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Unemployment & Inflation is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Unemployment & Inflation describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Unemployment & Inflation is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Unemployment & Inflation. Argumentation — Making evidence-based claims about Unemployment & Inflation. Spatial reasoning — Using geographic thinking to analyze Unemployment & Inflation.'
      }
    },
    {
      id: 'macroune6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Unemployment & Inflation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Unemployment & Inflation and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Unemployment & Inflation. The best approach is:',
            options: [
