...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcarclength-p5-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcarclength-p5-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
