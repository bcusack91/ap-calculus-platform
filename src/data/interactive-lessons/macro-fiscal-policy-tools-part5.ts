export const macroFiscalPolicyToolsPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Fiscal Policy Tools & Outcomes helps:',
            options: [
          ...
          {
            question: 'Continuity in Fiscal Policy Tools & Outcomes means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Fiscal Policy Tools & Outcomes that have remained stable over time?

2) What concept describes how Fiscal Policy Tools & Outcomes has transformed due to new forces and conditions?

3) Name the term for the direction of change in Fiscal Policy Tools & Outcomes over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Fiscal Policy Tools & Outcomes that have remained stable over time), Change (How Fiscal Policy Tools & Outcomes has transformed due to new forces and conditions), and Trend (The direction of change in Fiscal Policy Tools & Outcomes over time).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Fiscal Policy Tools & Outcomes that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Fiscal Policy Tools & Outcomes has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Fiscal Policy Tools & Outcomes over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Fiscal Policy Tools & Outcomes that have remained stable over time. Change — How Fiscal Policy Tools & Outcomes has transformed due to new forces and conditions. Trend — The direction of change in Fiscal Policy Tools & Outcomes over time.'
      }
    },
    {
...
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Fiscal Policy Tools & Outcomes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Fiscal Policy Tools & Outcomes has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Fiscal Policy Tools & Outcomes shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
