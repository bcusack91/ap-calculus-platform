        ...
        questions: [
          {
            ...
            correctAnswer: 1,
            explanation: 'Gas side higher means the gas is pushing the liquid *down* on the gas side (or equivalently, the atmosphere is pushing it up more). The gas pressure is *less* than atmospheric by $\\rho g \\Delta h$.'
          },
          {
