...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Production & Costs across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Production & Costs?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Production & Costs), Case study (A specific real-world example that illustrates Production & Costs), and Comparison (Analyzing similarities and differences across examples of Production & Costs).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Production & Costs is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Production & Costs. Case study — A specific real-world example that illustrates Production & Costs. Comparison — Analyzing similarities and differences across examples of Production & Costs.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Production & Costs.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Production & Costs is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
