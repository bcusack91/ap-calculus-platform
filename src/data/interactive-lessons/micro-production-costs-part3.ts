export const microProductionCostsPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Production & Costs |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Production & Costs across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'micropro3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Production & Costs. Understanding this concept is essential for mastering Production & Costs in AP Microeconomics.
...
1) What term refers to a recurring structure within Production & Costs?

2) What concept describes a specific real-world example that illustrates Production & Costs?

3) Name the term for analyzing similarities and differences across examples of Production & Costs.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Production & Costs), Case study (A specific real-world example that illustrates Production & Costs), and Comparison (Analyzing similarities and differences across examples of Production & Costs).'
      }
    },
    {
      id: 'micropro3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Production & Costs is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Production & Costs describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Production & Costs is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Production & Costs. Case study — A specific real-world example that illustrates Production & Costs. Comparison — Analyzing similarities and differences across examples of Production & Costs.'
      }
    },
    {
      id: 'micropro3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Production & Costs.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Production & Costs. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Production & Costs is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
