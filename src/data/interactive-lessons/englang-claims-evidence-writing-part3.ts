...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Claims & Evidence in Writing |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Claims & Evidence in Writing across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Claims & Evidence in Writing. Understanding this concept is essential for mastering Claims & Evidence in Writing in AP English Language.
...
1) What term refers to a recurring structure within Claims & Evidence in Writing?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Claims & Evidence in Writing), Case study (A specific real-world example that illustrates Claims & Evidence in Writing), and Comparison (Analyzing similarities and differences across examples of Claims & Evidence in Writing).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Claims & Evidence in Writing is called ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Claims & Evidence in Writing. Case study — A specific real-world example that illustrates Claims & Evidence in Writing. Comparison — Analyzing similarities and differences across examples of Claims & Evidence in Writing.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Claims & Evidence in Writing.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Claims & Evidence in Writing is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
