export const hgPoliticalGeographyPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Political Geography & Territoriality?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Political Geography & Territoriality helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Political Geography & Territoriality?

2) What concept describes a secondary process that shapes outcomes in Political Geography & Territoriality?

3) Name the term for the relationship between actions and outcomes in Political Geography & Territoriality.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Political Geography & Territoriality), Process 2 (A secondary process that shapes outcomes in Political Geography & Territoriality), and Cause and effect (The relationship between actions and outcomes in Political Geography & Territoriality).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Political Geography & Territoriality is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Political Geography & Territoriality describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Political Geography & Territoriality is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Political Geography & Territoriality. Process 2 — A secondary process that shapes outcomes in Political Geography & Territoriality. Cause and effect — The relationship between actions and outcomes in Political Geography & Territoriality.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Political Geography & Territoriality.
