  ...
  sections: [
    {
      id: "englitsh1-intro",
      type: 'text' as const,
      content: "# 🧭 Short Fiction III\n\n**Part 1 of 7 - Core Concepts, Analysis Skills, and AP Lit Application**\n\n---\n\n## Why Short Fiction III Matters\n\nLater-stage short fiction work emphasizes pattern recognition and inferential reasoning.\n\n| Core Concept | What To Notice | Why It Matters |\n|---|---|---|\n| **Motif** | Recurring element with interpretive significance | Patterns help track thematic development |\n| **Shift** | Change in tone, perspective, or emphasis | Shifts often mark argument turns |\n| **Inference** | Conclusion drawn from textual clues | Inference demonstrates analytical depth |\n\n> AP Lit rewards interpretation supported by textual evidence, not plot summary."
    },
    {
      id: "englitsh1-quiz1",
      ...
      "questions": [
            {
                  "question": "Which statement best reflects the role of Motif in literary analysis?",
                  "options": [
                        "Motif is a one-time symbol with no pattern.",
                        "Motif is a recurring element whose repetition builds meaning.",
                        "Motif and theme are identical terms.",
                        "Motif only appears in poetry."
                  ],
                  "correctAnswer": 1,
                  "explanation": "Motif helps readers interpret meaning and authorial choice, not just identify a feature."
            },
            {
    ...
    },
    {
      ...
      "hint1": "Concept 1: Motif",
      "hint2": "Concept 2: Shift",
      "hint3": "Concept 3: Inference",
      "explanation": "Motif, Shift, and Inference are core vocabulary for this unit."
}
    },
    {
      ...
      "dropdowns": [
            {
                  "label": "Motif in analysis usually refers to ___",
                  "options": [
                        "A recurring element that accumulates significance",
      ...
      "hint1": "Think how motif functions in meaning-making.",
      "hint2": "Interpretation must be supported.",
      "hint3": "Specific textual support is key.",
      "explanation": "Strong AP analysis treats motif as an interpretive tool, then develops claims through evidence and commentary."
}
    },
    {
      id: "englitsh1-strategy",
      type: 'text' as const,
      content: "## AP Exam Strategy: Short Fiction III\n\n- Start with a claim about how motif or shift shapes meaning\n- Use short quotations and explain them in context\n- Track contrast, shifts, and patterns across the whole passage\n- Avoid pure summary; prioritize interpretation\n- Qualify claims when text is ambiguous\n- Track recurrence plus variation, then infer thematic function."
    },
    {
      ...
      "questions": [
            {
                  "question": "A student identifies shift in a passage but does not explain effect. What is the best revision?",
                  "options": [
                        "Add more plot details",
                        "Explain how shift shapes tone or theme in that moment",
            ...
            },
            {
                  ...
                  "options": [
                        ...
                        "Advance a specific, defensible claim about how inference contributes to meaning",
