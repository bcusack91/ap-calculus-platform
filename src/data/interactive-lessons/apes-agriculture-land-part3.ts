export const apesAgricultureLandPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Agriculture & Land Use across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Agriculture & Land Use?

2) What concept describes a specific real-world example that illustrates Agriculture & Land Use?

3) Name the term for analyzing similarities and differences across examples of Agriculture & Land Use.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Agriculture & Land Use), Case study (A specific real-world example that illustrates Agriculture & Land Use), and Comparison (Analyzing similarities and differences across examples of Agriculture & Land Use).'
      }
    },
    {
      id: 'apesagri3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Agriculture & Land Use is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Agriculture & Land Use describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Agriculture & Land Use is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Agriculture & Land Use. Case study — A specific real-world example that illustrates Agriculture & Land Use. Comparison — Analyzing similarities and differences across examples of Agriculture & Land Use.'
      }
    },
    {
      id: 'apesagri3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Agriculture & Land Use.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Agriculture & Land Use. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Agriculture & Land Use is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
