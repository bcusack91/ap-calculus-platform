export const macroMultiplierEffectPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in The Multiplier Effect?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in The Multiplier Effect helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in The Multiplier Effect?

2) What concept describes a secondary process that shapes outcomes in The Multiplier Effect?

3) Name the term for the relationship between actions and outcomes in The Multiplier Effect.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in The Multiplier Effect), Process 2 (A secondary process that shapes outcomes in The Multiplier Effect), and Cause and effect (The relationship between actions and outcomes in The Multiplier Effect).'
      }
    },
    {
      id: 'macromul2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in The Multiplier Effect is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in The Multiplier Effect describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in The Multiplier Effect is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in The Multiplier Effect. Process 2 — A secondary process that shapes outcomes in The Multiplier Effect. Cause and effect — The relationship between actions and outcomes in The Multiplier Effect.'
      }
    },
    {
      id: 'macromul2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of The Multiplier Effect.
