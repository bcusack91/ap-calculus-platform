...
**Part 5 of 7 — Combinatorics basics**
...
- P(A or B) = P(A) + P(B) - P(A and B)\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "What is the mean of 13, 17, and 21?",
              options: [
                "19",
                "17",
                "8",
              ...
              correctAnswer: 1,
              explanation: "Mean is (13+17+21)/3 = 17."
            },
            {
