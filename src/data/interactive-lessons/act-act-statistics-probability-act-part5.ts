...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'What is a key strategy for combinations & permutations?',
            options: [
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Key concept for Combinations & Permutations:',
        ...
        hint1: 'Think about combinations & permutations',
