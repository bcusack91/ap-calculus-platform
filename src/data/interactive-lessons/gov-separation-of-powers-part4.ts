...
| Concept | Description |
|---------|-------------|
| **Interconnection** | How Separation of Powers links to other course topics |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Separation of Powers connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Separation of Powers means:',
            options: [
              'The process stops',
...
1) What term refers to how Separation of Powers links to other course topics?

2) What concept describes how Separation of Powers operates differently at local, national, and global scales?

3) Name the term for how outcomes of Separation of Powers can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Separation of Powers links to other course topics), Scale interaction (How Separation of Powers operates differently at local, national, and global scales), and Feedback loop (How outcomes of Separation of Powers can reinforce or modify the original process).'
      }
    },
    {
      id: 'govsepar4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Separation of Powers links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Separation of Powers operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Separation of Powers can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Separation of Powers links to other course topics. Scale interaction — How Separation of Powers operates differently at local, national, and global scales. Feedback loop — How outcomes of Separation of Powers can reinforce or modify the original process.'
      }
    },
    {
      id: 'govsepar4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Separation of Powers.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Separation of Powers and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Separation of Powers produces outcomes that further intensify the original process, this is:',
            options: [
