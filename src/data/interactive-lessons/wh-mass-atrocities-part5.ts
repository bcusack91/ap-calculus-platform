...
- Explain one cause and one effect linked to human-rights law and memory politics.
- Compare two regions or states affected by genocide and state violence in the 20th century.
- Evaluate continuity and change involving targeting by ethnicity, religion, and political identity.
`
    },
    {
      id: 'whmassatrocities5-dropdown',
