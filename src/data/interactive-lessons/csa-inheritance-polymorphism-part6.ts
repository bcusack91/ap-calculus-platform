export const csaInheritancePolymorphismPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Inheritance & Polymorphism, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Inheritance & Polymorphism requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Inheritance & Polymorphism?

2) What concept describes making evidence-based claims about Inheritance & Polymorphism?

3) Name the term for using geographic thinking to analyze Inheritance & Polymorphism.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Inheritance & Polymorphism), Argumentation (Making evidence-based claims about Inheritance & Polymorphism), and Spatial reasoning (Using geographic thinking to analyze Inheritance & Polymorphism).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Inheritance & Polymorphism is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Inheritance & Polymorphism describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Inheritance & Polymorphism is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Inheritance & Polymorphism. Argumentation — Making evidence-based claims about Inheritance & Polymorphism. Spatial reasoning — Using geographic thinking to analyze Inheritance & Polymorphism.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Inheritance & Polymorphism.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Inheritance & Polymorphism and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Inheritance & Polymorphism. The best approach is:',
            options: [
