export const whNewlyIndependentStatesPart7Data = {
  topicSlug: 'wh-newly-independent-states',
  sections: [
    {
      id: 'whnewlyindependentstates7-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whnewlyindependentstates7-mcq',
    ...
    {
      id: 'whnewlyindependentstates7-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to borders, ethnicity, and political legitimacy.
- Compare two regions or states affected by economic development strategies and debt.
- Evaluate continuity and change involving authoritarianism, democracy, and military rule.
`
    },
    {
      id: 'whnewlyindependentstates7-dropdown',
    ...
    {
      id: 'whnewlyindependentstates7-ap',
      type: 'multiple-choice' as const,
