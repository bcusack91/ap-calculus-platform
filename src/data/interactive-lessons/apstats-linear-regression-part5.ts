...
**Part 5 of 7 — Influential Points and Outliers**

---

### Key Concepts

This section covers essential concepts related to **influential points and outliers** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Influential Points and Outliers Check** 🎯
      `,
      exercise: {
        questions: [
          {
