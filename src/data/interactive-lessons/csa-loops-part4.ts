export const csaLoopsPart4Data = {
  topicSlug: 'csa-loops',
  sections: [
    {
      id: 'csaloops4-intro',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Advanced Loop Patterns connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Advanced Loop Patterns means:',
            options: [
              'The process stops',
...
1) What term refers to how Advanced Loop Patterns links to other course topics?

2) What concept describes how Advanced Loop Patterns operates differently at local, national, and global scales?

3) Name the term for how outcomes of Advanced Loop Patterns can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Advanced Loop Patterns links to other course topics), Scale interaction (How Advanced Loop Patterns operates differently at local, national, and global scales), and Feedback loop (How outcomes of Advanced Loop Patterns can reinforce or modify the original process).'
      }
    },
    {
      id: 'csaloops4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Advanced Loop Patterns links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Advanced Loop Patterns operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Advanced Loop Patterns can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Advanced Loop Patterns links to other course topics. Scale interaction — How Advanced Loop Patterns operates differently at local, national, and global scales. Feedback loop — How outcomes of Advanced Loop Patterns can reinforce or modify the original process.'
      }
    },
    {
      id: 'csaloops4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Advanced Loop Patterns.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Advanced Loop Patterns and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Advanced Loop Patterns produces outcomes that further intensify the original process, this is:',
            options: [
