export const macroMultiplierEffectPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about The Multiplier Effect, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about The Multiplier Effect requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to The Multiplier Effect?

2) What concept describes making evidence-based claims about The Multiplier Effect?

3) Name the term for using geographic thinking to analyze The Multiplier Effect.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to The Multiplier Effect), Argumentation (Making evidence-based claims about The Multiplier Effect), and Spatial reasoning (Using geographic thinking to analyze The Multiplier Effect).'
      }
    },
    {
      id: 'macromul6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to The Multiplier Effect is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about The Multiplier Effect describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze The Multiplier Effect is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to The Multiplier Effect. Argumentation — Making evidence-based claims about The Multiplier Effect. Spatial reasoning — Using geographic thinking to analyze The Multiplier Effect.'
      }
    },
    {
      id: 'macromul6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of The Multiplier Effect.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about The Multiplier Effect and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about The Multiplier Effect. The best approach is:',
            options: [
