...
**Part 4 of 7 — Coefficient of Determination**

---

### Key Concepts

This section covers essential concepts related to **coefficient of determination** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Coefficient of Determination Check** 🎯
      `,
      exercise: {
        questions: [
          {
