export const csaVariablesTypesPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Variables & Data Types connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Variables & Data Types means:',
            options: [
              'The process stops',
...
1) What term refers to how Variables & Data Types links to other course topics?

2) What concept describes how Variables & Data Types operates differently at local, national, and global scales?

3) Name the term for how outcomes of Variables & Data Types can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Variables & Data Types links to other course topics), Scale interaction (How Variables & Data Types operates differently at local, national, and global scales), and Feedback loop (How outcomes of Variables & Data Types can reinforce or modify the original process).'
      }
    },
    {
      id: 'csavaria4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Variables & Data Types links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Variables & Data Types operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Variables & Data Types can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Variables & Data Types links to other course topics. Scale interaction — How Variables & Data Types operates differently at local, national, and global scales. Feedback loop — How outcomes of Variables & Data Types can reinforce or modify the original process.'
      }
    },
    {
      id: 'csavaria4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Variables & Data Types.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Variables & Data Types and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Variables & Data Types produces outcomes that further intensify the original process, this is:',
            options: [
