        ...
        questions: [
          {
            ...
            options: [`Functionalist`, `Interactionist`, `Conflict theory — health and care analyzed as resources distributed by power and economic interest`, `Fundamental cause theory`],
            correctAnswer: 2,
          ...
          },
          {
            ...
            options: [`Add more workshop sessions with better advertising`, `Make enrollment automatic for eligible residents with easy opt-out, removing the knowledge- and initiative-dependent steps that advantaged groups exploit fastest`, `Charge a small fee to increase commitment`, `Restrict workshops to college-educated residents to maximize completion rates`],
            correctAnswer: 1,
            explanation: `Fundamental cause theory locates the widening in resource dependence: opt-in designs reward information, time, and confidence — flexible resources concentrated up the SES ladder. The corrective is architectural: defaults that require no resources to enter. More advertising is more information (same failure mode, larger), fees add a resource barrier, and option D abandons the disadvantaged entirely.`
          },
          {
            ...
            options: [`A larger sample of counties showing the same correlation`, `Expert opinion endorsing the hypothesis`, `A second cross-sectional survey in the same counties`, `A longitudinal cohort showing that individuals' fast-food consumption predicts their subsequent cardiovascular events, with SES and baseline health controlled`],
            correctAnswer: 3,
            explanation: `The ecological design's two fatal gaps are level (county correlations cannot transfer to individuals — the ecological fallacy) and temporality/confounding. Only option D repairs both: individual-level exposure and outcome, temporal ordering (consumption BEFORE events), and control of the SES confounding that plagues neighborhood food environments. More counties or repeated cross-sections replicate the same limitations at larger scale.`
          },
          {
          ...
          },
          {
            ...
            options: [`Minimize community contact to keep the data objective`, `Offer large payments to guarantee enrollment`, `Partner with community representatives in design, explain data use transparently, and commit to returning findings and health benefits to the community`, `Publish first and inform the community afterward to avoid biasing participants`],
            correctAnswer: 2,
