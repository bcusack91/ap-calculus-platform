export const csaArraysPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Array Algorithms?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Array Algorithms helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Array Algorithms?

2) What concept describes a secondary process that shapes outcomes in Array Algorithms?

3) Name the term for the relationship between actions and outcomes in Array Algorithms.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Array Algorithms), Process 2 (A secondary process that shapes outcomes in Array Algorithms), and Cause and effect (The relationship between actions and outcomes in Array Algorithms).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Array Algorithms is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Array Algorithms describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Array Algorithms is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Array Algorithms. Process 2 — A secondary process that shapes outcomes in Array Algorithms. Cause and effect — The relationship between actions and outcomes in Array Algorithms.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Array Algorithms.
