export const microScarcityMarginalAnalysisPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Scarcity & Marginal Analysis helps:',
            options: [
          ...
          {
            question: 'Continuity in Scarcity & Marginal Analysis means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Scarcity & Marginal Analysis that have remained stable over time?

2) What concept describes how Scarcity & Marginal Analysis has transformed due to new forces and conditions?

3) Name the term for the direction of change in Scarcity & Marginal Analysis over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Scarcity & Marginal Analysis that have remained stable over time), Change (How Scarcity & Marginal Analysis has transformed due to new forces and conditions), and Trend (The direction of change in Scarcity & Marginal Analysis over time).'
      }
    },
    {
      id: 'microsca5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Scarcity & Marginal Analysis that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Scarcity & Marginal Analysis has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Scarcity & Marginal Analysis over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Scarcity & Marginal Analysis that have remained stable over time. Change — How Scarcity & Marginal Analysis has transformed due to new forces and conditions. Trend — The direction of change in Scarcity & Marginal Analysis over time.'
      }
    },
    {
      id: 'microsca5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Scarcity & Marginal Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Scarcity & Marginal Analysis has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Scarcity & Marginal Analysis shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
