...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Comma',
            options: ['Colon: introduces a list, explanation, or elaboration (independent clause before it).', 'before FANBOYS in compound sentences, after introductory elements, around nonessential clauses.', 'Dash: sets off a parenthetical or emphatic statement — can replace commas or colons for emphasis.', 'connects two related independent clauses (no conjunction needed).']
          },
          {
            label: 'Semicolon',
          ...
          {
            label: 'Key Insight',
            options: ['before FANBOYS in compound sentences, after introductory elements, around nonessential clauses.', 'connects two related independent clauses (no conjunction needed).', 'Dash: sets off a parenthetical or emphatic statement — can replace commas or colons for emphasis.', 'Colon: introduces a list, explanation, or elaboration (independent clause before it).']
          }
        ],
