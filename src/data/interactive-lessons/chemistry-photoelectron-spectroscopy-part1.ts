...
> 💡 **Tip:** If the photon energy is **less than** the binding energy of a particular electron, that electron **cannot be ejected**. This is a direct consequence of the quantized nature of light — a single photon must provide all the energy needed.`
    },
    {
      id: 'ps1-quiz2',
      type: 'multiple-choice' as const,
...
> **Problem:** A PES experiment uses photons with an energy of 1200 eV. An ejected electron is measured to have a kinetic energy of 450 eV. What is the binding energy of that electron?`,
    ...
    },
    {
      ...
      content: `### ✏️ Calculation Practice
...
Consider two electrons: Electron A has a binding energy of 200 eV and Electron B has a binding energy of 2500 eV.`,
    ...
    },
    {
      id: 'ps1-summary',
      type: 'text' as const,
      content: `## 📋 Part 1 Summary: What Is PES?
...
- ☐ I know that PES measures binding energies of electrons
- ☐ I can use $BE = E_{photon} - KE$ to calculate binding energy
- ☐ I understand why high-energy photon sources are needed
- ☐ I can relate binding energy to distance from the nucleus

---

### 🔮 What's Next

In **Part 2**, you will learn how to **read and interpret PES spectra** — the graphical output of a PES experiment.`
    }
  ]
}
