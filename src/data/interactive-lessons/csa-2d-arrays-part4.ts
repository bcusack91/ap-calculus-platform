export const csa2dArraysPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: '2D Array Algorithms connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in 2D Array Algorithms means:',
            options: [
              'The process stops',
...
1) What term refers to how 2D Array Algorithms links to other course topics?

2) What concept describes how 2D Array Algorithms operates differently at local, national, and global scales?

3) Name the term for how outcomes of 2D Array Algorithms can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How 2D Array Algorithms links to other course topics), Scale interaction (How 2D Array Algorithms operates differently at local, national, and global scales), and Feedback loop (How outcomes of 2D Array Algorithms can reinforce or modify the original process).'
      }
    },
    {
      id: 'csa2darr4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How 2D Array Algorithms links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How 2D Array Algorithms operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of 2D Array Algorithms can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How 2D Array Algorithms links to other course topics. Scale interaction — How 2D Array Algorithms operates differently at local, national, and global scales. Feedback loop — How outcomes of 2D Array Algorithms can reinforce or modify the original process.'
      }
    },
    {
      id: 'csa2darr4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of 2D Array Algorithms.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between 2D Array Algorithms and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If 2D Array Algorithms produces outcomes that further intensify the original process, this is:',
            options: [
