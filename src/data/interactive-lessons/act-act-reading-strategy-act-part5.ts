export const actReadingStratPart5Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p5-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 5 of 7 — Inference without overreaching**
