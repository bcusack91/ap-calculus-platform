...
**Quick Check**
    ...
    {
      id: 'calcbcseriesapps-p2-example',
      type: 'text' as const,
      content: `
## Worked Example
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcseriesapps-p2-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcseriesapps-p2-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
