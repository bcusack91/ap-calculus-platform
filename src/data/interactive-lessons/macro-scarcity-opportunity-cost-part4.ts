export const macroScarcityOpportunityCostPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Scarcity & Opportunity Cost connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Scarcity & Opportunity Cost means:',
            options: [
              'The process stops',
...
1) What term refers to how Scarcity & Opportunity Cost links to other course topics?

2) What concept describes how Scarcity & Opportunity Cost operates differently at local, national, and global scales?

3) Name the term for how outcomes of Scarcity & Opportunity Cost can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Scarcity & Opportunity Cost links to other course topics), Scale interaction (How Scarcity & Opportunity Cost operates differently at local, national, and global scales), and Feedback loop (How outcomes of Scarcity & Opportunity Cost can reinforce or modify the original process).'
      }
    },
    {
      id: 'macrosca4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Scarcity & Opportunity Cost links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Scarcity & Opportunity Cost operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Scarcity & Opportunity Cost can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Scarcity & Opportunity Cost links to other course topics. Scale interaction — How Scarcity & Opportunity Cost operates differently at local, national, and global scales. Feedback loop — How outcomes of Scarcity & Opportunity Cost can reinforce or modify the original process.'
      }
    },
    {
      id: 'macrosca4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Scarcity & Opportunity Cost.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Scarcity & Opportunity Cost and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Scarcity & Opportunity Cost produces outcomes that further intensify the original process, this is:',
            options: [
