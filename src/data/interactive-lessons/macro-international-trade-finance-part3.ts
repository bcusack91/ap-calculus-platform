...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of International Trade & Finance across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to International Trade & Finance?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to International Trade & Finance), Case study (A specific real-world example that illustrates International Trade & Finance), and Comparison (Analyzing similarities and differences across examples of International Trade & Finance).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to International Trade & Finance is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to International Trade & Finance. Case study — A specific real-world example that illustrates International Trade & Finance. Comparison — Analyzing similarities and differences across examples of International Trade & Finance.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of International Trade & Finance.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in International Trade & Finance is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
