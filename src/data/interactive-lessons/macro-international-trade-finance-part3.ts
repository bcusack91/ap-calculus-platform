export const macroInternationalTradeFinancePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within International Trade & Finance |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of International Trade & Finance across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macroint3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within International Trade & Finance. Understanding this concept is essential for mastering International Trade & Finance in AP Macroeconomics.
...
1) What term refers to a recurring structure within International Trade & Finance?

2) What concept describes a specific real-world example that illustrates International Trade & Finance?

3) Name the term for analyzing similarities and differences across examples of International Trade & Finance.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within International Trade & Finance), Case study (A specific real-world example that illustrates International Trade & Finance), and Comparison (Analyzing similarities and differences across examples of International Trade & Finance).'
      }
    },
    {
      id: 'macroint3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within International Trade & Finance is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates International Trade & Finance describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of International Trade & Finance is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within International Trade & Finance. Case study — A specific real-world example that illustrates International Trade & Finance. Comparison — Analyzing similarities and differences across examples of International Trade & Finance.'
      }
    },
    {
      id: 'macroint3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of International Trade & Finance.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of International Trade & Finance. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in International Trade & Finance is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
