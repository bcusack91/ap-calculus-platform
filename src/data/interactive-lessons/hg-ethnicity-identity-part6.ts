export const hgEthnicityIdentityPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Ethnicity, Race & Identity, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Ethnicity, Race & Identity requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Ethnicity, Race & Identity?

2) What concept describes making evidence-based claims about Ethnicity, Race & Identity?

3) Name the term for using geographic thinking to analyze Ethnicity, Race & Identity.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Ethnicity, Race & Identity), Argumentation (Making evidence-based claims about Ethnicity, Race & Identity), and Spatial reasoning (Using geographic thinking to analyze Ethnicity, Race & Identity).'
      }
    },
    {
      id: 'hgethnic6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Ethnicity, Race & Identity is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Ethnicity, Race & Identity describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Ethnicity, Race & Identity is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Ethnicity, Race & Identity. Argumentation — Making evidence-based claims about Ethnicity, Race & Identity. Spatial reasoning — Using geographic thinking to analyze Ethnicity, Race & Identity.'
      }
    },
    {
      id: 'hgethnic6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Ethnicity, Race & Identity.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Ethnicity, Race & Identity and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Ethnicity, Race & Identity. The best approach is:',
            options: [
