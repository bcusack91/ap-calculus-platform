  ...
  sections: [
    ...
    },
    {
      ...
      exercise: {
        "questions": [
          {
            "question": "How does Slavery in America BEST connect to Resistance & Abolition?",
            "options": [
              "This oppressive system generated continuous resistance.",
              "Slavery in America and Resistance & Abolition are completely unrelated topics.",
    ...
    },
    {
      ...
      exercise: {
        "dropdowns": [
          {
            "label": "Slavery in America most directly causes ___",
            "options": [
    ...
    },
    {
      ...
      exercise: {
        "questions": [
          {
            "question": "A student writes: 'Slavery in America had no effect on Resistance & Abolition.' The best AP correction is:",
            "options": [
              "Show specific connections — this oppressive system generated continuous resistance — to demonstrate causal interaction.",
