export const aasSlaveryInAmericaPart4Data = {
...
| Concept | Description |
|---------|-------------|
| **Interconnection** | How Slavery in America links to other course topics |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Slavery in America connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Slavery in America means:',
            options: [
              'The process stops',
...
1) What term refers to how Slavery in America links to other course topics?

2) What concept describes how Slavery in America operates differently at local, national, and global scales?

3) Name the term for how outcomes of Slavery in America can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Slavery in America links to other course topics), Scale interaction (How Slavery in America operates differently at local, national, and global scales), and Feedback loop (How outcomes of Slavery in America can reinforce or modify the original process).'
      }
    },
    {
      id: 'aasslave4-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Slavery in America links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Slavery in America operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Slavery in America can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Slavery in America links to other course topics. Scale interaction — How Slavery in America operates differently at local, national, and global scales. Feedback loop — How outcomes of Slavery in America can reinforce or modify the original process.'
      }
    },
    {
      id: 'aasslave4-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Slavery in America.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Slavery in America and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Slavery in America produces outcomes that further intensify the original process, this is:',
            options: [
