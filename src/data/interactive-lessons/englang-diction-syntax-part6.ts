export const englangDictionSyntaxPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Diction & Syntax, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Diction & Syntax requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Diction & Syntax?

2) What concept describes making evidence-based claims about Diction & Syntax?

3) Name the term for using geographic thinking to analyze Diction & Syntax.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Diction & Syntax), Argumentation (Making evidence-based claims about Diction & Syntax), and Spatial reasoning (Using geographic thinking to analyze Diction & Syntax).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Diction & Syntax is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Diction & Syntax describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Diction & Syntax is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Diction & Syntax. Argumentation — Making evidence-based claims about Diction & Syntax. Spatial reasoning — Using geographic thinking to analyze Diction & Syntax.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Diction & Syntax.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Diction & Syntax and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Diction & Syntax. The best approach is:',
            options: [
