...
1) A solution has transmittance $T = 0.25$. What is the absorbance? (to 2 decimal places)
...
3) Using the same $\\varepsilon$ and path length from problem 2, what concentration gives an absorbance of 0.880? (in M, to 4 decimal places)
      `,
      exercise: {
        inputs: [
          {
