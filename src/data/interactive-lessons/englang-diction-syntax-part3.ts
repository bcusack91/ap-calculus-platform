...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Diction & Syntax across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Diction & Syntax?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Diction & Syntax), Case study (A specific real-world example that illustrates Diction & Syntax), and Comparison (Analyzing similarities and differences across examples of Diction & Syntax).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Diction & Syntax is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Diction & Syntax. Case study — A specific real-world example that illustrates Diction & Syntax. Comparison — Analyzing similarities and differences across examples of Diction & Syntax.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Diction & Syntax.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Diction & Syntax is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
