export const apesBiodiversityConservationPart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Biodiversity Conservation connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Biodiversity Conservation means:',
            options: [
              'The process stops',
...
1) What term refers to how Biodiversity Conservation links to other course topics?

2) What concept describes how Biodiversity Conservation operates differently at local, national, and global scales?

3) Name the term for how outcomes of Biodiversity Conservation can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Biodiversity Conservation links to other course topics), Scale interaction (How Biodiversity Conservation operates differently at local, national, and global scales), and Feedback loop (How outcomes of Biodiversity Conservation can reinforce or modify the original process).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Biodiversity Conservation links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Biodiversity Conservation operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Biodiversity Conservation can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Biodiversity Conservation links to other course topics. Scale interaction — How Biodiversity Conservation operates differently at local, national, and global scales. Feedback loop — How outcomes of Biodiversity Conservation can reinforce or modify the original process.'
      }
    },
    {
...
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Biodiversity Conservation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Biodiversity Conservation and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Biodiversity Conservation produces outcomes that further intensify the original process, this is:',
            options: [
