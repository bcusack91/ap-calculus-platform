export const actPassageTypesPart5Data = {
...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          ...
          {
            label: 'ACT Tip',
            options: ['Identify each author\'s position and how they agree or disagree.', 'Compare and contrast two shorter passages on a related topic.', 'Some questions ask about Passage A only, some about Passage B, some about both.', 'Relationship questions: how would Author A respond to Author B?.']
          }
        ],
        ...
        explanation: 'Each concept in Paired Passages describes a specific idea. Key Insight: Identify each author\'s position and how they agree or disagree. ACT Tip: Relationship questions: how would Author A respond to Author B?.'
      }
    }
  ]
}
