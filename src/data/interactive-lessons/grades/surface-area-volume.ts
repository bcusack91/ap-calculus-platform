...
| --- | --- | --- | --- |
| **Volume** | the space **inside** the shape | how much water it could hold | cubic units (cm³) |
| **Surface Area** | the total area of the **outside** | how much wrapping paper to cover it | square units (cm²) |
...
Because we are filling the shape with little cubes, volume is measured in **cubic units** — written with a little **3** like cm³, in³, m³, or ft³.
...
- **Volume $= 24$ cm³** ✓ (24 cubic centimeters of space inside)
...
To find it, you find the area of **each flat face** and **add them all up**. Because we're adding up areas, surface area is measured in **square units** like cm², in², m², or ft².

**Example:** A cube has **6 faces**. If each face is a $2$ cm × $2$ cm square:
- Area of one face: $2 \\times 2 = 4$ cm²
- There are $6$ faces: $6 \\times 4 = 24$ cm²
- **Surface Area $= 24$ cm²** ✓

> **Watch the units!** Volume uses **cubic** units (cm³) because it fills space. Surface area uses **square** units (cm²) because it covers a surface.`
      },
      {
        id: 'p1-check',
          ...
          questions: [
            {
              ...
              correctAnswer: 0,
              explanation: 'Wrapping paper covers the **outside** surfaces of the box, so she needs the surface area. Surface area is measured in square units (like cm²), not cubic units.'
            }
          ]
        }
      }
...
- **Volume:** $V = s^3 = 6 \\times 6 \\times 6 = 36 \\times 6 = 216$ cm³ ✓
- **Surface area:** $SA = 6s^2 = 6 \\times (6 \\times 6) = 6 \\times 36 = 216$ cm² ✓

> **Cool but tricky:** for this cube the volume and surface area are both **216**, but the **units are different** — $216$ cm³ of space inside vs. $216$ cm² of surface outside. Same number, totally different meaning!
...
**Box 1:** The **volume** in cm³ (use $V = l \\times w \\times h$)
**Box 2:** The **surface area** in cm² (use $SA = 2lw + 2lh + 2wh$)
**Box 3:** A **cube** has side $5$ cm. Its **volume** in cm³ (use $V = s^3$)`,
        exercise: {
          boxes: 3,
          ...
          explanation: 'Box 1 (volume): $8 \\times 2 \\times 3 = 48$ cm³. Box 2 (surface area): $2(16) + 2(24) + 2(6) = 32 + 48 + 12 = 92$ cm². Box 3 (cube volume): $5^3 = 125$ cm³. ✓'
        }
      }
    ]
  },
...
Remember: **volume** fills the inside (cubic units, cm³), **surface area** covers the outside (square units, cm²).`,
        exercise: {
          questions: [
            {
              ...
              correctAnswer: 1,
              explanation: 'Volume of a box is $V = l \\times w \\times h = 4 \\times 2 \\times 5 = 40$ m³. ✓'
            },
            {
              ...
              correctAnswer: 2,
              explanation: 'Surface area of a cube is $SA = 6s^2 = 6 \\times (4 \\times 4) = 6 \\times 16 = 96$ in². ($64$ in³ would be the volume, $4^3$.)'
            }
          ]
        }
      },
        ...
        exercise: {
          dropdowns: [
            ...
            },
            {
              ...
              options: ['cubic units (like cm³)', 'square units (like cm²)']
            }
          ],
          correctAnswers: ['$V = s^3$', 'cubic units (like cm³)'],
          ...
          explanation: 'The volume of a cube is $V = s^3$ (that is $s \\times s \\times s$), and volume is always measured in **cubic units** like cm³ because you are filling space with little cubes. ✓'
        }
      }
    ]
  },
...
- $V = l \\times w \\times h = 30 \\times 12 \\times 15 = 5400$ in³ of water. 🐠
...
**Box 3:** A **cube-shaped** crate has side $4$ ft. How many **cubic feet** does it hold? (volume)`,
        exercise: {
          ...
          explanation: 'Box 1 (volume): $6 \\times 3 \\times 2 = 36$ ft³. Box 2 (surface area): $2(18) + 2(12) + 2(6) = 36 + 24 + 12 = 72$ ft². Box 3 (cube volume): $4^3 = 64$ ft³. ✓'
        }
      },
      {
        id: 'p4-mc',
          ...
          questions: [
            {
              ...
              correctAnswer: 1,
              explanation: 'Water fills the **inside** of the pool, so use volume: $V = l \\times w \\times h = 10 \\times 4 \\times 2 = 80$ m³. ✓'
            }
          ]
        }
      }
...
- **Volume** is the space **inside** → fills the shape → **cubic units** (cm³, ft³).
- **Surface Area** is the total of the **outside** faces → covers the shape → **square units** (cm², ft²).
          ...
          questions: [
            {
              ...
              correctAnswer: 1,
              explanation: 'Volume of a cube is $V = s^3 = 3 \\times 3 \\times 3 = 27$ cm³. ($54$ cm² would be its surface area, $6 \\times 3^2$.)'
            },
            {
              ...
              correctAnswer: 2,
              explanation: 'Surface area is $SA = 2lw + 2lh + 2wh = 2(5 \\times 2) + 2(5 \\times 1) + 2(2 \\times 1) = 20 + 10 + 4 = 34$ m². ✓'
            }
          ]
        }
      }
