export const whColdWarDecolonizationPart1Data = {
  ...
  sections: [
    {
      id: 'whcoldwardecolonization1-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whcoldwardecolonization1-mcq',
    ...
    {
      id: 'whcoldwardecolonization1-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to ideological rivalry between the u.s. and ussr.
- Compare two regions or states affected by proxy wars and nuclear deterrence.
- Evaluate continuity and change involving decolonization movements in asia and africa.
`
    },
    {
      id: 'whcoldwardecolonization1-dropdown',
    ...
    {
      id: 'whcoldwardecolonization1-ap',
      type: 'multiple-choice' as const,
