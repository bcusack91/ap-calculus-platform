export const oChemAminesPart1Data = {
  ...
  sections: [
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s1-intro',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s2-mcq-core',
      ...
      **Mechanism checkpoint (2 questions)**
      ...
      exercise: {
        questions: [
          {
            question: 'Choose the best definition for amine basicity.',
            options: [
            ...
            correctAnswer: 3,
            explanation: 'amine basicity is defined as: depends on lone-pair availability and stabilization.'
          },
          {
    ...
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s3-deep-dive',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s4-input',
      ...
      **Input Practice — enter exact chemistry terms**
      ...
      exercise: {
        boxes: 3,
        correctAnswers: ['amine basicity', 'nucleophilic amine', 'primary amine major product'],
        hint1: 'Blank 1 is the vocabulary term paired with: depends on lone-pair availability and stabilization.',
        hint2: 'Blank 2 corresponds to nitrogen lone pair attacks electrophilic centers.',
        hint3: 'Use the worked example: R-X + NH3 (excess) gives primary amine major product.',
        explanation: 'Correct entries: amine basicity, nucleophilic amine, and primary amine major product. These anchor mechanism ID, vocabulary precision, and product prediction.'
      }
    },
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s5-dropdown',
      ...
      **Dropdown matching (3 prompts)**
      ...
      exercise: {
        dropdowns: [
          {
            label: 'over-alkylation',
            options: ['carbonyl + amine then reduction to C-N single bond', 'nitrogen lone pair attacks electrophilic centers', 'depends on lone-pair availability and stabilization', 'successive alkylation can push to quaternary ammonium']
          },
          {
          ...
          },
          {
            ...
            options: ['Reductive amination is not simple direct SN2 on carbonyl carbon.', 'Amides are far less basic than amines because lone pair is resonance-delocalized.', 'Diazonium salts require cold conditions to avoid decomposition.', 'Mechanism labels should be tied to observed bond changes, not memorized by reagent names alone.']
          }
        ],
        correctAnswers: ['successive alkylation can push to quaternary ammonium', 'secondary amine', 'Mechanism labels should be tied to observed bond changes, not memorized by reagent names alone.'],
    ...
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s6-strategy',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'ochem-amines-nitrogen-compounds-p1-s7-mcq-final',
      type: 'multiple-choice' as const,
      content: `
      **Applied synthesis/mechanism check (2 questions)**
      ...
      exercise: {
        questions: [
          {
            question: 'In a synthesis sequence centered on amine classification and basicity, a step uses R-COCl + R\'NH2. Which major product pattern is most defensible?',
            options: [
              'aryl diazonium salt',
              'secondary amine',
              'primary amine major product',
          ...
          {
            question: 'A mechanism rationale cites diazonium salt: aryl-N2+ intermediate used for substitution. Which interpretation applies this idea correctly in product prediction?',
            options: [
              'Ignore diazonium salt and choose products only by molecular weight.',
              'Use diazonium salt to justify why the pathway favors aryl diazonium salt under ArNH2 + NaNO2/HCl (0-5 °C).',
              'Treat diazonium salt as a naming convention unrelated to mechanism.',
              'Use diazonium salt only after final answer choice selection.'
            ],
            correctAnswer: 1,
            explanation: 'The correct approach applies diazonium salt directly to mechanism and product control. In this context, ArNH2 + NaNO2/HCl (0-5 °C) aligns with aryl diazonium salt.'
          }
        ]
      }
    }
