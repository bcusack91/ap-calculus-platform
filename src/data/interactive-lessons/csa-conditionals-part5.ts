export const csaConditionalsPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Conditionals & Control Flow helps:',
            options: [
          ...
          {
            question: 'Continuity in Conditionals & Control Flow means:',
            options: [
              'Everything changes',
...
2) What concept describes how Conditionals & Control Flow has transformed due to new forces and conditions?

3) Name the term for the direction of change in Conditionals & Control Flow over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Conditionals & Control Flow that have remained stable over time), Change (How Conditionals & Control Flow has transformed due to new forces and conditions), and Trend (The direction of change in Conditionals & Control Flow over time).'
      }
    },
    {
      id: 'csacondi5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Conditionals & Control Flow that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Conditionals & Control Flow has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Conditionals & Control Flow over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Conditionals & Control Flow that have remained stable over time. Change — How Conditionals & Control Flow has transformed due to new forces and conditions. Trend — The direction of change in Conditionals & Control Flow over time.'
      }
    },
    {
      id: 'csacondi5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Conditionals & Control Flow.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Conditionals & Control Flow has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Conditionals & Control Flow shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
