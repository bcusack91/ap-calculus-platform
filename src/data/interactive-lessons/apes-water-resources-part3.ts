export const apesWaterResourcesPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Water Resources & Pollution across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Water Resources & Pollution?

2) What concept describes a specific real-world example that illustrates Water Resources & Pollution?

3) Name the term for analyzing similarities and differences across examples of Water Resources & Pollution.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Water Resources & Pollution), Case study (A specific real-world example that illustrates Water Resources & Pollution), and Comparison (Analyzing similarities and differences across examples of Water Resources & Pollution).'
      }
    },
    {
      id: 'apeswate3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Water Resources & Pollution is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Water Resources & Pollution describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Water Resources & Pollution is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Water Resources & Pollution. Case study — A specific real-world example that illustrates Water Resources & Pollution. Comparison — Analyzing similarities and differences across examples of Water Resources & Pollution.'
      }
    },
    {
      id: 'apeswate3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Water Resources & Pollution.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Water Resources & Pollution. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Water Resources & Pollution is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
