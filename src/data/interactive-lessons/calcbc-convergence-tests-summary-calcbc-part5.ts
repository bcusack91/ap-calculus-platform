...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key concept of ratio, root & alternating tests?',
            options: [
              'Ratio Test',
          ...
          {
            question: 'In the context of ratio, root & alternating tests, which is accurate?',
            options: [
              'Σ(-1)ⁿbₙ converges if bₙ decreasing → 0',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which concept relates directly to ratio, root & alternating tests?',
            options: [
              'check if Σ|aₙ| converges or just Σaₙ',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'These concepts are fundamental to understanding Ratio, Root & Alternating Tests.'
      }
    }
  ]
}
