...
| Concept | Description |
|---------|-------------|
| **Spatial pattern** | The geographic distribution related to Resistance & Abolition |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Resistance & Abolition across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Resistance & Abolition?

2) What concept describes a specific real-world example that illustrates Resistance & Abolition?

3) Name the term for analyzing similarities and differences across examples of Resistance & Abolition.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Resistance & Abolition), Case study (A specific real-world example that illustrates Resistance & Abolition), and Comparison (Analyzing similarities and differences across examples of Resistance & Abolition).'
      }
    },
    {
      id: 'aasresis3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Resistance & Abolition is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Resistance & Abolition describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Resistance & Abolition is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Resistance & Abolition. Case study — A specific real-world example that illustrates Resistance & Abolition. Comparison — Analyzing similarities and differences across examples of Resistance & Abolition.'
      }
    },
    {
      id: 'aasresis3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Resistance & Abolition.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Resistance & Abolition. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Resistance & Abolition is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
