...
**Part 3 of 7 — Probability rules and complements**
...
- P(A or B) = P(A) + P(B) - P(A and B)\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "What is the mean of 11, 15, and 19?",
              options: [
                "17",
                "15",
                "8",
              ...
              correctAnswer: 1,
              explanation: "Mean is (11+15+19)/3 = 15."
            },
            {
