...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Variables & Data Types across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Variables & Data Types?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Variables & Data Types), Case study (A specific real-world example that illustrates Variables & Data Types), and Comparison (Analyzing similarities and differences across examples of Variables & Data Types).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Variables & Data Types is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Variables & Data Types. Case study — A specific real-world example that illustrates Variables & Data Types. Comparison — Analyzing similarities and differences across examples of Variables & Data Types.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Variables & Data Types.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Variables & Data Types is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
