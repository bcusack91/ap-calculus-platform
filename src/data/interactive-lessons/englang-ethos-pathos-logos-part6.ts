export const englangEthosPathosLogosPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Ethos, Pathos & Logos, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Ethos, Pathos & Logos requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Ethos, Pathos & Logos?

2) What concept describes making evidence-based claims about Ethos, Pathos & Logos?

3) Name the term for using geographic thinking to analyze Ethos, Pathos & Logos.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Ethos, Pathos & Logos), Argumentation (Making evidence-based claims about Ethos, Pathos & Logos), and Spatial reasoning (Using geographic thinking to analyze Ethos, Pathos & Logos).'
      }
    },
    {
      id: 'englange6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Ethos, Pathos & Logos is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Ethos, Pathos & Logos describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Ethos, Pathos & Logos is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Ethos, Pathos & Logos. Argumentation — Making evidence-based claims about Ethos, Pathos & Logos. Spatial reasoning — Using geographic thinking to analyze Ethos, Pathos & Logos.'
      }
    },
    {
      id: 'englange6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Ethos, Pathos & Logos.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Ethos, Pathos & Logos and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Ethos, Pathos & Logos. The best approach is:',
            options: [
