export const microLaborMarketsPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Labor Markets, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Labor Markets requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Labor Markets?

2) What concept describes making evidence-based claims about Labor Markets?

3) Name the term for using geographic thinking to analyze Labor Markets.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Labor Markets), Argumentation (Making evidence-based claims about Labor Markets), and Spatial reasoning (Using geographic thinking to analyze Labor Markets).'
      }
    },
    {
      id: 'microlab6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Labor Markets is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Labor Markets describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Labor Markets is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Labor Markets. Argumentation — Making evidence-based claims about Labor Markets. Spatial reasoning — Using geographic thinking to analyze Labor Markets.'
      }
    },
    {
      id: 'microlab6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Labor Markets.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Labor Markets and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Labor Markets. The best approach is:',
            options: [
