export const macroFiscalPolicyToolsPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Fiscal Policy Tools & Outcomes |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Fiscal Policy Tools & Outcomes across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Fiscal Policy Tools & Outcomes. Understanding this concept is essential for mastering Fiscal Policy Tools & Outcomes in AP Macroeconomics.
...
1) What term refers to a recurring structure within Fiscal Policy Tools & Outcomes?

2) What concept describes a specific real-world example that illustrates Fiscal Policy Tools & Outcomes?

3) Name the term for analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Fiscal Policy Tools & Outcomes), Case study (A specific real-world example that illustrates Fiscal Policy Tools & Outcomes), and Comparison (Analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Fiscal Policy Tools & Outcomes is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Fiscal Policy Tools & Outcomes describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Fiscal Policy Tools & Outcomes. Case study — A specific real-world example that illustrates Fiscal Policy Tools & Outcomes. Comparison — Analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Fiscal Policy Tools & Outcomes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Fiscal Policy Tools & Outcomes. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Fiscal Policy Tools & Outcomes is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
