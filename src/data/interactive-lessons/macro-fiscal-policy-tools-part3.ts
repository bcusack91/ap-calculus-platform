...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Fiscal Policy Tools & Outcomes across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Fiscal Policy Tools & Outcomes?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Fiscal Policy Tools & Outcomes), Case study (A specific real-world example that illustrates Fiscal Policy Tools & Outcomes), and Comparison (Analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Fiscal Policy Tools & Outcomes is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Fiscal Policy Tools & Outcomes. Case study — A specific real-world example that illustrates Fiscal Policy Tools & Outcomes. Comparison — Analyzing similarities and differences across examples of Fiscal Policy Tools & Outcomes.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Fiscal Policy Tools & Outcomes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Fiscal Policy Tools & Outcomes is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
