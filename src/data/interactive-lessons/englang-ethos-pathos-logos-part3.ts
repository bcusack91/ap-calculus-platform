...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Ethos, Pathos & Logos across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Ethos, Pathos & Logos?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Ethos, Pathos & Logos), Case study (A specific real-world example that illustrates Ethos, Pathos & Logos), and Comparison (Analyzing similarities and differences across examples of Ethos, Pathos & Logos).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Ethos, Pathos & Logos is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Ethos, Pathos & Logos. Case study — A specific real-world example that illustrates Ethos, Pathos & Logos. Comparison — Analyzing similarities and differences across examples of Ethos, Pathos & Logos.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Ethos, Pathos & Logos.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Ethos, Pathos & Logos is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
