export const englangEthosPathosLogosPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Ethos, Pathos & Logos |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Ethos, Pathos & Logos across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'englange3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Ethos, Pathos & Logos. Understanding this concept is essential for mastering Ethos, Pathos & Logos in AP English Language.
...
1) What term refers to a recurring structure within Ethos, Pathos & Logos?

2) What concept describes a specific real-world example that illustrates Ethos, Pathos & Logos?

3) Name the term for analyzing similarities and differences across examples of Ethos, Pathos & Logos.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Ethos, Pathos & Logos), Case study (A specific real-world example that illustrates Ethos, Pathos & Logos), and Comparison (Analyzing similarities and differences across examples of Ethos, Pathos & Logos).'
      }
    },
    {
      id: 'englange3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Ethos, Pathos & Logos is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Ethos, Pathos & Logos describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Ethos, Pathos & Logos is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Ethos, Pathos & Logos. Case study — A specific real-world example that illustrates Ethos, Pathos & Logos. Comparison — Analyzing similarities and differences across examples of Ethos, Pathos & Logos.'
      }
    },
    {
      id: 'englange3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Ethos, Pathos & Logos.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Ethos, Pathos & Logos. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Ethos, Pathos & Logos is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
