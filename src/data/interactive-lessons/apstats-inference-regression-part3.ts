...
**Part 3 of 7 — Confidence Interval for Slope**

---

### Key Concepts

This section covers essential concepts related to **confidence interval for slope** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Confidence Interval for Slope Check** 🎯
      `,
      exercise: {
        questions: [
          {
