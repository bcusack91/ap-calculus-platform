export const hgPopulationGrowthPart7Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'The most important exam strategy for Population Growth & Decline is:',
            options: [
              'Guess randomly',
          ...
          {
            question: 'AP multiple-choice questions about Population Growth & Decline often test:',
            options: [
              'Random trivia',
...
1) What term refers to essential terms and definitions for Population Growth & Decline?

2) What concept describes the most frequent ways Population Growth & Decline is tested on the AP exam?

3) Name the term for approaches for answering Population Growth & Decline questions effectively.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: E',
        explanation: 'Expected answers: Key vocabulary (Essential terms and definitions for Population Growth & Decline), Common question types (The most frequent ways Population Growth & Decline is tested on the AP exam), and Exam strategy (Approaches for answering Population Growth & Decline questions effectively).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Essential terms and definitions for Population Growth & Decline is called ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'None of these']
          },
          {
            label: 'The most frequent ways Population Growth & Decline is tested on the AP exam describes ___',
            options: ['Key vocabulary', 'Common question types', 'Exam strategy', 'All of these']
          },
          {
            label: 'Approaches for answering Population Growth & Decline questions effectively is known as ___',
        ...
        explanation: 'Key vocabulary — Essential terms and definitions for Population Growth & Decline. Common question types — The most frequent ways Population Growth & Decline is tested on the AP exam. Exam strategy — Approaches for answering Population Growth & Decline questions effectively.'
      }
    },
    {
...
- Don\'\'t confuse **Key vocabulary** with **Common question types** — while related, they address different aspects of Population Growth & Decline.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, a question presents a scenario you have never seen before about Population Growth & Decline. You should:',
            options: [
              'Panic',
          ...
          {
            question: 'For free-response questions on Population Growth & Decline, the most common mistake is:',
            options: [
              'Writing too clearly',
