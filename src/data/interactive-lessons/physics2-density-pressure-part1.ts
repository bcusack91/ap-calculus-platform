...
3) Will it sink or float in water? (type "sink" or "float")
      ...
      exercise: {
        ...
        hint2: '$V \\approx 5.24 \\times 10^{-4}\\ \\text{m}^3$. Then $\\rho = 1.5 / 5.24 \\times 10^{-4}$.',
        hint3: '$\\rho \\approx 2865$ kg/m³. Since $2865 > 1000$, it sinks.',
        explanation: '$V = (4/3)\\pi(0.05)^3 \\approx 5.24 \\times 10^{-4}$ m³. $\\rho = 1.5/0.000524 \\approx 2863$ kg/m³. Since this is greater than water (1000), it sinks. Accept values in range 2860-2890.'
      }
    },
    {
      id: 'dp1-exit-quiz',
