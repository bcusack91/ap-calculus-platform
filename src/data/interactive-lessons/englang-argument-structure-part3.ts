...
| Concept | Description |
|---------|-------------|
| **Spatial pattern** | The geographic distribution related to Argument Structure |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Argument Structure across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Argument Structure?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Argument Structure), Case study (A specific real-world example that illustrates Argument Structure), and Comparison (Analyzing similarities and differences across examples of Argument Structure).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Argument Structure is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Argument Structure. Case study — A specific real-world example that illustrates Argument Structure. Comparison — Analyzing similarities and differences across examples of Argument Structure.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Argument Structure.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Argument Structure is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
