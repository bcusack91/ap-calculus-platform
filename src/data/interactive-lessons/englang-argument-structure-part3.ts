export const englangArgumentStructurePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Argument Structure |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Argument Structure across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'englanga3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Argument Structure. Understanding this concept is essential for mastering Argument Structure in AP English Language.
...
1) What term refers to a recurring structure within Argument Structure?

2) What concept describes a specific real-world example that illustrates Argument Structure?

3) Name the term for analyzing similarities and differences across examples of Argument Structure.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Argument Structure), Case study (A specific real-world example that illustrates Argument Structure), and Comparison (Analyzing similarities and differences across examples of Argument Structure).'
      }
    },
    {
      id: 'englanga3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Argument Structure is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Argument Structure describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Argument Structure is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Argument Structure. Case study — A specific real-world example that illustrates Argument Structure. Comparison — Analyzing similarities and differences across examples of Argument Structure.'
      }
    },
    {
      id: 'englanga3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Argument Structure.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Argument Structure. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Argument Structure is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
