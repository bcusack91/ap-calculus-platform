export const psychGroupPart6Data = {
  ...
  sections: [
    {
      id: 'group-behavior-prejudice-p6-s1-intro',
      type: 'text' as const,
      content: `
      # 🧠 Group Behavior and Prejudice

      **Part 6 of 7 — Applied Interventions and Data**
    ...
    {
      id: 'group-behavior-prejudice-p6-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about survey and behavioral data on bias reduction, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'social identity',
              'obedience',
              'conformity',
    ...
    {
      id: 'group-behavior-prejudice-p6-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'group-behavior-prejudice-p6-s4-input',
    ...
    {
      id: 'group-behavior-prejudice-p6-s5-dropdown',
      ...
      exercise: {
        dropdowns: [
          ...
          },
          {
            ...
            options: ['ingroup bias', 'conformity', 'obedience', 'stereotype']
          },
          {
            label: 'Select the concept that best matches: adjusting behavior or beliefs to align with a group',
            options: ['conformity', 'social identity', 'fundamental attribution error', 'obedience']
          }
        ],
        correctAnswers: ['social identity', 'ingroup bias', 'conformity'],
    ...
    {
      id: 'group-behavior-prejudice-p6-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about survey and behavioral data on bias reduction, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'group-behavior-prejudice-p6-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating survey and behavioral data on bias reduction finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'obedience',
              'ingroup bias',
              'conformity',
