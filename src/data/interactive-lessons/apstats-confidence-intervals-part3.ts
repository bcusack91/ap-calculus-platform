...
**Part 3 of 7 — One-Sample T-Interval for Means**

---

### Key Concepts

This section covers essential concepts related to **one-sample t-interval for means** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**One-Sample T-Interval for Means Check** 🎯
      `,
      exercise: {
        questions: [
          {
