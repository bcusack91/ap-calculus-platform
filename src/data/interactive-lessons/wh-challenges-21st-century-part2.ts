export const whChallenges21stCenturyPart2Data = {
  ...
  sections: [
    {
      id: 'whchallenges21stcentury2-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whchallenges21stcentury2-mcq',
    ...
    {
      id: 'whchallenges21stcentury2-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whchallenges21stcentury2-dropdown',
    ...
    {
      id: 'whchallenges21stcentury2-ap',
      type: 'multiple-choice' as const,
