...
**Part 3 of 7 — Residuals and Residual Plots**

---

### Key Concepts

This section covers essential concepts related to **residuals and residual plots** in AP Statistics.
...
> 🔑 **AP Tip:** Always state hypotheses, check conditions, calculate the test statistic, find the p-value, and state your conclusion in context.`
    },
    {
      ...
      content: `
**Residuals and Residual Plots Check** 🎯
      `,
      exercise: {
        questions: [
          {
