export const actReadingStratPart7Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p7-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 7 of 7 — Mixed review and section strategy**
