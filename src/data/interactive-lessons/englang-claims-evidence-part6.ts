export const englangClaimsEvidencePart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Claims & Evidence, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Claims & Evidence requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Claims & Evidence?

2) What concept describes making evidence-based claims about Claims & Evidence?

3) Name the term for using geographic thinking to analyze Claims & Evidence.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Claims & Evidence), Argumentation (Making evidence-based claims about Claims & Evidence), and Spatial reasoning (Using geographic thinking to analyze Claims & Evidence).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Claims & Evidence is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Claims & Evidence describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Claims & Evidence is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Claims & Evidence. Argumentation — Making evidence-based claims about Claims & Evidence. Spatial reasoning — Using geographic thinking to analyze Claims & Evidence.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Claims & Evidence.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Claims & Evidence and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Claims & Evidence. The best approach is:',
            options: [
