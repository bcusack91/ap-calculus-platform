...
| Concept | Description |
|---------|-------------|
| **Process 1** | The primary mechanism that drives patterns in Social & Ethical Impacts |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Social & Ethical Impacts?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Social & Ethical Impacts helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Social & Ethical Impacts?

2) What concept describes a secondary process that shapes outcomes in Social & Ethical Impacts?

3) Name the term for the relationship between actions and outcomes in Social & Ethical Impacts.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Social & Ethical Impacts), Process 2 (A secondary process that shapes outcomes in Social & Ethical Impacts), and Cause and effect (The relationship between actions and outcomes in Social & Ethical Impacts).'
      }
    },
    {
      id: 'cspsocia2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Social & Ethical Impacts is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Social & Ethical Impacts describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Social & Ethical Impacts is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Social & Ethical Impacts. Process 2 — A secondary process that shapes outcomes in Social & Ethical Impacts. Cause and effect — The relationship between actions and outcomes in Social & Ethical Impacts.'
      }
    },
    {
      id: 'cspsocia2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Social & Ethical Impacts.
