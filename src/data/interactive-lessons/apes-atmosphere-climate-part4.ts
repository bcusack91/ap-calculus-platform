export const apesAtmosphereClimatePart4Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Atmosphere & Climate Change connects to other course topics through:',
            options: [
          ...
          {
            question: 'A feedback loop in Atmosphere & Climate Change means:',
            options: [
              'The process stops',
...
1) What term refers to how Atmosphere & Climate Change links to other course topics?

2) What concept describes how Atmosphere & Climate Change operates differently at local, national, and global scales?

3) Name the term for how outcomes of Atmosphere & Climate Change can reinforce or modify the original process.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: S',
        hint3: 'Starts with: F',
        explanation: 'Expected answers: Interconnection (How Atmosphere & Climate Change links to other course topics), Scale interaction (How Atmosphere & Climate Change operates differently at local, national, and global scales), and Feedback loop (How outcomes of Atmosphere & Climate Change can reinforce or modify the original process).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'How Atmosphere & Climate Change links to other course topics is called ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'None of these']
          },
          {
            label: 'How Atmosphere & Climate Change operates differently at local, national, and global scales describes ___',
            options: ['Interconnection', 'Scale interaction', 'Feedback loop', 'All of these']
          },
          {
            label: 'How outcomes of Atmosphere & Climate Change can reinforce or modify the original process is known as ___',
        ...
        explanation: 'Interconnection — How Atmosphere & Climate Change links to other course topics. Scale interaction — How Atmosphere & Climate Change operates differently at local, national, and global scales. Feedback loop — How outcomes of Atmosphere & Climate Change can reinforce or modify the original process.'
      }
    },
    {
...
- Don\'\'t confuse **Interconnection** with **Scale interaction** — while related, they address different aspects of Atmosphere & Climate Change.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'On the AP exam, demonstrating connections between Atmosphere & Climate Change and other units earns higher scores because:',
            options: [
              'The exam is random',
          ...
          {
            question: 'If Atmosphere & Climate Change produces outcomes that further intensify the original process, this is:',
            options: [
