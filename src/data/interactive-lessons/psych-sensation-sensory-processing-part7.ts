export const psychSensationPart7Data = {
  ...
  sections: [
    {
      id: 'sensation-sensory-processing-p7-s1-intro',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'sensation-sensory-processing-p7-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about AP synthesis using sensation and perception concepts, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'absolute threshold',
              'selective attention',
    ...
    {
      id: 'sensation-sensory-processing-p7-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'sensation-sensory-processing-p7-s4-input',
    ...
    {
      id: 'sensation-sensory-processing-p7-s5-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['bottom-up processing', 'absolute threshold', 'selective attention', 'top-down processing']
          },
          {
            label: 'Select the concept that best matches: smallest detectable difference between two stimuli',
            options: ['difference threshold', 'signal detection theory', 'bottom-up processing', 'selective attention']
          },
          {
            label: 'Select the concept that best matches: framework separating sensitivity from response bias under uncertainty',
            options: ['bottom-up processing', 'top-down processing', 'difference threshold', 'signal detection theory']
          }
        ],
        correctAnswers: ['absolute threshold', 'difference threshold', 'signal detection theory'],
    ...
    {
      id: 'sensation-sensory-processing-p7-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about AP synthesis using sensation and perception concepts, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'sensation-sensory-processing-p7-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating AP synthesis using sensation and perception concepts finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'difference threshold',
              'signal detection theory',
              'absolute threshold',
