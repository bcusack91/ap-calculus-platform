export const csaInheritancePolymorphismPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Inheritance & Polymorphism |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Inheritance & Polymorphism across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Inheritance & Polymorphism. Understanding this concept is essential for mastering Inheritance & Polymorphism in AP Computer Science A.
...
1) What term refers to a recurring structure within Inheritance & Polymorphism?

2) What concept describes a specific real-world example that illustrates Inheritance & Polymorphism?

3) Name the term for analyzing similarities and differences across examples of Inheritance & Polymorphism.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Inheritance & Polymorphism), Case study (A specific real-world example that illustrates Inheritance & Polymorphism), and Comparison (Analyzing similarities and differences across examples of Inheritance & Polymorphism).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Inheritance & Polymorphism is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Inheritance & Polymorphism describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Inheritance & Polymorphism is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Inheritance & Polymorphism. Case study — A specific real-world example that illustrates Inheritance & Polymorphism. Comparison — Analyzing similarities and differences across examples of Inheritance & Polymorphism.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Inheritance & Polymorphism.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Inheritance & Polymorphism. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Inheritance & Polymorphism is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
