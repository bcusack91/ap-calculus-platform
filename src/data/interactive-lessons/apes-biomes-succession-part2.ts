export const apesBiomesSuccessionPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Biomes & Ecological Succession?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Biomes & Ecological Succession helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Biomes & Ecological Succession?

2) What concept describes a secondary process that shapes outcomes in Biomes & Ecological Succession?

3) Name the term for the relationship between actions and outcomes in Biomes & Ecological Succession.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Biomes & Ecological Succession), Process 2 (A secondary process that shapes outcomes in Biomes & Ecological Succession), and Cause and effect (The relationship between actions and outcomes in Biomes & Ecological Succession).'
      }
    },
    {
      id: 'apesbiom2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Biomes & Ecological Succession is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Biomes & Ecological Succession describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Biomes & Ecological Succession is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Biomes & Ecological Succession. Process 2 — A secondary process that shapes outcomes in Biomes & Ecological Succession. Cause and effect — The relationship between actions and outcomes in Biomes & Ecological Succession.'
      }
    },
    {
      id: 'apesbiom2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Biomes & Ecological Succession.
