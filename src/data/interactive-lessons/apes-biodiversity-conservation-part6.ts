export const apesBiodiversityConservationPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Biodiversity Conservation, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Biodiversity Conservation requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Biodiversity Conservation?

2) What concept describes making evidence-based claims about Biodiversity Conservation?

3) Name the term for using geographic thinking to analyze Biodiversity Conservation.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Biodiversity Conservation), Argumentation (Making evidence-based claims about Biodiversity Conservation), and Spatial reasoning (Using geographic thinking to analyze Biodiversity Conservation).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Biodiversity Conservation is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Biodiversity Conservation describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Biodiversity Conservation is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Biodiversity Conservation. Argumentation — Making evidence-based claims about Biodiversity Conservation. Spatial reasoning — Using geographic thinking to analyze Biodiversity Conservation.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Biodiversity Conservation.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Biodiversity Conservation and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Biodiversity Conservation. The best approach is:',
            options: [
