export const whGlobalizationTechPart7Data = {
  topicSlug: 'wh-globalization-tech',
  sections: [
    {
      id: 'whglobalizationtech7-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whglobalizationtech7-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to role of international institutions.
- Compare two regions or states affected by digital revolution and information flows.
- Evaluate continuity and change involving cultural diffusion and hybrid identities.
`
    },
    {
      id: 'whglobalizationtech7-dropdown',
