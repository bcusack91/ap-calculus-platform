...
|---------|----------------|---------------|------|
| **Cr** (Z=24) | [Ar] $4s^{2}$ $3d^{4}$ | **[Ar] $3d^{5}$ $4s^{1}$** | Half-filled $d^{5}$ is extra stable |
| **Cu** (Z=29) | [Ar] $4s^{2}$ $3d^{9}$ | **[Ar] $3d^{10}$ $4s^{1}$** | Fully filled $d^{10}$ is extra stable |
...
**Why?** Half-filled $(d^{5})$ and fully filled $(d^{10})$ subshells have **extra stability** due to:
...
> ⚠️ **AP Must-Know:** Cr is [Ar] $3d^{5}$ $4s^{1}$ $(not 4s^{2} 3d^{4})$ and Cu is [Ar] $3d^{10}$ $4s^{1}$ $(not 4s^{2} 3d^{9})$. Half-filled and fully filled d subshells have extra stability.`
    },
    {
        ...
        questions: [
          {
            ...
            correctAnswer: 2,
            explanation: 'Chromium is an exception: it adopts [Ar] $3d^{5}$ $4s^{1}$ instead of the expected [Ar] $4s^{2}$ $3d^{4}$. The half-filled $3d^{5}$ configuration provides extra stability from exchange energy.'
          }
        ]
      }
    },
...
### Example 1: $Fe^{2+}$ (Z = 26, 24 electrons)

| Step | Action | Result |
|------|--------|--------|
| 1 | Write neutral Fe configuration | [Ar] $4s^{2}$ $3d^{6}$ |
| 2 | Identify highest n to remove from | 4s (n = 4) |
| 3 | Remove 2 electrons from 4s | $4s^{0}$ (both 4s electrons gone) |

**$Fe^{2+}$: [Ar] $3d^{6}$**

---

### Example 2: $Fe^{3+}$ (Z = 26, 23 electrons)

| Step | Action | Result |
|------|--------|--------|
| 1 | Start from $Fe^{2+}$ | [Ar] $3d^{6}$ |
| 2 | 4s is already empty — remove from 3d | Remove 1 electron from 3d |
| 3 | Final configuration | [Ar] $3d^{5}$ |

**$Fe^{3+}$: [Ar] $3d^{5}$**

> 🔑 **Notice:** $Fe^{3+}$ has a half-filled $3d^{5}$ subshell, giving it extra stability — this is why $Fe^{3+}$ is a very common ion.
...
| Step | Action | Result |
|------|--------|--------|
| 1 | Write neutral Cl configuration | [Ne] $3s^{2}$ $3p^{5}$ |
| 2 | Add 1 electron to 3p | $3p^{5}$ → $3p^{6}$ |
| 3 | Final configuration | [Ne] $3s^{2}$ $3p^{6}$ |
...
Recall: Cu (Z = 29) has the configuration [Ar] $3d^{10}$ $4s^{1}$ (exception).`,
      exercise: {
        questions: [
          {
            question: 'Electron configuration of $Cu^{2+}$:',
            options: [
              '[Ar] $3d^{9}$ $4s^{0}$',
              '[Ar] $3d^{9}$',
              '[Ar] $3d^{8}$ $4s^{1}$',
            ...
            correctAnswer: 1,
            explanation: 'Cu: [Ar] $3d^{10}$ $4s^{1}$. To form $Cu^{2+}$, remove 2 electrons. First remove the $4s^{1}$ electron (highest n), then remove 1 from 3d: [Ar] $3d^{9}$. We typically omit "$4s^{0}$" since that subshell is empty.'
          }
        ]
      }
    },
        ...
        inputs: [
          {
            ...
            explanation: 'Neutral Mn: [Ar] $4s^{2}$ $3d^{5}$. Remove 2 electrons from 4s (highest n): [Ar] $3d^{5}$. The $Mn^{2+}$ ion has a half-filled d subshell, which is very stable.'
          },
          {
            label: '$Zn^{2+}$ (Zn: Z = 30)',
            correctAnswer: '[Ar] 3d10',
            explanation: 'Neutral Zn: [Ar] $4s^{2}$ $3d^{10}$. Remove 2 electrons from 4s: [Ar] $3d^{10}$. The $Zn^{2+}$ ion has a completely filled d subshell.'
          }
        ]
      }
    },
        ...
        dropdowns: [
          {
            ...
            options: ['$Na^{+}$', '$Mg^{2+}$', '$K^{+}$', '$Fe^{2+}$'],
            correctIndex: 2,
            explanation: '$K^{+}$: potassium (Z = 19) loses 1 electron → 18 electrons, same as Ar. $Na^{+}$ has 10 electrons (like Ne), $Mg^{2+}$ has 10 electrons (like Ne), and $Fe^{2+}$ has 24 electrons. Only $K^{+}$ matches Ar\'s 18 electrons.'
          },
          {
            label: 'What is the electron configuration of $Cr^{3+}$?',
            options: ['[Ar] $4s^{1}$ $3d^{2}$', '[Ar] $3d^{3}$', '[Ar] $3d^{2}$ $4s^{1}$', '[Ar] $4s^{2}$ $3d^{1}$'],
            correctIndex: 1,
            explanation: 'Cr: [Ar] $3d^{5}$ $4s^{1}$ (exception). Remove 3 electrons: first the $4s^{1}$, then 2 from 3d. Result: [Ar] $3d^{3}$.'
          }
        ]
      }
    },
...
|---------|----------|--------|-----|
| Cr (Z = 24) | [Ar] $4s^{2}$ $3d^{4}$ | [Ar] $3d^{5}$ $4s^{1}$ | Half-filled $d^{5}$ = extra stability |
| Cu (Z = 29) | [Ar] $4s^{2}$ $3d^{9}$ | [Ar] $3d^{10}$ $4s^{1}$ | Fully filled $d^{10}$ = extra stability |
...
|----------|------|---------|
| Cations (+) | Remove from **highest n** first | $Fe^{2+}$: remove $4s^{2}$ → [Ar] $3d^{6}$ |
| Anions (−) | Add to next available subshell | $Cl^{-}$: add to 3p → [Ne] $3s^{2}$ $3p^{6}$ |
