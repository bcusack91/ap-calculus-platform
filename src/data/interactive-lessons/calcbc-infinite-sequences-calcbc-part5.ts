...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key concept of squeeze theorem for sequences?',
            options: [
              'If aₙ ≤ bₙ ≤ cₙ and lim aₙ = lim cₙ = L, then lim bₙ = L',
          ...
          {
            question: 'In the context of squeeze theorem for sequences, which is accurate?',
            options: [
              '(-1)ⁿ/n → 0 because |(-1)ⁿ/n| = 1/n → 0',
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which concept relates directly to squeeze theorem for sequences?',
            options: [
              'Squeeze theorem is especially useful for oscillating sequences',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'These concepts are fundamental to understanding Squeeze Theorem for Sequences.'
      }
    }
  ]
}
