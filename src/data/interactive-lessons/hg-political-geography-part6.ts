export const hgPoliticalGeographyPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Political Geography & Territoriality, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Political Geography & Territoriality requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Political Geography & Territoriality?

2) What concept describes making evidence-based claims about Political Geography & Territoriality?

3) Name the term for using geographic thinking to analyze Political Geography & Territoriality.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Political Geography & Territoriality), Argumentation (Making evidence-based claims about Political Geography & Territoriality), and Spatial reasoning (Using geographic thinking to analyze Political Geography & Territoriality).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Political Geography & Territoriality is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Political Geography & Territoriality describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Political Geography & Territoriality is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Political Geography & Territoriality. Argumentation — Making evidence-based claims about Political Geography & Territoriality. Spatial reasoning — Using geographic thinking to analyze Political Geography & Territoriality.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Political Geography & Territoriality.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Political Geography & Territoriality and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Political Geography & Territoriality. The best approach is:',
            options: [
