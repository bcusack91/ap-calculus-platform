export const whChallenges21stCenturyPart7Data = {
  topicSlug: 'wh-challenges-21st-century',
  sections: [
    {
      id: 'whchallenges21stcentury7-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whchallenges21stcentury7-mcq',
    ...
    {
      id: 'whchallenges21stcentury7-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to transnational terrorism and security policy.
- Compare two regions or states affected by pandemics and global health governance.
- Evaluate continuity and change involving migration, inequality, and human rights.
`
    },
    {
      id: 'whchallenges21stcentury7-dropdown',
    ...
    {
      id: 'whchallenges21stcentury7-ap',
      type: 'multiple-choice' as const,
