...
**Check Your Understanding** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Regarding Vocabulary in Context, which correctly describes ACT Tip?',
            options: [
              'Read the full sentence, not just the phrase around the word.',
              'the surrounding words reveal the meaning.',
              'ACT tests common words with uncommon meanings.',
...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Context clues',
            options: ['Substitute each answer choice — which one makes the most sense?.', 'the surrounding words reveal the meaning.', 'Read the full sentence, not just the phrase around the word.', 'ACT tests common words with uncommon meanings.']
          },
          {
            label: 'Key Insight',
            options: ['ACT tests common words with uncommon meanings.', 'Substitute each answer choice — which one makes the most sense?.', 'the surrounding words reveal the meaning.', 'Read the full sentence, not just the phrase around the word.']
          },
          {
            label: 'ACT Tip',
            options: ['ACT tests common words with uncommon meanings.', 'Read the full sentence, not just the phrase around the word.', 'Substitute each answer choice — which one makes the most sense?.', 'the surrounding words reveal the meaning.']
          }
        ],
        ...
        explanation: 'Each concept in Vocabulary in Context describes a specific idea. Context clues: the surrounding words reveal the meaning. Key Insight: ACT tests common words with uncommon meanings. ACT Tip: Read the full sentence, not just the phrase around the word.'
      }
    }
  ]
}
