        ...
        questions: [
          {
            ...
            options: [`Oxidative phosphorylation of fatty acids`, `Anaerobic glycolysis of liver glycogen`, `Creatine phosphate donating phosphate to ADP`, `Beta-oxidation of muscle triglycerides`],
            correctAnswer: 2,
          ...
          },
          {
            ...
            options: [`White color, few mitochondria, rapid fatigue, sprint specialists`, `Red color, abundant myoglobin, high fatigue resistance`, `Red color, glycolytic metabolism, rapid peak tension`, `White color, abundant myoglobin, posture maintenance`],
            correctAnswer: 1,
            explanation: `Type I fibers are the "slow red ox": myoglobin-rich (red), mitochondria- and capillary-dense, oxidative, slow to peak but extremely fatigue-resistant — ideal for posture and endurance. White, mitochondria-poor, rapidly fatiguing sprint fibers are type II. The red-glycolytic and white-myoglobin combinations mix the columns: red pairs with oxidative (not glycolytic), and abundant myoglobin makes a fiber red, not white.`
          },
          {
            question: `Cardiac muscle cannot be driven into tetanus like skeletal muscle because cardiac cells have:`,
            options: [`No sarcomeres and therefore no summation machinery`, `Too few gap junctions to synchronize contraction`, `No calcium influx during the action potential`, `A long plateau that keeps each cell refractory`],
            correctAnswer: 3,
            explanation: `The cardiac action potential's calcium-driven plateau keeps the cell refractory until the twitch is nearly over, so stimuli cannot summate — the heart must relax and refill between beats. Cardiac muscle IS striated with sarcomeres and is rich in gap junctions at intercalated discs; the plateau exists BECAUSE of calcium influx, so the no-calcium-influx claim is backwards.`
          },
          {
            question: `A muscle is passively stretched far beyond its optimal length and then stimulated. Active tension is low because:`,
            options: [`Actin-myosin overlap is reduced, so few cross-bridges form`, `The sarcoplasmic reticulum ruptures at long lengths`, `Excess overlap causes thin filaments to collide at the M line`, `Tropomyosin binds calcium at long sarcomere lengths`],
            correctAnswer: 0,
            explanation: `The length-tension curve is overlap logic: overstretching pulls thin filaments away from myosin heads, leaving few cross-bridge sites within reach. Thin-filament collision explains weakness at OVER-SHORTENED lengths — the other end of the curve. The SR does not rupture with physiologic stretch, and calcium binds troponin, never tropomyosin.`
          },
          {
            question: `Which property is shared by cardiac and single-unit smooth muscle but absent from skeletal muscle?`,
            options: [`Striations visible under the light microscope`, `Voluntary control through somatic motor neurons`, `Gap junctions that spread excitation between cells`, `Multiple nuclei at the periphery of each cell`],
            correctAnswer: 2,
            explanation: `Cardiac cells (via intercalated discs) and single-unit smooth muscle both use gap junctions to conduct depolarization cell-to-cell, acting as functional syncytia; skeletal fibers are electrically isolated and each needs its own neuromuscular input. Striations exist in skeletal AND cardiac but not smooth muscle; voluntary somatic control and multinucleated peripheral nuclei are exclusively skeletal traits.`
          }
        ]
      }
    },
