...
| Concept | Description |
|---------|-------------|
| **Spatial pattern** | The geographic distribution related to Slavery in America |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Slavery in America across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Slavery in America?

2) What concept describes a specific real-world example that illustrates Slavery in America?

3) Name the term for analyzing similarities and differences across examples of Slavery in America.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Slavery in America), Case study (A specific real-world example that illustrates Slavery in America), and Comparison (Analyzing similarities and differences across examples of Slavery in America).'
      }
    },
    {
      id: 'aasslave3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Slavery in America is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Slavery in America describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Slavery in America is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Slavery in America. Case study — A specific real-world example that illustrates Slavery in America. Comparison — Analyzing similarities and differences across examples of Slavery in America.'
      }
    },
    {
      id: 'aasslave3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Slavery in America.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Slavery in America. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Slavery in America is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
