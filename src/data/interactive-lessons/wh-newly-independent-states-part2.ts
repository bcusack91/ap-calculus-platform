export const whNewlyIndependentStatesPart2Data = {
  ...
  sections: [
    {
      id: 'whnewlyindependentstates2-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whnewlyindependentstates2-mcq',
    ...
    {
      id: 'whnewlyindependentstates2-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whnewlyindependentstates2-dropdown',
    ...
    {
      id: 'whnewlyindependentstates2-ap',
      type: 'multiple-choice' as const,
