export const englangToneVoiceAnalysisPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Tone & Voice Analysis |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Tone & Voice Analysis across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'englangt3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Tone & Voice Analysis. Understanding this concept is essential for mastering Tone & Voice Analysis in AP English Language.
...
1) What term refers to a recurring structure within Tone & Voice Analysis?

2) What concept describes a specific real-world example that illustrates Tone & Voice Analysis?

3) Name the term for analyzing similarities and differences across examples of Tone & Voice Analysis.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Tone & Voice Analysis), Case study (A specific real-world example that illustrates Tone & Voice Analysis), and Comparison (Analyzing similarities and differences across examples of Tone & Voice Analysis).'
      }
    },
    {
      id: 'englangt3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        ...
        explanation: 'Structural pattern — A recurring structure within Tone & Voice Analysis. Case study — A specific real-world example that illustrates Tone & Voice Analysis. Comparison — Analyzing similarities and differences across examples of Tone & Voice Analysis.'
      }
    },
    {
      id: 'englangt3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Tone & Voice Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Tone & Voice Analysis. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Tone & Voice Analysis is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
