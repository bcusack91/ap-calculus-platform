...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Tone & Voice Analysis across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Tone & Voice Analysis?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Tone & Voice Analysis), Case study (A specific real-world example that illustrates Tone & Voice Analysis), and Comparison (Analyzing similarities and differences across examples of Tone & Voice Analysis).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Tone & Voice Analysis is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Tone & Voice Analysis. Case study — A specific real-world example that illustrates Tone & Voice Analysis. Comparison — Analyzing similarities and differences across examples of Tone & Voice Analysis.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Tone & Voice Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Tone & Voice Analysis is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
