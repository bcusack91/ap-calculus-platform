...
**Part 7 of 7 — Mixed review and score-building plan**
...
Keep your process measurable: spend about 15–20 seconds scanning a figure and save full reading for questions that require detail.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "A table shows reaction yield rising from 75% at trial 1 to 88% at trial 2 and 101% at trial 3. Which statement is best supported?",
              options: [
              ...
              correctAnswer: 1,
              explanation: "The values 75%, 88%, and 101% increase each trial, so the supported claim is a rising trend."
            },
            {
              question: "A graph shows temperature at 27°C and 37°C with all other conditions fixed. If output is higher at 37°C, what is the safest inference?",
              options: [
...
3) You spend 2 minutes 20 seconds on a hard item but target 50 seconds. Enter how many extra seconds you used.\n        `,
      ...
      {
        id: "act-rsci-p7-strategy",
        type: 'text' as const,
        content: `\n## Trap Avoidance for Mixed review and score-building plan
