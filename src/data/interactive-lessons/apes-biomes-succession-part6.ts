export const apesBiomesSuccessionPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Biomes & Ecological Succession, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Biomes & Ecological Succession requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Biomes & Ecological Succession?

2) What concept describes making evidence-based claims about Biomes & Ecological Succession?

3) Name the term for using geographic thinking to analyze Biomes & Ecological Succession.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Biomes & Ecological Succession), Argumentation (Making evidence-based claims about Biomes & Ecological Succession), and Spatial reasoning (Using geographic thinking to analyze Biomes & Ecological Succession).'
      }
    },
    {
      id: 'apesbiom6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Biomes & Ecological Succession is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Biomes & Ecological Succession describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Biomes & Ecological Succession is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Biomes & Ecological Succession. Argumentation — Making evidence-based claims about Biomes & Ecological Succession. Spatial reasoning — Using geographic thinking to analyze Biomes & Ecological Succession.'
      }
    },
    {
      id: 'apesbiom6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Biomes & Ecological Succession.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Biomes & Ecological Succession and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Biomes & Ecological Succession. The best approach is:',
            options: [
