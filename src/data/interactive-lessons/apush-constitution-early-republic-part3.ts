...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Constitution & Early Republic across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to The Constitution & Early Republic?
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to The Constitution & Early Republic is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to The Constitution & Early Republic. Case study — A specific real-world example that illustrates The Constitution & Early Republic. Comparison — Analyzing similarities and differences across examples of The Constitution & Early Republic.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of The Constitution & Early Republic.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in The Constitution & Early Republic is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
