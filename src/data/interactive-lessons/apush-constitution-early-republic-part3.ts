export const apushConstitutionEarlyRepublicPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within The Constitution & Early Republic |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Constitution & Early Republic across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushcon3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within The Constitution & Early Republic. Understanding this concept is essential for mastering The Constitution & Early Republic in AP US History.
...
1) What term refers to a recurring structure within The Constitution & Early Republic?

2) What concept describes a specific real-world example that illustrates The Constitution & Early Republic?

3) Name the term for analyzing similarities and differences across examples of The Constitution & Early Republic.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within The Constitution & Early Republic), Case study (A specific real-world example that illustrates The Constitution & Early Republic), and Comparison (Analyzing similarities and differences across examples of The Constitution & Early Republic).'
      }
    },
    {
      id: 'apushcon3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within The Constitution & Early Republic is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates The Constitution & Early Republic describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of The Constitution & Early Republic is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within The Constitution & Early Republic. Case study — A specific real-world example that illustrates The Constitution & Early Republic. Comparison — Analyzing similarities and differences across examples of The Constitution & Early Republic.'
      }
    },
    {
      id: 'apushcon3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of The Constitution & Early Republic.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of The Constitution & Early Republic. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in The Constitution & Early Republic is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
