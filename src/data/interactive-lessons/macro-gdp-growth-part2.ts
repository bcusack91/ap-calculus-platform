export const macroGdpGrowthPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in GDP & Economic Growth?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in GDP & Economic Growth helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in GDP & Economic Growth?

2) What concept describes a secondary process that shapes outcomes in GDP & Economic Growth?

3) Name the term for the relationship between actions and outcomes in GDP & Economic Growth.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in GDP & Economic Growth), Process 2 (A secondary process that shapes outcomes in GDP & Economic Growth), and Cause and effect (The relationship between actions and outcomes in GDP & Economic Growth).'
      }
    },
    {
      id: 'macrogdp2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in GDP & Economic Growth is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in GDP & Economic Growth describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in GDP & Economic Growth is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in GDP & Economic Growth. Process 2 — A secondary process that shapes outcomes in GDP & Economic Growth. Cause and effect — The relationship between actions and outcomes in GDP & Economic Growth.'
      }
    },
    {
      id: 'macrogdp2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of GDP & Economic Growth.
