export const apushDepressionWwiiPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within The Great Depression & World War II |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Great Depression & World War II across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'apushdep3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within The Great Depression & World War II. Understanding this concept is essential for mastering The Great Depression & World War II in AP US History.
...
1) What term refers to a recurring structure within The Great Depression & World War II?

2) What concept describes a specific real-world example that illustrates The Great Depression & World War II?

3) Name the term for analyzing similarities and differences across examples of The Great Depression & World War II.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within The Great Depression & World War II), Case study (A specific real-world example that illustrates The Great Depression & World War II), and Comparison (Analyzing similarities and differences across examples of The Great Depression & World War II).'
      }
    },
    {
      id: 'apushdep3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within The Great Depression & World War II is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates The Great Depression & World War II describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of The Great Depression & World War II is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within The Great Depression & World War II. Case study — A specific real-world example that illustrates The Great Depression & World War II. Comparison — Analyzing similarities and differences across examples of The Great Depression & World War II.'
      }
    },
    {
      id: 'apushdep3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of The Great Depression & World War II.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of The Great Depression & World War II. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in The Great Depression & World War II is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
