...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Great Depression & World War II across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to The Great Depression & World War II?
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to The Great Depression & World War II is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to The Great Depression & World War II. Case study — A specific real-world example that illustrates The Great Depression & World War II. Comparison — Analyzing similarities and differences across examples of The Great Depression & World War II.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of The Great Depression & World War II.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in The Great Depression & World War II is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
