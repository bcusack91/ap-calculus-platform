export const calcbcAdvIntegrationPart6Data = {
  ...
  sections: [
    {
      id: 'calcbcadvintegration-p6-intro',
      type: 'text' as const,
      content: `
...
and interpret what the final value means in context.
    ...
    {
      id: 'calcbcadvintegration-p6-mcq1',
...
**Quick Check**
    ...
    {
      id: 'calcbcadvintegration-p6-example',
      type: 'text' as const,
      content: `
## Worked Example
...
Students often report only the numeric value and skip interpretation. On AP-style items, interpretation can be required for full credit.
    ...
    {
      id: 'calcbcadvintegration-p6-inputs',
...
3) If $p(x)=2x+1$, solve $p(x)=11$.
    ...
    {
      id: 'calcbcadvintegration-p6-dropdown',
...
**Match each prompt to the best strategy.**
    ...
    {
      id: 'calcbcadvintegration-p6-strategy',
      type: 'text' as const,
      content: `
## Exam Strategy Focus
...
If you finish early, do a 10-second validation: sign, magnitude, and units.
    ...
    {
      id: 'calcbcadvintegration-p6-mcq2',
      type: 'multiple-choice' as const,
      content: `
