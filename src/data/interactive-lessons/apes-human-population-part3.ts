export const apesHumanPopulationPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Human Population Dynamics across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Human Population Dynamics?

2) What concept describes a specific real-world example that illustrates Human Population Dynamics?

3) Name the term for analyzing similarities and differences across examples of Human Population Dynamics.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Human Population Dynamics), Case study (A specific real-world example that illustrates Human Population Dynamics), and Comparison (Analyzing similarities and differences across examples of Human Population Dynamics).'
      }
    },
    {
      id: 'apeshuma3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Human Population Dynamics is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Human Population Dynamics describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Human Population Dynamics is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Human Population Dynamics. Case study — A specific real-world example that illustrates Human Population Dynamics. Comparison — Analyzing similarities and differences across examples of Human Population Dynamics.'
      }
    },
    {
      id: 'apeshuma3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Human Population Dynamics.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Human Population Dynamics. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Human Population Dynamics is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
