export const apushGildedAgePart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in The Gilded Age & Progressive Era?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in The Gilded Age & Progressive Era helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in The Gilded Age & Progressive Era?

2) What concept describes a secondary process that shapes outcomes in The Gilded Age & Progressive Era?

3) Name the term for the relationship between actions and outcomes in The Gilded Age & Progressive Era.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in The Gilded Age & Progressive Era), Process 2 (A secondary process that shapes outcomes in The Gilded Age & Progressive Era), and Cause and effect (The relationship between actions and outcomes in The Gilded Age & Progressive Era).'
      }
    },
    {
      id: 'apushgil2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in The Gilded Age & Progressive Era is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in The Gilded Age & Progressive Era describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in The Gilded Age & Progressive Era is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in The Gilded Age & Progressive Era. Process 2 — A secondary process that shapes outcomes in The Gilded Age & Progressive Era. Cause and effect — The relationship between actions and outcomes in The Gilded Age & Progressive Era.'
      }
    },
    {
      id: 'apushgil2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of The Gilded Age & Progressive Era.
