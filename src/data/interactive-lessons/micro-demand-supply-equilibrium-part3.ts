...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Market Equilibrium across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Market Equilibrium?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Market Equilibrium), Case study (A specific real-world example that illustrates Market Equilibrium), and Comparison (Analyzing similarities and differences across examples of Market Equilibrium).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Market Equilibrium is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Market Equilibrium. Case study — A specific real-world example that illustrates Market Equilibrium. Comparison — Analyzing similarities and differences across examples of Market Equilibrium.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Market Equilibrium.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Market Equilibrium is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
