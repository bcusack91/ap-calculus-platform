export const microDemandSupplyEquilibriumPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Market Equilibrium |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Market Equilibrium across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'microdem3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Market Equilibrium. Understanding this concept is essential for mastering Market Equilibrium in AP Microeconomics.
...
1) What term refers to a recurring structure within Market Equilibrium?

2) What concept describes a specific real-world example that illustrates Market Equilibrium?

3) Name the term for analyzing similarities and differences across examples of Market Equilibrium.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Market Equilibrium), Case study (A specific real-world example that illustrates Market Equilibrium), and Comparison (Analyzing similarities and differences across examples of Market Equilibrium).'
      }
    },
    {
      id: 'microdem3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Market Equilibrium is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Market Equilibrium describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Market Equilibrium is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Market Equilibrium. Case study — A specific real-world example that illustrates Market Equilibrium. Comparison — Analyzing similarities and differences across examples of Market Equilibrium.'
      }
    },
    {
      id: 'microdem3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Market Equilibrium.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Market Equilibrium. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Market Equilibrium is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
