export const microExternalitiesPublicGoodsPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Externalities & Public Goods, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Externalities & Public Goods requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Externalities & Public Goods?

2) What concept describes making evidence-based claims about Externalities & Public Goods?

3) Name the term for using geographic thinking to analyze Externalities & Public Goods.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Externalities & Public Goods), Argumentation (Making evidence-based claims about Externalities & Public Goods), and Spatial reasoning (Using geographic thinking to analyze Externalities & Public Goods).'
      }
    },
    {
      id: 'microext6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Externalities & Public Goods is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Externalities & Public Goods describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Externalities & Public Goods is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Externalities & Public Goods. Argumentation — Making evidence-based claims about Externalities & Public Goods. Spatial reasoning — Using geographic thinking to analyze Externalities & Public Goods.'
      }
    },
    {
      id: 'microext6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Externalities & Public Goods.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Externalities & Public Goods and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Externalities & Public Goods. The best approach is:',
            options: [
