...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Phillips Curve across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to The Phillips Curve?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to The Phillips Curve), Case study (A specific real-world example that illustrates The Phillips Curve), and Comparison (Analyzing similarities and differences across examples of The Phillips Curve).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to The Phillips Curve is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to The Phillips Curve. Case study — A specific real-world example that illustrates The Phillips Curve. Comparison — Analyzing similarities and differences across examples of The Phillips Curve.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of The Phillips Curve.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in The Phillips Curve is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
