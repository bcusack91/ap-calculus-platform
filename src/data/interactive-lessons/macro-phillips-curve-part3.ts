export const macroPhillipsCurvePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within The Phillips Curve |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of The Phillips Curve across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macrophi3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within The Phillips Curve. Understanding this concept is essential for mastering The Phillips Curve in AP Macroeconomics.
...
1) What term refers to a recurring structure within The Phillips Curve?

2) What concept describes a specific real-world example that illustrates The Phillips Curve?

3) Name the term for analyzing similarities and differences across examples of The Phillips Curve.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within The Phillips Curve), Case study (A specific real-world example that illustrates The Phillips Curve), and Comparison (Analyzing similarities and differences across examples of The Phillips Curve).'
      }
    },
    {
      id: 'macrophi3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within The Phillips Curve is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates The Phillips Curve describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of The Phillips Curve is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within The Phillips Curve. Case study — A specific real-world example that illustrates The Phillips Curve. Comparison — Analyzing similarities and differences across examples of The Phillips Curve.'
      }
    },
    {
      id: 'macrophi3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of The Phillips Curve.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of The Phillips Curve. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in The Phillips Curve is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
