      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            options: ['$14$', '$2$', '$10$', '$2\\sqrt{7}$'],
            correctAnswer: 2,
            explanation: 'Right triangle with legs $8$ (tangent) and $6$ (radius): $d = \\sqrt{8^2 + 6^2} = \\sqrt{64+36} = \\sqrt{100} = 10$. $2\\sqrt{7}$ subtracts the squares ($\\sqrt{64 - 36}$), treating the distance as a leg instead of the hypotenuse; $14$ and $2$ add or subtract the lengths directly.'
          }
        ]
      }
    },
