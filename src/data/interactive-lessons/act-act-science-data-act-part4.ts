...
Precision beats speed-reading in data-heavy passages.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "In a graph, point A is (5, 22) and point B is (7, 30). What is the slope?",
              options: [
                "4.0",
                "0.25",
                "8",
              ...
              correctAnswer: 0,
              explanation: "Slope is rise/run = (30-22)/(7-5) = 4.0."
            },
            {
