export const hgMigrationPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Migration Patterns & Processes, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Migration Patterns & Processes requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Migration Patterns & Processes?

2) What concept describes making evidence-based claims about Migration Patterns & Processes?

3) Name the term for using geographic thinking to analyze Migration Patterns & Processes.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Migration Patterns & Processes), Argumentation (Making evidence-based claims about Migration Patterns & Processes), and Spatial reasoning (Using geographic thinking to analyze Migration Patterns & Processes).'
      }
    },
    {
      id: 'hgmigrat6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Migration Patterns & Processes is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Migration Patterns & Processes describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Migration Patterns & Processes is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Migration Patterns & Processes. Argumentation — Making evidence-based claims about Migration Patterns & Processes. Spatial reasoning — Using geographic thinking to analyze Migration Patterns & Processes.'
      }
    },
    {
      id: 'hgmigrat6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Migration Patterns & Processes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Migration Patterns & Processes and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Migration Patterns & Processes. The best approach is:',
            options: [
