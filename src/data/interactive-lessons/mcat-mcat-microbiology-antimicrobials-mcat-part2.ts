        ...
        questions: [
          {
            ...
            options: [`It also inhibits the 60S subunit at therapeutic doses`, `Mitochondrial ribosomes resemble bacterial 70S ribosomes and are inhibited too`, `Marrow stem cells take up the drug through bacterial-type porins`, `It chelates the iron needed for hemoglobin synthesis`],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: [`Also inhibit DNA gyrase`, `Bind reversibly, allowing repeated inhibition cycles`, `Lyse the peptidoglycan wall directly`, `Cause mRNA misreading, generating aberrant proteins that damage the membrane and cell`],
            correctAnswer: 3,
          ...
          },
          {
            ...
            options: [`An oxygen-dependent active transport process absent in anaerobes`, `Porins found only in gram-positive organisms`, `A functioning peptidoglycan synthesis pathway`, `Light-activated uptake channels`],
            correctAnswer: 0,
          ...
          },
          {
            ...
            options: [`Inhibiting peptidyl transferase on the 50S subunit`, `Methylating the 23S rRNA`, `Blocking the ribosomal A site so aminoacyl-tRNA cannot bind`, `Cleaving mRNA upstream of the start codon`],
            correctAnswer: 2,
          ...
          },
          {
            ...
            options: [`Resistance to aminoglycosides only`, `Resistance to macrolides and clindamycin, whose overlapping 50S binding site is destroyed`, `Increased susceptibility to vancomycin`, `Resistance to trimethoprim`],
            correctAnswer: 1,
