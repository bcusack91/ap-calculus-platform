export const hgMigrationPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Migration Patterns & Processes across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Migration Patterns & Processes?

2) What concept describes a specific real-world example that illustrates Migration Patterns & Processes?

3) Name the term for analyzing similarities and differences across examples of Migration Patterns & Processes.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Migration Patterns & Processes), Case study (A specific real-world example that illustrates Migration Patterns & Processes), and Comparison (Analyzing similarities and differences across examples of Migration Patterns & Processes).'
      }
    },
    {
      id: 'hgmigrat3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Migration Patterns & Processes is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Migration Patterns & Processes describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Migration Patterns & Processes is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Migration Patterns & Processes. Case study — A specific real-world example that illustrates Migration Patterns & Processes. Comparison — Analyzing similarities and differences across examples of Migration Patterns & Processes.'
      }
    },
    {
      id: 'hgmigrat3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Migration Patterns & Processes.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Migration Patterns & Processes. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Migration Patterns & Processes is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
