export const macroComparativeAdvantagePart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Comparative Advantage & Trade |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Comparative Advantage & Trade across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macrocom3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Comparative Advantage & Trade. Understanding this concept is essential for mastering Comparative Advantage & Trade in AP Macroeconomics.
...
1) What term refers to a recurring structure within Comparative Advantage & Trade?

2) What concept describes a specific real-world example that illustrates Comparative Advantage & Trade?

3) Name the term for analyzing similarities and differences across examples of Comparative Advantage & Trade.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Comparative Advantage & Trade), Case study (A specific real-world example that illustrates Comparative Advantage & Trade), and Comparison (Analyzing similarities and differences across examples of Comparative Advantage & Trade).'
      }
    },
    {
      id: 'macrocom3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Comparative Advantage & Trade is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Comparative Advantage & Trade describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Comparative Advantage & Trade is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Comparative Advantage & Trade. Case study — A specific real-world example that illustrates Comparative Advantage & Trade. Comparison — Analyzing similarities and differences across examples of Comparative Advantage & Trade.'
      }
    },
    {
      id: 'macrocom3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Comparative Advantage & Trade.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Comparative Advantage & Trade. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Comparative Advantage & Trade is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
