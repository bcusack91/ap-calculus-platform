...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Comparative Advantage & Trade across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Comparative Advantage & Trade?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Comparative Advantage & Trade), Case study (A specific real-world example that illustrates Comparative Advantage & Trade), and Comparison (Analyzing similarities and differences across examples of Comparative Advantage & Trade).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Comparative Advantage & Trade is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Comparative Advantage & Trade. Case study — A specific real-world example that illustrates Comparative Advantage & Trade. Comparison — Analyzing similarities and differences across examples of Comparative Advantage & Trade.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Comparative Advantage & Trade.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Comparative Advantage & Trade is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
