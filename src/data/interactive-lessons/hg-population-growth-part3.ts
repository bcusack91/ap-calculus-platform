export const hgPopulationGrowthPart3Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Population Growth & Decline across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Population Growth & Decline?

2) What concept describes a specific real-world example that illustrates Population Growth & Decline?

3) Name the term for analyzing similarities and differences across examples of Population Growth & Decline.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Population Growth & Decline), Case study (A specific real-world example that illustrates Population Growth & Decline), and Comparison (Analyzing similarities and differences across examples of Population Growth & Decline).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Population Growth & Decline is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Population Growth & Decline describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Population Growth & Decline is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Population Growth & Decline. Case study — A specific real-world example that illustrates Population Growth & Decline. Comparison — Analyzing similarities and differences across examples of Population Growth & Decline.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Population Growth & Decline.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Population Growth & Decline. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Population Growth & Decline is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
