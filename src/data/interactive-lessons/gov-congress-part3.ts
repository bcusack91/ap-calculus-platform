...
| Concept | Description |
|---------|-------------|
| **Spatial pattern** | The geographic distribution related to Congress |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Congress across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Congress?

2) What concept describes a specific real-world example that illustrates Congress?

3) Name the term for analyzing similarities and differences across examples of Congress.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Congress), Case study (A specific real-world example that illustrates Congress), and Comparison (Analyzing similarities and differences across examples of Congress).'
      }
    },
    {
      id: 'govcongr3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Congress is called ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Congress describes ___',
            options: ['Spatial pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Congress is known as ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Congress. Case study — A specific real-world example that illustrates Congress. Comparison — Analyzing similarities and differences across examples of Congress.'
      }
    },
    {
      id: 'govcongr3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Congress.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Congress. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Congress is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
