export const hgAgriculturalOriginsPart2Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Origins & Diffusion of Agriculture?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Origins & Diffusion of Agriculture helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Origins & Diffusion of Agriculture?

2) What concept describes a secondary process that shapes outcomes in Origins & Diffusion of Agriculture?

3) Name the term for the relationship between actions and outcomes in Origins & Diffusion of Agriculture.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Origins & Diffusion of Agriculture), Process 2 (A secondary process that shapes outcomes in Origins & Diffusion of Agriculture), and Cause and effect (The relationship between actions and outcomes in Origins & Diffusion of Agriculture).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Origins & Diffusion of Agriculture is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Origins & Diffusion of Agriculture describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Origins & Diffusion of Agriculture is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Origins & Diffusion of Agriculture. Process 2 — A secondary process that shapes outcomes in Origins & Diffusion of Agriculture. Cause and effect — The relationship between actions and outcomes in Origins & Diffusion of Agriculture.'
      }
    },
    {
...
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Origins & Diffusion of Agriculture.
