...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Conditionals & Control Flow across regions helps:',
            options: [
              'Nothing',
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Conditionals & Control Flow), Case study (A specific real-world example that illustrates Conditionals & Control Flow), and Comparison (Analyzing similarities and differences across examples of Conditionals & Control Flow).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Conditionals & Control Flow is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Conditionals & Control Flow. Case study — A specific real-world example that illustrates Conditionals & Control Flow. Comparison — Analyzing similarities and differences across examples of Conditionals & Control Flow.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Conditionals & Control Flow.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Conditionals & Control Flow is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
