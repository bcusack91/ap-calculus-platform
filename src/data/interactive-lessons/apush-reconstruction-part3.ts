...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Reconstruction |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Reconstruction across examples helps:',
            options: [
              'Nothing',
...
### Structural pattern
A recurring structure within Reconstruction. Understanding this concept is essential for mastering Reconstruction in AP US History.
...
1) What term refers to a recurring structure within Reconstruction?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Reconstruction), Case study (A specific real-world example that illustrates Reconstruction), and Comparison (Analyzing similarities and differences across examples of Reconstruction).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Reconstruction is called ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Reconstruction. Case study — A specific real-world example that illustrates Reconstruction. Comparison — Analyzing similarities and differences across examples of Reconstruction.'
      }
    },
    {
...
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Reconstruction.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Reconstruction is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
