        ...
        questions: [
          {
            ...
            options: [`Proactive interference, because Spanish was learned first`, `Encoding failure for Spanish`, `Retroactive interference — newly learned material impairing retrieval of older material`, `Storage decay of Spanish`],
            correctAnswer: 2,
          ...
          },
          {
            ...
            options: [`A retrieval failure, since the intact trace was recovered when recognition supplied a cue`, `A storage failure, since free recall failed`, `An encoding failure from childhood`, `Anterograde amnesia`],
            correctAnswer: 0,
          ...
          },
          {
            ...
            options: [`Blocking consolidation of the original scene`, `Introducing post-event information that is reconstructively incorporated into the memory report — the misinformation effect`, `Producing proactive interference from earlier accidents`, `Improving the depth of encoding of the crash`],
            correctAnswer: 1,
            explanation: `The wording arrives AFTER encoding, so it cannot affect consolidation of the original scene or its encoding depth; instead the leading verb supplies schema-consistent post-event information that gets rebuilt into the memory — Loftus's misinformation effect, the flagship evidence that recollection is reconstructive rather than playback.`
          },
          {
            ...
            options: [`Both responses are operant`, `Both responses are classical`, `Salivation is operant; sitting is classical`, `Salivation to the can opener is classical (a stimulus predicting food elicits a reflex), while sitting for treats is operant (a voluntary behavior maintained by its consequences)`],
            correctAnswer: 3,
          ...
          },
          {
            ...
            options: [`They are immune to normal forgetting`, `They decay faster than ordinary memories`, `Their subjective vividness and confidence dissociate from their accuracy, which erodes like ordinary memory`, `They are stored in a separate, error-proof memory system`],
            correctAnswer: 2,
