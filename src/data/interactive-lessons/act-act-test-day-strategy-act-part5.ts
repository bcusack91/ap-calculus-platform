export const actTestDayPart5Data = {
  ...
  sections: [
      {
        id: "act-tday-p5-intro",
        type: 'text' as const,
        content: `\n# ACT Test-Day Strategy
**Part 5 of 7 — Stress and energy management**
...
3) If you leave 5 questions blank versus random guessing, how many additional attempts does guessing provide?\n        `,
      ...
      {
        id: "act-tday-p5-strategy",
        type: 'text' as const,
        content: `\n## Practical Plan for Stress and energy management
