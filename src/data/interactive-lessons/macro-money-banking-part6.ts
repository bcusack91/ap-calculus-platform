export const macroMoneyBankingPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Money & Banking, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Money & Banking requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Money & Banking?

2) What concept describes making evidence-based claims about Money & Banking?

3) Name the term for using geographic thinking to analyze Money & Banking.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Money & Banking), Argumentation (Making evidence-based claims about Money & Banking), and Spatial reasoning (Using geographic thinking to analyze Money & Banking).'
      }
    },
    {
      id: 'macromon6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Money & Banking is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Money & Banking describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Money & Banking is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Money & Banking. Argumentation — Making evidence-based claims about Money & Banking. Spatial reasoning — Using geographic thinking to analyze Money & Banking.'
      }
    },
    {
      id: 'macromon6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Money & Banking.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Money & Banking and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Money & Banking. The best approach is:',
            options: [
