...
| Concept | Description |
|---------|-------------|
| **Process 1** | The primary mechanism that drives patterns in Resistance & Abolition |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Which best describes a key process in Resistance & Abolition?',
            options: [
              'A random event',
          ...
          {
            question: 'Understanding cause and effect in Resistance & Abolition helps students:',
            options: [
              'Memorize dates',
...
1) What term refers to the primary mechanism that drives patterns in Resistance & Abolition?

2) What concept describes a secondary process that shapes outcomes in Resistance & Abolition?

3) Name the term for the relationship between actions and outcomes in Resistance & Abolition.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: P',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Process 1 (The primary mechanism that drives patterns in Resistance & Abolition), Process 2 (A secondary process that shapes outcomes in Resistance & Abolition), and Cause and effect (The relationship between actions and outcomes in Resistance & Abolition).'
      }
    },
    {
      id: 'aasresis2-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The primary mechanism that drives patterns in Resistance & Abolition is called ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'None of these']
          },
          {
            label: 'A secondary process that shapes outcomes in Resistance & Abolition describes ___',
            options: ['Process 1', 'Process 2', 'Cause and effect', 'All of these']
          },
          {
            label: 'The relationship between actions and outcomes in Resistance & Abolition is known as ___',
        ...
        explanation: 'Process 1 — The primary mechanism that drives patterns in Resistance & Abolition. Process 2 — A secondary process that shapes outcomes in Resistance & Abolition. Cause and effect — The relationship between actions and outcomes in Resistance & Abolition.'
      }
    },
    {
      id: 'aasresis2-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Process 1** with **Process 2** — while related, they address different aspects of Resistance & Abolition.
