export const whNewlyIndependentStatesPart1Data = {
  ...
  sections: [
    {
      id: 'whnewlyindependentstates1-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whnewlyindependentstates1-mcq',
    ...
    {
      id: 'whnewlyindependentstates1-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whnewlyindependentstates1-dropdown',
    ...
    {
      id: 'whnewlyindependentstates1-ap',
      type: 'multiple-choice' as const,
