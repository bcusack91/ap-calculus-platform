export const whGlobalizationTechPart6Data = {
  topicSlug: 'wh-globalization-tech',
  sections: [
    {
      id: 'whglobalizationtech6-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whglobalizationtech6-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to integration of global markets and finance.
- Compare two regions or states affected by role of international institutions.
- Evaluate continuity and change involving digital revolution and information flows.
`
    },
    {
      id: 'whglobalizationtech6-dropdown',
