export const apushReformMovementsPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Reform Movements & Antebellum Era helps:',
            options: [
          ...
          {
            question: 'Continuity in Reform Movements & Antebellum Era means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Reform Movements & Antebellum Era that have remained stable over time?

2) What concept describes how Reform Movements & Antebellum Era has transformed due to new forces and conditions?

3) Name the term for the direction of change in Reform Movements & Antebellum Era over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Reform Movements & Antebellum Era that have remained stable over time), Change (How Reform Movements & Antebellum Era has transformed due to new forces and conditions), and Trend (The direction of change in Reform Movements & Antebellum Era over time).'
      }
    },
    {
      id: 'apushref5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Reform Movements & Antebellum Era that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Reform Movements & Antebellum Era has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Reform Movements & Antebellum Era over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Reform Movements & Antebellum Era that have remained stable over time. Change — How Reform Movements & Antebellum Era has transformed due to new forces and conditions. Trend — The direction of change in Reform Movements & Antebellum Era over time.'
      }
    },
    {
      id: 'apushref5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Reform Movements & Antebellum Era.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Reform Movements & Antebellum Era has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Reform Movements & Antebellum Era shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
