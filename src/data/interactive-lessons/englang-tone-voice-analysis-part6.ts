export const englangToneVoiceAnalysisPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Tone & Voice Analysis, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Tone & Voice Analysis requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Tone & Voice Analysis?

2) What concept describes making evidence-based claims about Tone & Voice Analysis?

3) Name the term for using geographic thinking to analyze Tone & Voice Analysis.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Tone & Voice Analysis), Argumentation (Making evidence-based claims about Tone & Voice Analysis), and Spatial reasoning (Using geographic thinking to analyze Tone & Voice Analysis).'
      }
    },
    {
      id: 'englangt6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Tone & Voice Analysis is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Tone & Voice Analysis describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Tone & Voice Analysis is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Tone & Voice Analysis. Argumentation — Making evidence-based claims about Tone & Voice Analysis. Spatial reasoning — Using geographic thinking to analyze Tone & Voice Analysis.'
      }
    },
    {
      id: 'englangt6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Tone & Voice Analysis.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Tone & Voice Analysis and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Tone & Voice Analysis. The best approach is:',
            options: [
