export const whNewlyIndependentStatesPart3Data = {
  topicSlug: 'wh-newly-independent-states',
  sections: [
    {
      id: 'whnewlyindependentstates3-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whnewlyindependentstates3-mcq',
    ...
    {
      id: 'whnewlyindependentstates3-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to economic development strategies and debt.
- Compare two regions or states affected by authoritarianism, democracy, and military rule.
- Evaluate continuity and change involving postcolonial identity and state capacity.
`
    },
    {
      id: 'whnewlyindependentstates3-dropdown',
    ...
    {
      id: 'whnewlyindependentstates3-ap',
      type: 'multiple-choice' as const,
