      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            options: [`Primary amide`, `Methyl ester`, `Acid anhydride`, `Acid chloride`],
            correctAnswer: 3,
          ...
          },
          {
            ...
            options: [`A tetrahedral intermediate`, `A planar carbocation`, `An enolate intermediate`, `A cyclic transition state`],
            correctAnswer: 0,
            explanation: `The nucleophile adds to the trigonal carbonyl carbon to give an $sp^{3}$ tetrahedral intermediate; this then collapses, ejecting the leaving group to regenerate the C=O. The quality of that leaving group sets the reactivity order (halide > anhydride > ester > amide). No carbocation forms, and an enolate (from alpha-deprotonation) is the nucleophile in aldol-type chemistry, not the intermediate of acyl substitution.`
          },
          {
            ...
            options: [`Sulfur donates less by resonance than oxygen`, `Sulfur donates more by resonance than oxygen`, `Sulfur is more electronegative than oxygen`, `Sulfur donates by resonance about as well as oxygen`],
            correctAnswer: 0,
            explanation: `In an ordinary ester, the oxygen lone pair donates into the carbonyl, stabilizing it. Sulfur's 3p orbitals overlap poorly with the carbonyl carbon's 2p, so this resonance stabilization is weak. The thioester is therefore "activated" — more electrophilic — which is why acetyl-CoA readily transfers its acetyl group in metabolism. Stronger donation would make it LESS reactive, and equal donation would make thioesters and esters equally reactive; sulfur is also less electronegative than oxygen, not more.`
          },
          {
            question: `An amide is the least reactive carboxylic acid derivative largely because:`,
            options: [`The nitrogen lone pair donates into the carbonyl`, `Nitrogen is a more electronegative atom than chlorine`, `The amide carbonyl carbon is more electron-poor than an ester's`, `The carbonyl carbon carries a full negative charge`],
            correctAnswer: 0,
            explanation: `Nitrogen donates electron density into the carbonyl by resonance (giving partial C–N double-bond character), reducing electrophilicity, and amide nitrogen would have to leave as the strongly basic $\\text{NH}_2^-$ — a terrible leaving group. Both factors make amides (e.g., peptide bonds) remarkably stable. That donation makes the amide carbonyl carbon LESS electron-poor than an ester's, nitrogen is less electronegative than chlorine, and the carbonyl carbon is partially positive.`
          }
        ]
      }
    },
