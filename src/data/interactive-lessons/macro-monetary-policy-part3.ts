...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Monetary Policy & The Federal Reserve across regions helps:',
            options: [
              'Nothing',
...
1) What term refers to the geographic distribution related to Monetary Policy & The Federal Reserve?
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Spatial pattern (The geographic distribution related to Monetary Policy & The Federal Reserve), Case study (A specific real-world example that illustrates Monetary Policy & The Federal Reserve), and Comparison (Analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'The geographic distribution related to Monetary Policy & The Federal Reserve is called ___',
        ...
        explanation: 'Spatial pattern — The geographic distribution related to Monetary Policy & The Federal Reserve. Case study — A specific real-world example that illustrates Monetary Policy & The Federal Reserve. Comparison — Analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve.'
      }
    },
    {
...
- Don\'\'t confuse **Spatial pattern** with **Case study** — while related, they address different aspects of Monetary Policy & The Federal Reserve.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'A pattern observed in Monetary Policy & The Federal Reserve is consistent across multiple world regions. This suggests:',
            options: [
              'Coincidence',
