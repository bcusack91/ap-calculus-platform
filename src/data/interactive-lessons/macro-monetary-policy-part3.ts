export const macroMonetaryPolicyPart3Data = {
...
| Concept | Description |
|---------|-------------|
| **Structural pattern** | A recurring structure within Monetary Policy & The Federal Reserve |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          ...
          {
            question: 'Comparing examples of Monetary Policy & The Federal Reserve across examples helps:',
            options: [
              'Nothing',
    ...
    {
      id: 'macromon3-content',
      type: 'text' as const,
      content: `
## Patterns & Examples — Deeper Dive

### Structural pattern
A recurring structure within Monetary Policy & The Federal Reserve. Understanding this concept is essential for mastering Monetary Policy & The Federal Reserve in AP Macroeconomics.
...
1) What term refers to a recurring structure within Monetary Policy & The Federal Reserve?

2) What concept describes a specific real-world example that illustrates Monetary Policy & The Federal Reserve?

3) Name the term for analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: C',
        explanation: 'Expected answers: Structural pattern (A recurring structure within Monetary Policy & The Federal Reserve), Case study (A specific real-world example that illustrates Monetary Policy & The Federal Reserve), and Comparison (Analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve).'
      }
    },
    {
      id: 'macromon3-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'A recurring structure within Monetary Policy & The Federal Reserve is called ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'None of these']
          },
          {
            label: 'A specific real-world example that illustrates Monetary Policy & The Federal Reserve describes ___',
            options: ['Structural pattern', 'Case study', 'Comparison', 'All of these']
          },
          {
            label: 'Analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve is known as ___',
        ...
        explanation: 'Structural pattern — A recurring structure within Monetary Policy & The Federal Reserve. Case study — A specific real-world example that illustrates Monetary Policy & The Federal Reserve. Comparison — Analyzing similarities and differences across examples of Monetary Policy & The Federal Reserve.'
      }
    },
    {
      id: 'macromon3-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Structural pattern** with **Case study** — while related, they address different aspects of Monetary Policy & The Federal Reserve.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks you to provide TWO examples of Monetary Policy & The Federal Reserve. The strongest response would:',
            options: [
          ...
          {
            question: 'A pattern observed in Monetary Policy & The Federal Reserve is consistent across many examples. This suggests:',
            options: [
              'Coincidence',
