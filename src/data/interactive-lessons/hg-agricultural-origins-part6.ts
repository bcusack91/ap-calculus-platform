export const hgAgriculturalOriginsPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Origins & Diffusion of Agriculture, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Origins & Diffusion of Agriculture requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Origins & Diffusion of Agriculture?

2) What concept describes making evidence-based claims about Origins & Diffusion of Agriculture?

3) Name the term for using geographic thinking to analyze Origins & Diffusion of Agriculture.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Origins & Diffusion of Agriculture), Argumentation (Making evidence-based claims about Origins & Diffusion of Agriculture), and Spatial reasoning (Using geographic thinking to analyze Origins & Diffusion of Agriculture).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Origins & Diffusion of Agriculture is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Origins & Diffusion of Agriculture describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Origins & Diffusion of Agriculture is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Origins & Diffusion of Agriculture. Argumentation — Making evidence-based claims about Origins & Diffusion of Agriculture. Spatial reasoning — Using geographic thinking to analyze Origins & Diffusion of Agriculture.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Origins & Diffusion of Agriculture.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Origins & Diffusion of Agriculture and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Origins & Diffusion of Agriculture. The best approach is:',
            options: [
