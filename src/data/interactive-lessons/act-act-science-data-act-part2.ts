...
Precision beats speed-reading in data-heavy passages.\n        `
      },
      {
        ...
        exercise: {
          questions: [
            {
              question: "In a graph, point A is (3, 16) and point B is (5, 24). What is the slope?",
              options: [
                "4.0",
                "0.25",
                "8",
              ...
              correctAnswer: 0,
              explanation: "Slope is rise/run = (24-16)/(5-3) = 4.0."
            },
            {
