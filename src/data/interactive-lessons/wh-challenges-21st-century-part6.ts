export const whChallenges21stCenturyPart6Data = {
  topicSlug: 'wh-challenges-21st-century',
  sections: [
    {
      id: 'whchallenges21stcentury6-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whchallenges21stcentury6-mcq',
    ...
    {
      id: 'whchallenges21stcentury6-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
- Explain one cause and one effect linked to climate change and environmental stress.
- Compare two regions or states affected by transnational terrorism and security policy.
- Evaluate continuity and change involving pandemics and global health governance.
`
    },
    {
      id: 'whchallenges21stcentury6-dropdown',
    ...
    {
      id: 'whchallenges21stcentury6-ap',
      type: 'multiple-choice' as const,
