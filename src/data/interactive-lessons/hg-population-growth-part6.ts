export const hgPopulationGrowthPart6Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Population Growth & Decline, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Population Growth & Decline requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Population Growth & Decline?

2) What concept describes making evidence-based claims about Population Growth & Decline?

3) Name the term for using geographic thinking to analyze Population Growth & Decline.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Population Growth & Decline), Argumentation (Making evidence-based claims about Population Growth & Decline), and Spatial reasoning (Using geographic thinking to analyze Population Growth & Decline).'
      }
    },
    {
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Population Growth & Decline is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Population Growth & Decline describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Population Growth & Decline is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Population Growth & Decline. Argumentation — Making evidence-based claims about Population Growth & Decline. Spatial reasoning — Using geographic thinking to analyze Population Growth & Decline.'
      }
    },
    {
...
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Population Growth & Decline.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Population Growth & Decline and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Population Growth & Decline. The best approach is:',
            options: [
