      ...
      exercise: {
        questions: [
          ...
          },
          {
            ...
            correctAnswer: 1,
            explanation: 'By the product rule, $\\ln x + \\ln 4 = \\ln(4x)$, so $\\ln(4x) = \\ln 20 \\implies 4x = 20 \\implies x = 5$. Getting $16$ treats the sum as $\\ln(x + 4)$, $80$ multiplies instead of dividing, and $\\frac{1}{5}$ divides in the wrong order.'
          },
          {
