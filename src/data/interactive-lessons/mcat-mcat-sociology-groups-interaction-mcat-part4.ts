        ...
        questions: [
          {
            ...
            options: [`Institutional discrimination operating without individual prejudice — differential treatment produced by procedure, feeding on past-in-present segregation`, `Prejudice without discrimination`, `A stereotype, because the algorithm holds beliefs`, `Scapegoating`],
            correctAnswer: 0,
            explanation: `The differential treatment (behavioral layer) is real and group-patterned, yet no actor holds an attitude — the pattern lives in rules and inherited geography, the defining mark of institutional discrimination compounded by past-in-present dynamics. Option B reverses the dissociation (this is discrimination WITHOUT prejudice), and algorithms hold no beliefs or displaced frustrations.`
          },
          {
            ...
            options: [`Mere exposure through shared meals`, `Punishing hostile behavior`, `A superordinate goal — an outcome neither group could achieve alone, requiring genuine intergroup cooperation`, `Separating the groups permanently`],
            correctAnswer: 2,
            explanation: `The field experiment's sequence is the lesson: competition manufactured hostility, unstructured contact (parties) failed and even sparked food fights, and only superordinate goals — the broken water supply, the stuck truck — dissolved group lines by making the out-group instrumental to in-group success. This is also why the contact hypothesis requires cooperation and common goals, not proximity.`
          },
          {
            ...
            options: [`That the ability difference is real but small`, `Stereotype threat — situational anxiety from the risk of confirming a group stereotype impairs performance, and reframing the task removes the effect`, `Institutional discrimination by the test-makers`, `Out-group homogeneity bias`],
            correctAnswer: 1,
          ...
          },
          {
            ...
            options: [`Because larger samples always imply causation`, `Because recruiters were unaware of being studied`, `Because fictitious resumes eliminate social desirability in survey responses`, `Because randomization guarantees the groups' resumes are equivalent in qualifications and all other characteristics, so callback differences can only stem from the manipulated group signal`],
            correctAnswer: 3,
            explanation: `Observational disparities are always vulnerable to the rejoinder that groups differed in qualifications; random assignment severs any link between the group signal and every other resume property, known or unknown, making the signal the only systematic difference. Field-blindness (option B) helps validity but does not create the causal license — randomization does.`
          },
          {
            ...
            options: [`The self-fulfilling prophecy — expectation-driven differential treatment elicits the expected behavior, appearing to confirm the original belief`, `Stereotype threat`, `Deindividuation`, `The iron law of oligarchy`],
            correctAnswer: 0,
            explanation: `The students were selected at RANDOM, so the gains cannot reflect detected talent; the expectation changed the teacher's behavior (attention, feedback), which changed learning — the definitional loop of a self-fulfilling prophecy, and the micro engine that lets stereotypes manufacture their own supporting evidence. Stereotype threat runs the opposite direction, impairing performance under negative expectations.`
          }
        ]
      }
    },
