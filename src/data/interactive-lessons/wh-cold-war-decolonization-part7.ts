export const whColdWarDecolonizationPart7Data = {
  topicSlug: 'wh-cold-war-decolonization',
  sections: [
    {
      id: 'whcoldwardecolonization7-intro',
      type: 'text' as const,
      content: `
...
> Key AP Move: Build a claim, support it with specific evidence, and explain causation or comparison clearly.`
    ...
    {
      id: 'whcoldwardecolonization7-mcq',
    ...
    {
      id: 'whcoldwardecolonization7-analysis',
      type: 'text' as const,
      content: `
## Historical Analysis
...
`
    ...
    {
      id: 'whcoldwardecolonization7-dropdown',
    ...
    {
      id: 'whcoldwardecolonization7-ap',
      type: 'multiple-choice' as const,
