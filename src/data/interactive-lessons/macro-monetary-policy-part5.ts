export const macroMonetaryPolicyPart5Data = {
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'Studying change over time in Monetary Policy & The Federal Reserve helps:',
            options: [
          ...
          {
            question: 'Continuity in Monetary Policy & The Federal Reserve means:',
            options: [
              'Everything changes',
...
1) What term refers to aspects of Monetary Policy & The Federal Reserve that have remained stable over time?

2) What concept describes how Monetary Policy & The Federal Reserve has transformed due to new forces and conditions?

3) Name the term for the direction of change in Monetary Policy & The Federal Reserve over time.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: C',
        hint3: 'Starts with: T',
        explanation: 'Expected answers: Continuity (Aspects of Monetary Policy & The Federal Reserve that have remained stable over time), Change (How Monetary Policy & The Federal Reserve has transformed due to new forces and conditions), and Trend (The direction of change in Monetary Policy & The Federal Reserve over time).'
      }
    },
    {
      id: 'macromon5-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Aspects of Monetary Policy & The Federal Reserve that have remained stable over time is called ___',
            options: ['Continuity', 'Change', 'Trend', 'None of these']
          },
          {
            label: 'How Monetary Policy & The Federal Reserve has transformed due to new forces and conditions describes ___',
            options: ['Continuity', 'Change', 'Trend', 'All of these']
          },
          {
            label: 'The direction of change in Monetary Policy & The Federal Reserve over time is known as ___',
        ...
        explanation: 'Continuity — Aspects of Monetary Policy & The Federal Reserve that have remained stable over time. Change — How Monetary Policy & The Federal Reserve has transformed due to new forces and conditions. Trend — The direction of change in Monetary Policy & The Federal Reserve over time.'
      }
    },
    {
      id: 'macromon5-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Continuity** with **Change** — while related, they address different aspects of Monetary Policy & The Federal Reserve.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'An AP question asks how Monetary Policy & The Federal Reserve has changed in the last 50 years. A strong answer would:',
            options: [
          ...
          {
            question: 'A trend in Monetary Policy & The Federal Reserve shows acceleration in recent decades. The most likely explanation is:',
            options: [
              'Random chance',
