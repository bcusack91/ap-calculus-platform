export const actReadingStratPart1Data = {
  ...
  sections: [
      {
        id: "act-rstrat-p1-intro",
        type: 'text' as const,
        content: `\n# ACT Reading Strategy
**Part 1 of 7 — Passage mapping**
