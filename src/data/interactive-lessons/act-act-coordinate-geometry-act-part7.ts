...
**Match the Concepts** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Translation',
            options: ['flip over x-axis (negate y) or y-axis (negate x).', '|f(x)|: reflects negative y-values above x-axis.', 'shift graph horizontally or vertically.', 'f(x) + k: up k; f(x-h): right h.']
          },
          {
            label: 'Reflection',
            options: ['|f(x)|: reflects negative y-values above x-axis.', 'f(x) + k: up k; f(x-h): right h.', 'shift graph horizontally or vertically.', 'flip over x-axis (negate y) or y-axis (negate x).']
          },
          {
            label: 'Key Insight',
            options: ['|f(x)|: reflects negative y-values above x-axis.', 'f(x) + k: up k; f(x-h): right h.', 'flip over x-axis (negate y) or y-axis (negate x).', 'shift graph horizontally or vertically.']
          }
        ],
        ...
        explanation: 'Each concept in Review & Applications describes a specific idea. Translation: shift graph horizontally or vertically. Reflection: flip over x-axis (negate y) or y-axis (negate x). Key Insight: f(x) + k: up k; f(x-h): right h.'
      }
    }
  ]
}
