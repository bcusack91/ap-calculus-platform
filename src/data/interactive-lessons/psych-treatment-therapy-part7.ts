export const psychTreatmentPart7Data = {
  ...
  sections: [
    {
      id: 'treatment-therapy-p7-s1-intro',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'treatment-therapy-p7-s2-check',
      ...
      **Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'In a study about AP synthesis on matching interventions to cases, participants change behavior after repeatedly seeing the same cue. Which concept is the best fit?',
            options: [
              'behavior activation',
    ...
    {
      id: 'treatment-therapy-p7-s3-deep',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'treatment-therapy-p7-s4-input',
    ...
    {
      id: 'treatment-therapy-p7-s5-dropdown',
        ...
        dropdowns: [
          {
            ...
            options: ['psychopharmacology', 'exposure therapy', 'client-centered therapy', 'SSRI']
          },
          {
            label: 'Select the concept that best matches: increasing engagement in rewarding and goal-directed activities',
            options: ['SSRI', 'client-centered therapy', 'behavior activation', 'therapeutic alliance']
          },
          {
            label: 'Select the concept that best matches: collaborative bond and agreement on goals and tasks',
            options: ['psychopharmacology', 'client-centered therapy', 'therapeutic alliance', 'SSRI']
          }
        ],
        correctAnswers: ['exposure therapy', 'behavior activation', 'therapeutic alliance'],
    ...
    {
      id: 'treatment-therapy-p7-s6-strategy',
      type: 'text' as const,
      content: `
      ...
      - In scenario questions about AP synthesis on matching interventions to cases, identify the manipulated variable and measured outcome.
    ...
    {
      id: 'treatment-therapy-p7-s7-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied Scenarios** 🎯
      `,
      exercise: {
        questions: [
          {
            question: 'A team investigating AP synthesis on matching interventions to cases finds that participants rely on a persuasive cue when they are distracted, but use argument quality when they are highly focused. Which concept best captures the focused-processing route?',
            options: [
              'exposure therapy',
              'client-centered therapy',
              'therapeutic alliance',
