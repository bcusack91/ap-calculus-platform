export const precalcContinuityPart7Data = {
  ...
  sections: [
    {
      id: 'precalc-continuity-precalc-p7-s1-intro',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'precalc-continuity-precalc-p7-s2-mcq-core',
      ...
      **Multiple-choice check (2 questions)**
      ...
      exercise: {
        questions: [
          {
            question: 'Choose the most accurate definition of IVT.',
            options: [
            ...
            correctAnswer: 0,
            explanation: 'IVT is defined as: continuous functions on closed intervals take all intermediate values.'
          },
          {
            question: 'In solving mixed continuity exam sets, which expression is the best starting model?',
            options: [
              '$\\frac{f(b)-f(a)}{b-a}$',
    ...
    {
      id: 'precalc-continuity-precalc-p7-s3-deep-dive',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'precalc-continuity-precalc-p7-s4-input',
    ...
    {
      id: 'precalc-continuity-precalc-p7-s5-dropdown',
      ...
      **Dropdown-select practice (3 prompts)**
      ...
      exercise: {
        dropdowns: [
          {
            label: 'IVT',
            options: ['limit exists and equals the function value', 'continuous functions on closed intervals take all intermediate values', 'rule changes across intervals of the domain', 'value approached by a function as input approaches a target']
          },
          {
            label: 'piecewise function',
            options: ['value approached by a function as input approaches a target', 'hole created by cancellation or redefinition', 'limit exists and equals the function value', 'rule changes across intervals of the domain']
          },
          {
            label: 'limit',
            options: ['left and right limits exist but are unequal', 'limit exists and equals the function value', 'value approached by a function as input approaches a target', 'hole created by cancellation or redefinition']
          }
        ],
        correctAnswers: ['continuous functions on closed intervals take all intermediate values', 'rule changes across intervals of the domain', 'value approached by a function as input approaches a target'],
        hint1: 'Match each term to the full definition, not just a keyword.',
        hint2: 'Use elimination by checking whether each definition captures the right dependency.',
        hint3: 'Read the label and option together as one complete mathematical sentence.',
        explanation: 'Correct mapping: IVT, piecewise function, and limit align with their exact definitions used in this part.'
      }
    },
    {
      id: 'precalc-continuity-precalc-p7-s6-strategy',
      type: 'text' as const,
      content: `
    ...
    {
      id: 'precalc-continuity-precalc-p7-s7-mcq-applied',
      type: 'multiple-choice' as const,
      content: `
      **Applied mixed questions (2 questions)**
      ...
      exercise: {
        questions: [
          {
            question: 'A student is solving mixed continuity exam sets. Which term best anchors the next reasoning step if the key idea is: limit exists and equals the function value?',
            options: [
              'limit',
              'IVT',
          ...
          {
            question: 'A student is solving a mixed continuity prompt. Which term best anchors the next reasoning step if the key idea is: hole created by cancellation or redefinition?',
            options: [
            ...
            correctAnswer: 0,
            explanation: 'removable discontinuity matches that description and keeps the model-to-interpretation chain consistent.'
          }
        ]
      }
    }
