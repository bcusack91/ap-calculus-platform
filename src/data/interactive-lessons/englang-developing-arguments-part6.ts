export const englangDevelopingArgumentsPart6Data = {
...
| Concept | Description |
|---------|-------------|
| **Data interpretation** | Analyzing maps, graphs, and tables related to Developing Arguments |
...
**Concept Check** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'When interpreting data about Developing Arguments, the first step is:',
            options: [
              'Jump to conclusions',
          ...
          {
            question: 'An evidence-based argument about Developing Arguments requires:',
            options: [
              'Just opinions',
...
1) What term refers to analyzing maps, graphs, and tables related to Developing Arguments?

2) What concept describes making evidence-based claims about Developing Arguments?

3) Name the term for using geographic thinking to analyze Developing Arguments.
...
Use the exact term from this part.
      ...
      exercise: {
        ...
        hint2: 'Starts with: A',
        hint3: 'Starts with: S',
        explanation: 'Expected answers: Data interpretation (Analyzing maps, graphs, and tables related to Developing Arguments), Argumentation (Making evidence-based claims about Developing Arguments), and Spatial reasoning (Using geographic thinking to analyze Developing Arguments).'
      }
    },
    {
      id: 'englangd6-dropdown',
...
**Fill in the Blanks** 🔍
      ...
      exercise: {
        dropdowns: [
          {
            label: 'Analyzing maps, graphs, and tables related to Developing Arguments is called ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'None of these']
          },
          {
            label: 'Making evidence-based claims about Developing Arguments describes ___',
            options: ['Data interpretation', 'Argumentation', 'Spatial reasoning', 'All of these']
          },
          {
            label: 'Using geographic thinking to analyze Developing Arguments is known as ___',
        ...
        explanation: 'Data interpretation — Analyzing maps, graphs, and tables related to Developing Arguments. Argumentation — Making evidence-based claims about Developing Arguments. Spatial reasoning — Using geographic thinking to analyze Developing Arguments.'
      }
    },
    {
      id: 'englangd6-strategy',
      type: 'text' as const,
      content: `
## Common Misconceptions and Exam Strategy

### Misconceptions to Avoid
- Don\'\'t confuse **Data interpretation** with **Argumentation** — while related, they address different aspects of Developing Arguments.
...
**Applied Scenarios** 🎯
      ...
      exercise: {
        questions: [
          {
            question: 'You are given a data table about Developing Arguments and asked to identify a trend. You should:',
            options: [
              'Pick random numbers',
          ...
          {
            question: 'A free-response question asks you to use evidence to support an argument about Developing Arguments. The best approach is:',
            options: [
