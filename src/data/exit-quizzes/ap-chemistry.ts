...
export const apChemQuestionPool: APChemQuestion[] = [
  ...
  { question: 'How many atoms are in 2 moles of helium?', options: ['$6.02 \\times 10^{23}$', '$1.204 \\times 10^{24}$', '$3.01 \\times 10^{23}$', '$2$'], correctAnswer: 1, explanation: '$2 \\times 6.022 \\times 10^{23} = 1.204 \\times 10^{24}$ atoms.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'moles-molar-mass', formSet: 'A' },
  { question: 'The molar mass of Ca(OH)₂ is:', options: ['57 g/mol', '74 g/mol', '40 g/mol', '58 g/mol'], correctAnswer: 1, explanation: '$40 + 2(16 + 1) = 40 + 34 = 74$ g/mol.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'moles-molar-mass', formSet: 'B' },
  { question: 'If 180 g of glucose ($C_6H_{12}O_6$, MM = 180 g/mol) is dissolved, how many moles is that?', options: ['0.5 mol', '1 mol', '2 mol', '180 mol'], correctAnswer: 1, explanation: '$n = m/M = 180/180 = 1$ mol.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'moles-molar-mass', formSet: 'both' },
  { question: 'At STP, 1 mole of any ideal gas occupies approximately:', options: ['11.2 L', '22.4 L', '44.8 L', '1 L'], correctAnswer: 1, explanation: 'Molar volume of an ideal gas at STP ≈ 22.4 L.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'moles-molar-mass', formSet: 'A' },
  ...
  { question: 'Hydrogen bonding occurs when H is bonded to:', options: ['Any element', 'C, Si, or Ge', 'N, O, or F', 'Only F'], correctAnswer: 2, explanation: 'H-bonding requires H attached to highly electronegative N, O, or F.', difficulty: 'easy', domain: 'intermolecular-forces', topicSlug: 'types-intermolecular-forces', formSet: 'A' },
  { question: 'London dispersion forces are present in:', options: ['Only polar molecules', 'Only nonpolar molecules', 'All molecules', 'Only ionic compounds'], correctAnswer: 2, explanation: 'LDF arise from temporary dipoles and exist in ALL molecules/atoms.', difficulty: 'easy', domain: 'intermolecular-forces', topicSlug: 'types-intermolecular-forces', formSet: 'B' },
  { question: 'Which has the highest boiling point: CH₄, SiH₄, GeH₄, SnH₄?', options: ['CH₄', 'SiH₄', 'GeH₄', 'SnH₄'], correctAnswer: 3, explanation: 'All nonpolar → only LDF → larger molar mass → stronger LDF → higher BP.', difficulty: 'medium', domain: 'intermolecular-forces', topicSlug: 'types-intermolecular-forces', formSet: 'A' },
  { question: 'Dipole-dipole forces exist between molecules that are:', options: ['Nonpolar', 'Polar', 'Ionic', 'Metallic'], correctAnswer: 1, explanation: 'Permanent dipoles attract each other → dipole-dipole interaction.', difficulty: 'easy', domain: 'intermolecular-forces', topicSlug: 'types-intermolecular-forces', formSet: 'B' },
  { question: 'Water has an unusually high boiling point due to:', options: ['Its large molar mass', 'Strong hydrogen bonding', 'London dispersion forces', 'Covalent network bonding'], correctAnswer: 1, explanation: 'Extensive H-bonding in water raises BP far above similar-mass molecules.', difficulty: 'easy', domain: 'intermolecular-forces', topicSlug: 'types-intermolecular-forces', formSet: 'both' },

  // ── ideal-gas-law (batch 2 — had 3, adding 5 → 8) ──────────────
  { question: 'At constant $T$ and $n$, if volume doubles, pressure:', options: ['Doubles', 'Halves', 'Stays the same', 'Quadruples'], correctAnswer: 1, explanation: 'Boyle\'s law: $P_1V_1 = P_2V_2$. Double $V$ → half $P$.', difficulty: 'easy', domain: 'gases', topicSlug: 'ideal-gas-law', formSet: 'A' },
  { question: 'At constant $P$ and $n$, if $T$ doubles (in K), volume:', options: ['Halves', 'Doubles', 'Stays the same', 'Quadruples'], correctAnswer: 1, explanation: 'Charles\'s law: $V/T = \\text{const}$. Double $T$ → double $V$.', difficulty: 'easy', domain: 'gases', topicSlug: 'ideal-gas-law', formSet: 'B' },
  { question: '2 moles of gas at 300 K in 10 L. What is $P$? ($R = 0.0821$ L·atm/(mol·K))', options: ['4.93 atm', '49.3 atm', '0.493 atm', '2.46 atm'], correctAnswer: 0, explanation: '$P = nRT/V = 2(0.0821)(300)/10 = 4.93$ atm.', difficulty: 'medium', domain: 'gases', topicSlug: 'ideal-gas-law', formSet: 'A' },
  { question: 'Dalton\'s law states that total pressure equals the sum of:', options: ['Volumes', 'Moles', 'Partial pressures', 'Temperatures'], correctAnswer: 2, explanation: '$P_{total} = P_1 + P_2 + P_3 + \\cdots$ (each gas contributes independently).', difficulty: 'easy', domain: 'gases', topicSlug: 'ideal-gas-law', formSet: 'B' },
  { question: 'Real gases deviate most from ideal behavior at:', options: ['High T, low P', 'Low T, high P', 'STP', 'Any condition'], correctAnswer: 1, explanation: 'Low T → slow molecules feel IMF; high P → molecules occupy significant volume.', difficulty: 'medium', domain: 'gases', topicSlug: 'ideal-gas-law', formSet: 'both' },

  // ── solutions-solubility (batch 2 — had 3, adding 5 → 8) ───────
  { question: '"Like dissolves like" means:', options: ['All substances dissolve in water', 'Polar solutes dissolve in polar solvents', 'Temperature doesn\'t matter', 'Solubility is always high'], correctAnswer: 1, explanation: 'Polar/ionic in polar solvents; nonpolar in nonpolar solvents.', difficulty: 'easy', domain: 'solutions', topicSlug: 'solutions-solubility', formSet: 'A' },
  { question: 'Molarity (M) is defined as:', options: ['Moles solute / kg solvent', 'Moles solute / L solution', 'Grams solute / L solution', 'Moles solute / moles solvent'], correctAnswer: 1, explanation: '$M = n/V$ (moles per liter of solution).', difficulty: 'easy', domain: 'solutions', topicSlug: 'solutions-solubility', formSet: 'B' },
  { question: 'Dissolving NaCl in water is aided by:', options: ['London forces', 'Ion-dipole interactions', 'Nonpolar bonding', 'Metallic bonding'], correctAnswer: 1, explanation: 'Water dipoles surround Na⁺ and Cl⁻ → ion-dipole interaction.', difficulty: 'easy', domain: 'solutions', topicSlug: 'solutions-solubility', formSet: 'A' },
  { question: 'A solution with more solute than the equilibrium amount is:', options: ['Unsaturated', 'Saturated', 'Supersaturated', 'Dilute'], correctAnswer: 2, explanation: 'Supersaturated: dissolved solute exceeds the normal solubility limit.', difficulty: 'easy', domain: 'solutions', topicSlug: 'solutions-solubility', formSet: 'B' },
  { question: 'Increasing temperature ___ the solubility of most solid solutes.', options: ['Decreases', 'Increases', 'Does not affect', 'Eliminates'], correctAnswer: 1, explanation: 'Most solid dissolution is endothermic → heat favors dissolving (Le Chatelier).', difficulty: 'easy', domain: 'solutions', topicSlug: 'solutions-solubility', formSet: 'both' },
  ...
  { question: 'The limiting reactant determines:', options: ['The color of products', 'The maximum amount of product formed', 'The reaction speed', 'The catalyst needed'], correctAnswer: 1, explanation: 'The limiting reactant runs out first → caps the product yield.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'stoichiometry-limiting-reactants', formSet: 'A' },
  { question: 'If 4 mol H₂ reacts with 1 mol O₂ ($2H_2 + O_2 \\to 2H_2O$), the limiting reactant is:', options: ['H₂', 'O₂', 'H₂O', 'Neither'], correctAnswer: 1, explanation: '1 mol O₂ requires 2 mol H₂. Only 1 mol O₂ → produces 2 mol H₂O; 2 mol H₂ excess.', difficulty: 'medium', domain: 'stoichiometry-and-quantitative', topicSlug: 'stoichiometry-limiting-reactants', formSet: 'B' },
  { question: 'Percent yield = (actual / theoretical) × 100. If 8 g produced out of 10 g theoretical:', options: ['80%', '125%', '8%', '10%'], correctAnswer: 0, explanation: '$(8/10) \\times 100 = 80\\%$.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'stoichiometry-limiting-reactants', formSet: 'A' },
  { question: 'In stoichiometry, mole ratios come from:', options: ['Molar masses', 'Coefficients in the balanced equation', 'Densities', 'Electron configurations'], correctAnswer: 1, explanation: 'Balanced equation coefficients give mole ratios of reactants and products.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'stoichiometry-limiting-reactants', formSet: 'B' },
  { question: 'The excess reactant is the one that:', options: ['Is used up first', 'Remains after the reaction', 'Has the highest molar mass', 'Is the catalyst'], correctAnswer: 1, explanation: 'Excess reactant = leftover after the limiting reactant is consumed.', difficulty: 'easy', domain: 'stoichiometry-and-quantitative', topicSlug: 'stoichiometry-limiting-reactants', formSet: 'both' },
  ...
  { question: 'A Brønsted-Lowry acid is a:', options: ['Proton acceptor', 'Electron pair donor', 'Proton donor', 'Electron acceptor'], correctAnswer: 2, explanation: 'Brønsted-Lowry: acid = proton (H⁺) donor.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-theories-ph', formSet: 'A' },
  { question: 'What is the pH of a 0.001 M HCl solution?', options: ['1', '3', '7', '11'], correctAnswer: 1, explanation: 'HCl strong acid: $[H^+] = 10^{-3}$ M; $pH = -\\log(10^{-3}) = 3$.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-theories-ph', formSet: 'B' },
  { question: 'pH + pOH =', options: ['7', '10', '14', '1'], correctAnswer: 2, explanation: 'At 25°C: $pH + pOH = 14$.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-theories-ph', formSet: 'A' },
  { question: 'A Lewis acid is:', options: ['A proton donor', 'An electron-pair acceptor', 'An electron-pair donor', 'A proton acceptor'], correctAnswer: 1, explanation: 'Lewis acid = electron-pair acceptor (e.g., BF₃, Al³⁺).', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-theories-ph', formSet: 'both' },

  // ── weak-acids-bases-ka-kb (batch 2 — had 3, adding 5 → 8) ─────
  { question: 'For a weak acid HA, $K_a$ expresses:', options: ['$[H^+][A^-]/[HA]$', '$[HA]/[H^+][A^-]$', '$[H^+]/[HA]$', '$[A^-]/[H^+]$'], correctAnswer: 0, explanation: '$K_a = [H^+][A^-]/[HA]$.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'weak-acids-bases-ka-kb', formSet: 'A' },
  { question: 'The conjugate base of H₂O is:', options: ['H₃O⁺', 'OH⁻', 'O²⁻', 'H₂O₂'], correctAnswer: 1, explanation: 'H₂O loses a proton → OH⁻.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'weak-acids-bases-ka-kb', formSet: 'B' },
  { question: '$K_a \\times K_b$ for a conjugate acid-base pair equals:', options: ['1', '$K_w = 10^{-14}$', '$10^{-7}$', '14'], correctAnswer: 1, explanation: '$K_a \\cdot K_b = K_w = 1.0 \\times 10^{-14}$ at 25°C.', difficulty: 'medium', domain: 'acids-and-bases', topicSlug: 'weak-acids-bases-ka-kb', formSet: 'A' },
  { question: 'A larger $K_a$ value means the acid is:', options: ['Weaker', 'Stronger', 'Neutral', 'A base'], correctAnswer: 1, explanation: 'Larger $K_a$ → more dissociation → stronger acid.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'weak-acids-bases-ka-kb', formSet: 'B' },
  { question: 'Percent ionization of a weak acid ___ as initial concentration decreases.', options: ['Decreases', 'Increases', 'Stays the same', 'Becomes zero'], correctAnswer: 1, explanation: 'More dilute → higher fraction ionized (even though [H⁺] decreases).', difficulty: 'hard', domain: 'acids-and-bases', topicSlug: 'weak-acids-bases-ka-kb', formSet: 'both' },

  // ── buffer-solutions-henderson-hasselbalch (batch 2 — had 3, adding 5 → 8)
  { question: 'A buffer resists pH changes because it contains:', options: ['A strong acid only', 'A weak acid and its conjugate base', 'Pure water', 'A strong base only'], correctAnswer: 1, explanation: 'Buffer = weak acid/conjugate base pair (or weak base/conjugate acid).', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'buffer-solutions-henderson-hasselbalch', formSet: 'A' },
  { question: 'Henderson-Hasselbalch: $pH =$', options: ['$pK_a + \\log([A^-]/[HA])$', '$pK_a - \\log([A^-]/[HA])$', '$pK_b + \\log([HA]/[A^-])$', '$-\\log[H^+]$'], correctAnswer: 0, explanation: '$pH = pK_a + \\log([A^-]/[HA])$.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'buffer-solutions-henderson-hasselbalch', formSet: 'B' },
  { question: 'When $[HA] = [A^-]$, $pH =$', options: ['7', '14', '$pK_a$', '0'], correctAnswer: 2, explanation: '$\\log(1) = 0$ → $pH = pK_a$.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'buffer-solutions-henderson-hasselbalch', formSet: 'A' },
  { question: 'Buffer capacity is greatest when:', options: ['pH is far from $pK_a$', 'pH ≈ $pK_a$ and concentrations are high', 'The solution is very dilute', 'Only the weak acid is present'], correctAnswer: 1, explanation: 'Maximum capacity near $pK_a$; higher absolute concentrations → more buffering.', difficulty: 'medium', domain: 'acids-and-bases', topicSlug: 'buffer-solutions-henderson-hasselbalch', formSet: 'B' },
  { question: 'Adding small amounts of strong acid to a buffer converts ___ to ___.', options: ['HA to A⁻', 'A⁻ to HA', 'H₂O to OH⁻', 'Salt to acid'], correctAnswer: 1, explanation: 'Added H⁺ reacts with A⁻ → HA, consuming the acid and resisting pH drop.', difficulty: 'medium', domain: 'acids-and-bases', topicSlug: 'buffer-solutions-henderson-hasselbalch', formSet: 'both' },

  // ── acid-base-titrations (batch 2 — had 3, adding 5 → 8) ───────
  { question: 'At the equivalence point of a strong acid–strong base titration, pH =', options: ['0', '7', '14', '<7'], correctAnswer: 1, explanation: 'Strong acid + strong base → neutral salt → pH = 7.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-titrations', formSet: 'A' },
  { question: 'The half-equivalence point of a weak acid titration has pH =', options: ['7', '$pK_a$', '$pK_b$', '14'], correctAnswer: 1, explanation: 'At half-equivalence: [HA] = [A⁻] → $pH = pK_a$.', difficulty: 'medium', domain: 'acids-and-bases', topicSlug: 'acid-base-titrations', formSet: 'B' },
  { question: 'Phenolphthalein turns pink above pH ≈', options: ['4.5', '7', '8.2', '12'], correctAnswer: 2, explanation: 'Phenolphthalein: colorless below ~8.2, pink above.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-titrations', formSet: 'A' },
  { question: 'At the equivalence point of a weak acid–strong base titration, pH is:', options: ['7', '<7', '>7', '0'], correctAnswer: 2, explanation: 'The conjugate base A⁻ remains → basic solution → pH > 7.', difficulty: 'medium', domain: 'acids-and-bases', topicSlug: 'acid-base-titrations', formSet: 'B' },
  { question: 'A titration curve\'s steepest region occurs near the:', options: ['Start', 'Buffer region', 'Equivalence point', 'End'], correctAnswer: 2, explanation: 'Near equivalence, small volume additions cause large pH changes.', difficulty: 'easy', domain: 'acids-and-bases', topicSlug: 'acid-base-titrations', formSet: 'both' },
  ...
  { question: 'In the solid state, particles are:', options: ['Far apart and moving freely', 'Close together in a fixed arrangement', 'Close together but flowing', 'Ionized'], correctAnswer: 1, explanation: 'Solids: fixed positions, vibrate in place.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'properties-states-matter', formSet: 'A' },
  { question: 'Sublimation is the transition from:', options: ['Solid to liquid', 'Liquid to gas', 'Solid directly to gas', 'Gas to liquid'], correctAnswer: 2, explanation: 'Sublimation: solid → gas (e.g., dry ice).', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'properties-states-matter', formSet: 'B' },
  { question: 'A phase diagram\'s triple point is where:', options: ['Only solid exists', 'All three phases coexist', 'Only gas exists', 'Temperature = 0 K'], correctAnswer: 1, explanation: 'Triple point: unique $T$ and $P$ where solid, liquid, and gas coexist.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'properties-states-matter', formSet: 'A' },
  { question: 'An intensive property is one that ___ on the amount of substance.', options: ['Depends', 'Does not depend', 'Sometimes depends', 'Always doubles with'], correctAnswer: 1, explanation: 'Intensive properties (density, temperature, color) are independent of amount.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'properties-states-matter', formSet: 'both' },

  // ── mixtures-separations (batch 2 — had 4, adding 4 → 8) ───────
  { question: 'Distillation separates components based on differences in:', options: ['Density', 'Boiling point', 'Color', 'Mass number'], correctAnswer: 1, explanation: 'Different boiling points → different vapor pressures → separation.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'mixtures-separations', formSet: 'A' },
  { question: 'Chromatography separates mixtures based on:', options: ['Melting point', 'Differential affinity for mobile vs. stationary phase', 'Mass number', 'Nuclear charge'], correctAnswer: 1, explanation: 'Components travel at different rates → separation.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'mixtures-separations', formSet: 'B' },
  { question: 'A homogeneous mixture is also called a:', options: ['Suspension', 'Colloid', 'Solution', 'Compound'], correctAnswer: 2, explanation: 'Uniform composition throughout → solution (homogeneous mixture).', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'mixtures-separations', formSet: 'A' },
  { question: 'Filtration separates:', options: ['Two liquids', 'A solid from a liquid', 'Two gases', 'Isotopes'], correctAnswer: 1, explanation: 'The solid is trapped by the filter; the liquid passes through.', difficulty: 'easy', domain: 'matter-and-properties', topicSlug: 'mixtures-separations', formSet: 'both' },
