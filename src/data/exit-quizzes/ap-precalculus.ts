...
export const apPrecalcQuestionPool: APPrecalcQuestion[] = [
  ...
  { question: 'If $f(x)=2x+3$ and $g(x)=x^2$, find $(f\\circ g)(x)$.', options: ['$2x^2+3$', '$(2x+3)^2$', '$4x^2+12x+9$', '$2x^2+6x+9$'], correctAnswer: 0, explanation: '$(f\\circ g)(x)=f(g(x))=2(x^2)+3=2x^2+3$.', difficulty: 'easy', domain: 'polynomial-rational', topicSlug: 'function-composition-inverses-precalc', formSet: 'A' },
  ...
  { question: 'Compounded continuously, $\\$1000$ at 5% per year is worth how much after 10 years? Use $A=Pe^{rt}$.', options: ['$\\$1500$', '$\\$1648.72$', '$\\$1628.89$', '$\\$1500.00$'], correctAnswer: 1, explanation: '$A=1000\\cdot e^{0.5} \\approx 1000(1.6487) = \\$1648.72$.', difficulty: 'medium', domain: 'exp-log', topicSlug: 'exponential-functions-precalc', formSet: 'A' },
