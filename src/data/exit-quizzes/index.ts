...
const quizLoaders: Record<string, QuizLoader> = {
  ...
  // AP Biology — actual topic slugs used by the routes (so /topics/<slug>/interactive
  // pages all surface a real exit quiz instead of skipping straight to competitive)
  'water-properties': () => import('./ap-biology'),
  'water-properties-biochemistry': () => import('./ap-biology'),
  'biological-macromolecules': () => import('./ap-biology'),
  'carbohydrates': () => import('./ap-biology'),
  'lipids': () => import('./ap-biology'),
  'proteins': () => import('./ap-biology'),
  'nucleic-acids': () => import('./ap-biology'),
  'enzyme-structure-function': () => import('./ap-biology'),
  'enzymes-metabolism': () => import('./ap-biology'),
  'enzyme-kinetics': () => import('./ap-biology'),
  'cell-structure-organelles': () => import('./ap-biology'),
  'cell-organelles': () => import('./ap-biology'),
  'prokaryotic-eukaryotic-cells': () => import('./ap-biology'),
  'cell-membrane-transport': () => import('./ap-biology'),
  'membrane-transport': () => import('./ap-biology'),
  'cell-compartmentalization': () => import('./ap-biology'),
  'cellular-respiration': () => import('./ap-biology'),
  'photosynthesis': () => import('./ap-biology'),
  'fitness-environment': () => import('./ap-biology'),
  'cell-communication-signaling': () => import('./ap-biology'),
  'cell-signaling': () => import('./ap-biology'),
  'cell-cycle-mitosis': () => import('./ap-biology'),
  'feedback-mechanisms': () => import('./ap-biology'),
  'meiosis': () => import('./ap-biology'),
  'meiosis-genetic-diversity': () => import('./ap-biology'),
  'mendelian-genetics': () => import('./ap-biology'),
  'non-mendelian-genetics': () => import('./ap-biology'),
  'chromosomal-inheritance': () => import('./ap-biology'),
  'chromosomal-inheritance-patterns': () => import('./ap-biology'),
  'dna-replication': () => import('./ap-biology'),
  'transcription-translation': () => import('./ap-biology'),
  'transcription-rna-processing': () => import('./ap-biology'),
  'translation': () => import('./ap-biology'),
  'gene-regulation': () => import('./ap-biology'),
  'natural-selection': () => import('./ap-biology'),
  'natural-selection-adaptation': () => import('./ap-biology'),
  'speciation': () => import('./ap-biology'),
  'speciation-macroevolution': () => import('./ap-biology'),
  'phylogeny-classification': () => import('./ap-biology'),
  'hardy-weinberg-equilibrium': () => import('./ap-biology'),
  'population-ecology': () => import('./ap-biology'),
  'population-community-ecology': () => import('./ap-biology'),
  'community-ecology': () => import('./ap-biology'),
  'ecosystems-energy': () => import('./ap-biology'),
  'population-dynamics': () => import('./ap-biology'),
