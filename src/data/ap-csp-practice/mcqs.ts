...
export const MCQS: MCQItem[] = [
  ...
  },
  {
    ...
    options: ['4', '6', '10', '16'],
    correctAnswer: 2,
    explanation: 'The loop runs 4 times, adding count = 1, 2, 3, 4 in turn: result = 1 + 2 + 3 + 4 = 10.',
    type: 'mcq',
    topic: 'algorithms-programming',
  },
  {
  ...
  {
    question: 'A list `data` contains [12, 7, 9, 15, 3, 8] (1-indexed). After the call `REMOVE(data, 2)`, which of the following is true?',
    options: ['The list still contains 6 elements, with an empty slot at index 2', 'The value at index 2 is replaced with 0', 'The list is automatically re-sorted in ascending order', 'The list becomes [12, 9, 15, 3, 8]: later elements shift left and LENGTH(data) is now 5'],
    correctAnswer: 3,
    explanation: 'REMOVE(list, i) deletes the element at index i; the elements after it shift down one position and the length decreases by 1, so data becomes [12, 9, 15, 3, 8].',
    type: 'mcq',
    topic: 'algorithms-programming',
  },
  {
  ...
  {
    question: 'Algorithm P takes about twice as long whenever the input size doubles. Algorithm Q takes about twice as long whenever a SINGLE element is added to the input. Which statement is consistent with the AP CSP framework?',
    options: ['Both P and Q run in unreasonable time', 'Q runs in reasonable time because each of its individual steps is simple', 'P and Q are equally practical for large inputs', 'P runs in reasonable time, while Q runs in unreasonable (exponential) time'],
    correctAnswer: 3,
    explanation: 'P\'s work grows in proportion to input size — polynomial, hence reasonable. Q\'s work doubles with each added element — exponential growth, hence unreasonable: even modest inputs become intractable.',
    type: 'mcq',
    topic: 'algorithms-programming',
  },
  {
