...
export const AP_PHYSICS1_QUESTION_POOL: PoolQuestion[] = [
  // ---- Kinematics ----
  { question: 'An object is thrown vertically upward. At the highest point, its acceleration is:', options: ['Zero', '9.8 $m/s^{2}$ downward', '9.8 $m/s^{2}$ upward', 'Dependent on the initial velocity'], correctAnswer: 1, explanation: 'Near Earth\'s surface, the acceleration due to gravity is always 9.8 $m/s^{2}$ downward, regardless of velocity.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  { question: 'A car accelerates uniformly from rest to 20 m/s in 5 seconds. How far does it travel?', options: ['50 m', '100 m', '25 m', '200 m'], correctAnswer: 0, explanation: 'd = $\\tfrac{1}{2} at^{2}$ = ½(4)(25) = 50 m. Or d = $(v_{0} + v)t/2$ = (0 + 20)(5)/2 = 50 m.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  ...
  { question: 'A car traveling at 30 m/s brakes uniformly and stops in 6 seconds. The braking distance is:', options: ['150 m', '90 m', '45 m', '180 m'], correctAnswer: 1, explanation: 'a = -30/6 = -5 $m/s^{2}$. d = $v_{0}t$ + $\\tfrac{1}{2} at^{2}$ = 30(6) + ½(-5)(36) = 180 - 90 = 90 m.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  { question: 'A ball is thrown upward at 20 m/s. The time to reach maximum height is approximately:', options: ['1 s', '2 s', '4 s', '10 s'], correctAnswer: 1, explanation: 't = $v_{0}/g$ = 20/10 = 2 s $(using g \\approx 10 m/s^{2})$.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  ...
  { question: 'An object moves 5 m east, then 5 m north. Its displacement magnitude is:', options: ['10 m', '5 m', '7.07 m', '0 m'], correctAnswer: 2, explanation: 'Displacement = $\\sqrt{5^{2} + 5^{2}}$ = $5\\sqrt{2}$ ≈ 7.07 m at 45° northeast.', domain: 'kinematics', topicSlug: 'two-dimensional-motion' },
  ...
  { question: 'A stone is dropped from a 45 m tower. The time to hit the ground is approximately:', options: ['2 s', '3 s', '4.5 s', '9 s'], correctAnswer: 1, explanation: 't = $\\sqrt{2h/g}$ = $\\sqrt{2\\cdot 45/10}$ = $\\sqrt{9}$ = 3 s.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  { question: 'A projectile is fired with initial speed $v_{0}$ at angle θ. Its maximum height is:', options: ['$v_{0}^{2}\\sin^{2}\\theta /(2g)$', '$v_{0}^{2}\\sin (2\\theta )/g$', '$v_{0}^{2}/(2g)$', '$v_{0}\\sin \\theta /g$'], correctAnswer: 0, explanation: 'At the peak, v_y = 0. Using $v^{2}$ = $v_{0}^{2}\\sin^{2}\\theta$ - 2gh → h = $v_{0}^{2}\\sin^{2}\\theta /(2g)$.', domain: 'kinematics', topicSlug: 'two-dimensional-motion' },
  { question: 'An object in free fall has been falling for 3 seconds. Its speed is approximately:', options: ['10 m/s', '20 m/s', '30 m/s', '45 m/s'], correctAnswer: 2, explanation: 'v = gt = 10(3) = 30 m/s $(using g \\approx 10 m/s^{2})$.', domain: 'kinematics', topicSlug: 'one-dimensional-motion' },
  ...
  { question: 'A boat crosses a river at 4 m/s perpendicular to a 3 m/s current. The resultant speed is:', options: ['5 m/s', '7 m/s', '1 m/s', '12 m/s'], correctAnswer: 0, explanation: 'Resultant = $\\sqrt{4^{2} + 3^{2}}$ = $\\sqrt{16 + 9}$ = $\\sqrt{25}$ = 5 m/s.', domain: 'kinematics', topicSlug: 'two-dimensional-motion' },
  ...
  { question: 'Two projectiles are launched at the same speed but at 30° and 60°. Which reaches a greater maximum height?', options: ['The one at 30°', 'The one at 60°', 'Both reach the same height', 'Cannot be determined'], correctAnswer: 1, explanation: 'h_max = $v_{0}^{2}\\sin^{2}\\theta /(2g)$. $\\sin^{2}60$° > $\\sin^{2}30$°, so the 60° launch reaches higher.', domain: 'kinematics', topicSlug: 'two-dimensional-motion' },
  // ---- Dynamics ----
  { question: 'A 5 kg object experiences a net force of 20 N. Its acceleration is:', options: ['4 $m/s^{2}$', '100 $m/s^{2}$', '0.25 $m/s^{2}$', '25 $m/s^{2}$'], correctAnswer: 0, explanation: 'Newton\'s second law: a = F/m = 20/5 = 4 $m/s^{2}$.', domain: 'dynamics', topicSlug: 'newtons-first-second-laws' },
  ...
  { question: 'A 10 kg box is pushed with 50 N across a floor with μk = 0.3. What is the acceleration? (use g = 9.8 $m/s^{2}$)', options: ['5 $m/s^{2}$', '2.06 $m/s^{2}$', '3 $m/s^{2}$', '7.94 $m/s^{2}$'], correctAnswer: 1, explanation: 'f = μk·mg = 0.3(10)(9.8) = 29.4 N. Fnet = 50 − 29.4 = 20.6 N. a = 20.6/10 ≈ 2.06 $m/s^{2}$.', domain: 'dynamics', topicSlug: 'friction' },
  ...
  { question: 'Two forces of 3 N and 4 N act perpendicular to each other on an object. The net force magnitude is:', options: ['1 N', '5 N', '7 N', '12 N'], correctAnswer: 1, explanation: 'F_net = $\\sqrt{3^{2} + 4^{2}}$ = $\\sqrt{9 + 16}$ = $\\sqrt{25}$ = 5 N.', domain: 'dynamics', topicSlug: 'newtons-first-second-laws' },
  ...
  { question: 'The weight of a 10 kg object on the Moon $(g \\approx 1.6 m/s^{2})$ is:', options: ['10 N', '16 N', '98 N', '160 N'], correctAnswer: 1, explanation: 'W = mg = 10(1.6) = 16 N (compared to 98 N on Earth).', domain: 'dynamics', topicSlug: 'newtons-first-second-laws' },
  { question: 'A 5 kg object on a frictionless surface has a 10 N horizontal force applied. After 4 seconds, its velocity is:', options: ['2 m/s', '4 m/s', '8 m/s', '20 m/s'], correctAnswer: 2, explanation: 'a = F/m = 10/5 = 2 $m/s^{2}$. v = at = 2(4) = 8 m/s.', domain: 'dynamics', topicSlug: 'newtons-first-second-laws' },
  ...
  { question: 'The centripetal acceleration of an object moving in a circle of radius r at speed v is:', options: ['v/r', '$v^{2}/r$', 'vr', '$v^{2}r$'], correctAnswer: 1, explanation: 'Centripetal acceleration ac = $v^{2}/r$, directed toward the center of the circle.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'Newton\'s law of gravitation states that gravitational force is proportional to:', options: ['The sum of the masses', 'The product of the masses divided by distance squared', 'The difference of the masses', 'Mass times distance'], correctAnswer: 1, explanation: 'F = $Gm_{1}m_{2}/r^{2}$. Force is proportional to the product of masses and inversely proportional to distance squared.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  { question: 'A satellite in circular orbit has its centripetal force provided by:', options: ['Its engines', 'Gravity', 'Normal force', 'Tension'], correctAnswer: 1, explanation: 'For a satellite, gravity provides the centripetal force: mg = $mv^{2}/r$.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  { question: 'If the radius of a circular orbit doubles (same speed), the centripetal acceleration:', options: ['Doubles', 'Halves', 'Quadruples', 'Stays the same'], correctAnswer: 1, explanation: 'ac = $v^{2}/r$. If r doubles and v stays the same, ac is halved.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'At the top of a vertical loop, the minimum speed for an object to maintain contact is found by setting:', options: ['N = mg', 'mg = $mv^{2}/r$ (with N = 0)', 'T = mg', 'F = 0'], correctAnswer: 1, explanation: 'At the minimum speed, normal force is zero: gravity alone provides centripetal force, so mg = $mv^{2}/r$ → v = $\\sqrt{gr}$.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'The gravitational field strength g at distance r from Earth\'s center is:', options: ['GM/r', '$GM/r^{2}$', 'GMr', '$GM/r^{3}$'], correctAnswer: 1, explanation: 'g = $GM/r^{2}$, which decreases as the square of the distance from the center.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  ...
  { question: 'If you double the speed of an object in circular motion (same radius), the centripetal force:', options: ['Doubles', 'Quadruples', 'Halves', 'Stays the same'], correctAnswer: 1, explanation: 'F = $mv^{2}/r$. Doubling v → F increases by factor of 4.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'The period of a satellite in circular orbit depends on:', options: ['Mass of the satellite', 'Orbital radius and mass of the planet', 'Only the satellite\'s speed', 'Mass of satellite and speed only'], correctAnswer: 1, explanation: 'From Kepler\'s third law: $T^{2}$ = $4\\pi^{2}r^{3}/(GM)$. Period depends on orbital radius and planet mass.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  ...
  { question: 'If the distance between two objects doubles, the gravitational force between them:', options: ['Doubles', 'Halves', 'Becomes one-quarter', 'Quadruples'], correctAnswer: 2, explanation: 'F ∝ $1/r^{2}$. Doubling r reduces F to $(1/2)^{2}$ = 1/4 of the original.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  ...
  { question: 'A ball on a string swings in a vertical circle. The string tension is greatest at:', options: ['The top', 'The bottom', 'The sides', 'Tension is constant'], correctAnswer: 1, explanation: 'At the bottom: T - mg = $mv^{2}/r$ → T = $mv^{2}/r$ + mg. Speed is also greatest at the bottom.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'Kepler\'s third law relates:', options: ['Period and eccentricity', 'Period squared and orbital radius cubed', 'Speed and mass', 'Force and distance'], correctAnswer: 1, explanation: '$T^{2}$ ∝ $r^{3}$ — the square of the orbital period is proportional to the cube of the semi-major axis.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  ...
  { question: 'The escape velocity from a planet depends on:', options: ['Only the object\'s mass', 'The planet\'s mass and radius', 'Only the planet\'s radius', 'The object\'s initial height'], correctAnswer: 1, explanation: 'v_esc = $\\sqrt{2GM/R}$. It depends on the planet\'s mass M and radius R, not the object\'s mass.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation' },
  { question: 'A coin on a turntable flies off when the rotation speed increases because:', options: ['Gravity decreases', 'The required centripetal force exceeds maximum static friction', 'The normal force decreases', 'The coin gains too much kinetic energy'], correctAnswer: 1, explanation: 'The required centripetal force $(m\\omega^{2}r)$ increases with ω. When it exceeds μsN, friction can\'t hold the coin.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  { question: 'For an object in uniform circular motion, the work done by the centripetal force is:', options: ['Positive', 'Negative', 'Zero', 'Equal to $\\tfrac{1}{2} mv^{2}$'], correctAnswer: 2, explanation: 'The centripetal force is always perpendicular to the velocity, so W = Fd cos 90° = 0.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion' },
  // ---- Energy ----
  { question: 'The work-energy theorem states:', options: ['Work equals force times distance always', 'The net work on an object equals its change in kinetic energy', 'Energy is always conserved', 'Work done by friction is always positive'], correctAnswer: 1, explanation: 'W_net = ΔKE = $\\tfrac{1}{2} mv^{2}$ − $\\tfrac{1}{2} mv_{0}^{2}$. Net work equals the change in kinetic energy.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
  { question: 'A spring compressed by x stores potential energy equal to:', options: ['kx', '½kx', '$kx^{2}$', '$\\tfrac{1}{2} kx^{2}$'], correctAnswer: 3, explanation: 'Elastic potential energy PE = $\\tfrac{1}{2} kx^{2}$, where k is the spring constant.', domain: 'energy', topicSlug: 'conservation-of-energy' },
  { question: 'If a ball is dropped from height h, its speed just before hitting the ground is:', options: ['$\\sqrt{gh}$', '$\\sqrt{2gh}$', '2gh', 'gh'], correctAnswer: 1, explanation: 'Conservation of energy: mgh = $\\tfrac{1}{2} mv^{2}$ → v = $\\sqrt{2gh}$.', domain: 'energy', topicSlug: 'conservation-of-energy' },
  ...
  { question: 'Doubling the speed of an object multiplies its kinetic energy by:', options: ['2', '4', '8', '$\\sqrt{2}$'], correctAnswer: 1, explanation: 'KE = $\\tfrac{1}{2} mv^{2}$. If v doubles, KE = $\\tfrac{1}{2} m(2v)^{2}$ = $4(\\tfrac{1}{2} mv^{2})$, so KE quadruples.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
  { question: 'A roller coaster car starts from rest at the top of a 20 m hill. Ignoring friction, its speed at the bottom is approximately:', options: ['10 m/s', '14 m/s', '20 m/s', '40 m/s'], correctAnswer: 2, explanation: 'v = $\\sqrt{2gh}$ = $\\sqrt{2 \\times 10 \\times 20}$ = $\\sqrt{400}$ = 20 m/s $(using g \\approx 10 m/s^{2})$.', domain: 'energy', topicSlug: 'conservation-of-energy' },
  { question: 'A 10 kg box is lifted 3 m vertically. The work done against gravity is: (use g = 9.8 $m/s^{2}$)', options: ['30 J', '98 J', '294 J', '147 J'], correctAnswer: 2, explanation: 'W = mgh = 10(9.8)(3) = 294 J.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
  ...
  { question: 'The SI unit of energy is:', options: ['Newton', 'Watt', 'Joule', 'Pascal'], correctAnswer: 2, explanation: 'Energy is measured in joules (J). 1 J = 1 N·m = 1 $kg\\cdot m^{2}/s^{2}$.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
  { question: 'A spring with k = 200 N/m is stretched 0.1 m. The elastic PE stored is:', options: ['1 J', '2 J', '10 J', '20 J'], correctAnswer: 0, explanation: 'PE = $\\tfrac{1}{2} kx^{2}$ = $\\tfrac{1}{2} (200)(0.1)^{2}$ = ½(200)(0.01) = 1 J.', domain: 'energy', topicSlug: 'conservation-of-energy' },
  { question: 'Two identical cars travel at 20 m/s and 40 m/s. The ratio of their kinetic energies is:', options: ['1:2', '1:4', '1:8', '2:1'], correctAnswer: 1, explanation: 'KE ∝ $v^{2}$. $(20)^{2}$:$(40)^{2}$ = 400:1600 = 1:4.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
  ...
  { question: 'Two objects with equal and opposite momenta collide and stick together. Their final velocity is:', options: ['Equal to the average speed', 'Zero', 'Equal to the faster object\'s velocity', 'Indeterminate'], correctAnswer: 1, explanation: 'p_total = +p + (−p) = 0. Since $(m_{1} + m_{2})v_{f}$ = 0, v_f = 0.', domain: 'momentum', topicSlug: 'collisions' },
  ...
  { question: 'The unit of impulse is equivalent to:', options: ['$kg\\cdot m/s^{2}$ (same as force)', 'N·s (same as kg·m/s)', 'J (same as energy)', 'W (same as power)'], correctAnswer: 1, explanation: 'Impulse = FΔt has units of N·s, which equals kg·m/s (units of momentum).', domain: 'momentum', topicSlug: 'momentum-and-impulse' },
  ...
  { question: 'The period of a simple pendulum depends on:', options: ['Mass and length', 'Length and gravitational acceleration only', 'Mass and amplitude', 'Amplitude only'], correctAnswer: 1, explanation: 'T = $2\\pi \\sqrt{L/g}$. Period depends only on length and g, not on mass or (small) amplitude.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  ...
  { question: 'The period of a mass-spring system is:', options: ['T = $2\\pi \\sqrt{m/k}$', 'T = $2\\pi \\sqrt{k/m}$', 'T = $2\\pi \\sqrt{L/g}$', 'T = $1/f^{2}$'], correctAnswer: 0, explanation: 'For a mass on a spring: T = $2\\pi \\sqrt{m/k}$. Period increases with mass and decreases with stiffer springs.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  { question: 'The speed of a wave on a string increases when:', options: ['Tension increases', 'Mass per unit length increases', 'Frequency decreases', 'Amplitude increases'], correctAnswer: 0, explanation: 'v = $\\sqrt{T/\\mu}$. Greater tension increases wave speed; greater linear density decreases it.', domain: 'simple-harmonic-motion', topicSlug: 'energy-in-shm' },
  ...
  { question: 'Doubling the mass on a spring changes the period by a factor of:', options: ['2', '$\\sqrt{2}$', '½', '4'], correctAnswer: 1, explanation: 'T = $2\\pi \\sqrt{m/k}$. Doubling m → T multiplied by $\\sqrt{2}$.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  { question: 'At maximum displacement in SHM, the magnitude of the acceleration is:', options: ['Zero', 'Maximum', 'Equal to the velocity', 'Minimum but nonzero'], correctAnswer: 1, explanation: 'a = $-\\omega^{2}x$. At maximum x (amplitude), |a| = $\\omega^{2}A$ is maximum.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  { question: 'The total energy in SHM equals:', options: ['$\\tfrac{1}{2} kA^{2}$ (where A is amplitude)', 'mgh', '$\\tfrac{1}{2} mv_{max}^{2}$', 'Both A and C are correct'], correctAnswer: 3, explanation: 'Total energy E = $\\tfrac{1}{2} kA^{2}$ = $\\tfrac{1}{2} mv_{max}^{2}$. It is constant and equals the maximum PE or maximum KE.', domain: 'simple-harmonic-motion', topicSlug: 'energy-in-shm' },
  { question: 'The frequency of a pendulum on the Moon (g = 1.6 $m/s^{2}$) compared to Earth is:', options: ['Higher', 'Lower', 'The same', 'Cannot be determined'], correctAnswer: 1, explanation: 'f = $(1/2\\pi )\\sqrt{g/L}$. Smaller g on the Moon means lower frequency (longer period).', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  ...
  { question: 'Two oscillators have the same amplitude but different frequencies ($f_{1}$ = $2f_{2}$). The oscillator with higher frequency has:', options: ['Greater maximum speed', 'Lesser maximum speed', 'The same maximum speed', 'Greater period'], correctAnswer: 0, explanation: 'v_max = A(2πf). Higher frequency → greater maximum speed (for the same amplitude).', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  ...
  { question: 'The phase difference between displacement and acceleration in SHM is:', options: ['0° (in phase)', '90°', '180° (out of phase)', '270°'], correctAnswer: 2, explanation: 'a = $-\\omega^{2}x$. Displacement and acceleration are 180° out of phase (when x is max positive, a is max negative).', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm' },
  ...
  { question: 'The moment of inertia of an object depends on:', options: ['Mass only', 'Shape only', 'Mass distribution relative to the axis of rotation', 'Angular velocity'], correctAnswer: 2, explanation: 'I = $\\Sigma mr^{2}$. Moment of inertia depends on both the mass and how it is distributed relative to the rotation axis.', domain: 'torque-rotation', topicSlug: 'angular-momentum' },
  ...
  { question: 'The rotational analog of F = ma is:', options: ['L = Iω', 'τ = Iα', 'KE = $\\tfrac{1}{2} I\\omega^{2}$', 'W = τθ'], correctAnswer: 1, explanation: 'τ = Iα is Newton\'s second law for rotation: net torque equals moment of inertia times angular acceleration.', domain: 'torque-rotation', topicSlug: 'angular-momentum' },
  ...
  { question: 'The rotational kinetic energy of a spinning object is:', options: ['$\\tfrac{1}{2} mv^{2}$', 'Iω', '$\\tfrac{1}{2} I\\omega^{2}$', 'Iα'], correctAnswer: 2, explanation: 'Rotational KE = $\\tfrac{1}{2} I\\omega^{2}$, analogous to translational KE = $\\tfrac{1}{2} mv^{2}$.', domain: 'torque-rotation', topicSlug: 'angular-momentum' },
  ...
  { question: 'A uniform rod pivoted at one end has a moment of inertia of $mL^{2}/3$. Pivoted at the center, it is $mL^{2}/12$. The ratio (end to center) is:', options: ['1:1', '2:1', '4:1', '3:1'], correctAnswer: 2, explanation: '$(mL^{2}/3)/(mL^{2}/12)$ = 12/3 = 4. Pivoting at the end gives 4× the moment of inertia.', domain: 'torque-rotation', topicSlug: 'angular-momentum' },
  ...
  { question: 'Pressure in a static fluid depends on:', options: ['Container shape', 'Surface area of the container', 'Depth and fluid density', 'Total volume of fluid'], correctAnswer: 2, explanation: 'For a static fluid, P = $P_{0}$ + ρgh — pressure depends only on depth h and density ρ, not container shape.', domain: 'fluids', topicSlug: 'fluid-pressure' },
  { question: 'A diver descends 10 m in fresh water (ρ = 1000 $kg/m^{3}$). The additional pressure on the diver is approximately:', options: ['1,000 Pa', '10,000 Pa', '100,000 Pa', '1,000,000 Pa'], correctAnswer: 2, explanation: 'ΔP = ρgh = 1000 × 10 × 10 = 100,000 Pa (≈ 1 atm of additional pressure per 10 m of fresh water).', domain: 'fluids', topicSlug: 'fluid-pressure' },
  { question: 'A 50 $cm^{2}$ piston pushes down on a hydraulic fluid with 100 N. A second piston on the same closed system has area 500 $cm^{2}$. The maximum lift force at the second piston is:', options: ['100 N', '500 N', '1,000 N', '5,000 N'], correctAnswer: 2, explanation: 'Pascal\u2019s principle: $P_{1}$ = $P_{2}$. $F_{2}$ = $F_{1}$ × $A_{2}/A_{1}$ = 100 × 500/50 = 1,000 N.', domain: 'fluids', topicSlug: 'fluid-pressure' },
  { question: 'Atmospheric pressure at sea level is approximately $10^{5}$ Pa. The downward force on a tabletop measuring 1 m × 0.5 m due to the atmosphere is roughly:', options: ['$5 \\times 10^{2}$ N', '$5 \\times 10^{4}$ N', '$5 \\times 10^{5}$ N', '$1 \\times 10^{5}$ N'], correctAnswer: 1, explanation: 'F = PA = $10^{5}$ × (1 × 0.5) = $5 \\times 10^{4}$ N. (We don\u2019t feel it because pressure also pushes up from below.)', domain: 'fluids', topicSlug: 'fluid-pressure' },
  ...
  { question: 'A 2 kg block of density 500 $kg/m^{3}$ is placed in water (ρ = 1000 $kg/m^{3}$). What fraction of the block is submerged when it floats?', options: ['1/4', '1/2', '3/4', 'It sinks'], correctAnswer: 1, explanation: 'Floating: ρ_obj/ρ_fluid of the volume is submerged. 500/1000 = 1/2.', domain: 'fluids', topicSlug: 'buoyancy' },
  ...
  { question: 'For an ideal fluid in steady flow, the continuity equation $A_{1}v_{1}$ = $A_{2}v_{2}$ expresses conservation of:', options: ['Energy', 'Momentum', 'Mass (volume) flow rate', 'Pressure'], correctAnswer: 2, explanation: 'Mass conservation in an incompressible fluid means the volume flow rate Av is constant along a streamline.', domain: 'fluids', topicSlug: 'fluid-dynamics' },
  { question: 'Water flows through a pipe whose radius narrows from 4 cm to 2 cm. If the speed in the wide section is 1 m/s, the speed in the narrow section is:', options: ['0.25 m/s', '1 m/s', '4 m/s', '16 m/s'], correctAnswer: 2, explanation: '$A_{1}v_{1}$ = $A_{2}v_{2}$ and A ∝ $r^{2}$. Area ratio 16/4 = 4, so $v_{2}$ = 4 × 1 = 4 m/s.', domain: 'fluids', topicSlug: 'fluid-dynamics' },
  { question: 'According to Bernoulli\u2019s equation, in a horizontal pipe where fluid speeds up:', options: ['Pressure increases', 'Pressure decreases', 'Pressure is unchanged', 'Density decreases'], correctAnswer: 1, explanation: 'P + $\\tfrac{1}{2} \\rho v^{2}$ + ρgh = constant. At the same height h, faster v means lower P.', domain: 'fluids', topicSlug: 'fluid-dynamics' },
