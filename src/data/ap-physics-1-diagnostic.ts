...
export const AP_PHYSICS1_QUESTION_POOL: PoolQuestion[] = [
  ...
  { question: 'A 10 kg box is pushed with 50 N across a floor with μk = 0.3. What is the acceleration? (use g = 9.8 m/s²)', options: ['5 m/s²', '2.06 m/s²', '3 m/s²', '7.94 m/s²'], correctAnswer: 1, explanation: 'f = μk·mg = 0.3(10)(9.8) = 29.4 N. Fnet = 50 − 29.4 = 20.6 N. a = 20.6/10 ≈ 2.06 m/s².', domain: 'dynamics', topicSlug: 'friction' },
  ...
  { question: 'A 10 kg box is lifted 3 m vertically. The work done against gravity is: (use g = 9.8 m/s²)', options: ['30 J', '98 J', '294 J', '147 J'], correctAnswer: 2, explanation: 'W = mgh = 10(9.8)(3) = 294 J.', domain: 'energy', topicSlug: 'work-and-kinetic-energy' },
