...
const questionPool: PoolQuestion[] = [
  ...
  // ---- Dynamics ----
  { question: 'A 5 kg object experiences a net force of 20 N. Its acceleration is:', options: ['4 m/s²', '100 m/s²', '0.25 m/s²', '25 m/s²'], correctAnswer: 0, explanation: 'Newton\'s second law: a = F/m = 20/5 = 4 m/s².', domain: 'dynamics', topicSlug: 'newtons-first-second-laws', formSet: 'A' },
  { question: 'A book sits on a table. The normal force on the book is an example of Newton\'s:', options: ['First law', 'Second law', 'Third law', 'Law of gravitation'], correctAnswer: 2, explanation: 'The normal force is the table\'s reaction to the book pushing down — an action-reaction pair (Third law).', domain: 'dynamics', topicSlug: 'newtons-first-second-laws', formSet: 'A' },
  { question: 'A 10 kg box is pushed with 50 N across a floor with μk = 0.3. What is the acceleration?', options: ['5 m/s²', '2.06 m/s²', '3 m/s²', '2 m/s²'], correctAnswer: 1, explanation: 'f = μk·mg = 0.3(10)(9.8) = 29.4 N. Fnet = 50 − 29.4 = 20.6 N. a = 20.6/10 ≈ 2.06 m/s².', domain: 'dynamics', topicSlug: 'friction', formSet: 'A' },
  { question: 'An elevator accelerates upward. The apparent weight of a person inside is:', options: ['Less than their true weight', 'Equal to their true weight', 'Greater than their true weight', 'Zero'], correctAnswer: 2, explanation: 'When accelerating up, the normal force (apparent weight) exceeds mg: N = m(g + a).', domain: 'dynamics', topicSlug: 'newtons-first-second-laws', formSet: 'B' },
  { question: 'Static friction is always:', options: ['Equal to μsN', 'Less than or equal to μsN', 'Greater than kinetic friction', 'Proportional to velocity'], correctAnswer: 1, explanation: 'Static friction adjusts up to a maximum of μsN. It\'s only equal to μsN at the point of impending motion.', domain: 'dynamics', topicSlug: 'friction', formSet: 'B' },
  { question: 'Two objects are connected by a massless string over a frictionless pulley (Atwood machine). They accelerate because:', options: ['The total force is zero', 'The net force on the system is the difference in their weights', 'Tension is different on each side', 'Gravity is different for each mass'], correctAnswer: 1, explanation: 'For an Atwood machine: a = (m₁ − m₂)g/(m₁ + m₂). The net force is the weight difference.', domain: 'dynamics', topicSlug: 'newtons-first-second-laws', formSet: 'B' },
  { question: 'Newton\'s first law (inertia) states:', options: ['F = ma', 'Every action has an equal and opposite reaction', 'An object maintains its state of motion unless a net force acts on it', 'Force equals the rate of change of momentum'], correctAnswer: 2, explanation: 'The law of inertia: without a net external force, an object remains at rest or moves at constant velocity.', domain: 'dynamics', topicSlug: 'newtons-first-second-laws', formSet: 'both' },
  { question: 'A block slides down a frictionless incline at angle θ. Its acceleration is:', options: ['g', 'g sin θ', 'g cos θ', 'g tan θ'], correctAnswer: 1, explanation: 'On a frictionless incline, the component of gravity along the surface is mg sin θ, so a = g sin θ.', domain: 'dynamics', topicSlug: 'friction', formSet: 'both' },

  // ---- Circular Motion & Gravitation ----
  { question: 'An object in uniform circular motion has a constant:', options: ['Velocity', 'Acceleration', 'Speed', 'Net force direction'], correctAnswer: 2, explanation: 'In uniform circular motion speed is constant but velocity changes direction continuously.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion', formSet: 'A' },
  { question: 'The centripetal acceleration of an object moving in a circle of radius r at speed v is:', options: ['v/r', 'v²/r', 'vr', 'v²r'], correctAnswer: 1, explanation: 'Centripetal acceleration ac = v²/r, directed toward the center of the circle.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion', formSet: 'A' },
  { question: 'Newton\'s law of gravitation states that gravitational force is proportional to:', options: ['The sum of the masses', 'The product of the masses divided by distance squared', 'The difference of the masses', 'Mass times distance'], correctAnswer: 1, explanation: 'F = Gm₁m₂/r². Force is proportional to the product of masses and inversely proportional to distance squared.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation', formSet: 'A' },
  { question: 'A satellite in circular orbit has its centripetal force provided by:', options: ['Its engines', 'Gravity', 'Normal force', 'Tension'], correctAnswer: 1, explanation: 'For a satellite, gravity provides the centripetal force: mg = mv²/r.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation', formSet: 'B' },
  { question: 'If the radius of a circular orbit doubles (same speed), the centripetal acceleration:', options: ['Doubles', 'Halves', 'Quadruples', 'Stays the same'], correctAnswer: 1, explanation: 'ac = v²/r. If r doubles and v stays the same, ac is halved.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion', formSet: 'B' },
  { question: 'At the top of a vertical loop, the minimum speed for an object to maintain contact is found by setting:', options: ['N = mg', 'mg = mv²/r (with N = 0)', 'T = mg', 'F = 0'], correctAnswer: 1, explanation: 'At the minimum speed, normal force is zero: gravity alone provides centripetal force, so mg = mv²/r → v = √(gr).', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion', formSet: 'B' },
  { question: 'The gravitational field strength g at distance r from Earth\'s center is:', options: ['GM/r', 'GM/r²', 'GMr', 'GM/r³'], correctAnswer: 1, explanation: 'g = GM/r², which decreases as the square of the distance from the center.', domain: 'circular-motion-gravity', topicSlug: 'universal-gravitation', formSet: 'both' },
  { question: 'A car rounds a flat, unbanked curve. The force providing centripetal acceleration is:', options: ['Gravity', 'Normal force', 'Friction', 'The engine force'], correctAnswer: 2, explanation: 'On a flat curve, static friction between the tires and road provides the centripetal force.', domain: 'circular-motion-gravity', topicSlug: 'uniform-circular-motion', formSet: 'both' },
  ...
  { question: 'Work done by a constant force at 90° to the displacement is:', options: ['Maximum', 'Positive', 'Negative', 'Zero'], correctAnswer: 3, explanation: 'W = Fd cos θ. When θ = 90°, cos 90° = 0, so no work is done.', domain: 'energy', topicSlug: 'work-and-kinetic-energy', formSet: 'B' },
  { question: 'Power is defined as:', options: ['Force × displacement', 'Work / time', 'Energy × time', 'Force / acceleration'], correctAnswer: 1, explanation: 'Power = W/t = rate of doing work, measured in watts (J/s).', domain: 'energy', topicSlug: 'work-and-kinetic-energy', formSet: 'B' },
  ...
  { question: 'Doubling the speed of an object multiplies its kinetic energy by:', options: ['2', '4', '8', '√2'], correctAnswer: 1, explanation: 'KE = ½mv². If v doubles, KE = ½m(2v)² = 4(½mv²), so KE quadruples.', domain: 'energy', topicSlug: 'work-and-kinetic-energy', formSet: 'both' },
  ...
  // ---- Momentum ----
  { question: 'Impulse is equal to:', options: ['Force × time = change in momentum', 'Force × distance', 'Mass × acceleration', 'Energy / time'], correctAnswer: 0, explanation: 'Impulse J = FΔt = Δp (change in momentum). This is the impulse-momentum theorem.', domain: 'momentum', topicSlug: 'momentum-and-impulse', formSet: 'A' },
  ...
  { question: 'A firecracker at rest explodes into two pieces. Their total momentum after the explosion is:', options: ['Greater than zero', 'Zero', 'Dependent on the masses', 'Equal to the kinetic energy'], correctAnswer: 1, explanation: 'Initial momentum was zero. By conservation of momentum, total momentum remains zero after the explosion.', domain: 'momentum', topicSlug: 'momentum-and-impulse', formSet: 'B' },
  ...
  { question: 'A longer collision time (like an airbag) reduces:', options: ['Impulse', 'Change in momentum', 'Force experienced', 'Total energy'], correctAnswer: 2, explanation: 'J = FΔt = Δp. If Δp is fixed but Δt increases, the average force F decreases — that is the purpose of airbags.', domain: 'momentum', topicSlug: 'momentum-and-impulse', formSet: 'B' },
  { question: 'The center of mass of a system with no external forces:', options: ['Accelerates toward the heavier object', 'Moves at constant velocity', 'Is always at rest', 'Oscillates'], correctAnswer: 1, explanation: 'Without external forces, the center of mass maintains constant velocity (Newton\'s first law for systems).', domain: 'momentum', topicSlug: 'momentum-and-impulse', formSet: 'both' },
  ...
  { question: 'In simple harmonic motion, the restoring force is proportional to:', options: ['Velocity', 'Displacement from equilibrium', 'Acceleration only', 'Mass'], correctAnswer: 1, explanation: 'SHM requires F = −kx: the restoring force is proportional to displacement and directed toward equilibrium.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm', formSet: 'A' },
  { question: 'The period of a simple pendulum depends on:', options: ['Mass and length', 'Length and gravitational acceleration only', 'Mass and amplitude', 'Amplitude only'], correctAnswer: 1, explanation: 'T = 2π√(L/g). Period depends only on length and g, not on mass or (small) amplitude.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm', formSet: 'A' },
  { question: 'A standing wave on a string fixed at both ends has nodes at the endpoints. The fundamental frequency has:', options: ['No nodes', 'One antinode in the middle', 'Two antinodes', 'Three antinodes'], correctAnswer: 1, explanation: 'The fundamental mode (first harmonic) has nodes at both ends and one antinode at the center (half wavelength).', domain: 'simple-harmonic-motion', topicSlug: 'energy-in-shm', formSet: 'A' },
  { question: 'The period of a mass-spring system is:', options: ['T = 2π√(m/k)', 'T = 2π√(k/m)', 'T = 2π√(L/g)', 'T = 1/f²'], correctAnswer: 0, explanation: 'For a mass on a spring: T = 2π√(m/k). Period increases with mass and decreases with stiffer springs.', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm', formSet: 'B' },
  { question: 'The speed of a wave on a string increases when:', options: ['Tension increases', 'Mass per unit length increases', 'Frequency decreases', 'Amplitude increases'], correctAnswer: 0, explanation: 'v = √(T/μ). Greater tension increases wave speed; greater linear density decreases it.', domain: 'simple-harmonic-motion', topicSlug: 'energy-in-shm', formSet: 'B' },
  { question: 'At the equilibrium position of SHM, the object has:', options: ['Maximum displacement and zero velocity', 'Maximum velocity and zero displacement', 'Maximum acceleration', 'Zero kinetic energy'], correctAnswer: 1, explanation: 'At equilibrium, displacement is zero (max velocity) and acceleration is zero (no restoring force).', domain: 'simple-harmonic-motion', topicSlug: 'introduction-to-shm', formSet: 'both' },
  { question: 'Resonance occurs when:', options: ['Friction is very high', 'The driving frequency matches the natural frequency of the system', 'The amplitude is zero', 'The system is critically damped'], correctAnswer: 1, explanation: 'Resonance produces maximum amplitude when the external driving frequency equals the system\'s natural frequency.', domain: 'simple-harmonic-motion', topicSlug: 'energy-in-shm', formSet: 'both' },
  ...
  { question: 'A spinning figure skater pulls in their arms. Their angular velocity:', options: ['Decreases', 'Increases', 'Stays the same', 'Goes to zero'], correctAnswer: 1, explanation: 'Pulling arms in reduces I. Since L = Iω is conserved, ω must increase.', domain: 'torque-rotation', topicSlug: 'angular-momentum', formSet: 'B' },
  ...
  { question: 'The rotational analog of F = ma is:', options: ['L = Iω', 'τ = Iα', 'KE = ½Iω²', 'W = τθ'], correctAnswer: 1, explanation: 'τ = Iα is Newton\'s second law for rotation: net torque equals moment of inertia times angular acceleration.', domain: 'torque-rotation', topicSlug: 'angular-momentum', formSet: 'both' },
