...
const QUESTION_POOL: Question[] = [
  ...
  { question: 'Factor: $x^{2}$ + 5x + 6', options: ['(x + 1)(x + 6)', '(x + 2)(x + 3)', '(x − 2)(x − 3)', '(x + 5)(x + 1)'], correctAnswer: 1, explanation: 'Find two numbers that multiply to 6 and add to 5: 2 and 3. So $x^{2}$ + 5x + 6 = (x + 2)(x + 3).' },
  ...
  { question: 'Simplify: $(-3)^{2}$ × 2', options: ['−18', '18', '−12', '12'], correctAnswer: 1, explanation: '$(-3)^{2}$ = 9, then 9 × 2 = 18. The parentheses mean the entire (−3) is squared.' },
  ...
  { question: 'If f(x) = $x^{2}$ − 4, what is f(3)?', options: ['5', '−1', '13', '9'], correctAnswer: 0, explanation: 'f(3) = $3^{2}$ − 4 = 9 − 4 = 5.' },
  ...
  { question: 'Simplify: $\\sqrt{36}$ + $\\sqrt{49}$', options: ['13', '85', '11', '15'], correctAnswer: 0, explanation: '$\\sqrt{36}$ = 6 and $\\sqrt{49}$ = 7, so 6 + 7 = 13.' },
  { question: 'Which expression is equivalent to $2^{4}$ × $2^{3}$?', options: ['$2^{7}$', '$2^{12}$', '$4^{7}$', '$2^{1}$'], correctAnswer: 0, explanation: 'When multiplying powers with the same base, add exponents: $2^{4}$ × $2^{3}$ = $2^{4+3}$ = $2^{7}$.' },
  ...
  { question: 'What type of number is $\\sqrt{2}$?', options: ['Rational', 'Irrational', 'Integer', 'Natural'], correctAnswer: 1, explanation: '$\\sqrt{2}$ cannot be expressed as a fraction p/q where p, q are integers. It is an irrational number (≈1.414...).' },
  { question: 'Solve: $x^{2}$ − 9 = 0', options: ['x = 3 only', 'x = −3 only', 'x = 3 or x = −3', 'x = 9'], correctAnswer: 2, explanation: '$x^{2}$ − 9 = 0 → $x^{2}$ = 9 → x = ±3. This is a difference of squares: (x − 3)(x + 3) = 0.' },
  { question: 'What is the GCF of $12x^{3}$ and $18x^{2}$?', options: ['$6x^{2}$', '$6x^{3}$', '$36x^{2}$', '3x'], correctAnswer: 0, explanation: 'GCF of 12 and 18 is 6. GCF of $x^{3}$ and $x^{2}$ is $x^{2}$. So GCF = $6x^{2}$.' },
  ...
  { question: 'Evaluate: $-2(3 - 5)^{2}$ + 4', options: ['−4', '0', '−12', '12'], correctAnswer: 0, explanation: '$-2(3 - 5)^{2}$ + 4 = $-2(-2)^{2}$ + 4 = −2(4) + 4 = −8 + 4 = −4.' },
  ...
  { question: 'What is the range of f(x) = $x^{2}$ if the domain is all real numbers?', options: ['All real numbers', 'y ≥ 0', 'y > 0', 'y ≤ 0'], correctAnswer: 1, explanation: '$x^{2}$ is always non-negative (≥ 0) for any real x. The minimum value is 0 (at x = 0), so the range is y ≥ 0.' },
  { question: 'Simplify: $(2x^{3})^{2}$', options: ['$2x^{6}$', '$4x^{6}$', '$4x^{5}$', '$2x^{5}$'], correctAnswer: 1, explanation: '$(2x^{3})^{2}$ = $2^{2}$ × $(x^{3})^{2}$ = $4x^{6}$. Raise both the coefficient and variable to the power.' },
  ...
  { question: 'Convert to scientific notation: 0.00045', options: ['$4.5 \\times 10^{-4}$', '$4.5 \\times 10^{-5}$', '$4.5 \\times 10^{-3}$', '$4.5 \\times 10^{4}$'], correctAnswer: 0, explanation: 'Move the decimal 4 places right: 0.00045 = $4.5 \\times 10^{-4}$.' },
  ...
  { question: 'What is the product of (x + 3)(x − 3)?', options: ['$x^{2}$ − 9', '$x^{2}$ + 9', '$x^{2}$ − 6x + 9', '$x^{2}$ + 6x + 9'], correctAnswer: 0, explanation: 'This is a difference of squares: (x + 3)(x − 3) = $x^{2}$ − 9.' },
