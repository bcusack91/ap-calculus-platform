...
export const MCQS: MCQItem[] = [
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-1-kinematics',
    question: 'A projectile is launched at 30° above the horizontal with speed 40 m/s. Its horizontal range on level ground (with $g = 10$ $m/s^{2}$) is closest to',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-1-kinematics',
    question: 'Two cars start from rest. Car A accelerates at 2 $m/s^{2}$, Car B at 4 $m/s^{2}$. At $t = 5$ s, the ratio of distance traveled by A to B is',
  ...
  /* ---- U2 Force & Translational Dynamics (6) ---- */
  {
    ...
    options: ['2 $m/s^{2}$', '4 $m/s^{2}$', '5 $m/s^{2}$', '20 $m/s^{2}$'],
    correctAnswer: 1,
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-2-force-translational-dynamics',
    question: 'A 2 kg block sits on a horizontal surface with coefficient of static friction 0.3. The minimum horizontal force needed to start sliding it is (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-2-force-translational-dynamics',
    question: 'An elevator accelerates upward at 2 $m/s^{2}$. A 60 kg person inside experiences an apparent weight (normal force from scale) of (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-2-force-translational-dynamics',
    question: 'Two blocks (5 kg and 3 kg) are connected by a string over a frictionless pulley (Atwood machine). Acceleration of the system (use $g = 10$ $m/s^{2}$) is',
    options: ['1.25 $m/s^{2}$', '2.5 $m/s^{2}$', '5 $m/s^{2}$', '10 $m/s^{2}$'],
    correctAnswer: 1,
    explanation: '$a = (m_1 - m_2)g/(m_1 + m_2) = (5-3)(10)/(8) = 2.5$ $m/s^{2}$.',
  },
  {
    type: 'mcq',
    topic: 'unit-2-force-translational-dynamics',
    question: 'A 10 kg block slides down a frictionless incline at 30°. Its acceleration along the incline is (use $g = 10$ $m/s^{2}$)',
    options: ['2.5 $m/s^{2}$', '5 $m/s^{2}$', '8.66 $m/s^{2}$', '10 $m/s^{2}$'],
    correctAnswer: 1,
    explanation: '$a = g\\sin\\theta = 10(0.5) = 5$ $m/s^{2}$. Mass cancels.',
  },
  {
    type: 'mcq',
    topic: 'unit-2-force-translational-dynamics',
    question: 'A car rounds a flat curve of radius 50 m at 20 m/s. The minimum coefficient of static friction needed is (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-3-work-energy-power',
    question: 'A 0.5 kg ball is dropped from rest from a height of 4 m. Its speed just before hitting the ground (no air resistance, $g = 10$ $m/s^{2}$) is',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-3-work-energy-power',
    question: 'A 1 kg block slides on a horizontal surface with $\\mu_k = 0.2$. It enters with speed 4 m/s. How far does it slide before stopping? (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    ...
    options: ['$0.33$ $kg\\cdot m^{2}$', '$1.33$ $kg\\cdot m^{2}$', '$4$ $kg\\cdot m^{2}$', '$5.33$ $kg\\cdot m^{2}$'],
    correctAnswer: 1,
    explanation: '$I_{center} = \\tfrac{1}{12}ML^2 = \\tfrac{1}{12}(4)(4) = 16/12 \\approx 1.33$ $kg\\cdot m^{2}$.',
  },
  {
    type: 'mcq',
    topic: 'unit-5-torque-rotational-dynamics',
    question: 'A net torque of 6 N·m acts on a wheel with moment of inertia 3 $kg\\cdot m^{2}$. Its angular acceleration is',
    options: ['0.5 $rad/s^{2}$', '2 $rad/s^{2}$', '6 $rad/s^{2}$', '18 $rad/s^{2}$'],
    correctAnswer: 1,
    explanation: '$\\alpha = \\tau/I = 6/3 = 2$ $rad/s^{2}$.',
  },
  {
    type: 'mcq',
    topic: 'unit-5-torque-rotational-dynamics',
    question: 'A uniform 10 kg beam, 4 m long, is supported at one end by a pivot and held horizontal by a vertical rope at the other end. Tension in the rope is (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-5-torque-rotational-dynamics',
    question: 'A merry-go-round of moment of inertia $I = 200$ $kg\\cdot m^{2}$ is initially at rest. A child applies tangential force 50 N at radius 2 m for 4 s. Final angular velocity is',
    options: ['1 rad/s', '2 rad/s', '4 rad/s', '8 rad/s'],
    correctAnswer: 1,
    explanation: '$\\tau = (50)(2) = 100$ N·m. $\\alpha = 100/200 = 0.5$ $rad/s^{2}$. $\\omega = \\alpha t = 0.5(4) = 2$ rad/s.',
  },
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-7-oscillations',
    question: 'A simple pendulum of length 1 m has period (use $g = 9.8$ $m/s^{2}$)',
  ...
  /* ---- U8 Fluids (5) ---- */
  {
    type: 'mcq',
    topic: 'unit-8-fluids',
    question: 'Pressure at depth 5 m below the surface of fresh water ($\\rho = 1000$ $kg/m^{3}$, $g = 10$ $m/s^{2}$, $P_{atm} = 10^5$ Pa) is',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-8-fluids',
    question: 'An object of volume $0.001$ $m^{3}$ is fully submerged in water. The buoyant force on it is (use $g = 10$ $m/s^{2}$)',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-8-fluids',
    question: 'A wood block ($\\rho = 600$ $kg/m^{3}$) floats in water. Fraction of its volume submerged is',
  ...
  },
  {
    type: 'mcq',
    topic: 'unit-8-fluids',
    question: 'Water flows steadily through a pipe whose cross-sectional area decreases from $0.10$ $m^{2}$ to $0.05$ $m^{2}$. If the inlet speed is 2 m/s, the outlet speed is',
