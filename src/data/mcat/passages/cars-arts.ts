    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'Viewers wholly unfamiliar with the pictorial tradition a work belongs to reliably agree with expert historians in ranking its works by inventiveness.',
        ],
        correctAnswer: 3,
        explanation:
          'The argument depends on inventiveness being a historical property invisible to anyone lacking the background of practice. The author allows that even untutored viewers absorb such a background "from every picture she has ever seen," so the finding must exclude that escape: viewers wholly outside the relevant tradition have no absorbed background to draw on, and their convergence with experts would mean inventiveness is readable off the surface after all, which is precisely what the author denies. The indistinguishable-panel finding is already granted in the first sentence and so changes nothing. Poorly executed documented originals is a point the author himself concedes. The enjoyment finding concerns pleasure, which the author has carefully separated from judgment.',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          'Audiences frequently weep at scenes that professional critics, reviewing the same films, describe as clumsily staged and poorly constructed.',
          'Filmmakers interviewed about their methods openly describe the cutting, scoring, and casting techniques they rely on to elicit strong emotion.',
