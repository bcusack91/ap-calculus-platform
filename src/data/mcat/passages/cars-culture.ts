...
export const CARS_CULTURE_PASSAGES: MCATPassage[] = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'The argument’s load-bearing claim is that personalized consumption starves the public of a common object — material that finds each person "by way of what that person already cares about" leaves disputants "merely elsewhere." A community of fully personalized consumers that nonetheless converges on commonly identified problems severs exactly that link: the shared object the author says personalization destroys has survived it. Reports of feeling distracted concern the quantity complaint the author already sets aside. Measurement accuracy is true-but-irrelevant to whether a commons exists. The exclusiveness of the old public is something the author himself asserts, so it cannot count against him.',
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'Visitors attending both versions frequently cannot tell a performance shortened for tourists from the complete rite as traditionally given.',
          'Many traditional performances were shortened, rearranged, or merged with others long before tourism, at the direction of the communities performing them and for reasons unrelated to outsiders.',
        ],
        correctAnswer: 1,
        explanation:
