...
export const CARS_ECONOMICS_PASSAGES: MCATPassage[] = [
  ...
  },
  {
    ...
    needsReview: false,
    passageText:
      'Consider a friend who visits you in the hospital, and then consider paying her to visit. The second visit is not a shabbier version of the first; it is a different object wearing the same outward shape. You have not bought friendship at a discount, you have bought attendance, and the thing you wanted has quietly left the room. An apology purchased is not a cheap apology. A vote sold is not a vote.\n\nWhat the example isolates is a claim about corruption: that certain goods are altered by being priced. Hold that claim beside the objection that dominates our public arguments. Every few years someone proposes a legal market in an organ, a vote, or a place at the front of a queue, and the first objection to arrive is about coercion. The seller of a kidney is desperate; his consent is the consent of a man with a gun at his back; a bargain struck on those terms is a taking. The argument is serious and often correct. It is also the weaker of the two objections available, and its dominance has crowded out the stronger one.\n\nNotice what the coercion argument concedes. It locates the wrong not in the exchange itself but in its surrounding circumstances, and so it can always be answered by improving the circumstances. Raise the seller’s income, impose a waiting period, require independent counsel, and the objection has been satisfied on its own terms. A wealthy man who sells a kidney out of curiosity is then doing nothing wrong whatever. Some will accept that cheerfully. Most people, pressed, will not, which suggests their discomfort was never really about bargaining power. The corruption claim, by contrast, survives every improvement in the bargaining: it concerns what the exchange does to the good itself.\n\nAgainst the corruption claim comes the objection I take most seriously. Who, it is asked, appointed you registrar of meanings? One man’s corruption is another man’s squeamishness. Markets in life insurance, lending at interest, and paid military service once struck decent people as obscene, and the obscenity faded without the sky falling. Absent some principle, the corruption argument is aesthetic distaste in a philosopher’s coat.\n\nThe demand for a principle is fair, and one is available, though it is narrower than its enthusiasts would like. Ask whether the good depends for its value on a motive that payment displaces. Friendship, apology, civic judgment, the care of the dying: each is valuable partly because of why it is offered; the price does not add a term to the transaction, it replaces the reason. Where no such motive is doing the work — where the good is simply the thing itself, delivered — the corruption charge has nothing to bite on, and the drift of sentiment about insurance and interest is exactly what one should expect. The test does not deliver every verdict its partisans want; a principle that decided everything in advance would be a prejudice, not a principle.\n\nNotice, finally, what the argument does not require. It does not require that anything be prohibited. The corruption claim is a claim about meaning, and its practical demand is only that such questions be settled in the open, as arguments about what a good is for, not left to a mechanism that merely records what people will pay. Markets are not neutral instruments; they are norms with an accounting system attached. To extend one into a new region of life is to assert something about the kind of thing that lives there, and a society unwilling to discuss that assertion has not thereby avoided making it.',
    questions: [
      {
      ...
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          'The example is glossed immediately: the paid visit "is not a shabbier version of the first; it is a different object wearing the same outward shape," and "you have bought attendance" instead. The next paragraph names what it was for — "What the example isolates is a claim about corruption: that certain goods are altered by being priced" — so the opening supplies the concrete case before the general claim. Reading it as a concession to the coercion argument inverts its purpose, since the coercion objection has not even been introduced yet. The claim about willingness to pay makes it an empirical observation about consumer behavior, which is not what the sentence does. And the call for legal protection contradicts the author’s explicit statement that his argument requires no prohibition.',
        skill: 'function',
        needsReview: false,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          'The test asks "whether the good depends for its value on a motive that payment displaces." A pattern in which paid apologies fail while paid firewood does not is precisely the pattern the test predicts, and it also confirms the test’s advertised narrowness. Reported discomfort about kidney sales is the raw squeamishness the author says needs a principle, so it cannot supply one. The insurance-and-interest drift is already accommodated by the author rather than added support for the test. And equal capability and loyalty among paid soldiers concerns how well the service is delivered, not whether its value depends on why it is offered — the only thing the test measures.',
        skill: 'strengthen-weaken',
        needsReview: false,
      },
      {
  ...
  },
  {
    ...
    needsReview: false,
    passageText:
      'Meaning in work is relational. It does not live inside the tasks. There is no essence of carpentry that dignifies the carpenter, no nobility distributed by occupation, and a man who sands a board all day under a supervisor who could as easily have set him sweeping is not ennobled by the wood. Meaning arises when one’s effort is required by identifiable others who would be worse off without it, and when one holds real discretion over how the thing gets done — enough that the doing could have gone otherwise, and that one is answerable for how it went. It is a feature of arrangements rather than of vocations. I put the claim first because everything else worth saying is either evidence for it or rubble to be cleared from around it.\n\nThe evidence first. The two conditions people describe as unbearable in their working lives are seldom about difficulty. The first is uselessness: the suspicion, common in prosperous offices, that the work would not be missed if it stopped, which no salary repairs and which the well paid report at least as often as anyone. The second is dictation: not that the work is hard, but that every judgment within it has been made elsewhere and arrives as instruction. Pay can compensate a person for effort. It cannot compensate him for irrelevance, because what irrelevance withholds is not comfort but standing.\n\nNow the rubble: two stories about work — both consoling, which ought to make us suspicious of each. The first treats work as pure cost: labor is what one endures for a wage, and the horizon of progress is less work, better paid, until machines take the remainder. The second is the older story, recited at graduations: that work is where a person becomes himself, that in shaping the world he shapes his own character. What the romance got wrong was not that work carries meaning but where the meaning sits; it went looking in the tasks, where there is nothing to find.\n\nThe critics of the romance have earned their contempt for it. The dignity of labor has been invoked to dignify the indignity of particular labors, to assure people worn out at fifty that their exhaustion was self-realization, and to sort the poor into the deserving employed and the suspect idle. When a phrase performs that much service for those who profit from its being believed, one is entitled to inspect it closely. But the inspection should not end where the critics end it. From the fact that the romance has been abused, they conclude the first story was right all along: meaning was a fable told to depress wages, and the honest demand is for more money and fewer hours. This concedes the wrong thing. It accepts the employer’s own framing, in which everything between the clock-in and the clock-out is a cost to be compensated, and then haggles over the price. The trade on offer is cash for voice, and it is a poor trade, offered constantly.\n\nThe practical upshot is unglamorous and does not sort neatly onto familiar sides. If meaning is relational, arrangements can be altered without abolishing anything: who decides the order of the tasks, whether the person doing the work ever meets the person it is for, whether a judgment made on the floor can survive contact with the office. These are not consolations offered in place of wages. They are the part of the bargain that wages were never able to buy, and that the demand for wages alone has trained us to stop asking for.',
    questions: [
      {
        ...
        correctAnswer: 3,
        explanation:
          'The passage opens with the claim itself — "Meaning in work is relational," arising when effort is "required by identifiable others" and joined to "real discretion" — and later diagnoses the romance accordingly: "What the romance got wrong was not that work carries meaning but where the meaning sits." The pure-cost account is the first story the author rejects. The claim that occupations confer dignity is the romance the author explicitly denies with "no nobility distributed by occupation." And confining demands to pay and hours is the conclusion the author calls conceding "the wrong thing."',
        skill: 'main-idea',
        needsReview: false,
      },
      {
  ...
  },
  {
    ...
    needsReview: false,
    passageText:
      'A graduate student entering development economics today learns, before anything else, the shape of an answerable question. It must involve many units, some receiving a program and some not; an effect that appears within a few years; an outcome someone can go and count. Deworming pills satisfy these conditions; so do school textbooks and cash transfers. A national exchange-rate regime does not, and neither does the ownership of the port, nor a decade of tariff protection for an industry that does not yet exist — not because such things are known to fail, but because there is only one national economy and it cannot be run twice. Nobody tells her that ports matter less than pills; she is taught which can appear in a dissertation, and the rest follows.\n\nThe rules she is absorbing were earned honestly. For decades, enormous programs were justified by little more than the eminence of the men proposing them, and when the money had been spent nobody could say what had been bought. The sceptics who insisted on testing — comparing villages that received a program against otherwise similar villages that did not — were right about something important, and the point should be conceded without grumbling. The insistence on testing was a genuine advance in honesty, and the field is better for the humility it forced.\n\nBut a method is never only a method. It is also a filter on the questions, and the student’s career runs through the filter. Advisers steer her toward projects that can be finished; journals prefer designs that can be defended; funders prefer to pay for what can be shown. It would be a slander to say that anyone intended this. The effect requires no intention: a field attends to what its instruments can hold. So the questions that can be answered rigorously drift toward the small, and the rest drift out of the seminar and eventually out of mind.\n\nThe word for what remains is not false. Each finding may be as solid as its authors claim. A result can be perfectly valid and still be a distraction, and a body of valid results can, in aggregate, misdescribe a subject by the pattern of its silences. A discipline organized around the correction of overconfidence has produced a literature confident about pills and silent about ports.\n\nThe planners — those who hold that poverty is a structural condition, yielding only to roads, ports, tariffs, a state deciding what its economy shall become — usually object in the wrong register. Trials are unrealistic, they say, or too slow, or condescending toward the countries studied: objections about manner, which invite the reply, quite justly, that being condescended to is preferable to being experimented upon by men who never check. The stronger objection concedes the method entirely and asks only what it leaves undiscussed.\n\nThe planners’ own record stands, and the demand that they show their working remains fair. What she deserves to be told is smaller and harder: that the choice of what to study is itself a claim about where the important causes lie, and that this claim cannot be settled by the trials, because it decides in advance which trials are run. Development economics is, at that level, an argument — about who is presumed competent, and about which arrangements are treated as background rather than as choices. That argument does not appear on her syllabus. It was settled before she arrived, built into the instrument she is learning to use, and it would be better conducted in the open than smuggled in as a matter of method.',
    questions: [
      {
  ...
  },
  {
    ...
    needsReview: false,
    passageText:
      'Put nine conscientious people in a room and ask them for a single number that says how a country is doing. Give them complete figures — mortality, literacy, wages, water quality, forests lost — and the data give them no trouble. The trouble begins when they must combine unlike things into one figure, because to do that is to fix a rate of exchange between them, and the rate is not discovered in the world; it is decided. How many hours of a river’s clarity equal a year of a child’s schooling? There is no fact of the matter awaiting a better statistical technique. Someone chooses, and the choosing is the substance of the thing.\n\nNow let the committee publish. Once the choosing is done and the result issued as one number, the choice becomes invisible. That is precisely what an index is for: to spare the reader the argument. A well-made index is a settled dispute wearing the clothes of a measurement.\n\nThe committee’s most successful ancestor is the national accounts, the figure that governments live by. It counts the felling of a forest and not the forest, the paid nurse and not the daughter; it rises after a hurricane, because rebuilding is activity. Everyone knows this indictment now; reciting it has become a form of good manners. The reformers have drawn a program from it: convene a better committee, add the unpaid hours, subtract the depleted soil, publish the improved figure. Their products are invariably more thoughtful than what they would replace. They also repeat, in a more agreeable register, the error they set out to correct, because they assume the trouble with the number was what went into it. The trouble is the number.\n\nSuppose the nine refuse the assignment altogether: publish the components, they say, and let citizens weigh them for themselves. The refusal has an honorable sound, and it accomplishes less than it promises. An unranked list does not abolish the weighting; it delegates it downstream to whoever is doing the reading — in practice, to those with the staff, the patience, and the standing to make their preferred column count. Confronted with fourteen indicators moving in different directions, a minister will find the one that flatters him, and a page that cannot say which way things are going will not be used to hold anyone to account. Plurality without ranking is not neutrality; it is a decision transferred to whoever can make it quietly.\n\nSo the choice is not between an index and honesty. It is between weights that are stated and weights that are buried, and stated weights are better for a reason that has nothing to do with their being correct. A published rate of exchange is a proposition. It can be named, contested, voted against, revised when a society changes its mind about what it owes to rivers or to daughters. A buried one cannot be argued with, because there is nothing on the page to argue with; the argument has already happened elsewhere, among people whose names do not appear.\n\nSend the nine back in, then, with the commission rewritten: not to find the true number, which does not exist, but to draft a proposal and sign it — a moral claim compressed into a decimal, kept reversible, so that anyone can open the number and find the argument inside it. The scandal of the accounts was never that they measured the wrong things, though they did. It was that they measured them so quietly that a whole civilization mistook a set of decisions for a set of facts.',
    questions: [
      {
        ...
        correctAnswer: 2,
        explanation:
          'The passage turns on the sentence "the choice is not between an index and honesty. It is between weights that are stated and weights that are buried." The improved index is the reformers’ program, whose better committees "repeat, in a more agreeable register, the error they set out to correct." Refusing aggregation is the exit the nine are imagined taking, and it fails because "Plurality without ranking is not neutrality" — the weighting is merely delegated. And defending the accounts as sound contradicts the closing charge that a civilization "mistook a set of decisions for a set of facts."',
        skill: 'main-idea',
        needsReview: false,
      },
      {
        ...
        correctAnswer: 0,
        explanation:
          'The hurricane belongs to the indictment the author treats as common property — "reciting it has become a form of good manners" — introduced as what the committee’s "most successful ancestor" illustrates. The paragraph then turns on the reformers, whose more thoughtful committees "repeat, in a more agreeable register, the error they set out to correct." The author’s own principal objection is to the form of any single figure — "The trouble is the number" — not to any particular entry in it. He does not claim disasters enrich anyone; rebuilding merely registers as activity. And removing reconstruction from the totals is exactly the repair-the-contents program he says misses the point.',
        skill: 'function',
        needsReview: false,
      },
      {
        ...
        correctAnswer: 3,
        explanation:
          'The surrounding sentences supply the sense: someone "chooses," the choosing is "the substance of the thing," and once the result is issued as one number "the choice becomes invisible," since an index exists "to spare the reader the argument." The image is of a decision presented as an observation. Committee failure to agree is not the issue — the nine are conscientious, and the reformers’ products are "invariably more thoughtful than what they would replace." No general ranking of measurement against verbal argument is offered. And the claim that better data resolve disputes about value is the opposite of "There is no fact of the matter awaiting a better statistical technique."',
        skill: 'meaning-in-context',
        needsReview: false,
      },
      {
        ...
        correctAnswer: 1,
        explanation:
          'The objection is that an unranked list "delegates" the weighting downstream to the powerful, so that "a minister will find the one that flatters him." Evidence that debate converges and that officials cannot cherry-pick removes exactly that mechanism. Readers finding lists too difficult to use supports the author instead, since a page nobody can read as a verdict "will not be used to hold anyone to account." Committee disagreement over weights confirms his claim that the rate of exchange "is not discovered in the world" but decided. And heavier press citation of indices reinforces his point about which form actually gets used to hold governments to account.',
        skill: 'strengthen-weaken',
        needsReview: false,
      },
      {
        ...
        correctAnswer: 2,
        explanation:
          'This is the delegation problem applied: "An unranked list does not abolish the weighting; it delegates it" — "downstream to whoever is doing the reading," in practice those with the staff, the patience, and the standing. Calling the change a clear improvement mistakes a refusal with "an honorable sound" for a solution, when the author holds that it "accomplishes less than it promises." Accuracy of measurement is never the passage’s concern — its concern is the fixing of rates of exchange. And restoring the old score unchanged ignores the author’s actual demand, which is that the weights be stated and contestable.',
        skill: 'application',
        needsReview: false,
      },
      {
