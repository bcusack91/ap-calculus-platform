...
const QUESTION_POOL: Question[] = [
  ...
  { question: 'Convert polar to rectangular: r = 4, theta = pi/3. Find x.', options: ['2', '$2\\sqrt{3}$', '4', '$\\sqrt{3}$'], correctAnswer: 0, explanation: 'x = r cos(theta) = 4 * cos(pi/3) = 4 * 1/2 = 2.' },
  ...
  { question: 'Simplify: $(x^{3})^{2}$', options: ['$x^{5}$', '$x^{6}$', '$2x^{3}$', '$x^{9}$'], correctAnswer: 1, explanation: 'Power of a power multiplies exponents: $x^{3\\cdot 2}$ = $x^{6}$.' },
