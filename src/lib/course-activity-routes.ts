// AUTO-GENERATED by scripts/gen-course-lookups.ts — do not edit by hand.
// Where a course's unit tests and free-response practice live, so an assignment of those types can send a student to the right page.
//
